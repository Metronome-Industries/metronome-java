...
private constructor(
    ...
    /** A builder for [V1CustomerPlanAddParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerPlanAddParams: V1CustomerPlanAddParams) = apply {
            customerId = v1CustomerPlanAddParams.customerId
            body = v1CustomerPlanAddParams.body.toBuilder()
            additionalHeaders = v1CustomerPlanAddParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerPlanAddParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerPlanAddParams =
            V1CustomerPlanAddParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerPlanAddParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(customerId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerPlanAddParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
