 ...
 */
class V1ContractCreateHistoricalInvoicesParams
private constructor(
    ...
    /** A builder for [V1ContractCreateHistoricalInvoicesParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractCreateHistoricalInvoicesParams: V1ContractCreateHistoricalInvoicesParams
        ) = apply {
            body = v1ContractCreateHistoricalInvoicesParams.body.toBuilder()
            additionalHeaders =
                v1ContractCreateHistoricalInvoicesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractCreateHistoricalInvoicesParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractCreateHistoricalInvoicesParams =
            V1ContractCreateHistoricalInvoicesParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractCreateHistoricalInvoicesParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractCreateHistoricalInvoicesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
