...
/**
 * A class that allows building an instance of [MetronomeClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class MetronomeOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MetronomeClientAsync]. */
        @JvmStatic
        fun builder() = Builder()
         ...
         */
        @JvmStatic
        fun fromEnv(): MetronomeClientAsync = builder().fromEnv().build()
    }
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MetronomeClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MetronomeClientAsync =
            MetronomeClientAsyncImpl(clientOptions
