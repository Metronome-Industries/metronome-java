...
class RateCardCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RateCardCreateResponse].
         *
    ...
    /** A builder for [RateCardCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateCardCreateResponse: RateCardCreateResponse) =
            apply {
                data = rateCardCreateResponse.data
                additionalProperties = rateCardCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RateCardCreateResponse].
         *
         ...
         */
        fun build(): RateCardCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): RateCardCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RateCardCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RateCardCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
