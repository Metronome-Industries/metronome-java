...
interface RateCardServiceAsync {
    ...
    /** @see create */
    fun create(params: RateCardCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardCreateResponse>
    ...
    /** @see retrieve */
    fun retrieve(params: RateCardRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardRetrieveResponse>

    /** @see retrieve */
    fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardRetrieveResponse> =
        retrieve(
    ...
    /** @see update */
    fun update(params: RateCardUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardUpdateResponse>
    ...
    /** @see list */
    fun list(params: RateCardListParams = RateCardListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardListPageAsync>

    /** @see list */
    fun list(params: RateCardListParams = RateCardListParams.none()): CompletableFuture<RateCardListPageAsync> =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(body: JsonValue, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardListPageAsync> =
        list(
    ...
    /** @see archive */
    fun archive(params: RateCardArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardArchiveResponse>

    /** @see archive */
    fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardArchiveResponse> =
        archive(
     ...
     *
     */
    fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams): CompletableFuture<RateCardRetrieveRateScheduleResponse> =
        retrieveRateSchedule(
          params, RequestOptions.none()
        )

    /** @see retrieveRateSchedule */
    fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RateCardRetrieveRateScheduleResponse>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): RateCardServiceAsync.WithRawResponse
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/create`, but is otherwise the             same as [RateCardServiceAsync.create]. */
        fun create(params: RateCardCreateParams): CompletableFuture<HttpResponseFor<RateCardCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: RateCardCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/get`, but is otherwise the             same as [RateCardServiceAsync.retrieve]. */
        fun retrieve(params: RateCardRetrieveParams): CompletableFuture<HttpResponseFor<RateCardRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: RateCardRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardRetrieveResponse>>

        /** @see retrieve */
        fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardRetrieveResponse>> =
            retrieve(
              RateCardRetrieveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/update`, but is otherwise the             same as [RateCardServiceAsync.update]. */
        fun update(params: RateCardUpdateParams): CompletableFuture<HttpResponseFor<RateCardUpdateResponse>> =
            update(
              params, RequestOptions.none()
            )

        /** @see update */
        fun update(params: RateCardUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardUpdateResponse>>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/list`, but is otherwise the             same as [RateCardServiceAsync.list]. */
        fun list(): CompletableFuture<HttpResponseFor<RateCardListPageAsync>> = list(RateCardListParams.none())

        /** @see list */
        fun list(params: RateCardListParams = RateCardListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardListPageAsync>>

        /** @see list */
        fun list(params: RateCardListParams = RateCardListParams.none()): CompletableFuture<HttpResponseFor<RateCardListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(body: JsonValue, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardListPageAsync>> =
            list(
              RateCardListParams.builder()
                  .body(body)
                  .build(), requestOptions
        ...
        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardListPageAsync>> =
            list(
              RateCardListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/archive`, but is otherwise the             same as [RateCardServiceAsync.archive]. */
        fun archive(params: RateCardArchiveParams): CompletableFuture<HttpResponseFor<RateCardArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: RateCardArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardArchiveResponse>>

        /** @see archive */
        fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardArchiveResponse>> =
            archive(
              RateCardArchiveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/getRateSchedule`, but is otherwise the             same as [RateCardServiceAsync.retrieveRateSchedule]. */
        fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams): CompletableFuture<HttpResponseFor<RateCardRetrieveRateScheduleResponse>> =
            retrieveRateSchedule(
              params, RequestOptions.none()
            )

        /** @see retrieveRateSchedule */
        fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RateCardRetrieveRateScheduleResponse>>
    }
}
