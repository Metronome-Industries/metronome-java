...
class CustomerServiceImpl internal constructor(
    ...
    private val billingConfig: BillingConfigService by lazy { BillingConfigServiceImpl(clientOptions) }
    ...
    override fun create(params: CustomerCreateParams, requestOptions: RequestOptions): CustomerCreateResponse =
        // post /v1/customers
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions): CustomerRetrieveResponse =
    ...
    override fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions): CustomerArchiveResponse =
        // post /v1/customers/archive
        withRawResponse().archive(params, requestOptions).parse()

    override fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions): CustomerArchiveBillingConfigurationsResponse =
    ...
    override fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions): CustomerListBillableMetricsPage =
        // get /v1/customers/{customer_id}/billable-metrics
        withRawResponse().listBillableMetrics(params, requestOptions).parse()

    override fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions): CustomerListCostsPage =
        // get /v1/customers/{customer_id}/costs
        withRawResponse().listCosts(params, requestOptions).parse()

    override fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions): CustomerPreviewEventsResponse =
        // post /v1/customers/{customer_id}/previewEvents
        withRawResponse().previewEvents(params, requestOptions).parse()

    override fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions): CustomerRetrieveBillingConfigurationsResponse =
    ...
    override fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions): CustomerSetBillingConfigurationsResponse =
        // post /v1/setCustomerBillingProviderConfigurations
        withRawResponse().setBillingConfigurations(params, requestOptions).parse()

    override fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions) {
      // post /v1/customers/{customer_id}/setIngestAliases
      withRawResponse().setIngestAliases(params, requestOptions)
    }

    override fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions): CustomerSetNameResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val billingConfig: BillingConfigService.WithRawResponse by lazy { BillingConfigServiceImpl.WithRawResponseImpl(clientOptions) }

        private val commits: CommitService.WithRawResponse by lazy { CommitServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun create(params: CustomerCreateParams, requestOptions: RequestOptions): HttpResponseFor<CustomerCreateResponse> {
        ...
        override fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<CustomerRetrieveResponse> {
          val request = HttpRequest.builder()
        ...
        override fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions): HttpResponseFor<CustomerArchiveResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerArchiveBillingConfigurationsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerListBillableMetricsPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerListCostsPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerPreviewEventsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions): HttpResponseFor<CustomerSetBillingConfigurationsResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions): HttpResponseFor<CustomerSetNameResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
