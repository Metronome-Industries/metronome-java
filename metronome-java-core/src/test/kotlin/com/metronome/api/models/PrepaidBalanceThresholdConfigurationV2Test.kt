...
class PrepaidBalanceThresholdConfigurationV2Test {

    @Test
    fun createPrepaidBalanceThresholdConfigurationV2() {
        val prepaidBalanceThresholdConfigurationV2 =
            PrepaidBalanceThresholdConfigurationV2.builder()
                ...
                .build()
        assertThat(prepaidBalanceThresholdConfigurationV2).isNotNull
