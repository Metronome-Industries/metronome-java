...
class ContractServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ContractService {

    private val withRawResponse: ContractService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ContractService = ContractServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun create(params: ContractCreateParams, requestOptions: RequestOptions): ContractCreateResponse =
        // post /v1/contracts/create
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: ContractRetrieveParams, requestOptions: RequestOptions): ContractRetrieveResponse =
        // post /v1/contracts/get
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun list(params: ContractListParams, requestOptions: RequestOptions): ContractListResponse =
        // post /v1/contracts/list
        withRawResponse().list(params, requestOptions).parse()

    override fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams, requestOptions: RequestOptions) {
      // post /v1/contracts/addManualBalanceLedgerEntry
      withRawResponse().addManualBalanceEntry(params, requestOptions)
    }

    override fun amend(params: ContractAmendParams, requestOptions: RequestOptions): ContractAmendResponse =
        // post /v1/contracts/amend
        withRawResponse().amend(params, requestOptions).parse()

    override fun archive(params: ContractArchiveParams, requestOptions: RequestOptions): ContractArchiveResponse =
        // post /v1/contracts/archive
        withRawResponse().archive(params, requestOptions).parse()

    override fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams, requestOptions: RequestOptions): ContractCreateHistoricalInvoicesResponse =
        // post /v1/contracts/createHistoricalInvoices
        withRawResponse().createHistoricalInvoices(params, requestOptions).parse()

    override fun getNetBalance(params: ContractGetNetBalanceParams, requestOptions: RequestOptions): ContractGetNetBalanceResponse =
        // post /v1/contracts/customerBalances/getNetBalance
        withRawResponse().getNetBalance(params, requestOptions).parse()

    override fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams, requestOptions: RequestOptions): ContractGetSubscriptionSeatsHistoryResponse =
        // post /v1/contracts/getSubscriptionSeatsHistory
        withRawResponse().getSubscriptionSeatsHistory(params, requestOptions).parse()

    override fun listBalances(params: ContractListBalancesParams, requestOptions: RequestOptions): ContractListBalancesPage =
        // post /v1/contracts/customerBalances/list
        withRawResponse().listBalances(params, requestOptions).parse()

    override fun listSeatBalances(params: ContractListSeatBalancesParams, requestOptions: RequestOptions): ContractListSeatBalancesResponse =
        // post /v1/contracts/seatBalances/list
        withRawResponse().listSeatBalances(params, requestOptions).parse()

    override fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams, requestOptions: RequestOptions): ContractRetrieveRateScheduleResponse =
        // post /v1/contracts/getContractRateSchedule
        withRawResponse().retrieveRateSchedule(params, requestOptions).parse()

    override fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams, requestOptions: RequestOptions): ContractRetrieveSubscriptionQuantityHistoryResponse =
    ...
    override fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams, requestOptions: RequestOptions): ContractScheduleProServicesInvoiceResponse =
        // post /v1/contracts/scheduleProServicesInvoice
        withRawResponse().scheduleProServicesInvoice(params, requestOptions).parse()

    override fun setUsageFilter(params: ContractSetUsageFilterParams, requestOptions: RequestOptions) {
      // post /v1/contracts/setUsageFilter
      withRawResponse().setUsageFilter(params, requestOptions)
    }

    override fun updateEndDate(params: ContractUpdateEndDateParams, requestOptions: RequestOptions): ContractUpdateEndDateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val rateCards: RateCardService.WithRawResponse by lazy { RateCardServiceImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ContractService.WithRawResponse = ContractServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: ContractCreateParams, requestOptions: RequestOptions): HttpResponseFor<ContractCreateResponse> {
        ...
        override fun retrieve(params: ContractRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<ContractRetrieveResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun list(params: ContractListParams, requestOptions: RequestOptions): HttpResponseFor<ContractListResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun amend(params: ContractAmendParams, requestOptions: RequestOptions): HttpResponseFor<ContractAmendResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun archive(params: ContractArchiveParams, requestOptions: RequestOptions): HttpResponseFor<ContractArchiveResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams, requestOptions: RequestOptions): HttpResponseFor<ContractCreateHistoricalInvoicesResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getNetBalance(params: ContractGetNetBalanceParams, requestOptions: RequestOptions): HttpResponseFor<ContractGetNetBalanceResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams, requestOptions: RequestOptions): HttpResponseFor<ContractGetSubscriptionSeatsHistoryResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listBalances(params: ContractListBalancesParams, requestOptions: RequestOptions): HttpResponseFor<ContractListBalancesPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listSeatBalances(params: ContractListSeatBalancesParams, requestOptions: RequestOptions): HttpResponseFor<ContractListSeatBalancesResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams, requestOptions: RequestOptions): HttpResponseFor<ContractRetrieveRateScheduleResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams, requestOptions: RequestOptions): HttpResponseFor<ContractRetrieveSubscriptionQuantityHistoryResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams, requestOptions: RequestOptions): HttpResponseFor<ContractScheduleProServicesInvoiceResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setUsageFilter(params: ContractSetUsageFilterParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun updateEndDate(params: ContractUpdateEndDateParams, requestOptions: RequestOptions): HttpResponseFor<ContractUpdateEndDateResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
