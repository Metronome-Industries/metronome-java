...
internal class InvoiceListBreakdownsPageResponseTest {
    ...
    @Test
    fun create() {
        val invoiceListBreakdownsPageResponse =
            InvoiceListBreakdownsPageResponse.builder()
                .addData(
        ...
        assertThat(invoiceListBreakdownsPageResponse.data())
            .containsExactly(
                InvoiceListBreakdownsResponse.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceListBreakdownsPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceListBreakdownsPageResponse),
                jacksonTypeRef<InvoiceListBreakdownsPageResponse>(),
            )

        assertThat(roundtrippedInvoiceListBreakdownsPageResponse)
            .isEqualTo(invoiceListBreakdownsPageResponse)
    }
}
