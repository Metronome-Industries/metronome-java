...
class ContractProductRetrieveResponseTest {

    @Test
    fun createContractProductRetrieveResponse() {
        val contractProductRetrieveResponse =
            ContractProductRetrieveResponse.builder()
                .data(
                    ContractProductRetrieveResponse.Data.builder()
                        ...
                        .type(ContractProductRetrieveResponse.Data.Type.USAGE)
                        .updates(
                            listOf(
                                ContractProductRetrieveResponse.Data.Update.builder()
                                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                    .createdBy("created_by")
                ...
                .build()
        assertThat(contractProductRetrieveResponse).isNotNull
        assertThat(contractProductRetrieveResponse.data())
            .isEqualTo(
                ContractProductRetrieveResponse.Data.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .current(
