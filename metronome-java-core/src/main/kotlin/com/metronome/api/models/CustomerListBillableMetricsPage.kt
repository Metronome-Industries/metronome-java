...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListBillableMetricsPage && customersService == other.customersService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = CustomerListBillableMetricsPage(customersService, params, response)
    }
    ...
    class AutoPager(private val firstPage: CustomerListBillableMetricsPage) :
