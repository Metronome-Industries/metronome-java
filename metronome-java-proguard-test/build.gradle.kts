...
dependencies {
    testImplementation(project(":metronome-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../metronome-java-core/src/main/resources/META-INF/proguard/metronome-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.metronome.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../metronome-java-core/src/main/resources/META-INF/proguard/metronome-java-core.pro",
