...
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    private val data: JsonField<List<Credit>> = JsonMissing.of(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerCreditListResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties /* spotless:on */
    }
