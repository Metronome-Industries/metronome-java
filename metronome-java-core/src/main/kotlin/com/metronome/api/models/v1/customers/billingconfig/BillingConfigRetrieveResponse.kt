...
class BillingConfigRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillingConfigRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingConfigRetrieveResponse: BillingConfigRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): BillingConfigRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("aws_expiration_date") @ExcludeMissing awsExpirationDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            ...
            @JsonProperty("azure_expiration_date") @ExcludeMissing azureExpirationDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("azure_plan_id") @ExcludeMissing azurePlanId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("azure_start_date") @ExcludeMissing azureStartDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("azure_subscription_status") @ExcludeMissing azureSubscriptionStatus: JsonField<AzureSubscriptionStatus> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun awsExpirationDate(): Optional<OffsetDateTime> = awsExpirationDate.getOptional("aws_expiration_date")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun azureExpirationDate(): Optional<OffsetDateTime> = azureExpirationDate.getOptional("azure_expiration_date")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun azureStartDate(): Optional<OffsetDateTime> = azureStartDate.getOptional("azure_start_date")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun azureSubscriptionStatus(): Optional<AzureSubscriptionStatus> = azureSubscriptionStatus.getOptional("azure_subscription_status")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun billingProviderCustomerId(): Optional<String> = billingProviderCustomerId.getOptional("billing_provider_customer_id")
         ...
         *
         * Unlike [awsExpirationDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [azureExpirationDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [azureStartDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [azureSubscriptionStatus], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var azureSubscriptionStatus: JsonField<AzureSubscriptionStatus> = JsonMissing.of()
            ...
            /** Contract expiration date for the customer. The expected format is RFC 3339 and can be retrieved from [AWS's GetEntitlements API](https://docs.aws.amazon.com/marketplaceentitlement/latest/APIReference/API_GetEntitlements.html). */
            fun awsExpirationDate(awsExpirationDate: OffsetDateTime) = awsExpirationDate(JsonField.of(awsExpirationDate))

            /**
             * Sets [Builder.awsExpirationDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.awsExpirationDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun awsExpirationDate(awsExpirationDate: JsonField<OffsetDateTime>) =
                apply {
            ...
            /** Subscription term start/end date for the customer. The expected format is RFC 3339 and can be retrieved from [Azure's Get Subscription API](https://learn.microsoft.com/en-us/partner-center/marketplace/partner-center-portal/pc-saas-fulfillment-subscription-api#get-subscription). */
            fun azureExpirationDate(azureExpirationDate: OffsetDateTime) = azureExpirationDate(JsonField.of(azureExpirationDate))

            /**
             * Sets [Builder.azureExpirationDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.azureExpirationDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun azureExpirationDate(azureExpirationDate: JsonField<OffsetDateTime>) =
                apply {
             ...
             *
             * You should usually call [Builder.azurePlanId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun azurePlanId(azurePlanId: JsonField<String>) =
                apply {
                    this.azurePlanId = azurePlanId
                }

            /** Subscription term start/end date for the customer. The expected format is RFC 3339 and can be retrieved from [Azure's Get Subscription API](https://learn.microsoft.com/en-us/partner-center/marketplace/partner-center-portal/pc-saas-fulfillment-subscription-api#get-subscription). */
            fun azureStartDate(azureStartDate: OffsetDateTime) = azureStartDate(JsonField.of(azureStartDate))

            /**
             * Sets [Builder.azureStartDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.azureStartDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun azureStartDate(azureStartDate: JsonField<OffsetDateTime>) =
                apply {
                    this.azureStartDate = azureStartDate
                }

            fun azureSubscriptionStatus(azureSubscriptionStatus: AzureSubscriptionStatus) = azureSubscriptionStatus(JsonField.of(azureSubscriptionStatus))

            /**
             * Sets [Builder.azureSubscriptionStatus] to an arbitrary JSON value.
             *
             * You should usually call [Builder.azureSubscriptionStatus] with a well-typed [AzureSubscriptionStatus] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun azureSubscriptionStatus(azureSubscriptionStatus: JsonField<AzureSubscriptionStatus>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (awsCustomerAccountId.asKnown().isPresent) 1 else 0) + (if (awsCustomerId.asKnown().isPresent) 1 else 0) + (if (awsExpirationDate.asKnown().isPresent) 1 else 0) + (if (awsIsSubscriptionProduct.asKnown().isPresent) 1 else 0) + (if (awsProductCode.asKnown().isPresent) 1 else 0) + (awsRegion.asKnown().getOrNull()?.validity() ?: 0) + (if (azureExpirationDate.asKnown().isPresent) 1 else 0) + (if (azurePlanId.asKnown().isPresent) 1 else 0) + (if (azureStartDate.asKnown().isPresent) 1 else 0) + (azureSubscriptionStatus.asKnown().getOrNull()?.validity() ?: 0) + (if (billingProviderCustomerId.asKnown().isPresent) 1 else 0) + (stripeCollectionMethod.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class AzureSubscriptionStatus @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            /**
             * An enum containing [AzureSubscriptionStatus]'s known values, as well as an [_UNKNOWN] member.
             *
             * An instance of [AzureSubscriptionStatus] can contain an unknown value in a couple of cases:
             *
             * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
             *   an older version than the API, then the API may respond with new members that the SDK is unaware
             *   of.
            ...
            enum class Value {
                ...
                SUSPENDED,
                PENDING_FULFILLMENT_START,
                /** An enum member indicating that [AzureSubscriptionStatus] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw MetronomeInvalidDataException("Unknown AzureSubscriptionStatus: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): AzureSubscriptionStatus =
                apply {
                    if (validated) {
                      return@apply
                    }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && awsCustomerAccountId == other.awsCustomerAccountId && awsCustomerId == other.awsCustomerId && awsExpirationDate == other.awsExpirationDate && awsIsSubscriptionProduct == other.awsIsSubscriptionProduct && awsProductCode == other.awsProductCode && awsRegion == other.awsRegion && azureExpirationDate == other.azureExpirationDate && azurePlanId == other.azurePlanId && azureStartDate == other.azureStartDate && azureSubscriptionStatus == other.azureSubscriptionStatus && billingProviderCustomerId == other.billingProviderCustomerId && stripeCollectionMethod == other.stripeCollectionMethod && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(awsCustomerAccountId, awsCustomerId, awsExpirationDate, awsIsSubscriptionProduct, awsProductCode, awsRegion, azureExpirationDate, azurePlanId, azureStartDate, azureSubscriptionStatus, billingProviderCustomerId, stripeCollectionMethod, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{awsCustomerAccountId=$awsCustomerAccountId, awsCustomerId=$awsCustomerId, awsExpirationDate=$awsExpirationDate, awsIsSubscriptionProduct=$awsIsSubscriptionProduct, awsProductCode=$awsProductCode, awsRegion=$awsRegion, azureExpirationDate=$azureExpirationDate, azurePlanId=$azurePlanId, azureStartDate=$azureStartDate, azureSubscriptionStatus=$azureSubscriptionStatus, billingProviderCustomerId=$billingProviderCustomerId, stripeCollectionMethod=$stripeCollectionMethod, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillingConfigRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BillingConfigRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
