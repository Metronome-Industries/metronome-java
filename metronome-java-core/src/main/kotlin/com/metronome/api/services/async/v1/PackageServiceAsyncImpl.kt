...
class PackageServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PackageServiceAsync {

    private val withRawResponse: PackageServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): PackageServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PackageServiceAsync = PackageServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: PackageCreateParams, requestOptions: RequestOptions): CompletableFuture<PackageCreateResponse> =
        // post /v1/packages/create
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions): CompletableFuture<PackageRetrieveResponse> =
        // post /v1/packages/get
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun list(params: PackageListParams, requestOptions: RequestOptions): CompletableFuture<PackageListPageAsync> =
        // post /v1/packages/list
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun archive(params: PackageArchiveParams, requestOptions: RequestOptions): CompletableFuture<PackageArchiveResponse> =
        // post /v1/packages/archive
        withRawResponse().archive(params, requestOptions).thenApply { it.parse() }

    override fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions): CompletableFuture<PackageListContractsOnPackagePageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PackageServiceAsync.WithRawResponse = PackageServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<PackageCreateResponse> = jsonHandler<PackageCreateResponse>(clientOptions.jsonMapper)

        override fun create(params: PackageCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageCreateResponse>> {
        ...
        override fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageRetrieveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun list(params: PackageListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun archive(params: PackageArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageArchiveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageListContractsOnPackagePageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
