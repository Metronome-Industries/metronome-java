...
class CreditGrantVoidResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditGrantVoidResponse].
         *
    ...
    /** A builder for [CreditGrantVoidResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantVoidResponse: CreditGrantVoidResponse) =
            apply {
                data = creditGrantVoidResponse.data
                additionalProperties = creditGrantVoidResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CreditGrantVoidResponse].
         *
         ...
         */
        fun build(): CreditGrantVoidResponse =
     ...
     *   expected type.
     */
    fun validate(): CreditGrantVoidResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantVoidResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditGrantVoidResponse{data=$data, additionalProperties=$additionalProperties}"
}
