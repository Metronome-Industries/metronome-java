 ...
 * entity types.
 */
class V1CustomFieldListKeysParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1CustomFieldListKeysParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1CustomFieldListKeysParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomFieldListKeysParams: V1CustomFieldListKeysParams) = apply {
            nextPage = v1CustomFieldListKeysParams.nextPage
            body = v1CustomFieldListKeysParams.body.toBuilder()
            additionalHeaders = v1CustomFieldListKeysParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomFieldListKeysParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomFieldListKeysParams =
            V1CustomFieldListKeysParams(
                nextPage,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomFieldListKeysParams && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(nextPage, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomFieldListKeysParams{nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
