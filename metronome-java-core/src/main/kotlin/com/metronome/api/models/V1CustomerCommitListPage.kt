 ...
 */
class V1CustomerCommitListPage
private constructor(
    private val commitsService: CommitService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerCommitListPage && commitsService == other.commitsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(commitsService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerCommitListPage{commitsService=$commitsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1CustomerCommitListPage> {
        return getNextPageParams().map { commitsService.list(it) }
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(
            commitsService: CommitService,
            params: V1CustomerCommitListParams,
            response: Response,
        ) = V1CustomerCommitListPage(commitsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerCommitListPage) : Iterable<Commit> {

        override fun iterator(): Iterator<Commit> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
