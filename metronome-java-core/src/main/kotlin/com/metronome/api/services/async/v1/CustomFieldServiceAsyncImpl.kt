...
class CustomFieldServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CustomFieldServiceAsync {

    private val withRawResponse: CustomFieldServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CustomFieldServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldServiceAsync = CustomFieldServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /v1/customFields/addKey
        withRawResponse().addKey(params, requestOptions).thenAccept {}

    override fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /v1/customFields/deleteValues
        withRawResponse().deleteValues(params, requestOptions).thenAccept {}

    override fun listKeys(params: CustomFieldListKeysParams, requestOptions: RequestOptions): CompletableFuture<CustomFieldListKeysPageAsync> =
        // post /v1/customFields/listKeys
        withRawResponse().listKeys(params, requestOptions).thenApply { it.parse() }

    override fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /v1/customFields/removeKey
        withRawResponse().removeKey(params, requestOptions).thenAccept {}

    override fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldServiceAsync.WithRawResponse = CustomFieldServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val addKeyHandler: Handler<Void?> = emptyHandler()

        override fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
        ...
        override fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  deleteValuesHandler.handle(it)
              }
          } }
        }

        private val listKeysHandler: Handler<CustomFieldListKeysPageResponse> = jsonHandler<CustomFieldListKeysPageResponse>(clientOptions.jsonMapper)

        override fun listKeys(params: CustomFieldListKeysParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomFieldListKeysPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
