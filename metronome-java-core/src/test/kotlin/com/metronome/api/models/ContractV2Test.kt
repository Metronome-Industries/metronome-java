...
internal class ContractV2Test {
    ...
    fun create() {
            ...
            ContractV2.builder()
                ...
                .customerBillingProviderConfiguration(
                    ContractV2.CustomerBillingProviderConfiguration.builder()
                        ...
                        .configuration(
                            ContractV2.CustomerBillingProviderConfiguration.Configuration.builder()
                                .putAdditionalProperty("foo", JsonValue.from("bar"))
                                .build()
                        )
                        .customerId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                ...
                .addRevenueSystemConfigurationSchedule(
                    ContractV2.RevenueSystemConfigurationSchedule.builder()
                        ...
                        .revenueSystemConfiguration(
                            ContractV2.RevenueSystemConfigurationSchedule.RevenueSystemConfiguration
                                .builder()
                                .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                .configuration(
                    ...
                    ContractV2.SpendTracker.builder()
                        ...
                        .addApplicableSpendSpecifier(
                            ContractV2.SpendTracker.ApplicableSpendSpecifier.builder()
                                ...
                                .discounted(
                                    ContractV2.SpendTracker.ApplicableSpendSpecifier.Discounted.ANY
                                )
                                .build()
                        )
                        .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                ...
                ContractV2.Commit.builder()
                    ...
                    .addLedger(
                        ContractV2.Commit.Ledger.PrepaidCommitSegmentStartLedgerEntry.builder()
                            ...
                            .timestamp(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .type(
                                ContractV2.Commit.Ledger.PrepaidCommitSegmentStartLedgerEntry.Type
                                    .PREPAID_COMMIT_SEGMENT_START
                            )
                            .build()
                    )
        ...
        assertThat(contractV2.createdAt())
        ...
        assertThat(contractV2.overrides())
            .containsExactly(
                ContractV2.Override.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    ...
                    .addOverrideSpecifier(
                        ContractV2.Override.OverrideSpecifier.builder()
                            ...
                            .pricingGroupValues(
                                ContractV2.Override.OverrideSpecifier.PricingGroupValues.builder()
                                    .putAdditionalProperty("foo", JsonValue.from("string"))
                                    .build()
                            )
                            .productId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(contractV2.scheduledCharges())
            .containsExactly(
                ScheduledCharge.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .product(
        ...
        assertThat(contractV2.startingAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(contractV2.transitions())
            .containsExactly(
                ContractV2.Transition.builder()
                    .fromContractId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .toContractId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(contractV2.usageStatementSchedule())
            .isEqualTo(
                ContractV2.UsageStatementSchedule.builder()
                    .billingAnchorDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .frequency(ContractV2.UsageStatementSchedule.Frequency.MONTHLY)
        ...
        assertThat(contractV2.billingProviderConfigurationSchedule().getOrNull())
            .containsExactly(
                ContractV2.BillingProviderConfigurationSchedule.builder()
                    .billingProviderConfiguration(
                        ContractV2.BillingProviderConfigurationSchedule.BillingProviderConfiguration
                            .builder()
                            .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .archivedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .billingProvider(
        ...
        assertThat(contractV2.customFields())
            .contains(
                ContractV2.CustomFields.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(contractV2.customerBillingProviderConfiguration())
            .contains(
                ContractV2.CustomerBillingProviderConfiguration.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .archivedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    ...
                    .deliveryMethodConfiguration(
                        ContractV2.CustomerBillingProviderConfiguration.DeliveryMethodConfiguration
                            .builder()
                            .putAdditionalProperty("foo", JsonValue.from("bar"))
                            .build()
                    )
        ...
        assertThat(contractV2.endingBefore())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(contractV2.hasMore())
            .contains(ContractV2.HasMore.builder().commits(true).credits(true).build())
        assertThat(contractV2.hierarchyConfiguration())
            .contains(
                ContractV2.HierarchyConfiguration.ofParent(
                    ContractV2.HierarchyConfiguration.ParentHierarchyConfiguration.builder()
                        .addChild(
                            ContractV2.HierarchyConfiguration.ParentHierarchyConfiguration.Child
                                .builder()
        ...
        assertThat(contractV2.multiplierOverridePrioritization())
            .contains(ContractV2.MultiplierOverridePrioritization.LOWEST_MULTIPLIER)
        ...
        assertThat(contractV2.prepaidBalanceThresholdConfiguration())
            .contains(
                PrepaidBalanceThresholdConfigurationV2.builder()
                    .commit(
                        PrepaidBalanceThresholdConfigurationV2.Commit.builder()
        ...
        assertThat(contractV2.revenueSystemConfigurationSchedule().getOrNull())
            .containsExactly(
                ContractV2.RevenueSystemConfigurationSchedule.builder()
                    .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .revenueSystemConfiguration(
        ...
        assertThat(contractV2.scheduledChargesOnUsageInvoices())
            .contains(ContractV2.ScheduledChargesOnUsageInvoices.ALL)
        assertThat(contractV2.spendThresholdConfiguration())
            .contains(
                SpendThresholdConfigurationV2.builder()
                    .commit(
                        BaseThresholdCommit.builder()
        ...
        assertThat(contractV2.spendTrackers().getOrNull())
            .containsExactly(
                ContractV2.SpendTracker.builder()
                    .alias("alias")
                    .addApplicableSpendSpecifier(
