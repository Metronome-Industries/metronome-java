...
private constructor(
    ...
    @JvmSynthetic internal fun getBody(): InvoiceRegenerateBody = body
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InvoiceRegenerateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
