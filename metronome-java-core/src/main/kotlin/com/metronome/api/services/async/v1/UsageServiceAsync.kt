...
interface UsageServiceAsync {
    ...
    /** @see list */
    fun list(params: UsageListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<UsageListPageAsync>
    ...
    /** @see ingest */
    fun ingest(params: UsageIngestParams = UsageIngestParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see ingest */
    fun ingest(usage: List<UsageIngestParams.Usage>, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?> =
        ingest(
     ...
     *
     */
    fun listWithGroups(params: UsageListWithGroupsParams): CompletableFuture<UsageListWithGroupsPageAsync> =
        listWithGroups(
          params, RequestOptions.none()
        )

    /** @see listWithGroups */
    fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<UsageListWithGroupsPageAsync>
    ...
    /** @see search */
    fun search(params: UsageSearchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<List<UsageSearchResponse>>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/usage`, but is otherwise the             same as [UsageServiceAsync.list]. */
        ...
        /** @see list */
        fun list(params: UsageListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<UsageListPageAsync>>

        /** Returns a raw HTTP response for `post /v1/ingest`, but is otherwise the             same as [UsageServiceAsync.ingest]. */
        fun ingest(): CompletableFuture<HttpResponse> = ingest(UsageIngestParams.none())

        /** @see ingest */
        fun ingest(params: UsageIngestParams = UsageIngestParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** @see ingest */
        fun ingest(params: UsageIngestParams = UsageIngestParams.none()): CompletableFuture<HttpResponse> =
            ingest(
              params, RequestOptions.none()
            )

        /** @see ingest */
        fun ingest(usage: List<UsageIngestParams.Usage>, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse> =
            ingest(
              UsageIngestParams.builder()
                  .usage(usage)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/usage/groups`, but is otherwise the             same as [UsageServiceAsync.listWithGroups]. */
        fun listWithGroups(params: UsageListWithGroupsParams): CompletableFuture<HttpResponseFor<UsageListWithGroupsPageAsync>> =
            listWithGroups(
              params, RequestOptions.none()
            )

        /** @see listWithGroups */
        fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<UsageListWithGroupsPageAsync>>

        /** Returns a raw HTTP response for `post /v1/events/search`, but is otherwise the             same as [UsageServiceAsync.search]. */
        fun search(params: UsageSearchParams): CompletableFuture<HttpResponseFor<List<UsageSearchResponse>>> =
            search(
              params, RequestOptions.none()
            )

        /** @see search */
        fun search(params: UsageSearchParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<List<UsageSearchResponse>>>
    }
}
