...
class AuditLogListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<AuditLogListResponse>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AuditLogListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(auditLogListPageResponse: AuditLogListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<AuditLogListResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AuditLogListResponse>>) =
            apply {
         ...
         */
        fun addData(data: AuditLogListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): AuditLogListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AuditLogListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AuditLogListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
