...
internal class RateAddParamsTest {
    ...
    @Test
    fun body() {
      val params = RateAddParams.builder()
          .entitled(true)
          .productId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .rateCardId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .rateType(RateAddParams.RateType.FLAT)
      ...
      assertThat(body.commitRate()).contains(CommitRate.builder()
          .rateType(CommitRate.RateType.FLAT)
          .price(0.0)
          .addTier(CommitRate.Tier.builder()
              .price(0.0)
      ...
      assertThat(body.customRate()).contains(RateAddParams.CustomRate.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      ...
      assertThat(body.pricingGroupValues()).contains(RateAddParams.PricingGroupValues.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(body.quantity()).contains(0.0)
      assertThat(body.tiers().getOrNull()).containsExactly(RateAddParams.Tier.builder()
          .price(0.0)
          .size(0.0)
          .build())
    }
