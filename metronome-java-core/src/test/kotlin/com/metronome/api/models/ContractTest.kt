...
internal class ContractTest {
    ...
    fun create() {
                    ...
                    Contract.SpendTracker.builder()
                        ...
                        .addApplicableSpendSpecifier(
                            Contract.SpendTracker.ApplicableSpendSpecifier.builder()
                                ...
                                .discounted(
                                    Contract.SpendTracker.ApplicableSpendSpecifier.Discounted.ANY
                                )
                                .build()
                        )
                        .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(contract.customerBillingProviderConfiguration())
            .contains(
                Contract.CustomerBillingProviderConfiguration.builder()
                    ...
                    .deliveryMethodConfiguration(
                        Contract.CustomerBillingProviderConfiguration.DeliveryMethodConfiguration
                            .builder()
                            .putAdditionalProperty("foo", JsonValue.from("bar"))
                            .build()
                    )
        ...
        assertThat(contract.spendTrackers().getOrNull())
            .containsExactly(
                Contract.SpendTracker.builder()
                    .alias("alias")
                    .addApplicableSpendSpecifier(
        ...
        assertThat(contract.subscriptions().getOrNull())
            .containsExactly(
                Subscription.builder()
                    .billingPeriods(
                        Subscription.BillingPeriods.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedContract =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(contract),
                jacksonTypeRef<Contract>(),
            )
