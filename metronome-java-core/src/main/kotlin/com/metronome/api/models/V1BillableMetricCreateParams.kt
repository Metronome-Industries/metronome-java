 ...
 */
class V1BillableMetricCreateParams
private constructor(
    ...
    /** A builder for [V1BillableMetricCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1BillableMetricCreateParams: V1BillableMetricCreateParams) = apply {
            body = v1BillableMetricCreateParams.body.toBuilder()
            additionalHeaders = v1BillableMetricCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1BillableMetricCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1BillableMetricCreateParams =
            V1BillableMetricCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1BillableMetricCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1BillableMetricCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
