 ...
 *
 */
class PackageListContractsOnPackageParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PackageListContractsOnPackageParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(packageListContractsOnPackageParams: PackageListContractsOnPackageParams) =
            apply {
                ...
                additionalQueryParams = packageListContractsOnPackageParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (packageId.asKnown().isPresent) 1 else 0) + (if (coveringDate.asKnown().isPresent) 1 else 0) + (if (includeArchived.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && packageId == other.packageId && coveringDate == other.coveringDate && includeArchived == other.includeArchived && startingAt == other.startingAt && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(packageId, coveringDate, includeArchived, startingAt, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{packageId=$packageId, coveringDate=$coveringDate, includeArchived=$includeArchived, startingAt=$startingAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PackageListContractsOnPackageParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PackageListContractsOnPackageParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
