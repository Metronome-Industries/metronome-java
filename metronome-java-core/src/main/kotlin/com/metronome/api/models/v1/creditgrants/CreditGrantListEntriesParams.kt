 ...
 *
 */
class CreditGrantListEntriesParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantListEntriesParams: CreditGrantListEntriesParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditTypeIds.asKnown().getOrNull()?.size ?: 0) + (customerIds.asKnown().getOrNull()?.size ?: 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (startingOn.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && creditTypeIds == other.creditTypeIds && customerIds == other.customerIds && endingBefore == other.endingBefore && startingOn == other.startingOn && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{creditTypeIds=$creditTypeIds, customerIds=$customerIds, endingBefore=$endingBefore, startingOn=$startingOn, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantListEntriesParams && nextPage == other.nextPage && sort == other.sort && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(nextPage, sort, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditGrantListEntriesParams{nextPage=$nextPage, sort=$sort, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
