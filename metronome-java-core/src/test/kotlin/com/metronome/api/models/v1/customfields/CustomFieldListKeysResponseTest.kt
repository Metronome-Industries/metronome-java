...
internal class CustomFieldListKeysResponseTest {
    ...
    @Test
    fun create() {
      val customFieldListKeysResponse = CustomFieldListKeysResponse.builder()
      ...
      assertThat(customFieldListKeysResponse.entity()).isEqualTo(CustomFieldListKeysResponse.Entity.ALERT)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomFieldListKeysResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(customFieldListKeysResponse), jacksonTypeRef<CustomFieldListKeysResponse>())
