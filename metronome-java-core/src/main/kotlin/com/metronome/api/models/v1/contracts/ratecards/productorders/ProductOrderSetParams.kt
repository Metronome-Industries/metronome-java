 ...
 *
 */
class ProductOrderSetParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productOrderSetParams: ProductOrderSetParams) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (productOrder.asKnown().getOrNull()?.size ?: 0) + (if (rateCardId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && productOrder == other.productOrder && rateCardId == other.rateCardId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{productOrder=$productOrder, rateCardId=$rateCardId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductOrderSetParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ProductOrderSetParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
