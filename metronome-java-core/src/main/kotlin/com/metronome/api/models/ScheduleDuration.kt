...
private constructor(
    ...
    ) : this(scheduleItems, accessType, creditType, mutableMapOf())
    ...
    /**
     * Indicates how the balance is drawn down. `SPEND` deducts the dollar cost of usage. `QUANTITY`
     * deducts the number of units used.
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(scheduleDuration: ScheduleDuration) = apply {
            ...
            accessType = scheduleDuration.accessType
    ...
    private val hashCode: Int by lazy {
        Objects.hash(scheduleItems, accessType, creditType, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ScheduleDuration{scheduleItems=$scheduleItems, accessType=$accessType, creditType=$creditType, additionalProperties=$additionalProperties}"
}
