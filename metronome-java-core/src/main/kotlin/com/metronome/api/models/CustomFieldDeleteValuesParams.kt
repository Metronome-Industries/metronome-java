...
constructor(
    ...
    override fun toString() =
        "CustomFieldDeleteValuesParams{entity=$entity, entityId=$entityId, keys=$keys, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
