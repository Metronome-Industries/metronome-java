...
interface BillableMetricService {
    ...
    /** @see create */
    fun create(params: BillableMetricCreateParams, requestOptions: RequestOptions = RequestOptions.none()): BillableMetricCreateResponse
    ...
    /** @see retrieve */
    fun retrieve(params: BillableMetricRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): BillableMetricRetrieveResponse
    ...
    /** @see list */
    fun list(params: BillableMetricListParams = BillableMetricListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): BillableMetricListPage

    /** @see list */
    fun list(params: BillableMetricListParams = BillableMetricListParams.none()): BillableMetricListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    /** @see archive */
    fun archive(params: BillableMetricArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): BillableMetricArchiveResponse

    /** @see archive */
    fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): BillableMetricArchiveResponse =
        archive(
    ...
    /** @see archive */
    fun archive(id: Id): BillableMetricArchiveResponse =
        archive(
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BillableMetricService.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/billable-metrics/create`, but is otherwise the             same as [BillableMetricService.create]. */
        @MustBeClosed
        fun create(params: BillableMetricCreateParams): HttpResponseFor<BillableMetricCreateResponse> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: BillableMetricCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillableMetricCreateResponse>

        /** Returns a raw HTTP response for `get /v1/billable-metrics/{billable_metric_id}`, but is otherwise the             same as [BillableMetricService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: BillableMetricRetrieveParams): HttpResponseFor<BillableMetricRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: BillableMetricRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillableMetricRetrieveResponse>

        /** Returns a raw HTTP response for `get /v1/billable-metrics`, but is otherwise the             same as [BillableMetricService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<BillableMetricListPage> = list(BillableMetricListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: BillableMetricListParams = BillableMetricListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillableMetricListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: BillableMetricListParams = BillableMetricListParams.none()): HttpResponseFor<BillableMetricListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `post /v1/billable-metrics/archive`, but is otherwise the             same as [BillableMetricService.archive]. */
        @MustBeClosed
        fun archive(params: BillableMetricArchiveParams): HttpResponseFor<BillableMetricArchiveResponse> =
            archive(
              params, RequestOptions.none()
            )
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: BillableMetricArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillableMetricArchiveResponse>

        /** @see archive */
        @MustBeClosed
        fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillableMetricArchiveResponse> =
            archive(
              BillableMetricArchiveParams.builder()
                  .id(id)
                  .build(), requestOptions
