...
internal class PricingUnitListResponseTest {
    ...
    @Test
    fun create() {
      val pricingUnitListResponse = PricingUnitListResponse.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedPricingUnitListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(pricingUnitListResponse), jacksonTypeRef<PricingUnitListResponse>())
