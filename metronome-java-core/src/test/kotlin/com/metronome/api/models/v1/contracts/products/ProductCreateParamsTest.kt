...
internal class ProductCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.compositeProductIds().getOrNull()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.compositeTags().getOrNull()).containsExactly("string")
      assertThat(body.customFields()).contains(ProductCreateParams.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(body.quantityConversion()).contains(QuantityConversion.builder()
          .conversionFactor(0.0)
          .operation(QuantityConversion.Operation.MULTIPLY)
          .name("name")
          .build())
      assertThat(body.quantityRounding()).contains(QuantityRounding.builder()
          .decimalPlaces(0.0)
          .roundingMethod(QuantityRounding.RoundingMethod.ROUND_UP)
          .build())
      assertThat(body.sqlBreakdownGranularity()).contains(ProductCreateParams.SqlBreakdownGranularity.HOUR)
