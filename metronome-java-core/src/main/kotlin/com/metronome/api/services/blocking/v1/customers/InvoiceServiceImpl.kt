...
class InvoiceServiceImpl internal constructor(
    ...
    override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): InvoiceRetrieveResponse =
    ...
    override fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions): InvoiceAddChargeResponse =
        // post /v1/customers/{customer_id}/addCharge
        withRawResponse().addCharge(params, requestOptions).parse()

    override fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions): InvoiceListBreakdownsPage =
        // get /v1/customers/{customer_id}/invoices/breakdowns
        withRawResponse().listBreakdowns(params, requestOptions).parse()

    override fun retrievePdf(params: InvoiceRetrievePdfParams, requestOptions: RequestOptions): HttpResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<InvoiceRetrieveResponse> {
        ...
        override fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions): HttpResponseFor<InvoiceAddChargeResponse> {
          val request = HttpRequest.builder()
        ...
        override fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions): HttpResponseFor<InvoiceListBreakdownsPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
