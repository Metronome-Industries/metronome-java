 ...
 *
 */
class CustomerListCostsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerListCostsParams: CustomerListCostsParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerListCostsParams && customerId == other.customerId && endingBefore == other.endingBefore && startingOn == other.startingOn && limit == other.limit && nextPage == other.nextPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, endingBefore, startingOn, limit, nextPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerListCostsParams{customerId=$customerId, endingBefore=$endingBefore, startingOn=$startingOn, limit=$limit, nextPage=$nextPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
