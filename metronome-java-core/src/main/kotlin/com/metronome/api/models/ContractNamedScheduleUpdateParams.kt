...
constructor(
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(rateCardId, scheduleName, startingAt, value, endingBefore, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "ContractNamedScheduleUpdateParams{rateCardId=$rateCardId, scheduleName=$scheduleName, startingAt=$startingAt, value=$value, endingBefore=$endingBefore, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
