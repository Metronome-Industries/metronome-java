 ...
 *
 */
class CreditGrantCreateParams private constructor(
     ...
     *
     * Unlike [rolloverSettings], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantCreateParams: CreditGrantCreateParams) =
            apply {
         ...
         *
         * You should usually call [Builder.grantAmount] with a well-typed [GrantAmount] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun grantAmount(grantAmount: JsonField<GrantAmount>) =
            apply {
                body.grantAmount(grantAmount)
            }
         ...
         *
         * You should usually call [Builder.paidAmount] with a well-typed [PaidAmount] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun paidAmount(paidAmount: JsonField<PaidAmount>) =
            apply {
                body.paidAmount(paidAmount)
            }
         ...
         *
         * You should usually call [Builder.creditGrantType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun creditGrantType(creditGrantType: JsonField<String>) =
            apply {
                body.creditGrantType(creditGrantType)
            }
         ...
         *
         * You should usually call [Builder.invoiceDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** The product(s) which these credits will be applied to. (If unspecified, the credits will be applied to charges for all products.). The array ordering specified here will be used to determine the order in which credits will be applied to invoice line items */
        fun productIds(productIds: List<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.productIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun productIds(productIds: JsonField<List<String>>) =
            apply {
                body.productIds(productIds)
            }
         ...
         */
        fun addProductId(productId: String) =
            apply {
                body.addProductId(productId)
            }
         ...
         *
         * You should usually call [Builder.rolloverSettings] with a well-typed [RolloverSettings] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun rolloverSettings(rolloverSettings: JsonField<RolloverSettings>) =
            apply {
                body.rolloverSettings(rolloverSettings)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("grant_amount") @ExcludeMissing grantAmount: JsonField<GrantAmount> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("paid_amount") @ExcludeMissing paidAmount: JsonField<PaidAmount> = JsonMissing.of(),
            @JsonProperty("priority") @ExcludeMissing priority: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("credit_grant_type") @ExcludeMissing creditGrantType: JsonField<String> = JsonMissing.of(),
            ...
            @JsonProperty("invoice_date") @ExcludeMissing invoiceDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("product_ids") @ExcludeMissing productIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("reason") @ExcludeMissing reason: JsonField<String> = JsonMissing.of(),
            @JsonProperty("rollover_settings") @ExcludeMissing rolloverSettings: JsonField<RolloverSettings> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun rolloverSettings(): Optional<RolloverSettings> = rolloverSettings.getOptional("rollover_settings")
        ...
        class Builder internal constructor() {
            ...
            fun creditGrantType(creditGrantType: String) = creditGrantType(JsonField.of(creditGrantType))
            ...
            fun addProductId(productId: String) =
                apply {
                    productIds = (productIds ?: JsonField.of(mutableListOf())).also {
            ...
            /** Configure a rollover for this credit grant so if it expires it rolls over a configured amount to a new credit grant. This feature is currently opt-in only. Contact Metronome to be added to the beta. */
            fun rolloverSettings(rolloverSettings: RolloverSettings) = rolloverSettings(JsonField.of(rolloverSettings))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (customerId.asKnown().isPresent) 1 else 0) + (if (expiresAt.asKnown().isPresent) 1 else 0) + (grantAmount.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (paidAmount.asKnown().getOrNull()?.validity() ?: 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (creditGrantType.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (if (effectiveAt.asKnown().isPresent) 1 else 0) + (if (invoiceDate.asKnown().isPresent) 1 else 0) + (productIds.asKnown().getOrNull()?.size ?: 0) + (if (reason.asKnown().isPresent) 1 else 0) + (rolloverSettings.asKnown().getOrNull()?.validity() ?: 0) + (if (uniquenessKey.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "Body{customerId=$customerId, expiresAt=$expiresAt, grantAmount=$grantAmount, name=$name, paidAmount=$paidAmount, priority=$priority, creditGrantType=$creditGrantType, customFields=$customFields, effectiveAt=$effectiveAt, invoiceDate=$invoiceDate, productIds=$productIds, reason=$reason, rolloverSettings=$rolloverSettings, uniquenessKey=$uniquenessKey, additionalProperties=$additionalProperties}"
    }

    /** the amount of credits granted */
    class GrantAmount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(grantAmount: GrantAmount) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is GrantAmount && amount == other.amount && creditTypeId == other.creditTypeId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "GrantAmount{amount=$amount, creditTypeId=$creditTypeId, additionalProperties=$additionalProperties}"
    }

    /** the amount paid for this credit grant */
    class PaidAmount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val amount: JsonField<Double>,
        private val creditTypeId: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(paidAmount: PaidAmount) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PaidAmount && amount == other.amount && creditTypeId == other.creditTypeId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PaidAmount{amount=$amount, creditTypeId=$creditTypeId, additionalProperties=$additionalProperties}"
    }
    ...
    /** Configure a rollover for this credit grant so if it expires it rolls over a configured amount to a new credit grant. This feature is currently opt-in only. Contact Metronome to be added to the beta. */
    class RolloverSettings @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val expiresAt: JsonField<OffsetDateTime>,
        private val priority: JsonField<Double>,
        ...
        private constructor(
            @JsonProperty("expires_at") @ExcludeMissing expiresAt: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("priority") @ExcludeMissing priority: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("rollover_amount") @ExcludeMissing rolloverAmount: JsonField<RolloverAmount> = JsonMissing.of()
        ) : this(
          expiresAt,
          priority,
          rolloverAmount,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(rolloverSettings: RolloverSettings) =
                apply {
            ...
            /** Specify how much to rollover to the rollover credit grant */
            fun rolloverAmount(rolloverAmount: RolloverAmount) = rolloverAmount(JsonField.of(rolloverAmount))

            /**
             * Sets [Builder.rolloverAmount] to an arbitrary JSON value.
             *
             * You should usually call [Builder.rolloverAmount] with a well-typed [RolloverAmount] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rolloverAmount(rolloverAmount: JsonField<RolloverAmount>) =
                apply {
                    this.rolloverAmount = rolloverAmount
                }

            /** Alias for calling [rolloverAmount] with `RolloverAmount.ofMaxPercentage(maxPercentage)`. */
            fun rolloverAmount(maxPercentage: RolloverAmountMaxPercentage) = rolloverAmount(RolloverAmount.ofMaxPercentage(maxPercentage))

            /** Alias for calling [rolloverAmount] with `RolloverAmount.ofMax(max)`. */
            fun rolloverAmount(max: RolloverAmountMaxAmount) = rolloverAmount(RolloverAmount.ofMax(max))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (expiresAt.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (rolloverAmount.asKnown().getOrNull()?.validity() ?: 0)

        /** Specify how much to rollover to the rollover credit grant */
        @JsonDeserialize(using = RolloverAmount.Deserializer::class)
        @JsonSerialize(using = RolloverAmount.Serializer::class)
        class RolloverAmount private constructor(
            ...
            fun maxPercentage(): Optional<RolloverAmountMaxPercentage> = Optional.ofNullable(maxPercentage)
            ...
            fun asMaxPercentage(): RolloverAmountMaxPercentage = maxPercentage.getOrThrow("maxPercentage")
            ...
            fun validate(): RolloverAmount =
                apply {
                    ...
                    accept(object : Visitor<Unit> {
                        override fun visitMaxPercentage(maxPercentage: RolloverAmountMaxPercentage) {
            ...
            internal fun validity(): Int =
                accept(object : Visitor<Int> {
                    override fun visitMaxPercentage(maxPercentage: RolloverAmountMaxPercentage) = maxPercentage.validity()
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is RolloverAmount && maxPercentage == other.maxPercentage && max == other.max
            }
            ...
            companion object {
                ...
                @JvmStatic
                fun ofMaxPercentage(maxPercentage: RolloverAmountMaxPercentage) = RolloverAmount(maxPercentage = maxPercentage)

                @JvmStatic
                fun ofMax(max: RolloverAmountMaxAmount) = RolloverAmount(max = max)
            }

            /** An interface that defines how to map each variant of [RolloverAmount] to a value of type [T]. */
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [RolloverAmount] can contain an unknown variant if it was deserialized from data
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): RolloverAmount {
                  ...
                  val bestMatches = sequenceOf(
                          tryDeserialize(node, jacksonTypeRef<RolloverAmountMaxPercentage>())
                              ?.let {
                                  RolloverAmount(maxPercentage = it, _json = json)
                              },
                          tryDeserialize(node, jacksonTypeRef<RolloverAmountMaxAmount>())
                              ?.let {
                                  RolloverAmount(max = it, _json = json)
                              }
                      )
                      .filterNotNull()
            ...
            internal class Serializer : BaseSerializer<RolloverAmount>(RolloverAmount::class) {
                ...
                override fun serialize(value: RolloverAmount, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is RolloverSettings && expiresAt == other.expiresAt && priority == other.priority && rolloverAmount == other.rolloverAmount && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "RolloverSettings{expiresAt=$expiresAt, priority=$priority, rolloverAmount=$rolloverAmount, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditGrantCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
