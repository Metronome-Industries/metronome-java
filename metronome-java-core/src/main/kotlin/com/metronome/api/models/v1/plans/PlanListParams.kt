...
class PlanListParams private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanListParams && limit == other.limit && nextPage == other.nextPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "PlanListParams{limit=$limit, nextPage=$nextPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
