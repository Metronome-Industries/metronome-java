 ...
 */
class V1CustomerNamedScheduleUpdateParams
private constructor(
    ...
    /** A builder for [V1CustomerNamedScheduleUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerNamedScheduleUpdateParams: V1CustomerNamedScheduleUpdateParams
        ) = apply {
            body = v1CustomerNamedScheduleUpdateParams.body.toBuilder()
            additionalHeaders = v1CustomerNamedScheduleUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerNamedScheduleUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerNamedScheduleUpdateParams =
            V1CustomerNamedScheduleUpdateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerNamedScheduleUpdateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerNamedScheduleUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
