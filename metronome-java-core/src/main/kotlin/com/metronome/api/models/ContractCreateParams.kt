...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractCreateParams && this.customerId == other.customerId && this.startingAt == other.startingAt && this.billingProviderConfiguration == other.billingProviderConfiguration && this.commits == other.commits && this.credits == other.credits && this.customFields == other.customFields && this.discounts == other.discounts && this.endingBefore == other.endingBefore && this.multiplierOverridePrioritization == other.multiplierOverridePrioritization && this.name == other.name && this.netPaymentTermsDays == other.netPaymentTermsDays && this.netsuiteSalesOrderId == other.netsuiteSalesOrderId && this.overrides == other.overrides && this.professionalServices == other.professionalServices && this.rateCardAlias == other.rateCardAlias && this.rateCardId == other.rateCardId && this.resellerRoyalties == other.resellerRoyalties && this.salesforceOpportunityId == other.salesforceOpportunityId && this.scheduledCharges == other.scheduledCharges && this.totalContractValue == other.totalContractValue && this.transition == other.transition && this.uniquenessKey == other.uniquenessKey && this.usageFilter == other.usageFilter && this.usageStatementSchedule == other.usageStatementSchedule && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(customerId, startingAt, billingProviderConfiguration, commits, credits, customFields, discounts, endingBefore, multiplierOverridePrioritization, name, netPaymentTermsDays, netsuiteSalesOrderId, overrides, professionalServices, rateCardAlias, rateCardId, resellerRoyalties, salesforceOpportunityId, scheduledCharges, totalContractValue, transition, uniquenessKey, usageFilter, usageStatementSchedule, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "ContractCreateParams{customerId=$customerId, startingAt=$startingAt, billingProviderConfiguration=$billingProviderConfiguration, commits=$commits, credits=$credits, customFields=$customFields, discounts=$discounts, endingBefore=$endingBefore, multiplierOverridePrioritization=$multiplierOverridePrioritization, name=$name, netPaymentTermsDays=$netPaymentTermsDays, netsuiteSalesOrderId=$netsuiteSalesOrderId, overrides=$overrides, professionalServices=$professionalServices, rateCardAlias=$rateCardAlias, rateCardId=$rateCardId, resellerRoyalties=$resellerRoyalties, salesforceOpportunityId=$salesforceOpportunityId, scheduledCharges=$scheduledCharges, totalContractValue=$totalContractValue, transition=$transition, uniquenessKey=$uniquenessKey, usageFilter=$usageFilter, usageStatementSchedule=$usageStatementSchedule, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Commit && this.type == other.type && this.rateType == other.rateType && this.name == other.name && this.productId == other.productId && this.accessSchedule == other.accessSchedule && this.invoiceSchedule == other.invoiceSchedule && this.amount == other.amount && this.description == other.description && this.rolloverFraction == other.rolloverFraction && this.priority == other.priority && this.applicableProductIds == other.applicableProductIds && this.applicableProductTags == other.applicableProductTags && this.netsuiteSalesOrderId == other.netsuiteSalesOrderId && this.customFields == other.customFields && this.temporaryId == other.temporaryId && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun hashCode(): Int {
            if (hashCode == 0) {
                hashCode = /* spotless:off */ Objects.hash(type, rateType, name, productId, accessSchedule, invoiceSchedule, amount, description, rolloverFraction, priority, applicableProductIds, applicableProductTags, netsuiteSalesOrderId, customFields, temporaryId, additionalProperties) /* spotless:on */
            }
            return hashCode
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            /**
             * If provided, the override will only apply to the specified commits. Can only be used
             * for commit specific overrides. If not provided, the override will apply to all
             * commits.
             */
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return /* spotless:off */ other is OverrideSpecifier && this.commitIds == other.commitIds && this.productId == other.productId && this.productTags == other.productTags && this.pricingGroupValues == other.pricingGroupValues && this.presentationGroupValues == other.presentationGroupValues && this.additionalProperties == other.additionalProperties /* spotless:on */
            }
            ...
            override fun hashCode(): Int {
                if (hashCode == 0) {
                    hashCode = /* spotless:off */ Objects.hash(commitIds, productId, productTags, pricingGroupValues, presentationGroupValues, additionalProperties) /* spotless:on */
                }
                return hashCode
            }
        ...
        override fun hashCode(): Int {
            if (hashCode == 0) {
                hashCode = /* spotless:off */ Objects.hash(startingAt, endingBefore, entitled, type, multiplier, priority, overwriteRate, productId, applicableProductTags, overrideSpecifiers, tiers, isCommitSpecific, target, additionalProperties) /* spotless:on */
            }
            return hashCode
        }
