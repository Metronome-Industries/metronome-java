...
interface CreditService {
     ...
     */
    fun list(params: CreditListParams): CreditListPage = list(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [CreditService.create].
         */
        @MustBeClosed
         ...
         * is otherwise the same as [CreditService.updateEndDate].
         */
        @MustBeClosed
        fun updateEndDate(
            params: CreditUpdateEndDateParams
