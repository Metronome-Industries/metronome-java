...
private constructor(
    ...
    /** A builder for [V1CreditGrantVoidParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantVoidParams: V1CreditGrantVoidParams) = apply {
            body = v1CreditGrantVoidParams.body.toBuilder()
            additionalHeaders = v1CreditGrantVoidParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreditGrantVoidParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CreditGrantVoidParams =
            V1CreditGrantVoidParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantVoidParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CreditGrantVoidParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
