...
internal class UsageListParamsTest {
    ...
    fun create() {
      UsageListParams.builder()
          ...
          .addBillableMetric(UsageListParams.BillableMetric.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .groupBy(UsageListParams.BillableMetric.GroupBy.builder()
                  .key("key")
                  .addValue("x")
                  .build())
              .build())
    ...
    @Test
    fun queryParams() {
      val params = UsageListParams.builder()
          .nextPage("next_page")
          .endingBefore(OffsetDateTime.parse("2021-01-03T00:00:00Z"))
          .startingOn(OffsetDateTime.parse("2021-01-01T00:00:00Z"))
          .windowSize(UsageListParams.WindowSize.HOUR)
    ...
    fun body() {
      ...
      assertThat(body.billableMetrics().getOrNull()).containsExactly(UsageListParams.BillableMetric.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .groupBy(UsageListParams.BillableMetric.GroupBy.builder()
              .key("key")
              .addValue("x")
              .build())
          .build())
      assertThat(body.customerIds().getOrNull()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    }
