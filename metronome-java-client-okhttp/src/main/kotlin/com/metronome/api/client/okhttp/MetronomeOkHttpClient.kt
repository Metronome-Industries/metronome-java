...
/**
 * A class that allows building an instance of [MetronomeClient] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class MetronomeOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MetronomeClient]. */
        @JvmStatic
        fun builder() = Builder()
         ...
         */
        @JvmStatic
        fun fromEnv(): MetronomeClient = builder().fromEnv().build()
    }

    /** A builder for [MetronomeOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MetronomeClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MetronomeClient =
            MetronomeClientImpl(clientOptions
