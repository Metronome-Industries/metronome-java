...
@NoAutoDetect
class V1PlanListCustomersResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1PlanListCustomersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1PlanListCustomersResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1PlanListCustomersResponse: V1PlanListCustomersResponse) = apply {
            customerDetails = v1PlanListCustomersResponse.customerDetails
            planDetails = v1PlanListCustomersResponse.planDetails
            additionalProperties = v1PlanListCustomersResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1PlanListCustomersResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1PlanListCustomersResponse && customerDetails == other.customerDetails && planDetails == other.planDetails && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1PlanListCustomersResponse{customerDetails=$customerDetails, planDetails=$planDetails, additionalProperties=$additionalProperties}"
}
