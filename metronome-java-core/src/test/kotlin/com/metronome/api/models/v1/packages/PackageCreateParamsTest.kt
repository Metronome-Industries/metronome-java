...
internal class PackageCreateParamsTest {
                ...
                PackageCreateParams.Commit.builder()
                    .accessSchedule(
                        PackageCreateParams.Commit.AccessSchedule.builder()
                            .addScheduleItem(
                                PackageCreateParams.Commit.AccessSchedule.ScheduleItem.builder()
                                    .amount(0.0)
                                    .duration(
                            ...
                            .accessType(PackageCreateParams.Commit.AccessSchedule.AccessType.SPEND)
                    ...
                    .invoiceSchedule(
                        PackageCreateParams.Commit.InvoiceSchedule.builder()
                            .addScheduleItem(
                                PackageCreateParams.Commit.InvoiceSchedule.ScheduleItem.builder()
                                    .dateOffset(
                ...
                PackageCreateParams.Credit.builder()
                    .accessSchedule(
                        PackageCreateParams.Credit.AccessSchedule.builder()
                            .addScheduleItem(
                                PackageCreateParams.Credit.AccessSchedule.ScheduleItem.builder()
                                    .amount(0.0)
                                    .duration(
                            ...
                            .accessType(PackageCreateParams.Credit.AccessSchedule.AccessType.SPEND)
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .build()
                    )
                    .productId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                ...
                PackageCreateParams.Override.builder()
                    .addOverrideSpecifier(
                        PackageCreateParams.Override.OverrideSpecifier.builder()
                            ...
                            .pricingGroupValues(
                                PackageCreateParams.Override.OverrideSpecifier.PricingGroupValues
                                    .builder()
                                    .putAdditionalProperty("foo", JsonValue.from("string"))
                                    .build()
                            )
                    ...
                    .overwriteRate(
                        PackageCreateParams.Override.OverwriteRate.builder()
                            ...
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .customRate(
                                PackageCreateParams.Override.OverwriteRate.CustomRate.builder()
                ...
                PackageCreateParams.RecurringCommit.builder()
                    .accessAmount(
                        PackageCreateParams.RecurringCommit.AccessAmount.builder()
                            .unitPrice(0.0)
                            .accessType(
                                PackageCreateParams.RecurringCommit.AccessAmount.AccessType.SPEND
                            )
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .quantity(0.0)
                            .build()
                    ...
                    .prorationRounding(
                        PackageCreateParams.RecurringCommit.ProrationRounding.builder()
                            ...
                            .invoice(
                                PackageCreateParams.RecurringCommit.ProrationRounding.Invoice
                                    .builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
                    ...
                    .subscriptionConfig(
                        PackageCreateParams.RecurringCommit.SubscriptionConfig.builder()
                            ...
                            .allocation(
                                PackageCreateParams.RecurringCommit.SubscriptionConfig.Allocation
                                    .INDIVIDUAL
                            )
                            .build()
                    )
                ...
                PackageCreateParams.RecurringCredit.builder()
                    .accessAmount(
                        PackageCreateParams.RecurringCredit.AccessAmount.builder()
                            .unitPrice(0.0)
                            .accessType(
                                PackageCreateParams.RecurringCredit.AccessAmount.AccessType.SPEND
                            )
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .quantity(0.0)
                            .build()
                    ...
                    .subscriptionConfig(
                        PackageCreateParams.RecurringCredit.SubscriptionConfig.builder()
                            ...
                            .subscriptionId("subscription_id")
                            .allocation(
                                PackageCreateParams.RecurringCredit.SubscriptionConfig.Allocation
                                    .INDIVIDUAL
                            )
                            .build()
                    )
                ...
                PackageCreateParams.ScheduledCharge.builder()
                    ...
                    .schedule(
                        PackageCreateParams.ScheduledCharge.Schedule.builder()
                            .addScheduleItem(
                                PackageCreateParams.ScheduledCharge.Schedule.ScheduleItem.builder()
                                    .dateOffset(
                ...
                PackageCreateParams.Subscription.builder()
                    ...
                    .proration(
                        PackageCreateParams.Subscription.Proration.builder()
                            ...
                            .isProrated(true)
                            .rounding(
                                PackageCreateParams.Subscription.Proration.Rounding.builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
                    ...
                    .subscriptionRate(
                        PackageCreateParams.Subscription.SubscriptionRate.builder()
                            .billingFrequency(
                                PackageCreateParams.Subscription.SubscriptionRate.BillingFrequency
                                    .MONTHLY
                            )
                            .productId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .build()
                    ...
                    .billingCycleConfig(
                        PackageCreateParams.Subscription.BillingCycleConfig.builder()
                            .invoicePlacement(
                                PackageCreateParams.Subscription.BillingCycleConfig.InvoicePlacement
            ...
            .usageStatementSchedule(
                PackageCreateParams.UsageStatementSchedule.builder()
                    ...
                    .invoiceGenerationStartingAtOffset(
                        PackageCreateParams.UsageStatementSchedule.InvoiceGenerationStartingAtOffset
                            .builder()
                            .unit(
    ...
    fun body() {
                    ...
                    PackageCreateParams.Commit.builder()
                        .accessSchedule(
                            PackageCreateParams.Commit.AccessSchedule.builder()
                                ...
                                .accessType(
                                    PackageCreateParams.Commit.AccessSchedule.AccessType.SPEND
                                )
                                .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                .build()
                        )
                    ...
                    PackageCreateParams.Credit.builder()
                        .accessSchedule(
                            PackageCreateParams.Credit.AccessSchedule.builder()
                                ...
                                .accessType(
                                    PackageCreateParams.Credit.AccessSchedule.AccessType.SPEND
                                )
                                .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                .build()
                        )
                    ...
                    PackageCreateParams.RecurringCommit.builder()
                        .accessAmount(
                            PackageCreateParams.RecurringCommit.AccessAmount.builder()
                                .unitPrice(0.0)
                                .accessType(
                                    PackageCreateParams.RecurringCommit.AccessAmount.AccessType
                                        .SPEND
                                )
                                .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                .quantity(0.0)
                        ...
                        .commitDuration(
                            PackageCreateParams.RecurringCommit.CommitDuration.builder()
                                .value(0.0)
                                .unit(
                                    PackageCreateParams.RecurringCommit.CommitDuration.Unit.PERIODS
                                )
                                .build()
                        )
                        .priority(0.0)
                        ...
                        .startingAtOffset(
                            PackageCreateParams.RecurringCommit.StartingAtOffset.builder()
                                .unit(
                                    PackageCreateParams.RecurringCommit.StartingAtOffset.Unit.DAYS
                                )
                                .value(0L)
                                .build()
                        )
                    ...
                    PackageCreateParams.RecurringCredit.builder()
                        .accessAmount(
                            PackageCreateParams.RecurringCredit.AccessAmount.builder()
                                .unitPrice(0.0)
                                .accessType(
                                    PackageCreateParams.RecurringCredit.AccessAmount.AccessType
                                        .SPEND
                                )
                                .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                .quantity(0.0)
                        ...
                        .commitDuration(
                            PackageCreateParams.RecurringCredit.CommitDuration.builder()
                                .value(0.0)
                                .unit(
                                    PackageCreateParams.RecurringCredit.CommitDuration.Unit.PERIODS
                                )
                                .build()
                        )
                        .priority(0.0)
                        ...
                        .startingAtOffset(
                            PackageCreateParams.RecurringCredit.StartingAtOffset.builder()
                                .unit(
                                    PackageCreateParams.RecurringCredit.StartingAtOffset.Unit.DAYS
                                )
                                .value(0L)
                                .build()
                        )
                            ...
                            PackageCreateParams.RecurringCredit.ProrationRounding.builder()
                                .access(
                                    PackageCreateParams.RecurringCredit.ProrationRounding.Access
                                        ...
                                        .decimalPlaces(-5.0)
                                        .roundingMethod(
                                            PackageCreateParams.RecurringCredit.ProrationRounding
                                                .Access
                                                .RoundingMethod
                                                .HALF_UP
                                        )
        ...
        assertThat(body.deliveryMethod())
            .contains(PackageCreateParams.DeliveryMethod.DIRECT_TO_BILLING_PROVIDER)
        assertThat(body.duration())
            .contains(
                PackageCreateParams.Duration.builder()
                    .unit(PackageCreateParams.Duration.Unit.DAYS)
                    .value(0L)
        ...
        assertThat(body.multiplierOverridePrioritization())
            .contains(PackageCreateParams.MultiplierOverridePrioritization.LOWEST_MULTIPLIER)
        ...
        assertThat(body.scheduledChargesOnUsageInvoices())
            .contains(PackageCreateParams.ScheduledChargesOnUsageInvoices.ALL)
    ...
    fun bodyWithoutOptionalFields() {
        val params = PackageCreateParams.builder().name("My package").build()
