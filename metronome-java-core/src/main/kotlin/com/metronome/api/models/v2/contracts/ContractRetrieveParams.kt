...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.asOfDate] with a well-typed [OffsetDateTime] value
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            asOfDate: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        ) : this(contractId, customerId, asOfDate, includeBalance, includeLedgers, mutableMapOf())
