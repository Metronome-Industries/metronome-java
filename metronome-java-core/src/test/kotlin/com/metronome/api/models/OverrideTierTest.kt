...
internal class OverrideTierTest {
    ...
    @Test
    fun create() {
      val overrideTier = OverrideTier.builder()
          .multiplier(0.0)
          .size(0.0)
          .build()
    ...
    fun roundtrip() {
      ...
      val roundtrippedOverrideTier = jsonMapper.readValue(jsonMapper.writeValueAsString(overrideTier), jacksonTypeRef<OverrideTier>())
