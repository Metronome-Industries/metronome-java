...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerInvoiceListPage && invoicesService == other.invoicesService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = CustomerInvoiceListPage(invoicesService, params, response)
    }
    ...
    class AutoPager(private val firstPage: CustomerInvoiceListPage) : Iterable<Invoice> {
