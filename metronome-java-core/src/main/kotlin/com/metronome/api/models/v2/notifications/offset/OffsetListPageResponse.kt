...
class OffsetListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<LifecycleEventOffsetNotificationConfig>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(offsetListPageResponse: OffsetListPageResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<LifecycleEventOffsetNotificationConfig>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<LifecycleEventOffsetNotificationConfig>>) =
            apply {
         ...
         */
        fun addData(data: LifecycleEventOffsetNotificationConfig) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): OffsetListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OffsetListPageResponse && data == other.data && cursor == other.cursor && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "OffsetListPageResponse{data=$data, cursor=$cursor, additionalProperties=$additionalProperties}"
}
