...
@NoAutoDetect
class V1ContractProductRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1ContractProductRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractProductRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractProductRetrieveResponse: V1ContractProductRetrieveResponse) =
            apply {
                data = v1ContractProductRetrieveResponse.data
                additionalProperties =
                    v1ContractProductRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): V1ContractProductRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractProductRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractProductRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
