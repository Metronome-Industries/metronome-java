...
class InvoiceListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceListPageResponse: InvoiceListPageResponse) =
            apply {
                data = invoiceListPageResponse.data.map { it.toMutableList() }
                nextPage = invoiceListPageResponse.nextPage
     ...
     *   expected type.
     */
    fun validate(): InvoiceListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "InvoiceListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
