...
class CommitCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commitCreateResponse: CommitCreateResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): CommitCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CommitCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CommitCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
