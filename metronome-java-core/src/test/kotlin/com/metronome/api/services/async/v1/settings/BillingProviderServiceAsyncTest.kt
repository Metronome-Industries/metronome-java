...
internal class BillingProviderServiceAsyncTest {
    ...
    fun create() {
      ...
      val billingProviderFuture = billingProviderServiceAsync.create(BillingProviderCreateParams.builder()
    ...
    fun list() {
      ...
      val billingProvidersFuture = billingProviderServiceAsync.list(BillingProviderListParams.builder()
