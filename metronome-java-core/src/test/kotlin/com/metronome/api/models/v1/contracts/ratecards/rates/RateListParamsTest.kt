...
internal class RateListParamsTest {
    ...
    fun create() {
      RateListParams.builder()
          ...
          .addSelector(RateListParams.Selector.builder()
              .billingFrequency(RateListParams.Selector.BillingFrequency.MONTHLY)
              .partialPricingGroupValues(RateListParams.Selector.PartialPricingGroupValues.builder()
                  .putAdditionalProperty("region", JsonValue.from("us-west-2"))
                  .putAdditionalProperty("cloud", JsonValue.from("aws"))
                  .build())
              .pricingGroupValues(RateListParams.Selector.PricingGroupValues.builder()
    ...
    @Test
    fun queryParams() {
      val params = RateListParams.builder()
          .limit(1L)
          .nextPage("next_page")
          .at(OffsetDateTime.parse("2024-01-01T00:00:00.000Z"))
          .rateCardId("f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe")
    ...
    fun body() {
      ...
      assertThat(body.selectors().getOrNull()).containsExactly(RateListParams.Selector.builder()
          .billingFrequency(RateListParams.Selector.BillingFrequency.MONTHLY)
          .partialPricingGroupValues(RateListParams.Selector.PartialPricingGroupValues.builder()
              .putAdditionalProperty("region", JsonValue.from("us-west-2"))
              .putAdditionalProperty("cloud", JsonValue.from("aws"))
