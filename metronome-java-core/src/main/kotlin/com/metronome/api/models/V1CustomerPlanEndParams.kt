...
private constructor(
    ...
    /** A builder for [V1CustomerPlanEndParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerPlanEndParams: V1CustomerPlanEndParams) = apply {
            customerId = v1CustomerPlanEndParams.customerId
            customerPlanId = v1CustomerPlanEndParams.customerPlanId
            body = v1CustomerPlanEndParams.body.toBuilder()
            additionalHeaders = v1CustomerPlanEndParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerPlanEndParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerPlanEndParams =
            V1CustomerPlanEndParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerPlanEndParams && customerId == other.customerId && customerPlanId == other.customerPlanId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerPlanEndParams{customerId=$customerId, customerPlanId=$customerPlanId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
