...
class RateCardServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : RateCardServiceAsync {

    private val withRawResponse: RateCardServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    private val productOrders: ProductOrderServiceAsync by lazy { ProductOrderServiceAsyncImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RateCardServiceAsync = RateCardServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun create(params: RateCardCreateParams, requestOptions: RequestOptions): CompletableFuture<RateCardCreateResponse> =
        // post /v1/contract-pricing/rate-cards/create
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: RateCardRetrieveParams, requestOptions: RequestOptions): CompletableFuture<RateCardRetrieveResponse> =
        // post /v1/contract-pricing/rate-cards/get
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: RateCardUpdateParams, requestOptions: RequestOptions): CompletableFuture<RateCardUpdateResponse> =
        // post /v1/contract-pricing/rate-cards/update
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: RateCardListParams, requestOptions: RequestOptions): CompletableFuture<RateCardListPageAsync> =
        // post /v1/contract-pricing/rate-cards/list
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun archive(params: RateCardArchiveParams, requestOptions: RequestOptions): CompletableFuture<RateCardArchiveResponse> =
        // post /v1/contract-pricing/rate-cards/archive
        withRawResponse().archive(params, requestOptions).thenApply { it.parse() }

    override fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams, requestOptions: RequestOptions): CompletableFuture<RateCardRetrieveRateScheduleResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val productOrders: ProductOrderServiceAsync.WithRawResponse by lazy { ProductOrderServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val rates: RateServiceAsync.WithRawResponse by lazy { RateServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RateCardServiceAsync.WithRawResponse = RateCardServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun create(params: RateCardCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardCreateResponse>> {
        ...
        override fun retrieve(params: RateCardRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardRetrieveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun update(params: RateCardUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardUpdateResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun list(params: RateCardListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun archive(params: RateCardArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardArchiveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun retrieveRateSchedule(params: RateCardRetrieveRateScheduleParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateCardRetrieveRateScheduleResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
