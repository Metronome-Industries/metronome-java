...
@NoAutoDetect
class V1CustomerNamedScheduleRetrieveResponse
@JsonCreator
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    ...
    fun validate(): V1CustomerNamedScheduleRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerNamedScheduleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerNamedScheduleRetrieveResponse: V1CustomerNamedScheduleRetrieveResponse
        ) = apply {
            data = v1CustomerNamedScheduleRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties =
                v1CustomerNamedScheduleRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerNamedScheduleRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerNamedScheduleRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerNamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
