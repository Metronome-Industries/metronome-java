 ...
 */
class V1CustomerInvoiceListBreakdownsParams
private constructor(
    ...
    /** A builder for [V1CustomerInvoiceListBreakdownsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerInvoiceListBreakdownsParams: V1CustomerInvoiceListBreakdownsParams
        ) = apply {
            customerId = v1CustomerInvoiceListBreakdownsParams.customerId
            endingBefore = v1CustomerInvoiceListBreakdownsParams.endingBefore
            startingOn = v1CustomerInvoiceListBreakdownsParams.startingOn
            creditTypeId = v1CustomerInvoiceListBreakdownsParams.creditTypeId
            limit = v1CustomerInvoiceListBreakdownsParams.limit
            nextPage = v1CustomerInvoiceListBreakdownsParams.nextPage
            skipZeroQtyLineItems = v1CustomerInvoiceListBreakdownsParams.skipZeroQtyLineItems
            sort = v1CustomerInvoiceListBreakdownsParams.sort
            status = v1CustomerInvoiceListBreakdownsParams.status
            windowSize = v1CustomerInvoiceListBreakdownsParams.windowSize
            additionalHeaders = v1CustomerInvoiceListBreakdownsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerInvoiceListBreakdownsParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerInvoiceListBreakdownsParams =
            V1CustomerInvoiceListBreakdownsParams(
