...
class AlertServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions): CompletableFuture<AlertRetrieveResponse> =
    ...
    override fun reset(params: AlertResetParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val retrieveHandler: Handler<AlertRetrieveResponse> = jsonHandler<AlertRetrieveResponse>(clientOptions.jsonMapper)

        override fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<AlertRetrieveResponse>> {
        ...
        private val listHandler: Handler<AlertListPageResponse> = jsonHandler<AlertListPageResponse>(clientOptions.jsonMapper)
        ...
        override fun reset(params: AlertResetParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
