...
class RateCardUpdateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RateCardUpdateResponse].
         *
    ...
    /** A builder for [RateCardUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateCardUpdateResponse: RateCardUpdateResponse) =
            apply {
                data = rateCardUpdateResponse.data
                additionalProperties = rateCardUpdateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [RateCardUpdateResponse].
         *
         ...
         */
        fun build(): RateCardUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): RateCardUpdateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RateCardUpdateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RateCardUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
