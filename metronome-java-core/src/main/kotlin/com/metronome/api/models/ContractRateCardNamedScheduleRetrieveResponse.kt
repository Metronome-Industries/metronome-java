...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.data = contractRateCardNamedScheduleRetrieveResponse.data
            additionalProperties(contractRateCardNamedScheduleRetrieveResponse.additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardNamedScheduleRetrieveResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ContractRateCardNamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
