                    ...
                    PrepaidBalanceThresholdConfiguration.Commit.builder()
                        ...
                        .duration(
                            PrepaidBalanceThresholdConfiguration.Commit.Duration.builder()
                                .unit(
                                    PrepaidBalanceThresholdConfiguration.Commit.Duration.Unit.DAYS
                                )
                                .value(0L)
                                .build()
                        )
                        .rateType(PrepaidBalanceThresholdConfiguration.Commit.RateType.COMMIT_RATE)
        ...
        assertThat(prepaidBalanceThresholdConfiguration.commit())
            .isEqualTo(
                PrepaidBalanceThresholdConfiguration.Commit.builder()
                    ...
                    .duration(
                        PrepaidBalanceThresholdConfiguration.Commit.Duration.builder()
                            .unit(PrepaidBalanceThresholdConfiguration.Commit.Duration.Unit.DAYS)
                            .value(0L)
                            .build()
                    )
                    .rateType(PrepaidBalanceThresholdConfiguration.Commit.RateType.COMMIT_RATE)
