...
internal class CreditGrantListParamsTest {
    ...
    @Test
    fun queryParams() {
      val params = CreditGrantListParams.builder()
          .limit(1L)
          .nextPage("next_page")
          .addCreditGrantId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addCreditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
    ...
    fun body() {
      ...
      assertThat(body.creditGrantIds().getOrNull()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(body.creditTypeIds().getOrNull()).containsExactly("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
      assertThat(body.customerIds().getOrNull()).containsExactly("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc", "0e5b8609-d901-4992-b394-c3c2e3f37b1c")
