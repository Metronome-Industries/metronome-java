...
internal class ProductRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val productRetrieveResponse = ProductRetrieveResponse.builder()
          .data(ProductRetrieveResponse.Data.builder()
              ...
              .addUpdate(ProductRetrieveResponse.Data.Update.builder()
                  .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                  .createdBy("created_by")
              ...
              .customFields(ProductRetrieveResponse.Data.CustomFields.builder()
                  .putAdditionalProperty("foo", JsonValue.from("string"))
                  .build())
              .build())
          .build()

      assertThat(productRetrieveResponse.data()).isEqualTo(ProductRetrieveResponse.Data.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .current(ProductListItemState.builder()
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .createdBy("created_by")
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(productRetrieveResponse), jacksonTypeRef<ProductRetrieveResponse>())
