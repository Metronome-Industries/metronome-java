...
class CreditGrantListEntriesPageAsync private constructor(
     ...
     */
    fun data(): List<CreditGrantListEntriesResponse> = response._data().getOptional("data").getOrNull() ?: emptyList()
    ...
    override fun nextPage(): CompletableFuture<CreditGrantListEntriesPageAsync> = service.listEntries(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditGrantListEntriesPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        /** The parameters that were used to request this page. */
        fun params(params: CreditGrantListEntriesParams) =
            apply {
                this.params = params
            }

        /** The response that this page was parsed from. */
        fun response(response: CreditGrantListEntriesPageResponse) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantListEntriesPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "CreditGrantListEntriesPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
