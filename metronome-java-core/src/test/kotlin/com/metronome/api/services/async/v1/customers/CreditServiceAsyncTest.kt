...
internal class CreditServiceAsyncTest {
    ...
    fun create() {
      val client = MetronomeOkHttpClientAsync.builder()
          ...
          .build()
      val creditServiceAsync = client.v1().customers().credits()

      val creditFuture = creditServiceAsync.create(CreditCreateParams.builder()
          ...
          .customFields(CreditCreateParams.CustomFields.builder()
    ...
    fun list() {
      ...
      val pageFuture = creditServiceAsync.list(CreditListParams.builder()
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .build())
    ...
    fun updateEndDate() {
      ...
      val responseFuture = creditServiceAsync.updateEndDate(CreditUpdateEndDateParams.builder()
