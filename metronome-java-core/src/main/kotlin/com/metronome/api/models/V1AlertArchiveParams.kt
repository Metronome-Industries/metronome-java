...
private constructor(
    ...
    /** A builder for [V1AlertArchiveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1AlertArchiveParams: V1AlertArchiveParams) = apply {
            body = v1AlertArchiveParams.body.toBuilder()
            additionalHeaders = v1AlertArchiveParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1AlertArchiveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1AlertArchiveParams =
            V1AlertArchiveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1AlertArchiveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1AlertArchiveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
