 ...
 */
class V1CustomFieldSetValuesParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && customFields == other.customFields && entity == other.entity && entityId == other.entityId && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1CustomFieldSetValuesParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomFieldSetValuesParams: V1CustomFieldSetValuesParams) = apply {
            body = v1CustomFieldSetValuesParams.body.toBuilder()
            additionalHeaders = v1CustomFieldSetValuesParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomFieldSetValuesParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomFieldSetValuesParams =
            V1CustomFieldSetValuesParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomFieldSetValuesParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomFieldSetValuesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
