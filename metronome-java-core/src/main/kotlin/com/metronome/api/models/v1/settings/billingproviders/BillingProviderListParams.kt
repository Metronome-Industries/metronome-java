 ...
 */
class BillingProviderListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BillingProviderListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingProviderListParams: BillingProviderListParams) = apply {
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(nextPage, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (if (nextPage.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() =
            "Body{nextPage=$nextPage, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillingProviderListParams &&
            body == other.body &&
    ...
    override fun toString() =
        "BillingProviderListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
