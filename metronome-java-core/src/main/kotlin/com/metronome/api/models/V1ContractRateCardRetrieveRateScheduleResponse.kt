...
@NoAutoDetect
class V1ContractRateCardRetrieveRateScheduleResponse
@JsonCreator
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    ...
    fun validate(): V1ContractRateCardRetrieveRateScheduleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractRateCardRetrieveRateScheduleResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = v1ContractRateCardRetrieveRateScheduleResponse.data.map { it.toMutableList() }
            nextPage = v1ContractRateCardRetrieveRateScheduleResponse.nextPage
            additionalProperties =
                v1ContractRateCardRetrieveRateScheduleResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ContractRateCardRetrieveRateScheduleResponse =
            V1ContractRateCardRetrieveRateScheduleResponse(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && entitled == other.entitled && productCustomFields == other.productCustomFields && productId == other.productId && productName == other.productName && productTags == other.productTags && rate == other.rate && startingAt == other.startingAt && billingFrequency == other.billingFrequency && commitRate == other.commitRate && endingBefore == other.endingBefore && pricingGroupValues == other.pricingGroupValues && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() =
            "Data{entitled=$entitled, productCustomFields=$productCustomFields, productId=$productId, productName=$productName, productTags=$productTags, rate=$rate, startingAt=$startingAt, billingFrequency=$billingFrequency, commitRate=$commitRate, endingBefore=$endingBefore, pricingGroupValues=$pricingGroupValues, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRetrieveRateScheduleResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRateCardRetrieveRateScheduleResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
