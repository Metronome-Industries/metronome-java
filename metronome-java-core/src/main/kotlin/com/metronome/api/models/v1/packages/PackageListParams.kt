 ...
 *
 */
class PackageListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PackageListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PackageListParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [PackageListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(packageListParams: PackageListParams) =
            apply {
                limit = packageListParams.limit
                nextPage = packageListParams.nextPage
                body = packageListParams.body.toBuilder()
                additionalHeaders = packageListParams.additionalHeaders.toBuilder()
                additionalQueryParams = packageListParams.additionalQueryParams.toBuilder()
            }
         ...
         *
         * You should usually call [Builder.archiveFilter] with a well-typed [ArchiveFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun archiveFilter(archiveFilter: JsonField<ArchiveFilter>) =
            apply {
                body.archiveFilter(archiveFilter)
            }
        ...
        /**
         * Returns an immutable instance of [PackageListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PackageListParams =
            PackageListParams(
              limit,
              nextPage,
              body.build(),
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("archive_filter") @ExcludeMissing archiveFilter: JsonField<ArchiveFilter> = JsonMissing.of()
        ) : this(
          archiveFilter, mutableMapOf()
        )
        ...
        class Builder internal constructor() {
            ...
            /** Filter packages by archived status. Defaults to NOT_ARCHIVED. */
            fun archiveFilter(archiveFilter: ArchiveFilter) = archiveFilter(JsonField.of(archiveFilter))
            ...
            fun build(): Body =
                Body(
                  archiveFilter, additionalProperties.toMutableMap()
                )
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && archiveFilter == other.archiveFilter && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{archiveFilter=$archiveFilter, additionalProperties=$additionalProperties}"
    }

    /** Filter packages by archived status. Defaults to NOT_ARCHIVED. */
    class ArchiveFilter @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            NOT_ARCHIVED,
            ALL,
            /** An enum member indicating that [ArchiveFilter] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PackageListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PackageListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
