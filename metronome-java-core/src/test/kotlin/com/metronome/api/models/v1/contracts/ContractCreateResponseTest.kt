                        ...
                        ContractCreateResponse.Data.Contract.builder()
                            ...
                            .addRecurringCommit(
                                ContractCreateResponse.Data.Contract.RecurringCommit.builder()
                                    ...
                                    .priority(0.0)
                                    .product(
                                        ContractCreateResponse.Data.Contract.RecurringCommit.Product
                                            .builder()
                                            .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                            .name("name")
                                            .build()
                            ...
                            .addRecurringCredit(
                                ContractCreateResponse.Data.Contract.RecurringCredit.builder()
                                    ...
                                    .priority(0.0)
                                    .product(
                                        ContractCreateResponse.Data.Contract.RecurringCredit.Product
                                            .builder()
                                            .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                            .name("name")
                                            .build()
                            ...
                            .scheduledChargesOnUsageInvoices(
                                ContractCreateResponse.Data.Contract.ScheduledChargesOnUsageInvoices
                                    .ALL
                            )
                            .spendThresholdConfiguration(
                                SpendThresholdConfiguration.builder()
