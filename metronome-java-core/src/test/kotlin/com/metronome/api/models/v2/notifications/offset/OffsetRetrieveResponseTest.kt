...
internal class OffsetRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val offsetRetrieveResponse = OffsetRetrieveResponse.builder()
      ...
      assertThat(offsetRetrieveResponse.data()).isEqualTo(LifecycleEventOffsetNotificationConfig.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .archivedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .createdBy("created_by")
    ...
    fun roundtrip() {
      ...
      val roundtrippedOffsetRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(offsetRetrieveResponse), jacksonTypeRef<OffsetRetrieveResponse>())
