...
internal class ContractAddManualBalanceEntryParamsTest {
    ...
    fun create() {
      ContractAddManualBalanceEntryParams.builder()
          ...
          .perGroupAmounts(ContractAddManualBalanceEntryParams.PerGroupAmounts.builder()
    ...
    @Test
    fun body() {
      val params = ContractAddManualBalanceEntryParams.builder()
          .id("6162d87b-e5db-4a33-b7f2-76ce6ead4e85")
          .amount(-1000.0)
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .reason("Reason for entry")
      ...
      assertThat(body.perGroupAmounts()).contains(ContractAddManualBalanceEntryParams.PerGroupAmounts.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
