...
class QuantityConversion @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("conversion_factor") @ExcludeMissing conversionFactor: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("operation") @ExcludeMissing operation: JsonField<Operation> = JsonMissing.of(),
     ...
     *
     * Unlike [conversionFactor], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(quantityConversion: QuantityConversion) =
            apply {
        ...
        /** The factor to multiply or divide the quantity by. */
        fun conversionFactor(conversionFactor: Double) = conversionFactor(JsonField.of(conversionFactor))

        /**
         * Sets [Builder.conversionFactor] to an arbitrary JSON value.
         *
         * You should usually call [Builder.conversionFactor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun conversionFactor(conversionFactor: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.operation] with a well-typed [Operation] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun operation(operation: JsonField<Operation>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): QuantityConversion =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (conversionFactor.asKnown().isPresent) 1 else 0) + (operation.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0)

    /** The operation to perform on the quantity */
    class Operation @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuantityConversion && conversionFactor == other.conversionFactor && operation == other.operation && name == other.name && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "QuantityConversion{conversionFactor=$conversionFactor, operation=$operation, name=$name, additionalProperties=$additionalProperties}"
}
