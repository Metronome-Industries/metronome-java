...
interface PackageService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): PackageService
     ...
     *
     */
    fun create(params: PackageCreateParams): PackageCreateResponse =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: PackageCreateParams, requestOptions: RequestOptions = RequestOptions.none()): PackageCreateResponse
     ...
     *
     */
    fun retrieve(params: PackageRetrieveParams): PackageRetrieveResponse =
        retrieve(
          params, RequestOptions.none()
        )

    /** @see retrieve */
    fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): PackageRetrieveResponse
     ...
     *
     */
    fun list(): PackageListPage = list(PackageListParams.none())

    /** @see list */
    fun list(params: PackageListParams = PackageListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): PackageListPage

    /** @see list */
    fun list(params: PackageListParams = PackageListParams.none()): PackageListPage =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(requestOptions: RequestOptions): PackageListPage =
        list(
          PackageListParams.none(), requestOptions
        )
     ...
     *
     */
    fun archive(params: PackageArchiveParams): PackageArchiveResponse =
        archive(
          params, RequestOptions.none()
        )

    /** @see archive */
    fun archive(params: PackageArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): PackageArchiveResponse
     ...
     *
     */
    fun listContractsOnPackage(params: PackageListContractsOnPackageParams): PackageListContractsOnPackagePage =
        listContractsOnPackage(
          params, RequestOptions.none()
        )

    /** @see listContractsOnPackage */
    fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions = RequestOptions.none()): PackageListContractsOnPackagePage

    /** A view of [PackageService] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): PackageService.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/packages/create`, but is otherwise the             same as [PackageService.create]. */
        @MustBeClosed
        fun create(params: PackageCreateParams): HttpResponseFor<PackageCreateResponse> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: PackageCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PackageCreateResponse>

        /** Returns a raw HTTP response for `post /v1/packages/get`, but is otherwise the             same as [PackageService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: PackageRetrieveParams): HttpResponseFor<PackageRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PackageRetrieveResponse>

        /** Returns a raw HTTP response for `post /v1/packages/list`, but is otherwise the             same as [PackageService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<PackageListPage> = list(PackageListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: PackageListParams = PackageListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PackageListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: PackageListParams = PackageListParams.none()): HttpResponseFor<PackageListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see list */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<PackageListPage> =
            list(
              PackageListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /v1/packages/archive`, but is otherwise the             same as [PackageService.archive]. */
        @MustBeClosed
        fun archive(params: PackageArchiveParams): HttpResponseFor<PackageArchiveResponse> =
            archive(
              params, RequestOptions.none()
            )
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: PackageArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PackageArchiveResponse>

        /** Returns a raw HTTP response for `post /v1/packages/listContractsOnPackage`, but is otherwise the             same as [PackageService.listContractsOnPackage]. */
        @MustBeClosed
        fun listContractsOnPackage(params: PackageListContractsOnPackageParams): HttpResponseFor<PackageListContractsOnPackagePage> =
            listContractsOnPackage(
              params, RequestOptions.none()
            )
        ...
        /** @see listContractsOnPackage */
        @MustBeClosed
        fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PackageListContractsOnPackagePage>
    }
}
