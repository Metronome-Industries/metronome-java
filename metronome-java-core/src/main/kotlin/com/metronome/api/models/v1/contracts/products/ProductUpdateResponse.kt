...
class ProductUpdateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductUpdateResponse].
         *
    ...
    /** A builder for [ProductUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUpdateResponse: ProductUpdateResponse) =
            apply {
                data = productUpdateResponse.data
                additionalProperties = productUpdateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductUpdateResponse].
         *
         ...
         */
        fun build(): ProductUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): ProductUpdateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductUpdateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
