...
class ContractGetSubscriptionSeatsHistoryResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractGetSubscriptionSeatsHistoryResponse: ContractGetSubscriptionSeatsHistoryResponse) =
            apply {
                ...
                additionalProperties = contractGetSubscriptionSeatsHistoryResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ContractGetSubscriptionSeatsHistoryResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("assigned_seat_ids") @ExcludeMissing assignedSeatIds: JsonField<List<String>> = JsonMissing.of(),
            ...
            @JsonProperty("total_quantity") @ExcludeMissing totalQuantity: JsonField<Long> = JsonMissing.of()
        ) : this(
          assignedSeatIds,
          endingBefore,
          startingAt,
         ...
         *
         * Unlike [assignedSeatIds], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [totalQuantity], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            /** Array of seat IDs that are assigned in this period */
            fun assignedSeatIds(assignedSeatIds: List<String>) = assignedSeatIds(JsonField.of(assignedSeatIds))

            /**
             * Sets [Builder.assignedSeatIds] to an arbitrary JSON value.
             *
             * You should usually call [Builder.assignedSeatIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun assignedSeatIds(assignedSeatIds: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addAssignedSeatId(assignedSeatId: String) =
                apply {
                    assignedSeatIds = (assignedSeatIds ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.totalQuantity] with a well-typed [Long] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun totalQuantity(totalQuantity: JsonField<Long>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (assignedSeatIds.asKnown().getOrNull()?.size ?: 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (if (totalQuantity.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && assignedSeatIds == other.assignedSeatIds && endingBefore == other.endingBefore && startingAt == other.startingAt && totalQuantity == other.totalQuantity && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(assignedSeatIds, endingBefore, startingAt, totalQuantity, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{assignedSeatIds=$assignedSeatIds, endingBefore=$endingBefore, startingAt=$startingAt, totalQuantity=$totalQuantity, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractGetSubscriptionSeatsHistoryResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractGetSubscriptionSeatsHistoryResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
