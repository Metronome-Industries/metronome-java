            ...
            private constructor(
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * Indicates how the balance of child commits is drawn down. `SPEND` deducts
                         * the dollar cost of usage. `QUANTITY` deducts the number of units used.
                         */
                        fun accessType(accessType: AccessType) =
                            accessType(JsonField.of(accessType))

                        /**
                         * Sets [Builder.accessType] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.accessType] with a well-typed
                         * [AccessType] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
