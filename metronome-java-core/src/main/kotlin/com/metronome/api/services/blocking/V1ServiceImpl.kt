...
class V1ServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : V1Service {

    private val withRawResponse: V1Service.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    private val billableMetrics: BillableMetricService by lazy { BillableMetricServiceImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V1Service = V1ServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val creditGrants: CreditGrantService.WithRawResponse by lazy { CreditGrantServiceImpl.WithRawResponseImpl(clientOptions) }

        private val pricingUnits: PricingUnitService.WithRawResponse by lazy { PricingUnitServiceImpl.WithRawResponseImpl(clientOptions) }

        private val customers: CustomerService.WithRawResponse by lazy { CustomerServiceImpl.WithRawResponseImpl(clientOptions) }

        private val dashboards: DashboardService.WithRawResponse by lazy { DashboardServiceImpl.WithRawResponseImpl(clientOptions) }

        private val usage: UsageService.WithRawResponse by lazy { UsageServiceImpl.WithRawResponseImpl(clientOptions) }

        private val auditLogs: AuditLogService.WithRawResponse by lazy { AuditLogServiceImpl.WithRawResponseImpl(clientOptions) }

        private val customFields: CustomFieldService.WithRawResponse by lazy { CustomFieldServiceImpl.WithRawResponseImpl(clientOptions) }

        private val billableMetrics: BillableMetricService.WithRawResponse by lazy { BillableMetricServiceImpl.WithRawResponseImpl(clientOptions) }

        private val services: ServiceService.WithRawResponse by lazy { ServiceServiceImpl.WithRawResponseImpl(clientOptions) }

        private val invoices: InvoiceService.WithRawResponse by lazy { InvoiceServiceImpl.WithRawResponseImpl(clientOptions) }

        private val contracts: ContractService.WithRawResponse by lazy { ContractServiceImpl.WithRawResponseImpl(clientOptions) }

        private val packages: PackageService.WithRawResponse by lazy { PackageServiceImpl.WithRawResponseImpl(clientOptions) }

        private val settings: SettingService.WithRawResponse by lazy { SettingServiceImpl.WithRawResponseImpl(clientOptions) }

        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V1Service.WithRawResponse = V1ServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
