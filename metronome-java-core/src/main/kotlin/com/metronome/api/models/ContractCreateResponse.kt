...
@JsonDeserialize(builder = ContractCreateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(contractCreateResponse: ContractCreateResponse) = apply {
            this.data = contractCreateResponse.data
            additionalProperties(contractCreateResponse.additionalProperties)
        }
        ...
        fun build(): ContractCreateResponse =
            ContractCreateResponse(data, additionalProperties.toUnmodifiable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractCreateResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
