...
interface UsageService {
     ...
     *
     */
    fun list(params: UsageListParams): UsageListPage =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(params: UsageListParams, requestOptions: RequestOptions = RequestOptions.none()): UsageListPage
    ...
    /** @see ingest */
    fun ingest(params: UsageIngestParams = UsageIngestParams.none(), requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see ingest */
    fun ingest(usage: List<UsageIngestParams.Usage>, requestOptions: RequestOptions = RequestOptions.none()) =
        ingest(
    ...
    /** @see ingest */
    fun ingest(usage: List<UsageIngestParams.Usage>) =
        ingest(
          usage, RequestOptions.none()
        )

    /** @see ingest */
    fun ingest(requestOptions: RequestOptions) =
        ingest(
    ...
    /** @see listWithGroups */
    fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions = RequestOptions.none()): UsageListWithGroupsPage
    ...
    /** @see search */
    fun search(params: UsageSearchParams, requestOptions: RequestOptions = RequestOptions.none()): List<UsageSearchResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/usage`, but is otherwise the             same as [UsageService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: UsageListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageListPage>

        /** Returns a raw HTTP response for `post /v1/ingest`, but is otherwise the             same as [UsageService.ingest]. */
        @MustBeClosed
        fun ingest(): HttpResponse = ingest(UsageIngestParams.none())

        /** @see ingest */
        @MustBeClosed
        fun ingest(params: UsageIngestParams = UsageIngestParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
        ...
        /** @see ingest */
        @MustBeClosed
        fun ingest(usage: List<UsageIngestParams.Usage>, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse =
            ingest(
              UsageIngestParams.builder()
                  .usage(usage)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/usage/groups`, but is otherwise the             same as [UsageService.listWithGroups]. */
        @MustBeClosed
        fun listWithGroups(params: UsageListWithGroupsParams): HttpResponseFor<UsageListWithGroupsPage> =
            listWithGroups(
              params, RequestOptions.none()
            )
        ...
        /** @see listWithGroups */
        @MustBeClosed
        fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<UsageListWithGroupsPage>

        /** Returns a raw HTTP response for `post /v1/events/search`, but is otherwise the             same as [UsageService.search]. */
        @MustBeClosed
        ...
        /** @see search */
        @MustBeClosed
        fun search(params: UsageSearchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<List<UsageSearchResponse>>
    }
}
