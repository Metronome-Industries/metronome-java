...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentCancelParams].
         *
    ...
    /** A builder for [PaymentCancelParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentCancelParams: PaymentCancelParams) = apply {
            body = paymentCancelParams.body.toBuilder()
            additionalHeaders = paymentCancelParams.additionalHeaders.toBuilder()
            additionalQueryParams = paymentCancelParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentCancelParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentCancelParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PaymentCancelParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
