...
internal class RateServiceTest {
    ...
    fun list() {
      val client = MetronomeOkHttpClient.builder()
          ...
          .build()
      val rateService = client.v1().contracts().rateCards().rates()

      val page = rateService.list(RateListParams.builder()
    ...
    fun add() {
      ...
      val response = rateService.add(RateAddParams.builder()
          .entitled(true)
          ...
          .commitRate(CommitRate.builder()
              .rateType(CommitRate.RateType.FLAT)
              .price(0.0)
              .addTier(CommitRate.Tier.builder()
                  .price(0.0)
                  .size(0.0)
                  .build())
              .build())
          .creditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
          .customRate(RateAddParams.CustomRate.builder()
              .putAdditionalProperty("foo", JsonValue.from("bar"))
              .build())
          .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .isProrated(true)
          .price(100.0)
          .pricingGroupValues(RateAddParams.PricingGroupValues.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
          .quantity(0.0)
          .addTier(RateAddParams.Tier.builder()
              .price(0.0)
              .size(0.0)
              .build())
          .build())
    ...
    fun addMany() {
      ...
      val response = rateService.addMany(RateAddManyParams.builder()
          .rateCardId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .addRate(RateAddManyParams.Rate.builder()
              ...
              .commitRate(CommitRate.builder()
                  ...
                  .build())
              .creditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
              .customRate(RateAddManyParams.Rate.CustomRate.builder()
                  .putAdditionalProperty("foo", JsonValue.from("bar"))
                  .build())
              .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .isProrated(true)
              .price(100.0)
              .pricingGroupValues(RateAddManyParams.Rate.PricingGroupValues.builder()
                  .putAdditionalProperty("region", JsonValue.from("us-west-2"))
                  .putAdditionalProperty("cloud", JsonValue.from("aws"))
                  .build())
              .quantity(0.0)
              .addTier(RateAddManyParams.Rate.Tier.builder()
                  .price(0.0)
                  .size(0.0)
                  .build())
              .build())
