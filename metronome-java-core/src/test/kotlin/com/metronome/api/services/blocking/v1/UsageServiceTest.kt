...
internal class UsageServiceTest {
    ...
    fun list() {
      ...
      val page = usageService.list(UsageListParams.builder()
    ...
    fun ingest() {
      ...
      usageService.ingest(listOf(UsageIngestParams.Usage.builder()
    ...
    fun listWithGroups() {
      ...
      val page = usageService.listWithGroups(UsageListWithGroupsParams.builder()
    ...
    fun search() {
      ...
      val response = usageService.search(UsageSearchParams.builder()
