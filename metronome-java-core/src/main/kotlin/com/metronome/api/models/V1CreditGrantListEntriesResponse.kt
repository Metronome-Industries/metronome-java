...
@NoAutoDetect
class V1CreditGrantListEntriesResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CreditGrantListEntriesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CreditGrantListEntriesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantListEntriesResponse: V1CreditGrantListEntriesResponse) =
            apply {
                customerId = v1CreditGrantListEntriesResponse.customerId
                ledgers = v1CreditGrantListEntriesResponse.ledgers.map { it.toMutableList() }
                additionalProperties =
                    v1CreditGrantListEntriesResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): V1CreditGrantListEntriesResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantListEntriesResponse && customerId == other.customerId && ledgers == other.ledgers && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CreditGrantListEntriesResponse{customerId=$customerId, ledgers=$ledgers, additionalProperties=$additionalProperties}"
}
