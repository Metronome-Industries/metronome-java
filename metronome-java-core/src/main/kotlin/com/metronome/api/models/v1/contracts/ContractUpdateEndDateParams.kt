 ...
 *
 */
class ContractUpdateEndDateParams private constructor(
     ...
     */
    fun allowEndingBeforeFinalizedInvoice(): Optional<Boolean> = body.allowEndingBeforeFinalizedInvoice()
     ...
     *
     * Unlike [allowEndingBeforeFinalizedInvoice], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _allowEndingBeforeFinalizedInvoice(): JsonField<Boolean> = body._allowEndingBeforeFinalizedInvoice()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractUpdateEndDateParams: ContractUpdateEndDateParams) =
            apply {
         ...
         *
         * You should usually call [Builder.allowEndingBeforeFinalizedInvoice] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun allowEndingBeforeFinalizedInvoice(allowEndingBeforeFinalizedInvoice: JsonField<Boolean>) =
            apply {
                body.allowEndingBeforeFinalizedInvoice(allowEndingBeforeFinalizedInvoice)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("allow_ending_before_finalized_invoice") @ExcludeMissing allowEndingBeforeFinalizedInvoice: JsonField<Boolean> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun allowEndingBeforeFinalizedInvoice(): Optional<Boolean> = allowEndingBeforeFinalizedInvoice.getOptional("allow_ending_before_finalized_invoice")
        ...
        @ExcludeMissing
        fun _allowEndingBeforeFinalizedInvoice(): JsonField<Boolean> = allowEndingBeforeFinalizedInvoice
        ...
        class Builder internal constructor() {
            ...
            /** If true, allows setting the contract end date earlier than the end_timestamp of existing finalized invoices. Finalized invoices will be unchanged; if you want to incorporate the new end date, you can void and regenerate finalized usage invoices. Defaults to true. */
            fun allowEndingBeforeFinalizedInvoice(allowEndingBeforeFinalizedInvoice: Boolean) = allowEndingBeforeFinalizedInvoice(JsonField.of(allowEndingBeforeFinalizedInvoice))
            ...
            fun allowEndingBeforeFinalizedInvoice(allowEndingBeforeFinalizedInvoice: JsonField<Boolean>) =
                apply {
                    this.allowEndingBeforeFinalizedInvoice = allowEndingBeforeFinalizedInvoice
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (allowEndingBeforeFinalizedInvoice.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && allowEndingBeforeFinalizedInvoice == other.allowEndingBeforeFinalizedInvoice && endingBefore == other.endingBefore && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, allowEndingBeforeFinalizedInvoice=$allowEndingBeforeFinalizedInvoice, endingBefore=$endingBefore, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractUpdateEndDateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractUpdateEndDateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
