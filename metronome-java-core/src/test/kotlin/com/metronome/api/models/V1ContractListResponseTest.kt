...
class V1ContractListResponseTest {

    @Test
    fun createV1ContractListResponse() {
        val v1ContractListResponse =
            V1ContractListResponse.builder()
                .addData(
                    Contract.builder()
                ...
                .build()
        assertThat(v1ContractListResponse).isNotNull
        assertThat(v1ContractListResponse.data())
            .containsExactly(
                Contract.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .addAmendment(
