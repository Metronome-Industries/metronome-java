...
class CreditUpdateEndDateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditUpdateEndDateResponse].
         *
    ...
    /** A builder for [CreditUpdateEndDateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditUpdateEndDateResponse: CreditUpdateEndDateResponse) =
            apply {
                data = creditUpdateEndDateResponse.data
                additionalProperties = creditUpdateEndDateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CreditUpdateEndDateResponse].
         *
         ...
         */
        fun build(): CreditUpdateEndDateResponse =
     ...
     *   expected type.
     */
    fun validate(): CreditUpdateEndDateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditUpdateEndDateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditUpdateEndDateResponse{data=$data, additionalProperties=$additionalProperties}"
}
