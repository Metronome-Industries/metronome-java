...
interface DashboardService {
     ...
     *     - `dashboard_options`: Configure dashboard behavior. For the invoices dashboard,
     *       supported keys include: `show_zero_usage_line_items` ("true"/"false"),
     *       `hide_voided_invoices` ("true"/"false"), `contract_id` (UUID, filters invoices by
     *       contract), `invoice_type` ("USAGE" or "SCHEDULED", filters by invoice type),
     *       `invoice_status_filter` ("VOID", "FINALIZED", "DRAFT", "FINALIZED_AND_DRAFT", or
     *       "ALL"), and `billable_status_filter` ("BILLABLE", "UNBILLABLE", or "ALL")
