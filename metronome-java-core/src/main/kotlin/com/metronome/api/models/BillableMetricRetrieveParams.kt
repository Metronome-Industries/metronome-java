...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillableMetricRetrieveParams && this.billableMetricId == other.billableMetricId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(billableMetricId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "BillableMetricRetrieveParams{billableMetricId=$billableMetricId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
