...
private constructor(
    ...
    /**
     * Set to true to enable webhook messages for the notification indicated in the policy, false to
     * disable. Only supported by system lifecycle events.
     *
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(offsetEditParams: OffsetEditParams) = apply {
        ...
        /**
         * Updated policy configuration. The policy.type must match the existing lifecycle event
         * type.
         */
         ...
         */
        fun policy(lifecycleEventOffset: Policy.LifecycleEventOffsetPolicy) = apply {
         ...
         */
        fun policy(lifecycleEventSystem: Policy.LifecycleEventSystemPolicy) = apply {
        ...
        /**
         * Set to true to enable webhook messages for the notification indicated in the policy,
         * false to disable. Only supported by system lifecycle events.
         */
        ...
        fun build(): OffsetEditParams =
            OffsetEditParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    private constructor(
        ...
        ) : this(policy, id, isEnabled, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [policy] with
             * `Policy.ofLifecycleEventOffset(lifecycleEventOffset)`.
             */
            fun policy(lifecycleEventOffset: Policy.LifecycleEventOffsetPolicy) =
                policy(Policy.ofLifecycleEventOffset(lifecycleEventOffset))

            /**
             * Alias for calling [policy] with
             * `Policy.ofLifecycleEventSystem(lifecycleEventSystem)`.
             */
            fun policy(lifecycleEventSystem: Policy.LifecycleEventSystemPolicy) =
                policy(Policy.ofLifecycleEventSystem(lifecycleEventSystem))
        ...
        private val hashCode: Int by lazy {
            Objects.hash(policy, id, isEnabled, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{policy=$policy, id=$id, isEnabled=$isEnabled, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        fun lifecycleEventOffset(): Optional<LifecycleEventOffsetPolicy> =
            Optional.ofNullable(lifecycleEventOffset)

        fun lifecycleEventSystem(): Optional<LifecycleEventSystemPolicy> =
            Optional.ofNullable(lifecycleEventSystem)

        fun isLifecycleEventOffset(): Boolean = lifecycleEventOffset != null

        fun isLifecycleEventSystem(): Boolean = lifecycleEventSystem != null

        fun asLifecycleEventOffset(): LifecycleEventOffsetPolicy =
            lifecycleEventOffset.getOrThrow("lifecycleEventOffset")

        fun asLifecycleEventSystem(): LifecycleEventSystemPolicy =
            lifecycleEventSystem.getOrThrow("lifecycleEventSystem")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                lifecycleEventOffset != null ->
                    visitor.visitLifecycleEventOffset(lifecycleEventOffset)
                lifecycleEventSystem != null ->
                    visitor.visitLifecycleEventSystem(lifecycleEventSystem)
        ...
        fun validate(): Policy = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitLifecycleEventOffset(
                        lifecycleEventOffset: LifecycleEventOffsetPolicy
                    ) {
                        lifecycleEventOffset.validate()
                    }

                    override fun visitLifecycleEventSystem(
                        lifecycleEventSystem: LifecycleEventSystemPolicy
                    ) {
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitLifecycleEventOffset(
                        lifecycleEventOffset: LifecycleEventOffsetPolicy
                    ) = lifecycleEventOffset.validity()

                    override fun visitLifecycleEventSystem(
                        lifecycleEventSystem: LifecycleEventSystemPolicy
                    ) = lifecycleEventSystem.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Policy &&
                lifecycleEventOffset == other.lifecycleEventOffset &&
                lifecycleEventSystem == other.lifecycleEventSystem
        }
        ...
        companion object {
            ...
            @JvmStatic
            fun ofLifecycleEventOffset(lifecycleEventOffset: LifecycleEventOffsetPolicy) =
                Policy(lifecycleEventOffset = lifecycleEventOffset)

            @JvmStatic
            fun ofLifecycleEventSystem(lifecycleEventSystem: LifecycleEventSystemPolicy) =
                Policy(lifecycleEventSystem = lifecycleEventSystem)
        }
        ...
        interface Visitor<out T> {
             ...
             *
             * An instance of [Policy] can contain an unknown variant if it was deserialized from
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<LifecycleEventOffsetPolicy>())
                                ?.let { Policy(lifecycleEventOffset = it, _json = json) },
                            tryDeserialize(node, jacksonTypeRef<LifecycleEventSystemPolicy>())
                                ?.let { Policy(lifecycleEventSystem = it, _json = json) },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Policy>(Policy::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.lifecycleEventOffset != null ->
                        generator.writeObject(value.lifecycleEventOffset)
                    value.lifecycleEventSystem != null ->
                        generator.writeObject(value.lifecycleEventSystem)
        ...
        class LifecycleEventOffsetPolicy
        @JsonCreator(mode = JsonCreator.Mode.DISABLED)
        private constructor(
            ...
            private constructor(
                @JsonProperty("offset")
                @ExcludeMissing
                offset: JsonField<String> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(lifecycleEventOffsetPolicy: LifecycleEventOffsetPolicy) = apply {
                    offset = lifecycleEventOffsetPolicy.offset
                    type = lifecycleEventOffsetPolicy.type
                    additionalProperties =
                        lifecycleEventOffsetPolicy.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.offset] with a well-typed [String] value
             ...
             *   its expected type.
             */
            fun validate(): LifecycleEventOffsetPolicy = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is LifecycleEventOffsetPolicy &&
                    offset == other.offset &&
                    type == other.type &&
                    additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() =
                "LifecycleEventOffsetPolicy{offset=$offset, type=$type, additionalProperties=$additionalProperties}"
        }

        class LifecycleEventSystemPolicy
        @JsonCreator(mode = JsonCreator.Mode.DISABLED)
        private constructor(
            private val type: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(lifecycleEventSystemPolicy: LifecycleEventSystemPolicy) = apply {
                    type = lifecycleEventSystemPolicy.type
                    additionalProperties =
                        lifecycleEventSystemPolicy.additionalProperties.toMutableMap()
                }
             ...
             *   its expected type.
             */
            fun validate(): LifecycleEventSystemPolicy = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is LifecycleEventSystemPolicy &&
                    type == other.type &&
                    additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() =
                "LifecycleEventSystemPolicy{type=$type, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OffsetEditParams &&
            body == other.body &&
    ...
    override fun toString() =
        "OffsetEditParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
