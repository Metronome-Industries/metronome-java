 ...
 *
 */
class ContractCreateHistoricalInvoicesParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractCreateHistoricalInvoicesParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractCreateHistoricalInvoicesParams: ContractCreateHistoricalInvoicesParams) =
            apply {
                ...
                additionalQueryParams = contractCreateHistoricalInvoicesParams.additionalQueryParams.toBuilder()
            }
        ...
        fun invoices(invoices: List<Invoice>) =
            apply {
         ...
         *
         * You should usually call [Builder.invoices] with a well-typed `List<Invoice>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.preview] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun preview(preview: JsonField<Boolean>) =
            apply {
                body.preview(preview)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("invoices") @ExcludeMissing invoices: JsonField<List<Invoice>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _preview(): JsonField<Boolean> = preview
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (invoices.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (preview.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && invoices == other.invoices && preview == other.preview && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{invoices=$invoices, preview=$preview, additionalProperties=$additionalProperties}"
    }
    ...
    class Invoice @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("exclusive_end_date") @ExcludeMissing exclusiveEndDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("inclusive_start_date") @ExcludeMissing inclusiveStartDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("issue_date") @ExcludeMissing issueDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("usage_line_items") @ExcludeMissing usageLineItems: JsonField<List<UsageLineItem>> = JsonMissing.of(),
            @JsonProperty("billable_status") @ExcludeMissing billableStatus: JsonField<BillableStatus> = JsonMissing.of(),
            @JsonProperty("breakdown_granularity") @ExcludeMissing breakdownGranularity: JsonField<BreakdownGranularity> = JsonMissing.of(),
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun inclusiveStartDate(): OffsetDateTime = inclusiveStartDate.getRequired("inclusive_start_date")
         ...
         */
        fun billableStatus(): Optional<BillableStatus> = billableStatus.getOptional("billable_status")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun breakdownGranularity(): Optional<BreakdownGranularity> = breakdownGranularity.getOptional("breakdown_granularity")
         ...
         *
         * Unlike [exclusiveEndDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [inclusiveStartDate], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [usageLineItems], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [billableStatus], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [breakdownGranularity], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            fun exclusiveEndDate(exclusiveEndDate: OffsetDateTime) = exclusiveEndDate(JsonField.of(exclusiveEndDate))

            /**
             * Sets [Builder.exclusiveEndDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.exclusiveEndDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun exclusiveEndDate(exclusiveEndDate: JsonField<OffsetDateTime>) =
                apply {
                    this.exclusiveEndDate = exclusiveEndDate
                }

            fun inclusiveStartDate(inclusiveStartDate: OffsetDateTime) = inclusiveStartDate(JsonField.of(inclusiveStartDate))

            /**
             * Sets [Builder.inclusiveStartDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.inclusiveStartDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun inclusiveStartDate(inclusiveStartDate: JsonField<OffsetDateTime>) =
                apply {
            ...
            fun usageLineItems(usageLineItems: List<UsageLineItem>) = usageLineItems(JsonField.of(usageLineItems))

            /**
             * Sets [Builder.usageLineItems] to an arbitrary JSON value.
             *
             * You should usually call [Builder.usageLineItems] with a well-typed `List<UsageLineItem>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun usageLineItems(usageLineItems: JsonField<List<UsageLineItem>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addUsageLineItem(usageLineItem: UsageLineItem) =
                apply {
                    usageLineItems = (usageLineItems ?: JsonField.of(mutableListOf())).also {
                        checkKnown("usageLineItems", it).add(usageLineItem)
                    }
                }

            /** This field's availability is dependent on your client's configuration. */
            fun billableStatus(billableStatus: BillableStatus) = billableStatus(JsonField.of(billableStatus))

            /**
             * Sets [Builder.billableStatus] to an arbitrary JSON value.
             *
             * You should usually call [Builder.billableStatus] with a well-typed [BillableStatus] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun billableStatus(billableStatus: JsonField<BillableStatus>) =
                apply {
                    this.billableStatus = billableStatus
                }

            fun breakdownGranularity(breakdownGranularity: BreakdownGranularity) = breakdownGranularity(JsonField.of(breakdownGranularity))

            /**
             * Sets [Builder.breakdownGranularity] to an arbitrary JSON value.
             *
             * You should usually call [Builder.breakdownGranularity] with a well-typed [BreakdownGranularity] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (creditTypeId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (exclusiveEndDate.asKnown().isPresent) 1 else 0) + (if (inclusiveStartDate.asKnown().isPresent) 1 else 0) + (if (issueDate.asKnown().isPresent) 1 else 0) + (usageLineItems.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (billableStatus.asKnown().getOrNull()?.validity() ?: 0) + (breakdownGranularity.asKnown().getOrNull()?.validity() ?: 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0)

        class UsageLineItem @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val exclusiveEndDate: JsonField<OffsetDateTime>,
            private val inclusiveStartDate: JsonField<OffsetDateTime>,
            ...
            private constructor(
                ...
                @JsonProperty("subtotals_with_quantity") @ExcludeMissing subtotalsWithQuantity: JsonField<List<SubtotalsWithQuantity>> = JsonMissing.of()
            ) : this(
              exclusiveEndDate,
              inclusiveStartDate,
              productId,
            ...
            /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun subtotalsWithQuantity(): Optional<List<SubtotalsWithQuantity>> = subtotalsWithQuantity.getOptional("subtotals_with_quantity")
             ...
             *
             * Unlike [subtotalsWithQuantity], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("subtotals_with_quantity")
            @ExcludeMissing
            fun _subtotalsWithQuantity(): JsonField<List<SubtotalsWithQuantity>> = subtotalsWithQuantity
            ...
            class Builder internal constructor() {
                ...
                private var subtotalsWithQuantity: JsonField<MutableList<SubtotalsWithQuantity>>? = null
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                @JvmSynthetic
                internal fun from(usageLineItem: UsageLineItem) =
                    apply {
                        ...
                        subtotalsWithQuantity = usageLineItem.subtotalsWithQuantity.map { it.toMutableList() }
                ...
                fun subtotalsWithQuantity(subtotalsWithQuantity: List<SubtotalsWithQuantity>) = subtotalsWithQuantity(JsonField.of(subtotalsWithQuantity))

                /**
                 * Sets [Builder.subtotalsWithQuantity] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.subtotalsWithQuantity] with a well-typed `List<SubtotalsWithQuantity>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun subtotalsWithQuantity(subtotalsWithQuantity: JsonField<List<SubtotalsWithQuantity>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addSubtotalsWithQuantity(subtotalsWithQuantity: SubtotalsWithQuantity) =
                    apply {
                        this.subtotalsWithQuantity = (this.subtotalsWithQuantity ?: JsonField.of(mutableListOf())).also {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (exclusiveEndDate.asKnown().isPresent) 1 else 0) + (if (inclusiveStartDate.asKnown().isPresent) 1 else 0) + (if (productId.asKnown().isPresent) 1 else 0) + (presentationGroupValues.asKnown().getOrNull()?.validity() ?: 0) + (pricingGroupValues.asKnown().getOrNull()?.validity() ?: 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (subtotalsWithQuantity.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            class SubtotalsWithQuantity @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                private val exclusiveEndDate: JsonField<OffsetDateTime>,
                private val inclusiveStartDate: JsonField<OffsetDateTime>,
                private val quantity: JsonField<Double>,
                private val additionalProperties: MutableMap<String, JsonValue>,
                ...
                companion object {
                    ...
                    /**
                     * Returns a mutable builder for constructing an instance of [SubtotalsWithQuantity].
                     *
                     * The following fields are required:
                     *
                     * ```java
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(subtotalsWithQuantity: SubtotalsWithQuantity) =
                        apply {
                            ...
                            additionalProperties = subtotalsWithQuantity.additionalProperties.toMutableMap()
                        }
                 ...
                 *   expected type.
                 */
                fun validate(): SubtotalsWithQuantity =
                    apply {
                        if (validated) {
                          return@apply
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (exclusiveEndDate.asKnown().isPresent) 1 else 0) + (if (inclusiveStartDate.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is SubtotalsWithQuantity && exclusiveEndDate == other.exclusiveEndDate && inclusiveStartDate == other.inclusiveStartDate && quantity == other.quantity && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "SubtotalsWithQuantity{exclusiveEndDate=$exclusiveEndDate, inclusiveStartDate=$inclusiveStartDate, quantity=$quantity, additionalProperties=$additionalProperties}"
            }
            ...
            override fun toString() = "UsageLineItem{exclusiveEndDate=$exclusiveEndDate, inclusiveStartDate=$inclusiveStartDate, productId=$productId, presentationGroupValues=$presentationGroupValues, pricingGroupValues=$pricingGroupValues, quantity=$quantity, subtotalsWithQuantity=$subtotalsWithQuantity, additionalProperties=$additionalProperties}"
        }

        /** This field's availability is dependent on your client's configuration. */
        class BillableStatus @JsonCreator private constructor(
            ...
            enum class Value {
                BILLABLE,
                UNBILLABLE,
                /** An enum member indicating that [BillableStatus] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        class BreakdownGranularity @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            /**
             * An enum containing [BreakdownGranularity]'s known values, as well as an [_UNKNOWN] member.
             *
             * An instance of [BreakdownGranularity] can contain an unknown value in a couple of cases:
             *
             * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
             *   an older version than the API, then the API may respond with new members that the SDK is unaware
             *   of.
            ...
            enum class Value {
                HOUR,
                DAY,
                /** An enum member indicating that [BreakdownGranularity] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    HOUR -> Known.HOUR
                    DAY -> Known.DAY
                    else -> throw MetronomeInvalidDataException("Unknown BreakdownGranularity: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): BreakdownGranularity =
                apply {
                    if (validated) {
                      return@apply
                    }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Invoice && contractId == other.contractId && creditTypeId == other.creditTypeId && customerId == other.customerId && exclusiveEndDate == other.exclusiveEndDate && inclusiveStartDate == other.inclusiveStartDate && issueDate == other.issueDate && usageLineItems == other.usageLineItems && billableStatus == other.billableStatus && breakdownGranularity == other.breakdownGranularity && customFields == other.customFields && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractCreateHistoricalInvoicesParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractCreateHistoricalInvoicesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
