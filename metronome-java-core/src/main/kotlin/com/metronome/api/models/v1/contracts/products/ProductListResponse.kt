...
import com.metronome.api.models.v1.contracts.products.ProductListResponse
...
class ProductListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductListResponse && id == other.id && current == other.current && initial == other.initial && type == other.type && updates == other.updates && archivedAt == other.archivedAt && customFields == other.customFields && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductListResponse{id=$id, current=$current, initial=$initial, type=$type, updates=$updates, archivedAt=$archivedAt, customFields=$customFields, additionalProperties=$additionalProperties}"
}
