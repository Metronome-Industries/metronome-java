...
class PrepaidBalanceThresholdConfigurationV2 @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PrepaidBalanceThresholdConfigurationV2].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(prepaidBalanceThresholdConfigurationV2: PrepaidBalanceThresholdConfigurationV2) =
            apply {
                ...
                thresholdBalanceSpecifiers = prepaidBalanceThresholdConfigurationV2.thresholdBalanceSpecifiers.map { it.toMutableList() }
                additionalProperties = prepaidBalanceThresholdConfigurationV2.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): PrepaidBalanceThresholdConfigurationV2 =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PrepaidBalanceThresholdConfigurationV2 && commit == other.commit && isEnabled == other.isEnabled && paymentGateConfig == other.paymentGateConfig && rechargeToAmount == other.rechargeToAmount && thresholdAmount == other.thresholdAmount && customCreditTypeId == other.customCreditTypeId && discountConfiguration == other.discountConfiguration && thresholdBalanceSpecifiers == other.thresholdBalanceSpecifiers && additionalProperties == other.additionalProperties
    }
