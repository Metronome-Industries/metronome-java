...
@NoAutoDetect
class V1BillableMetricListResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1BillableMetricListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1BillableMetricListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1BillableMetricListResponse: V1BillableMetricListResponse) = apply {
            id = v1BillableMetricListResponse.id
            name = v1BillableMetricListResponse.name
            aggregationKey = v1BillableMetricListResponse.aggregationKey
            aggregationType = v1BillableMetricListResponse.aggregationType
            archivedAt = v1BillableMetricListResponse.archivedAt
            customFields = v1BillableMetricListResponse.customFields
            eventTypeFilter = v1BillableMetricListResponse.eventTypeFilter
            groupKeys = v1BillableMetricListResponse.groupKeys.map { it.toMutableList() }
            propertyFilters =
                v1BillableMetricListResponse.propertyFilters.map { it.toMutableList() }
            sql = v1BillableMetricListResponse.sql
            additionalProperties = v1BillableMetricListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1BillableMetricListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1BillableMetricListResponse && id == other.id && name == other.name && aggregationKey == other.aggregationKey && aggregationType == other.aggregationType && archivedAt == other.archivedAt && customFields == other.customFields && eventTypeFilter == other.eventTypeFilter && groupKeys == other.groupKeys && propertyFilters == other.propertyFilters && sql == other.sql && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1BillableMetricListResponse{id=$id, name=$name, aggregationKey=$aggregationKey, aggregationType=$aggregationType, archivedAt=$archivedAt, customFields=$customFields, eventTypeFilter=$eventTypeFilter, groupKeys=$groupKeys, propertyFilters=$propertyFilters, sql=$sql, additionalProperties=$additionalProperties}"
}
