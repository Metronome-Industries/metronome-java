 ...
 */
class V1ContractRateCardProductOrderSetParams
private constructor(
    ...
    /** A builder for [V1ContractRateCardProductOrderSetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRateCardProductOrderSetParams: V1ContractRateCardProductOrderSetParams
        ) = apply {
            body = v1ContractRateCardProductOrderSetParams.body.toBuilder()
            additionalHeaders =
                v1ContractRateCardProductOrderSetParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRateCardProductOrderSetParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardProductOrderSetParams =
            V1ContractRateCardProductOrderSetParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardProductOrderSetParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardProductOrderSetParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
