...
class ContractArchiveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractArchiveResponse].
         *
    ...
    /** A builder for [ContractArchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractArchiveResponse: ContractArchiveResponse) =
            apply {
                data = contractArchiveResponse.data
                additionalProperties = contractArchiveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ContractArchiveResponse].
         *
         ...
         */
        fun build(): ContractArchiveResponse =
     ...
     *   expected type.
     */
    fun validate(): ContractArchiveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractArchiveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractArchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
