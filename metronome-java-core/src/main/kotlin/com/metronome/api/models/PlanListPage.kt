...
private constructor(
    ...
    constructor(
        ...
        override fun toString() =
            "PlanListPage.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    constructor(
    ...
    ) : Iterable<PlanListResponse> {

        override fun iterator(): Iterator<PlanListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<PlanListResponse> {
