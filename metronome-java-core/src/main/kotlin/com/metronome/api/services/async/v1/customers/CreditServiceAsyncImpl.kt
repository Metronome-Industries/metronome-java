...
class CreditServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditServiceAsync = CreditServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: CreditCreateParams, requestOptions: RequestOptions): CompletableFuture<CreditCreateResponse> =
        // post /v1/contracts/customerCredits/create
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun list(params: CreditListParams, requestOptions: RequestOptions): CompletableFuture<CreditListPageAsync> =
        // post /v1/contracts/customerCredits/list
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions): CompletableFuture<CreditUpdateEndDateResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditServiceAsync.WithRawResponse = CreditServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<CreditCreateResponse> = jsonHandler<CreditCreateResponse>(clientOptions.jsonMapper)

        override fun create(params: CreditCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditCreateResponse>> {
        ...
        private val listHandler: Handler<CreditListPageResponse> = jsonHandler<CreditListPageResponse>(clientOptions.jsonMapper)

        override fun list(params: CreditListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val updateEndDateHandler: Handler<CreditUpdateEndDateResponse> = jsonHandler<CreditUpdateEndDateResponse>(clientOptions.jsonMapper)

        override fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreditUpdateEndDateResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
