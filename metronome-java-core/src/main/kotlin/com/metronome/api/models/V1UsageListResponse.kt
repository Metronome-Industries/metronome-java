...
private constructor(
    ...
    fun validate(): V1UsageListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1UsageListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1UsageListResponse: V1UsageListResponse) = apply {
            billableMetricId = v1UsageListResponse.billableMetricId
            billableMetricName = v1UsageListResponse.billableMetricName
            customerId = v1UsageListResponse.customerId
            endTimestamp = v1UsageListResponse.endTimestamp
            startTimestamp = v1UsageListResponse.startTimestamp
            value = v1UsageListResponse.value
            groups = v1UsageListResponse.groups
            additionalProperties = v1UsageListResponse.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1UsageListResponse && billableMetricId == other.billableMetricId && billableMetricName == other.billableMetricName && customerId == other.customerId && endTimestamp == other.endTimestamp && startTimestamp == other.startTimestamp && value == other.value && groups == other.groups && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1UsageListResponse{billableMetricId=$billableMetricId, billableMetricName=$billableMetricName, customerId=$customerId, endTimestamp=$endTimestamp, startTimestamp=$startTimestamp, value=$value, groups=$groups, additionalProperties=$additionalProperties}"
}
