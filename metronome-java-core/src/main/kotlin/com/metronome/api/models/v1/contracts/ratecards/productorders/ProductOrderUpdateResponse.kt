...
class ProductOrderUpdateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductOrderUpdateResponse].
         *
    ...
    /** A builder for [ProductOrderUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productOrderUpdateResponse: ProductOrderUpdateResponse) =
            apply {
                data = productOrderUpdateResponse.data
                additionalProperties = productOrderUpdateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductOrderUpdateResponse].
         *
         ...
         */
        fun build(): ProductOrderUpdateResponse =
     ...
     *   expected type.
     */
    fun validate(): ProductOrderUpdateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductOrderUpdateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductOrderUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
