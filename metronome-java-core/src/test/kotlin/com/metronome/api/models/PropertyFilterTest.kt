...
internal class PropertyFilterTest {
    ...
    @Test
    fun create() {
      val propertyFilter = PropertyFilter.builder()
          .name("name")
          .exists(true)
          .addInValue("string")
    ...
    fun roundtrip() {
      ...
      val roundtrippedPropertyFilter = jsonMapper.readValue(jsonMapper.writeValueAsString(propertyFilter), jacksonTypeRef<PropertyFilter>())
