...
internal class AlertCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = AlertCreateParams.builder()
          .alertType(AlertCreateParams.AlertType.SPEND_THRESHOLD_REACHED)
          .name("\$100 spend threshold reached")
          .threshold(10000.0)
          .addAlertSpecifier(AlertCreateParams.AlertSpecifier.builder()
      ...
      assertThat(body.alertSpecifiers().getOrNull()).containsExactly(AlertCreateParams.AlertSpecifier.builder()
          .addCustomFieldFilter(AlertCreateParams.AlertSpecifier.CustomFieldFilter.builder()
              .entity(AlertCreateParams.AlertSpecifier.CustomFieldFilter.Entity.CONTRACT)
              .key("key")
              .value("value")
      ...
      assertThat(body.customFieldFilters().getOrNull()).containsExactly(AlertCreateParams.CustomFieldFilter.builder()
          .entity(AlertCreateParams.CustomFieldFilter.Entity.CONTRACT)
          .key("key")
          .value("value")
          .build())
      ...
      assertThat(body.groupValues().getOrNull()).containsExactly(AlertCreateParams.GroupValue.builder()
          .key("key")
          .value("value")
          .build())
      ...
      assertThat(body.seatFilter()).contains(AlertCreateParams.SeatFilter.builder()
          .seatGroupKey("seat_group_key")
          .seatGroupValue("seat_group_value")
          .build())
