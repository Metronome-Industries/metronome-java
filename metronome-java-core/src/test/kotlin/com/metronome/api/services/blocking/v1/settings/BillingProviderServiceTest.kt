...
internal class BillingProviderServiceTest {
    ...
    fun create() {
      ...
      val billingProvider = billingProviderService.create(BillingProviderCreateParams.builder()
    ...
    fun list() {
      ...
      val billingProviders = billingProviderService.list(BillingProviderListParams.builder()
