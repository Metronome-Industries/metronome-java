 ...
 */
class V1ContractUpdateEndDateParams
private constructor(
    ...
    /** A builder for [V1ContractUpdateEndDateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractUpdateEndDateParams: V1ContractUpdateEndDateParams) = apply {
            body = v1ContractUpdateEndDateParams.body.toBuilder()
            additionalHeaders = v1ContractUpdateEndDateParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractUpdateEndDateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractUpdateEndDateParams =
            V1ContractUpdateEndDateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractUpdateEndDateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractUpdateEndDateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
