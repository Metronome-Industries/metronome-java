...
class ContractCreateHistoricalInvoicesResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractCreateHistoricalInvoicesResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractCreateHistoricalInvoicesResponse: ContractCreateHistoricalInvoicesResponse) =
            apply {
                data = contractCreateHistoricalInvoicesResponse.data.map { it.toMutableList() }
                additionalProperties = contractCreateHistoricalInvoicesResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ContractCreateHistoricalInvoicesResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): ContractCreateHistoricalInvoicesResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractCreateHistoricalInvoicesResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractCreateHistoricalInvoicesResponse{data=$data, additionalProperties=$additionalProperties}"
}
