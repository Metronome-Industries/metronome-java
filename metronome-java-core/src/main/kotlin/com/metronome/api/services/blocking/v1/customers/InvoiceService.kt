...
interface InvoiceService {
    ...
    /** @see retrieve */
    fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): InvoiceRetrieveResponse
     ...
     *
     */
    fun list(params: InvoiceListParams): InvoiceListPage =
        list(
          params, RequestOptions.none()
        )
     ...
     *
     */
    fun addCharge(params: InvoiceAddChargeParams): InvoiceAddChargeResponse =
        addCharge(
          params, RequestOptions.none()
        )

    /** @see addCharge */
    fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions = RequestOptions.none()): InvoiceAddChargeResponse
     ...
     */
    fun listBreakdowns(params: InvoiceListBreakdownsParams): InvoiceListBreakdownsPage =
        listBreakdowns(
          params, RequestOptions.none()
        )

    /** @see listBreakdowns */
    fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions = RequestOptions.none()): InvoiceListBreakdownsPage
     ...
     */
    @MustBeClosed
    fun retrievePdf(params: InvoiceRetrievePdfParams): HttpResponse =
        retrievePdf(
          params, RequestOptions.none()
        )
    ...
    /** @see retrievePdf */
    @MustBeClosed
    fun retrievePdf(params: InvoiceRetrievePdfParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/{invoice_id}`, but is otherwise the             same as [InvoiceService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InvoiceRetrieveResponse>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices`, but is otherwise the             same as [InvoiceService.list]. */
        @MustBeClosed
        fun list(params: InvoiceListParams): HttpResponseFor<InvoiceListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: InvoiceListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InvoiceListPage>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/addCharge`, but is otherwise the             same as [InvoiceService.addCharge]. */
        @MustBeClosed
        fun addCharge(params: InvoiceAddChargeParams): HttpResponseFor<InvoiceAddChargeResponse> =
            addCharge(
              params, RequestOptions.none()
            )
        ...
        /** @see addCharge */
        @MustBeClosed
        fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InvoiceAddChargeResponse>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/breakdowns`, but is otherwise the             same as [InvoiceService.listBreakdowns]. */
        @MustBeClosed
        fun listBreakdowns(params: InvoiceListBreakdownsParams): HttpResponseFor<InvoiceListBreakdownsPage> =
            listBreakdowns(
              params, RequestOptions.none()
            )
        ...
        /** @see listBreakdowns */
        @MustBeClosed
        fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<InvoiceListBreakdownsPage>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/{invoice_id}/pdf`, but is otherwise the             same as [InvoiceService.retrievePdf]. */
        @MustBeClosed
        fun retrievePdf(params: InvoiceRetrievePdfParams): HttpResponse =
            retrievePdf(
              params, RequestOptions.none()
