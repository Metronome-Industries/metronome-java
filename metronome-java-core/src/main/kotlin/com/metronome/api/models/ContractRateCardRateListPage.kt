...
class ContractRateCardRateListPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardRateListPage && this.ratesService == other.ratesService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(ratesService, params, response) /* spotless:on */
    }

    override fun toString() =
        "ContractRateCardRateListPage{ratesService=$ratesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<ContractRateCardRateListPage> {
    ...
    constructor(
        ...
        private val data: JsonField<List<ContractRateCardRateListResponse>>,
        ...
        override fun toString() =
            "ContractRateCardRateListPage.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContractRateCardRateListPage,
    ) : Iterable<ContractRateCardRateListResponse> {

        override fun iterator(): Iterator<ContractRateCardRateListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<ContractRateCardRateListResponse> {
