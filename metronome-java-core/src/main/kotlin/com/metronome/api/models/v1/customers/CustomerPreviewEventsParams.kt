 ...
 *
 */
class CustomerPreviewEventsParams private constructor(
     ...
     *
     * Unlike [skipZeroQtyLineItems], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerPreviewEventsParams: CustomerPreviewEventsParams) =
            apply {
         ...
         *
         * You should usually call [Builder.events] with a well-typed `List<Event>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.skipZeroQtyLineItems] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun skipZeroQtyLineItems(skipZeroQtyLineItems: JsonField<Boolean>) =
            apply {
                body.skipZeroQtyLineItems(skipZeroQtyLineItems)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("skip_zero_qty_line_items") @ExcludeMissing skipZeroQtyLineItems: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          events,
          mode,
          skipZeroQtyLineItems,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun skipZeroQtyLineItems(): Optional<Boolean> = skipZeroQtyLineItems.getOptional("skip_zero_qty_line_items")
        ...
        class Builder internal constructor() {
            ...
            /** When `true`, line items with zero quantity are excluded from the response. */
            fun skipZeroQtyLineItems(skipZeroQtyLineItems: Boolean) = skipZeroQtyLineItems(JsonField.of(skipZeroQtyLineItems))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (events.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (mode.asKnown().getOrNull()?.validity() ?: 0) + (if (skipZeroQtyLineItems.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && events == other.events && mode == other.mode && skipZeroQtyLineItems == other.skipZeroQtyLineItems && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{events=$events, mode=$mode, skipZeroQtyLineItems=$skipZeroQtyLineItems, additionalProperties=$additionalProperties}"
    }
    ...
    class Event @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (eventType.asKnown().isPresent) 1 else 0) + (properties.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + (if (transactionId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Event && eventType == other.eventType && properties == other.properties && timestamp == other.timestamp && transactionId == other.transactionId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Event{eventType=$eventType, properties=$properties, timestamp=$timestamp, transactionId=$transactionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerPreviewEventsParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerPreviewEventsParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
