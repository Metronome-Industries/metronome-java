...
class CustomerPlanListPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerPlanListPageAsync && this.plansService == other.plansService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    override fun toString() =
        "CustomerPlanListPageAsync{plansService=$plansService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<CustomerPlanListPageAsync>> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(plansService: PlanServiceAsync, params: CustomerPlanListParams, response: Response) =
            CustomerPlanListPageAsync(
                plansService,
                params,
                response,
            )
    ...
    constructor(
        ...
        private val data: JsonField<List<CustomerPlanListResponse>>,
        ...
        override fun toString() =
            "CustomerPlanListPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CustomerPlanListPageAsync,
    ) {

        fun forEach(
            action: Predicate<CustomerPlanListResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CustomerPlanListPageAsync>>.forEach(
                action: (CustomerPlanListResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<CustomerPlanListResponse>> {
            val values = mutableListOf<CustomerPlanListResponse>()
