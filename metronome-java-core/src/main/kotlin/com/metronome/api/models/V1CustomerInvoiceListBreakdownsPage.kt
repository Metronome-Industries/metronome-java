 ...
 */
class V1CustomerInvoiceListBreakdownsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerInvoiceListBreakdownsPage && invoicesService == other.invoicesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(invoicesService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerInvoiceListBreakdownsPage{invoicesService=$invoicesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1CustomerInvoiceListBreakdownsPage> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1CustomerInvoiceListBreakdownsPage(invoicesService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerInvoiceListBreakdownsPage) :
        Iterable<V1CustomerInvoiceListBreakdownsResponse> {

        override fun iterator(): Iterator<V1CustomerInvoiceListBreakdownsResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<V1CustomerInvoiceListBreakdownsResponse> {
