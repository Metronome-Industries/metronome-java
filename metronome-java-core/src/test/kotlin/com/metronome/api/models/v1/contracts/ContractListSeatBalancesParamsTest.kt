...
internal class ContractListSeatBalancesParamsTest {
    ...
    @Test
    fun body() {
      val params = ContractListSeatBalancesParams.builder()
          .contractId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .coveringDate(OffsetDateTime.parse("2024-03-01T00:00:00.000Z"))
          .cursor("cursor")
      ...
      assertThat(body.effectiveBefore()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.skipMissingSeatIds()).contains(true)
      assertThat(body.startingAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(body.subscriptionIds().getOrNull()).containsExactly("8deed800-1b7a-495d-a207-6c52bac54dc9")
    }
