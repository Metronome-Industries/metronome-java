...
class AuditLogListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("resource_id") @ExcludeMissing resourceId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("resource_type") @ExcludeMissing resourceType: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("actor")
    @ExcludeMissing
    fun _actor(): JsonField<Actor> = actor
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(auditLogListResponse: AuditLogListResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.request] with a well-typed [Request] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.actor] with a well-typed [Actor] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun actor(actor: JsonField<Actor>) =
            apply {
                this.actor = actor
            }
         ...
         *
         * You should usually call [Builder.resourceId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resourceId(resourceId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.resourceType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resourceType(resourceType: JsonField<String>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): AuditLogListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (request.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + (if (action.asKnown().isPresent) 1 else 0) + (actor.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (resourceId.asKnown().isPresent) 1 else 0) + (if (resourceType.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0)

    class Request @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.ip] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.userAgent] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun userAgent(userAgent: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (ip.asKnown().isPresent) 1 else 0) + (if (userAgent.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Request && id == other.id && ip == other.ip && userAgent == other.userAgent && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Request{id=$id, ip=$ip, userAgent=$userAgent, additionalProperties=$additionalProperties}"
    }

    class Actor @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (email.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Actor && id == other.id && name == other.name && email == other.email && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Actor{id=$id, name=$name, email=$email, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AuditLogListResponse && id == other.id && request == other.request && timestamp == other.timestamp && action == other.action && actor == other.actor && description == other.description && resourceId == other.resourceId && resourceType == other.resourceType && status == other.status && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AuditLogListResponse{id=$id, request=$request, timestamp=$timestamp, action=$action, actor=$actor, description=$description, resourceId=$resourceId, resourceType=$resourceType, status=$status, additionalProperties=$additionalProperties}"
}
