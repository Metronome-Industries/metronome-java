...
internal class UsageListResponseTest {
    ...
    @Test
    fun create() {
      val usageListResponse = UsageListResponse.builder()
          ...
          .value(0.0)
          .groups(UsageListResponse.Groups.builder()
              .putAdditionalProperty("foo", JsonValue.from(0))
              .build())
          .build()

      assertThat(usageListResponse.billableMetricId()).isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(usageListResponse.endTimestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(usageListResponse.startTimestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(usageListResponse.value()).contains(0.0)
      assertThat(usageListResponse.groups()).contains(UsageListResponse.Groups.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedUsageListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(usageListResponse), jacksonTypeRef<UsageListResponse>())
