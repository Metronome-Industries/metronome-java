...
class CustomerListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    private val data: JsonField<List<CustomerDetail>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CustomerDetail>> = JsonMissing.of(),
    ...
    fun data(): List<CustomerDetail> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CustomerDetail>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CustomerDetail>>? = null
        ...
        internal fun from(customerListPageResponse: CustomerListPageResponse) =
            apply {
                ...
                nextPage = customerListPageResponse.nextPage
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CustomerDetail>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CustomerDetail>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [CustomerDetail] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CustomerDetail) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
