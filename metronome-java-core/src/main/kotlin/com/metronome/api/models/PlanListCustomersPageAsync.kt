...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanListCustomersPageAsync && this.plansService == other.plansService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    override fun toString() =
        "PlanListCustomersPageAsync{plansService=$plansService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<PlanListCustomersPageAsync>> {
    ...
    constructor(
        ...
        override fun toString() =
            "PlanListCustomersPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: PlanListCustomersPageAsync,
    ) {

        fun forEach(
            action: Predicate<PlanListCustomersResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<PlanListCustomersPageAsync>>.forEach(
                action: (PlanListCustomersResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<PlanListCustomersResponse>> {
            val values = mutableListOf<PlanListCustomersResponse>()
