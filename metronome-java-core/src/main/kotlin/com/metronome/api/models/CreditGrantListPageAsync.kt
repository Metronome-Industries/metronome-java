...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditGrantListPageAsync && this.creditGrantsService == other.creditGrantsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(creditGrantsService, params, response) /* spotless:on */
    }

    override fun toString() =
        "CreditGrantListPageAsync{creditGrantsService=$creditGrantsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<CreditGrantListPageAsync>> {
    ...
    constructor(
        ...
        override fun toString() =
            "CreditGrantListPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CreditGrantListPageAsync,
    ) {

        fun forEach(
            action: Predicate<CreditGrantListResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CreditGrantListPageAsync>>.forEach(
                action: (CreditGrantListResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<CreditGrantListResponse>> {
            val values = mutableListOf<CreditGrantListResponse>()
