...
class CustomerServiceAsyncImpl internal constructor(
    ...
    private val billingConfig: BillingConfigServiceAsync by lazy { BillingConfigServiceAsyncImpl(clientOptions) }
    ...
    override fun create(params: CustomerCreateParams, requestOptions: RequestOptions): CompletableFuture<CustomerCreateResponse> =
        // post /v1/customers
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CustomerRetrieveResponse> =
    ...
    override fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions): CompletableFuture<CustomerArchiveResponse> =
        // post /v1/customers/archive
        withRawResponse().archive(params, requestOptions).thenApply { it.parse() }

    override fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<CustomerArchiveBillingConfigurationsResponse> =
        // post /v1/archiveCustomerBillingProviderConfigurations
        withRawResponse().archiveBillingConfigurations(params, requestOptions).thenApply { it.parse() }

    override fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions): CompletableFuture<CustomerListBillableMetricsPageAsync> =
    ...
    override fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions): CompletableFuture<CustomerListCostsPageAsync> =
        // get /v1/customers/{customer_id}/costs
        withRawResponse().listCosts(params, requestOptions).thenApply { it.parse() }

    override fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions): CompletableFuture<CustomerPreviewEventsResponse> =
        // post /v1/customers/{customer_id}/previewEvents
        withRawResponse().previewEvents(params, requestOptions).thenApply { it.parse() }

    override fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<CustomerRetrieveBillingConfigurationsResponse> =
        // post /v1/getCustomerBillingProviderConfigurations
        withRawResponse().retrieveBillingConfigurations(params, requestOptions).thenApply { it.parse() }

    override fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<CustomerSetBillingConfigurationsResponse> =
    ...
    override fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /v1/customers/{customer_id}/setIngestAliases
        withRawResponse().setIngestAliases(params, requestOptions).thenAccept {}

    override fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions): CompletableFuture<CustomerSetNameResponse> =
        // post /v1/customers/{customer_id}/setName
        withRawResponse().setName(params, requestOptions).thenApply { it.parse() }

    override fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val billingConfig: BillingConfigServiceAsync.WithRawResponse by lazy { BillingConfigServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val commits: CommitServiceAsync.WithRawResponse by lazy { CommitServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val createHandler: Handler<CustomerCreateResponse> = jsonHandler<CustomerCreateResponse>(clientOptions.jsonMapper)

        override fun create(params: CustomerCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerCreateResponse>> {
        ...
        private val retrieveHandler: Handler<CustomerRetrieveResponse> = jsonHandler<CustomerRetrieveResponse>(clientOptions.jsonMapper)

        override fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerRetrieveResponse>> {
          val request = HttpRequest.builder()
        ...
        private val archiveHandler: Handler<CustomerArchiveResponse> = jsonHandler<CustomerArchiveResponse>(clientOptions.jsonMapper)

        override fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerArchiveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val archiveBillingConfigurationsHandler: Handler<CustomerArchiveBillingConfigurationsResponse> = jsonHandler<CustomerArchiveBillingConfigurationsResponse>(clientOptions.jsonMapper)

        override fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerArchiveBillingConfigurationsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  archiveBillingConfigurationsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val listBillableMetricsHandler: Handler<CustomerListBillableMetricsPageResponse> = jsonHandler<CustomerListBillableMetricsPageResponse>(clientOptions.jsonMapper)

        override fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerListBillableMetricsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  listBillableMetricsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val listCostsHandler: Handler<CustomerListCostsPageResponse> = jsonHandler<CustomerListCostsPageResponse>(clientOptions.jsonMapper)

        override fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerListCostsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val previewEventsHandler: Handler<CustomerPreviewEventsResponse> = jsonHandler<CustomerPreviewEventsResponse>(clientOptions.jsonMapper)

        override fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerPreviewEventsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  previewEventsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val retrieveBillingConfigurationsHandler: Handler<CustomerRetrieveBillingConfigurationsResponse> = jsonHandler<CustomerRetrieveBillingConfigurationsResponse>(clientOptions.jsonMapper)

        override fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  retrieveBillingConfigurationsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        private val setBillingConfigurationsHandler: Handler<CustomerSetBillingConfigurationsResponse> = jsonHandler<CustomerSetBillingConfigurationsResponse>(clientOptions.jsonMapper)

        override fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerSetBillingConfigurationsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  setBillingConfigurationsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        override fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  setIngestAliasesHandler.handle(it)
              }
          } }
        }

        private val setNameHandler: Handler<CustomerSetNameResponse> = jsonHandler<CustomerSetNameResponse>(clientOptions.jsonMapper)

        override fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomerSetNameResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
