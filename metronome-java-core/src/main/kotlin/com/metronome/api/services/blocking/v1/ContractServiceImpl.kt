...
class ContractServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listBalancesHandler: Handler<V1ContractListBalancesPage.Response> =
        jsonHandler<V1ContractListBalancesPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun listBalances(
        ...
        return response
            ...
            .let { V1ContractListBalancesPage.of(this, params, it) }
    }
