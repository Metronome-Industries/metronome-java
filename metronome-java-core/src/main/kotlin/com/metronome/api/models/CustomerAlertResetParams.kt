...
private constructor(
    ...
    @JvmSynthetic internal fun _body(): CustomerAlertResetBody = body
    ...
    internal constructor(
        ...
        /** A builder for [CustomerAlertResetBody]. */
        class Builder internal constructor() {
            ...
            internal fun from(customerAlertResetBody: CustomerAlertResetBody) = apply {
                alertId = customerAlertResetBody.alertId
                customerId = customerAlertResetBody.customerId
                additionalProperties = customerAlertResetBody.additionalProperties.toMutableMap()
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is CustomerAlertResetBody && alertId == other.alertId && customerId == other.customerId && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [CustomerAlertResetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
