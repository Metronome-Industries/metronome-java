 ...
 *
 */
class UsageListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageListParams: UsageListParams) =
            apply {
         ...
         *
         * You should usually call [Builder.billableMetrics] with a well-typed `List<BillableMetric>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun billableMetrics(billableMetrics: JsonField<List<BillableMetric>>) =
            apply {
                body.billableMetrics(billableMetrics)
            }
         ...
         */
        fun addBillableMetric(billableMetric: BillableMetric) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("billable_metrics") @ExcludeMissing billableMetrics: JsonField<List<BillableMetric>> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun billableMetrics(): Optional<List<BillableMetric>> = billableMetrics.getOptional("billable_metrics")
        ...
        class Builder internal constructor() {
            ...
            /** A list of billable metrics to fetch usage for. If absent, all billable metrics will be returned. */
            fun billableMetrics(billableMetrics: List<BillableMetric>) = billableMetrics(JsonField.of(billableMetrics))
            ...
            fun addBillableMetric(billableMetric: BillableMetric) =
                apply {
                    billableMetrics = (billableMetrics ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (startingOn.asKnown().isPresent) 1 else 0) + (windowSize.asKnown().getOrNull()?.validity() ?: 0) + (billableMetrics.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (customerIds.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && endingBefore == other.endingBefore && startingOn == other.startingOn && windowSize == other.windowSize && billableMetrics == other.billableMetrics && customerIds == other.customerIds && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{endingBefore=$endingBefore, startingOn=$startingOn, windowSize=$windowSize, billableMetrics=$billableMetrics, customerIds=$customerIds, additionalProperties=$additionalProperties}"
    }
    ...
    class BillableMetric @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (groupBy.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is BillableMetric && id == other.id && groupBy == other.groupBy && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "BillableMetric{id=$id, groupBy=$groupBy, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UsageListParams && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "UsageListParams{nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
