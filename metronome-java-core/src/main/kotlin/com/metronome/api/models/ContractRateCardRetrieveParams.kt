...
constructor(
    ...
    @JsonDeserialize(builder = ContractRateCardRetrieveBody.Builder::class)
    @NoAutoDetect
    ...
    internal constructor(
        ...
        class Builder {
            ...
            internal fun from(contractRateCardRetrieveBody: ContractRateCardRetrieveBody) = apply {
                this.id = contractRateCardRetrieveBody.id
                additionalProperties(contractRateCardRetrieveBody.additionalProperties)
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is ContractRateCardRetrieveBody && this.id == other.id && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardRetrieveParams && this.id == other.id && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ContractRateCardRetrieveParams{id=$id, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
