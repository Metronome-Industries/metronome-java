...
@NoAutoDetect
class V1CreditGrantListResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CreditGrantListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CreditGrantListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantListResponse: V1CreditGrantListResponse) = apply {
            id = v1CreditGrantListResponse.id
            balance = v1CreditGrantListResponse.balance
            customFields = v1CreditGrantListResponse.customFields
            customerId = v1CreditGrantListResponse.customerId
            deductions = v1CreditGrantListResponse.deductions.map { it.toMutableList() }
            effectiveAt = v1CreditGrantListResponse.effectiveAt
            expiresAt = v1CreditGrantListResponse.expiresAt
            grantAmount = v1CreditGrantListResponse.grantAmount
            name = v1CreditGrantListResponse.name
            paidAmount = v1CreditGrantListResponse.paidAmount
            pendingDeductions =
                v1CreditGrantListResponse.pendingDeductions.map { it.toMutableList() }
            priority = v1CreditGrantListResponse.priority
            creditGrantType = v1CreditGrantListResponse.creditGrantType
            invoiceId = v1CreditGrantListResponse.invoiceId
            products = v1CreditGrantListResponse.products.map { it.toMutableList() }
            reason = v1CreditGrantListResponse.reason
            uniquenessKey = v1CreditGrantListResponse.uniquenessKey
            additionalProperties = v1CreditGrantListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CreditGrantListResponse =
