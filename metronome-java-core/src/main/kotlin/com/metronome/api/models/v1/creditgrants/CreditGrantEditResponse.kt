...
class CreditGrantEditResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditGrantEditResponse].
         *
    ...
    /** A builder for [CreditGrantEditResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantEditResponse: CreditGrantEditResponse) =
            apply {
                data = creditGrantEditResponse.data
                additionalProperties = creditGrantEditResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CreditGrantEditResponse].
         *
         ...
         */
        fun build(): CreditGrantEditResponse =
     ...
     *   expected type.
     */
    fun validate(): CreditGrantEditResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantEditResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditGrantEditResponse{data=$data, additionalProperties=$additionalProperties}"
}
