 ...
 *   background
 */
class V1CustomerAlertResetParams
private constructor(
    ...
    /** A builder for [V1CustomerAlertResetParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerAlertResetParams: V1CustomerAlertResetParams) = apply {
            body = v1CustomerAlertResetParams.body.toBuilder()
            additionalHeaders = v1CustomerAlertResetParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerAlertResetParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerAlertResetParams =
            V1CustomerAlertResetParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerAlertResetParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerAlertResetParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
