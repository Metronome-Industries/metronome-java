...
class ContractEditCreditResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractEditCreditResponse].
         *
    ...
    /** A builder for [ContractEditCreditResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractEditCreditResponse: ContractEditCreditResponse) =
            apply {
                data = contractEditCreditResponse.data
                additionalProperties = contractEditCreditResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ContractEditCreditResponse].
         *
         ...
         */
        fun build(): ContractEditCreditResponse =
     ...
     *   expected type.
     */
    fun validate(): ContractEditCreditResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractEditCreditResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractEditCreditResponse{data=$data, additionalProperties=$additionalProperties}"
}
