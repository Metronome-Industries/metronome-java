...
class CreditGrantCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditGrantCreateResponse].
         *
    ...
    /** A builder for [CreditGrantCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantCreateResponse: CreditGrantCreateResponse) =
            apply {
                data = creditGrantCreateResponse.data
                additionalProperties = creditGrantCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CreditGrantCreateResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): CreditGrantCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditGrantCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
