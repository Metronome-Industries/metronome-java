 ...
 *
 */
class UsageSearchParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageSearchParams: UsageSearchParams) =
            apply {
        ...
        fun addTransactionId(transactionId: String) =
            apply {
                body.addTransactionId(transactionId)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("transactionIds") @ExcludeMissing transactionIds: JsonField<List<String>> = JsonMissing.of()
        ) : this(
          transactionIds, mutableMapOf()
        )
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && transactionIds == other.transactionIds && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{transactionIds=$transactionIds, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UsageSearchParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "UsageSearchParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
