...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = contractRateCardNamedScheduleRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties =
                contractRateCardNamedScheduleRetrieveResponse.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardNamedScheduleRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
