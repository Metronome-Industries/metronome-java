...
class ContractListBalancesPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<ContractListBalancesPageAsync> = service.listBalances(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractListBalancesPageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractListBalancesPageAsync: ContractListBalancesPageAsync) =
            apply {
        ...
        fun service(service: ContractServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractListBalancesPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "ContractListBalancesPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
