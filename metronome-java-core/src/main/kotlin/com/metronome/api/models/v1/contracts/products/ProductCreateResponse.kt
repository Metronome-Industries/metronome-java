...
class ProductCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductCreateResponse].
         *
    ...
    /** A builder for [ProductCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productCreateResponse: ProductCreateResponse) =
            apply {
                data = productCreateResponse.data
                additionalProperties = productCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductCreateResponse].
         *
         ...
         */
        fun build(): ProductCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): ProductCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
