 ...
 */
class V1CustomerNamedScheduleRetrieveParams
private constructor(
    ...
    /** A builder for [V1CustomerNamedScheduleRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerNamedScheduleRetrieveParams: V1CustomerNamedScheduleRetrieveParams
        ) = apply {
            body = v1CustomerNamedScheduleRetrieveParams.body.toBuilder()
            additionalHeaders = v1CustomerNamedScheduleRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerNamedScheduleRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerNamedScheduleRetrieveParams =
            V1CustomerNamedScheduleRetrieveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerNamedScheduleRetrieveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerNamedScheduleRetrieveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
