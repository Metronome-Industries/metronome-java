...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanListCustomersParams && this.planId == other.planId && this.limit == other.limit && this.nextPage == other.nextPage && this.status == other.status && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(planId, limit, nextPage, status, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "PlanListCustomersParams{planId=$planId, limit=$limit, nextPage=$nextPage, status=$status, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
