...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            thresholdBalanceSpecifiers =
                prepaidBalanceThresholdConfigurationV2.thresholdBalanceSpecifiers.map {
                    it.toMutableList()
                }
    ...
    private constructor(
        ...
        /**
         * The length of time the created commit will be valid, starting from the end of the
         * invoice's service period. If not provided, defaults to one year.
         *
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
         */
        ...
        /**
         * Fraction of the created commit's unused balance that will roll over. Must be between 0
         * and 1.
         *
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if
         *   the server responded with an unexpected value).
        ...
        class Builder internal constructor() {
            ...
            /**
             * Fraction of the created commit's unused balance that will roll over. Must be between
             * 0 and 1.
             */
        ...
        override fun toString() =
            "Commit{productId=$productId, description=$description, name=$name, priority=$priority, applicableProductIds=$applicableProductIds, applicableProductTags=$applicableProductTags, duration=$duration, rateType=$rateType, rolloverFraction=$rolloverFraction, specifiers=$specifiers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "PrepaidBalanceThresholdConfigurationV2{commit=$commit, isEnabled=$isEnabled, paymentGateConfig=$paymentGateConfig, rechargeToAmount=$rechargeToAmount, thresholdAmount=$thresholdAmount, customCreditTypeId=$customCreditTypeId, discountConfiguration=$discountConfiguration, thresholdBalanceSpecifiers=$thresholdBalanceSpecifiers, additionalProperties=$additionalProperties}"
}
