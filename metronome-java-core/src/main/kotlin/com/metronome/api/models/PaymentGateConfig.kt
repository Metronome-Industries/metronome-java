...
class PaymentGateConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentGateConfig: PaymentGateConfig) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PaymentGateConfig =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PaymentGateConfig && paymentGateType == other.paymentGateType && precalculatedTaxConfig == other.precalculatedTaxConfig && stripeConfig == other.stripeConfig && taxType == other.taxType && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PaymentGateConfig{paymentGateType=$paymentGateType, precalculatedTaxConfig=$precalculatedTaxConfig, stripeConfig=$stripeConfig, taxType=$taxType, additionalProperties=$additionalProperties}"
}
