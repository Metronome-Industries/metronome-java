...
class BillingConfigServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : BillingConfigService {

    private val withRawResponse: BillingConfigService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): BillingConfigService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BillingConfigService = BillingConfigServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun retrieve(params: BillingConfigRetrieveParams, requestOptions: RequestOptions): BillingConfigRetrieveResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): BillingConfigService.WithRawResponse = BillingConfigServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<Void?> = emptyHandler()

        override fun create(params: BillingConfigCreateParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun retrieve(params: BillingConfigRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<BillingConfigRetrieveResponse> {
          val request = HttpRequest.builder()
        ...
        override fun delete(params: BillingConfigDeleteParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
