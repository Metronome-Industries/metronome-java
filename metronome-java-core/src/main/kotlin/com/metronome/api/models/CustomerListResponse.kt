...
private constructor(
    ...
    override fun toString() =
        "CustomerListResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerListResponse: CustomerListResponse) = apply {
            this.data = customerListResponse.data
            this.nextPage = customerListResponse.nextPage
            additionalProperties(customerListResponse.additionalProperties)
        }
