...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.current] with a well-typed [ProductListItemState]
             ...
             *
             * You should usually call [Builder.initial] with a well-typed [ProductListItemState]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
        ...
        private constructor(
            ...
            fun compositeTags(): Optional<List<String>> =
                compositeTags.getOptional("composite_tags")
             ...
             *
             * Unlike [excludeFreeUsage], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("exclude_free_usage")
            @ExcludeMissing
             ...
             *
             * Unlike [pricingGroupKey], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("pricing_group_key")
            @ExcludeMissing
             ...
             *
             * Unlike [quantityRounding], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("quantity_rounding")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(update: Update) = apply {
                    ...
                    includeCompositeSpend = update.includeCompositeSpend
                 ...
                 *
                 * You should usually call [Builder.excludeFreeUsage] with a well-typed [Boolean]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.includeCompositeSpend] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.netsuiteInternalItemId] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.netsuiteOverageItemId] with a well-typed
                 * [String] value instead. This method is primarily for setting the field to an
                 * undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.pricingGroupKey] with a well-typed
                 * `List<String>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 * [QuantityConversion] value instead. This method is primarily for setting the
                ...
                /**
                 * Alias for calling [Builder.quantityRounding] with
                 * `quantityRounding.orElse(null)`.
                 */
                 ...
                 * [QuantityRounding] value instead. This method is primarily for setting the field
    ...
    override fun toString() =
        "ProductRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
