...
@NoAutoDetect
class V1CustomerListCostsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CustomerListCostsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerListCostsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerListCostsResponse: V1CustomerListCostsResponse) = apply {
            creditTypes = v1CustomerListCostsResponse.creditTypes
            endTimestamp = v1CustomerListCostsResponse.endTimestamp
            startTimestamp = v1CustomerListCostsResponse.startTimestamp
            additionalProperties = v1CustomerListCostsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerListCostsResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerListCostsResponse && creditTypes == other.creditTypes && endTimestamp == other.endTimestamp && startTimestamp == other.startTimestamp && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerListCostsResponse{creditTypes=$creditTypes, endTimestamp=$endTimestamp, startTimestamp=$startTimestamp, additionalProperties=$additionalProperties}"
}
