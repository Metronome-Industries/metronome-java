...
class LifecycleEventSystemNotificationConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LifecycleEventSystemNotificationConfig].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lifecycleEventSystemNotificationConfig: LifecycleEventSystemNotificationConfig) =
            apply {
                ...
                additionalProperties = lifecycleEventSystemNotificationConfig.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): LifecycleEventSystemNotificationConfig =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (policy.asKnown().getOrNull()?.validity() ?: 0) + (if (type.asKnown().isPresent) 1 else 0) + (if (isEnabled.asKnown().isPresent) 1 else 0)
    ...
    class Policy @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Policy && type == other.type && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LifecycleEventSystemNotificationConfig && policy == other.policy && type == other.type && isEnabled == other.isEnabled && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(policy, type, isEnabled, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "LifecycleEventSystemNotificationConfig{policy=$policy, type=$type, isEnabled=$isEnabled, additionalProperties=$additionalProperties}"
}
