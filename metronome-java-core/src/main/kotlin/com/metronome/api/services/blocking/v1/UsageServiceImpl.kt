...
class UsageServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listHandler: Handler<V1UsageListPage.Response> =
        jsonHandler<V1UsageListPage.Response>(clientOptions.jsonMapper)
     ...
     */
    override fun list(params: V1UsageListParams, requestOptions: RequestOptions): V1UsageListPage {
        val request =
            HttpRequest.builder()
        ...
        return response
            ...
            .let { V1UsageListPage.of(this, params, it) }
    }
     ...
     */
    override fun ingest(params: V1UsageIngestParams, requestOptions: RequestOptions) {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
    ...
    private val listWithGroupsHandler: Handler<V1UsageListWithGroupsPage.Response> =
        jsonHandler<V1UsageListWithGroupsPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun listWithGroups(
        ...
        return response
            ...
            .let { V1UsageListWithGroupsPage.of(this, params, it) }
    }

    private val searchHandler: Handler<List<UnnamedSchemaWithArrayParent0>> =
