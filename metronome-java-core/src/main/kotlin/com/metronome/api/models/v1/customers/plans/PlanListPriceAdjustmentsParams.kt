 ...
 *
 */
class PlanListPriceAdjustmentsParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlanListPriceAdjustmentsParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planListPriceAdjustmentsParams: PlanListPriceAdjustmentsParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanListPriceAdjustmentsParams && customerId == other.customerId && customerPlanId == other.customerPlanId && limit == other.limit && nextPage == other.nextPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, customerPlanId, limit, nextPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "PlanListPriceAdjustmentsParams{customerId=$customerId, customerPlanId=$customerPlanId, limit=$limit, nextPage=$nextPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
