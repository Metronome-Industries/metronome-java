...
/** Add a new rate */
class V1ContractRateCardRateAddParams
private constructor(
    ...
    /**
     * Optional. Frequency to bill subscriptions with. Required for subscription type products with
     * Flat rate.
     */
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && entitled == other.entitled && productId == other.productId && rateCardId == other.rateCardId && rateType == other.rateType && startingAt == other.startingAt && billingFrequency == other.billingFrequency && commitRate == other.commitRate && creditTypeId == other.creditTypeId && customRate == other.customRate && endingBefore == other.endingBefore && isProrated == other.isProrated && price == other.price && pricingGroupValues == other.pricingGroupValues && quantity == other.quantity && tiers == other.tiers && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1ContractRateCardRateAddParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardRateAddParams: V1ContractRateCardRateAddParams) =
            apply {
                body = v1ContractRateCardRateAddParams.body.toBuilder()
                additionalHeaders = v1ContractRateCardRateAddParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v1ContractRateCardRateAddParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): V1ContractRateCardRateAddParams =
            V1ContractRateCardRateAddParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateAddParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardRateAddParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
