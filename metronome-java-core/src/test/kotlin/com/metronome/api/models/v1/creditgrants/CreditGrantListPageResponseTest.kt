...
internal class CreditGrantListPageResponseTest {
    ...
    @Test
    fun create() {
      val creditGrantListPageResponse = CreditGrantListPageResponse.builder()
          .addData(CreditGrantListResponse.builder()
      ...
      assertThat(creditGrantListPageResponse.data()).containsExactly(CreditGrantListResponse.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .balance(CreditGrantListResponse.Balance.builder()
              .effectiveAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .excludingPending(0.0)
    ...
    fun roundtrip() {
      ...
      val roundtrippedCreditGrantListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(creditGrantListPageResponse), jacksonTypeRef<CreditGrantListPageResponse>())
