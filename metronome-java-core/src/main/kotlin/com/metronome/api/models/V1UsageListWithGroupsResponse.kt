...
@NoAutoDetect
class V1UsageListWithGroupsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1UsageListWithGroupsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1UsageListWithGroupsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1UsageListWithGroupsResponse: V1UsageListWithGroupsResponse) = apply {
            endingBefore = v1UsageListWithGroupsResponse.endingBefore
            groupKey = v1UsageListWithGroupsResponse.groupKey
            groupValue = v1UsageListWithGroupsResponse.groupValue
            startingOn = v1UsageListWithGroupsResponse.startingOn
            value = v1UsageListWithGroupsResponse.value
            additionalProperties = v1UsageListWithGroupsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1UsageListWithGroupsResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1UsageListWithGroupsResponse && endingBefore == other.endingBefore && groupKey == other.groupKey && groupValue == other.groupValue && startingOn == other.startingOn && value == other.value && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1UsageListWithGroupsResponse{endingBefore=$endingBefore, groupKey=$groupKey, groupValue=$groupValue, startingOn=$startingOn, value=$value, additionalProperties=$additionalProperties}"
}
