...
internal class CreditCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = CreditCreateParams.builder()
          .accessSchedule(CreditCreateParams.AccessSchedule.builder()
              .addScheduleItem(CreditCreateParams.AccessSchedule.ScheduleItem.builder()
                  .amount(1000.0)
                  .endingBefore(OffsetDateTime.parse("2020-02-01T00:00:00.000Z"))
      ...
      assertThat(body.accessSchedule()).isEqualTo(CreditCreateParams.AccessSchedule.builder()
          .addScheduleItem(CreditCreateParams.AccessSchedule.ScheduleItem.builder()
              .amount(1000.0)
              .endingBefore(OffsetDateTime.parse("2020-02-01T00:00:00.000Z"))
              .startingAt(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
      ...
      assertThat(body.customFields()).contains(CreditCreateParams.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
