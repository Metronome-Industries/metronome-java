...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerPlanListPriceAdjustmentsPageAsync && this.plansService == other.plansService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    override fun toString() =
        "CustomerPlanListPriceAdjustmentsPageAsync{plansService=$plansService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<CustomerPlanListPriceAdjustmentsPageAsync>> {
        return getNextPageParams()
            .map { plansService.listPriceAdjustments(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            CustomerPlanListPriceAdjustmentsPageAsync(
                plansService,
                params,
                response,
            )
    ...
    constructor(
        ...
        override fun toString() =
            "CustomerPlanListPriceAdjustmentsPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: CustomerPlanListPriceAdjustmentsPageAsync,
    ) {

        fun forEach(
            action: Predicate<CustomerPlanListPriceAdjustmentsResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<CustomerPlanListPriceAdjustmentsPageAsync>>.forEach(
                action: (CustomerPlanListPriceAdjustmentsResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(
            executor: Executor
        ): CompletableFuture<List<CustomerPlanListPriceAdjustmentsResponse>> {
            val values = mutableListOf<CustomerPlanListPriceAdjustmentsResponse>()
