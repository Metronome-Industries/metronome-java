...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanListChargesPageAsync && this.plansService == other.plansService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    override fun toString() =
        "PlanListChargesPageAsync{plansService=$plansService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<PlanListChargesPageAsync>> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(plansService: PlanServiceAsync, params: PlanListChargesParams, response: Response) =
    ...
    constructor(
        ...
        override fun toString() =
            "PlanListChargesPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: PlanListChargesPageAsync,
    ) {

        fun forEach(
            action: Predicate<PlanListChargesResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<PlanListChargesPageAsync>>.forEach(
                action: (PlanListChargesResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<PlanListChargesResponse>> {
            val values = mutableListOf<PlanListChargesResponse>()
