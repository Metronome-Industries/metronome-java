...
class InvoiceListBreakdownsResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("line_items") @ExcludeMissing lineItems: JsonField<List<Invoice.LineItem>> = JsonMissing.of(),
        ...
        @JsonProperty("constituent_invoices") @ExcludeMissing constituentInvoices: JsonField<List<Invoice.ConstituentInvoice>> = JsonMissing.of(),
        @JsonProperty("contract_custom_fields") @ExcludeMissing contractCustomFields: JsonField<Invoice.ContractCustomFields> = JsonMissing.of(),
        @JsonProperty("contract_id") @ExcludeMissing contractId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("correction_record") @ExcludeMissing correctionRecord: JsonField<Invoice.CorrectionRecord> = JsonMissing.of(),
        @JsonProperty("created_at") @ExcludeMissing createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("custom_fields") @ExcludeMissing customFields: JsonField<Invoice.CustomFields> = JsonMissing.of(),
        @JsonProperty("customer_custom_fields") @ExcludeMissing customerCustomFields: JsonField<Invoice.CustomerCustomFields> = JsonMissing.of(),
        @JsonProperty("end_timestamp") @ExcludeMissing endTimestamp: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("external_invoice") @ExcludeMissing externalInvoice: JsonField<Invoice.ExternalInvoice> = JsonMissing.of(),
        @JsonProperty("invoice_adjustments") @ExcludeMissing invoiceAdjustments: JsonField<List<Invoice.InvoiceAdjustment>> = JsonMissing.of(),
        ...
        @JsonProperty("plan_custom_fields") @ExcludeMissing planCustomFields: JsonField<Invoice.PlanCustomFields> = JsonMissing.of(),
        ...
        @JsonProperty("reseller_royalty") @ExcludeMissing resellerRoyalty: JsonField<Invoice.ResellerRoyalty> = JsonMissing.of(),
        @JsonProperty("revenue_system_invoices") @ExcludeMissing revenueSystemInvoices: JsonField<List<Invoice.RevenueSystemInvoice>> = JsonMissing.of(),
        ...
        @JsonProperty("breakdown_end_timestamp") @ExcludeMissing breakdownEndTimestamp: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("breakdown_start_timestamp") @ExcludeMissing breakdownStartTimestamp: JsonField<OffsetDateTime> = JsonMissing.of()
    ) : this(
      id,
      creditType,
      customerId,
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun constituentInvoices(): Optional<List<Invoice.ConstituentInvoice>> = constituentInvoices.getOptional("constituent_invoices")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun contractCustomFields(): Optional<Invoice.ContractCustomFields> = contractCustomFields.getOptional("contract_custom_fields")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun contractId(): Optional<String> = contractId.getOptional("contract_id")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun correctionRecord(): Optional<Invoice.CorrectionRecord> = correctionRecord.getOptional("correction_record")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun customerCustomFields(): Optional<Invoice.CustomerCustomFields> = customerCustomFields.getOptional("customer_custom_fields")
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun externalInvoice(): Optional<Invoice.ExternalInvoice> = externalInvoice.getOptional("external_invoice")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun invoiceAdjustments(): Optional<List<Invoice.InvoiceAdjustment>> = invoiceAdjustments.getOptional("invoice_adjustments")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun planCustomFields(): Optional<Invoice.PlanCustomFields> = planCustomFields.getOptional("plan_custom_fields")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun resellerRoyalty(): Optional<Invoice.ResellerRoyalty> = resellerRoyalty.getOptional("reseller_royalty")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun revenueSystemInvoices(): Optional<List<Invoice.RevenueSystemInvoice>> = revenueSystemInvoices.getOptional("revenue_system_invoices")
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    fun breakdownEndTimestamp(): OffsetDateTime = breakdownEndTimestamp.getRequired("breakdown_end_timestamp")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    fun breakdownStartTimestamp(): OffsetDateTime = breakdownStartTimestamp.getRequired("breakdown_start_timestamp")
    ...
    @JsonProperty("payer")
    @ExcludeMissing
    fun _payer(): JsonField<Invoice.Payer> = payer
    ...
    @ExcludeMissing
    fun _revenueSystemInvoices(): JsonField<List<Invoice.RevenueSystemInvoice>> = revenueSystemInvoices
     ...
     *
     * Unlike [breakdownEndTimestamp], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [breakdownStartTimestamp], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvoiceListBreakdownsResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        private var revenueSystemInvoices: JsonField<MutableList<Invoice.RevenueSystemInvoice>>? = null
        ...
        @JvmSynthetic
        internal fun from(invoiceListBreakdownsResponse: InvoiceListBreakdownsResponse) =
            apply {
                ...
                constituentInvoices = invoiceListBreakdownsResponse.constituentInvoices.map { it.toMutableList() }
                ...
                invoiceAdjustments = invoiceListBreakdownsResponse.invoiceAdjustments.map { it.toMutableList() }
                ...
                revenueSystemInvoices = invoiceListBreakdownsResponse.revenueSystemInvoices.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.lineItems] with a well-typed `List<Invoice.LineItem>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun lineItems(lineItems: JsonField<List<Invoice.LineItem>>) =
            apply {
         ...
         */
        fun addLineItem(lineItem: Invoice.LineItem) =
            apply {
        ...
        /** Required on invoices with type USAGE_CONSOLIDATED. List of constituent invoices that were consolidated to create this invoice. */
        fun constituentInvoices(constituentInvoices: List<Invoice.ConstituentInvoice>) = constituentInvoices(JsonField.of(constituentInvoices))

        /**
         * Sets [Builder.constituentInvoices] to an arbitrary JSON value.
         *
         * You should usually call [Builder.constituentInvoices] with a well-typed `List<Invoice.ConstituentInvoice>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addConstituentInvoice(constituentInvoice: Invoice.ConstituentInvoice) =
            apply {
        ...
        /** Custom fields to be added eg. { "key1": "value1", "key2": "value2" } */
        fun contractCustomFields(contractCustomFields: Invoice.ContractCustomFields) = contractCustomFields(JsonField.of(contractCustomFields))

        /**
         * Sets [Builder.contractCustomFields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.contractCustomFields] with a well-typed [Invoice.ContractCustomFields] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun correctionRecord(correctionRecord: Invoice.CorrectionRecord) = correctionRecord(JsonField.of(correctionRecord))

        /**
         * Sets [Builder.correctionRecord] to an arbitrary JSON value.
         *
         * You should usually call [Builder.correctionRecord] with a well-typed [Invoice.CorrectionRecord] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun correctionRecord(correctionRecord: JsonField<Invoice.CorrectionRecord>) =
            apply {
        ...
        fun customFields(customFields: Invoice.CustomFields) = customFields(JsonField.of(customFields))

        /**
         * Sets [Builder.customFields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.customFields] with a well-typed [Invoice.CustomFields] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun customFields(customFields: JsonField<Invoice.CustomFields>) =
            apply {
                this.customFields = customFields
            }

        /** Custom fields to be added eg. { "key1": "value1", "key2": "value2" } */
        fun customerCustomFields(customerCustomFields: Invoice.CustomerCustomFields) = customerCustomFields(JsonField.of(customerCustomFields))

        /**
         * Sets [Builder.customerCustomFields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.customerCustomFields] with a well-typed [Invoice.CustomerCustomFields] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun externalInvoice(externalInvoice: Invoice.ExternalInvoice?) = externalInvoice(JsonField.ofNullable(externalInvoice))

        /** Alias for calling [Builder.externalInvoice] with `externalInvoice.orElse(null)`. */
        fun externalInvoice(externalInvoice: Optional<Invoice.ExternalInvoice>) = externalInvoice(externalInvoice.getOrNull())

        /**
         * Sets [Builder.externalInvoice] to an arbitrary JSON value.
         *
         * You should usually call [Builder.externalInvoice] with a well-typed [Invoice.ExternalInvoice] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun externalInvoice(externalInvoice: JsonField<Invoice.ExternalInvoice>) =
            apply {
                this.externalInvoice = externalInvoice
            }

        fun invoiceAdjustments(invoiceAdjustments: List<Invoice.InvoiceAdjustment>) = invoiceAdjustments(JsonField.of(invoiceAdjustments))

        /**
         * Sets [Builder.invoiceAdjustments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invoiceAdjustments] with a well-typed `List<Invoice.InvoiceAdjustment>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addInvoiceAdjustment(invoiceAdjustment: Invoice.InvoiceAdjustment) =
            apply {
         ...
         *
         * You should usually call [Builder.payer] with a well-typed [Invoice.Payer] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun payer(payer: JsonField<Invoice.Payer>) =
            apply {
                this.payer = payer
            }

        /** Custom fields to be added eg. { "key1": "value1", "key2": "value2" } */
        fun planCustomFields(planCustomFields: Invoice.PlanCustomFields) = planCustomFields(JsonField.of(planCustomFields))

        /**
         * Sets [Builder.planCustomFields] to an arbitrary JSON value.
         *
         * You should usually call [Builder.planCustomFields] with a well-typed [Invoice.PlanCustomFields] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun planCustomFields(planCustomFields: JsonField<Invoice.PlanCustomFields>) =
            apply {
        ...
        /** Only present for contract invoices with reseller royalties. */
        fun resellerRoyalty(resellerRoyalty: Invoice.ResellerRoyalty) = resellerRoyalty(JsonField.of(resellerRoyalty))

        /**
         * Sets [Builder.resellerRoyalty] to an arbitrary JSON value.
         *
         * You should usually call [Builder.resellerRoyalty] with a well-typed [Invoice.ResellerRoyalty] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resellerRoyalty(resellerRoyalty: JsonField<Invoice.ResellerRoyalty>) =
            apply {
                this.resellerRoyalty = resellerRoyalty
            }

        fun revenueSystemInvoices(revenueSystemInvoices: List<Invoice.RevenueSystemInvoice>?) = revenueSystemInvoices(JsonField.ofNullable(revenueSystemInvoices))

        /** Alias for calling [Builder.revenueSystemInvoices] with `revenueSystemInvoices.orElse(null)`. */
        fun revenueSystemInvoices(revenueSystemInvoices: Optional<List<Invoice.RevenueSystemInvoice>>) = revenueSystemInvoices(revenueSystemInvoices.getOrNull())

        /**
         * Sets [Builder.revenueSystemInvoices] to an arbitrary JSON value.
         *
         * You should usually call [Builder.revenueSystemInvoices] with a well-typed `List<Invoice.RevenueSystemInvoice>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun revenueSystemInvoices(revenueSystemInvoices: JsonField<List<Invoice.RevenueSystemInvoice>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRevenueSystemInvoice(revenueSystemInvoice: Invoice.RevenueSystemInvoice) =
            apply {
        ...
        fun breakdownEndTimestamp(breakdownEndTimestamp: OffsetDateTime) = breakdownEndTimestamp(JsonField.of(breakdownEndTimestamp))

        /**
         * Sets [Builder.breakdownEndTimestamp] to an arbitrary JSON value.
         *
         * You should usually call [Builder.breakdownEndTimestamp] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun breakdownEndTimestamp(breakdownEndTimestamp: JsonField<OffsetDateTime>) =
            apply {
                this.breakdownEndTimestamp = breakdownEndTimestamp
            }

        fun breakdownStartTimestamp(breakdownStartTimestamp: OffsetDateTime) = breakdownStartTimestamp(JsonField.of(breakdownStartTimestamp))

        /**
         * Sets [Builder.breakdownStartTimestamp] to an arbitrary JSON value.
         *
         * You should usually call [Builder.breakdownStartTimestamp] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun breakdownStartTimestamp(breakdownStartTimestamp: JsonField<OffsetDateTime>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): InvoiceListBreakdownsResponse =
        apply {
            if (validated) {
              return@apply
            }
