...
internal class ProductOrderServiceAsyncTest {
    ...
    fun update() {
      ...
      val productOrderFuture = productOrderServiceAsync.update(ProductOrderUpdateParams.builder()
    ...
    fun set() {
      ...
      val responseFuture = productOrderServiceAsync.set(ProductOrderSetParams.builder()
