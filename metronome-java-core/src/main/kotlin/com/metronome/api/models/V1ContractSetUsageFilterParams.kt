 ...
 */
class V1ContractSetUsageFilterParams
private constructor(
    ...
    /** A builder for [V1ContractSetUsageFilterParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractSetUsageFilterParams: V1ContractSetUsageFilterParams) = apply {
            body = v1ContractSetUsageFilterParams.body.toBuilder()
            additionalHeaders = v1ContractSetUsageFilterParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractSetUsageFilterParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractSetUsageFilterParams =
            V1ContractSetUsageFilterParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractSetUsageFilterParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractSetUsageFilterParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
