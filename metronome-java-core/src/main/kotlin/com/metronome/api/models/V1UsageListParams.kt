...
private constructor(
    ...
    /** A builder for [V1UsageListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1UsageListParams: V1UsageListParams) = apply {
            nextPage = v1UsageListParams.nextPage
            body = v1UsageListParams.body.toBuilder()
            additionalHeaders = v1UsageListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1UsageListParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1UsageListParams && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(nextPage, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1UsageListParams{nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
