...
internal class CreditGrantServiceAsyncTest {
    ...
    fun create() {
      ...
      val creditGrantFuture = creditGrantServiceAsync.create(CreditGrantCreateParams.builder()
    ...
    fun edit() {
      ...
      val responseFuture = creditGrantServiceAsync.edit(CreditGrantEditParams.builder()
    ...
    fun void_() {
      ...
      val responseFuture = creditGrantServiceAsync.void_(CreditGrantVoidParams.builder()
          .id("9b85c1c1-5238-4f2a-a409-61412905e1e1")
