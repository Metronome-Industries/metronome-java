 ...
 * instead.
 */
class V1CustomerCommitUpdateEndDateParams
private constructor(
    ...
    /** A builder for [V1CustomerCommitUpdateEndDateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerCommitUpdateEndDateParams: V1CustomerCommitUpdateEndDateParams
        ) = apply {
            body = v1CustomerCommitUpdateEndDateParams.body.toBuilder()
            additionalHeaders = v1CustomerCommitUpdateEndDateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerCommitUpdateEndDateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerCommitUpdateEndDateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerCommitUpdateEndDateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerCommitUpdateEndDateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
