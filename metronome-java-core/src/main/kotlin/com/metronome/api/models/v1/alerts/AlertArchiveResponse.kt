...
class AlertArchiveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlertArchiveResponse].
         *
    ...
    /** A builder for [AlertArchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(alertArchiveResponse: AlertArchiveResponse) =
            apply {
                data = alertArchiveResponse.data
                additionalProperties = alertArchiveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AlertArchiveResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): AlertArchiveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AlertArchiveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AlertArchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
