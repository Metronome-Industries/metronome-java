...
class CustomerAlert @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("customer_status") @ExcludeMissing customerStatus: JsonField<CustomerStatus> = JsonMissing.of(),
        @JsonProperty("triggered_by") @ExcludeMissing triggeredBy: JsonField<String> = JsonMissing.of()
    ) : this(
      alert,
      customerStatus,
      triggeredBy,
    ...
    /**
     * The status of the threshold notification. If the notification is archived, null will be returned.
     *
    ...
    @JsonProperty("alert")
    @ExcludeMissing
    fun _alert(): JsonField<Alert> = alert
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerAlert: CustomerAlert) =
            apply {
         ...
         *
         * You should usually call [Builder.alert] with a well-typed [Alert] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alert(alert: JsonField<Alert>) =
            apply {
                this.alert = alert
            }

        /** The status of the threshold notification. If the notification is archived, null will be returned. */
        fun customerStatus(customerStatus: CustomerStatus?) = customerStatus(JsonField.ofNullable(customerStatus))

        /** Alias for calling [Builder.customerStatus] with `customerStatus.orElse(null)`. */
        fun customerStatus(customerStatus: Optional<CustomerStatus>) = customerStatus(customerStatus.getOrNull())

        /**
         * Sets [Builder.customerStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.customerStatus] with a well-typed [CustomerStatus] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun customerStatus(customerStatus: JsonField<CustomerStatus>) =
            apply {
         ...
         *
         * You should usually call [Builder.triggeredBy] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun triggeredBy(triggeredBy: JsonField<String>) =
            apply {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (alert.asKnown().getOrNull()?.validity() ?: 0) + (customerStatus.asKnown().getOrNull()?.validity() ?: 0) + (if (triggeredBy.asKnown().isPresent) 1 else 0)

    class Alert @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("alert_specifiers") @ExcludeMissing alertSpecifiers: JsonField<List<AlertSpecifier>> = JsonMissing.of(),
            @JsonProperty("credit_grant_type_filters") @ExcludeMissing creditGrantTypeFilters: JsonField<List<String>> = JsonMissing.of(),
            ...
            @JsonProperty("group_key_filter") @ExcludeMissing groupKeyFilter: JsonField<GroupKeyFilter> = JsonMissing.of(),
            @JsonProperty("group_values") @ExcludeMissing groupValues: JsonField<List<GroupValue>> = JsonMissing.of(),
            @JsonProperty("invoice_types_filter") @ExcludeMissing invoiceTypesFilter: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("seat_filter") @ExcludeMissing seatFilter: JsonField<SeatFilter> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun alertSpecifiers(): Optional<List<AlertSpecifier>> = alertSpecifiers.getOptional("alert_specifiers")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun creditGrantTypeFilters(): Optional<List<String>> = creditGrantTypeFilters.getOptional("credit_grant_type_filters")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun customFieldFilters(): Optional<List<CustomFieldFilter>> = customFieldFilters.getOptional("custom_field_filters")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun groupKeyFilter(): Optional<GroupKeyFilter> = groupKeyFilter.getOptional("group_key_filter")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun invoiceTypesFilter(): Optional<List<String>> = invoiceTypesFilter.getOptional("invoice_types_filter")
         ...
         *
         * Unlike [creditGrantTypeFilters], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [groupKeyFilter], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [invoiceTypesFilter], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(alert: Alert) =
                apply {
                    ...
                    alertSpecifiers = alert.alertSpecifiers.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.threshold] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun threshold(threshold: JsonField<Double>) =
                apply {
            ...
            /** Present for `low_remaining_contract_credit_and_commit_balance_reached` notifications. The filters that define the balances that are considered when evaluating the alert. */
            fun alertSpecifiers(alertSpecifiers: List<AlertSpecifier>) = alertSpecifiers(JsonField.of(alertSpecifiers))

            /**
             * Sets [Builder.alertSpecifiers] to an arbitrary JSON value.
             *
             * You should usually call [Builder.alertSpecifiers] with a well-typed `List<AlertSpecifier>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun alertSpecifiers(alertSpecifiers: JsonField<List<AlertSpecifier>>) =
                apply {
             ...
             */
            fun addAlertSpecifier(alertSpecifier: AlertSpecifier) =
                apply {
                    alertSpecifiers = (alertSpecifiers ?: JsonField.of(mutableListOf())).also {
                        checkKnown("alertSpecifiers", it).add(alertSpecifier)
                    }
                }

            /** An array of strings, representing a way to filter the credit grant this threshold notification applies to, by looking at the credit_grant_type field on the credit grant. This field is only defined for CreditPercentage and CreditBalance notifications */
            fun creditGrantTypeFilters(creditGrantTypeFilters: List<String>) = creditGrantTypeFilters(JsonField.of(creditGrantTypeFilters))

            /**
             * Sets [Builder.creditGrantTypeFilters] to an arbitrary JSON value.
             *
             * You should usually call [Builder.creditGrantTypeFilters] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun creditGrantTypeFilters(creditGrantTypeFilters: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addCreditGrantTypeFilter(creditGrantTypeFilter: String) =
                apply {
                    creditGrantTypeFilters = (creditGrantTypeFilters ?: JsonField.of(mutableListOf())).also {
                        checkKnown("creditGrantTypeFilters", it).add(creditGrantTypeFilter)
                    }
                }

            fun creditType(creditType: CreditTypeData?) = creditType(JsonField.ofNullable(creditType))

            /** Alias for calling [Builder.creditType] with `creditType.orElse(null)`. */
            fun creditType(creditType: Optional<CreditTypeData>) = creditType(creditType.getOrNull())
            ...
            /** Scopes threshold notification evaluation to a specific presentation group key on individual line items. Only present for spend notifications. */
            fun groupKeyFilter(groupKeyFilter: GroupKeyFilter) = groupKeyFilter(JsonField.of(groupKeyFilter))

            /**
             * Sets [Builder.groupKeyFilter] to an arbitrary JSON value.
             *
             * You should usually call [Builder.groupKeyFilter] with a well-typed [GroupKeyFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun groupKeyFilter(groupKeyFilter: JsonField<GroupKeyFilter>) =
                apply {
             ...
             *
             * You should usually call [Builder.groupValues] with a well-typed `List<GroupValue>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun groupValues(groupValues: JsonField<List<GroupValue>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addGroupValue(groupValue: GroupValue) =
                apply {
            ...
            /** Only supported for invoice_total_reached threshold notifications. A list of invoice types to evaluate. */
            fun invoiceTypesFilter(invoiceTypesFilter: List<String>) = invoiceTypesFilter(JsonField.of(invoiceTypesFilter))

            /**
             * Sets [Builder.invoiceTypesFilter] to an arbitrary JSON value.
             *
             * You should usually call [Builder.invoiceTypesFilter] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun invoiceTypesFilter(invoiceTypesFilter: JsonField<List<String>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addInvoiceTypesFilter(invoiceTypesFilter: String) =
                apply {
                    this.invoiceTypesFilter = (this.invoiceTypesFilter ?: JsonField.of(mutableListOf())).also {
             ...
             *
             * You should usually call [Builder.seatFilter] with a well-typed [SeatFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun seatFilter(seatFilter: JsonField<SeatFilter>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (status.asKnown().getOrNull()?.validity() ?: 0) + (if (threshold.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (updatedAt.asKnown().isPresent) 1 else 0) + (alertSpecifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (creditGrantTypeFilters.asKnown().getOrNull()?.size ?: 0) + (creditType.asKnown().getOrNull()?.validity() ?: 0) + (customFieldFilters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (groupKeyFilter.asKnown().getOrNull()?.validity() ?: 0) + (groupValues.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (invoiceTypesFilter.asKnown().getOrNull()?.size ?: 0) + (seatFilter.asKnown().getOrNull()?.validity() ?: 0) + (if (uniquenessKey.asKnown().isPresent) 1 else 0)
        ...
        class Type @JsonCreator private constructor(
            ...
            companion object {
                ...
                @JvmField val MONTHLY_INVOICE_TOTAL_SPEND_THRESHOLD_REACHED = of("monthly_invoice_total_spend_threshold_reached")

                @JvmField val LOW_REMAINING_DAYS_IN_PLAN_REACHED = of("low_remaining_days_in_plan_reached")

                @JvmField val LOW_REMAINING_CREDIT_PERCENTAGE_REACHED = of("low_remaining_credit_percentage_reached")

                @JvmField val USAGE_THRESHOLD_REACHED = of("usage_threshold_reached")

                @JvmField val LOW_REMAINING_DAYS_FOR_COMMIT_SEGMENT_REACHED = of("low_remaining_days_for_commit_segment_reached")

                @JvmField val LOW_REMAINING_COMMIT_BALANCE_REACHED = of("low_remaining_commit_balance_reached")

                @JvmField val LOW_REMAINING_COMMIT_PERCENTAGE_REACHED = of("low_remaining_commit_percentage_reached")

                @JvmField val LOW_REMAINING_DAYS_FOR_CONTRACT_CREDIT_SEGMENT_REACHED = of("low_remaining_days_for_contract_credit_segment_reached")

                @JvmField val LOW_REMAINING_CONTRACT_CREDIT_BALANCE_REACHED = of("low_remaining_contract_credit_balance_reached")

                @JvmField val LOW_REMAINING_CONTRACT_CREDIT_PERCENTAGE_REACHED = of("low_remaining_contract_credit_percentage_reached")

                @JvmField val LOW_REMAINING_CONTRACT_CREDIT_AND_COMMIT_BALANCE_REACHED = of("low_remaining_contract_credit_and_commit_balance_reached")

                @JvmField val LOW_REMAINING_SEAT_BALANCE_REACHED = of("low_remaining_seat_balance_reached")
            ...
            fun value(): Value =
                when (this) {
                    ...
                    MONTHLY_INVOICE_TOTAL_SPEND_THRESHOLD_REACHED -> Value.MONTHLY_INVOICE_TOTAL_SPEND_THRESHOLD_REACHED
                    LOW_REMAINING_DAYS_IN_PLAN_REACHED -> Value.LOW_REMAINING_DAYS_IN_PLAN_REACHED
                    LOW_REMAINING_CREDIT_PERCENTAGE_REACHED -> Value.LOW_REMAINING_CREDIT_PERCENTAGE_REACHED
                    USAGE_THRESHOLD_REACHED -> Value.USAGE_THRESHOLD_REACHED
                    LOW_REMAINING_DAYS_FOR_COMMIT_SEGMENT_REACHED -> Value.LOW_REMAINING_DAYS_FOR_COMMIT_SEGMENT_REACHED
                    LOW_REMAINING_COMMIT_BALANCE_REACHED -> Value.LOW_REMAINING_COMMIT_BALANCE_REACHED
                    LOW_REMAINING_COMMIT_PERCENTAGE_REACHED -> Value.LOW_REMAINING_COMMIT_PERCENTAGE_REACHED
                    LOW_REMAINING_DAYS_FOR_CONTRACT_CREDIT_SEGMENT_REACHED -> Value.LOW_REMAINING_DAYS_FOR_CONTRACT_CREDIT_SEGMENT_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_BALANCE_REACHED -> Value.LOW_REMAINING_CONTRACT_CREDIT_BALANCE_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_PERCENTAGE_REACHED -> Value.LOW_REMAINING_CONTRACT_CREDIT_PERCENTAGE_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_AND_COMMIT_BALANCE_REACHED -> Value.LOW_REMAINING_CONTRACT_CREDIT_AND_COMMIT_BALANCE_REACHED
            ...
            fun known(): Known =
                when (this) {
                    ...
                    MONTHLY_INVOICE_TOTAL_SPEND_THRESHOLD_REACHED -> Known.MONTHLY_INVOICE_TOTAL_SPEND_THRESHOLD_REACHED
                    LOW_REMAINING_DAYS_IN_PLAN_REACHED -> Known.LOW_REMAINING_DAYS_IN_PLAN_REACHED
                    LOW_REMAINING_CREDIT_PERCENTAGE_REACHED -> Known.LOW_REMAINING_CREDIT_PERCENTAGE_REACHED
                    USAGE_THRESHOLD_REACHED -> Known.USAGE_THRESHOLD_REACHED
                    LOW_REMAINING_DAYS_FOR_COMMIT_SEGMENT_REACHED -> Known.LOW_REMAINING_DAYS_FOR_COMMIT_SEGMENT_REACHED
                    LOW_REMAINING_COMMIT_BALANCE_REACHED -> Known.LOW_REMAINING_COMMIT_BALANCE_REACHED
                    LOW_REMAINING_COMMIT_PERCENTAGE_REACHED -> Known.LOW_REMAINING_COMMIT_PERCENTAGE_REACHED
                    LOW_REMAINING_DAYS_FOR_CONTRACT_CREDIT_SEGMENT_REACHED -> Known.LOW_REMAINING_DAYS_FOR_CONTRACT_CREDIT_SEGMENT_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_BALANCE_REACHED -> Known.LOW_REMAINING_CONTRACT_CREDIT_BALANCE_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_PERCENTAGE_REACHED -> Known.LOW_REMAINING_CONTRACT_CREDIT_PERCENTAGE_REACHED
                    LOW_REMAINING_CONTRACT_CREDIT_AND_COMMIT_BALANCE_REACHED -> Known.LOW_REMAINING_CONTRACT_CREDIT_AND_COMMIT_BALANCE_REACHED
        ...
        class AlertSpecifier @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val customFieldFilters: JsonField<List<CustomFieldFilter>>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(alertSpecifier: AlertSpecifier) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (customFieldFilters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (exclude.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            class Exclude @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    fun build(): Exclude =
                        Exclude(
                          (customFieldFilters?: JsonMissing.of()).map { it.toImmutable() }, additionalProperties.toMutableMap()
                        )
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is AlertSpecifier && customFieldFilters == other.customFieldFilters && exclude == other.exclude && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(customFieldFilters, exclude, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "AlertSpecifier{customFieldFilters=$customFieldFilters, exclude=$exclude, additionalProperties=$additionalProperties}"
        }
        ...
        /** Scopes threshold notification evaluation to a specific presentation group key on individual line items. Only present for spend notifications. */
        class GroupKeyFilter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val key: JsonField<String>,
            private val value: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(groupKeyFilter: GroupKeyFilter) =
                    apply {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is GroupKeyFilter && key == other.key && value == other.value && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "GroupKeyFilter{key=$key, value=$value, additionalProperties=$additionalProperties}"
        }

        class GroupValue @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val key: JsonField<String>,
            private val value: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(groupValue: GroupValue) =
                    apply {
                        key = groupValue.key
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is GroupValue && key == other.key && value == other.value && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "GroupValue{key=$key, value=$value, additionalProperties=$additionalProperties}"
        }

        /** Only present for low_remaining_seat_balance_reached notifications. The seat group key or seat group key-value pair the alert is scoped to. */
        class SeatFilter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("seat_group_value") @ExcludeMissing seatGroupValue: JsonField<String> = JsonMissing.of()
            ) : this(
              seatGroupKey,
              seatGroupValue,
              mutableMapOf(),
             ...
             *
             * Unlike [seatGroupValue], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(seatFilter: SeatFilter) =
                    apply {
                ...
                /** The seat group value that the alert is scoped to. */
                fun seatGroupValue(seatGroupValue: String) = seatGroupValue(JsonField.of(seatGroupValue))

                /**
                 * Sets [Builder.seatGroupValue] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.seatGroupValue] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun seatGroupValue(seatGroupValue: JsonField<String>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (seatGroupKey.asKnown().isPresent) 1 else 0) + (if (seatGroupValue.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is SeatFilter && seatGroupKey == other.seatGroupKey && seatGroupValue == other.seatGroupValue && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "SeatFilter{seatGroupKey=$seatGroupKey, seatGroupValue=$seatGroupValue, additionalProperties=$additionalProperties}"
        }
    ...
    class CustomerStatus @JsonCreator private constructor(
        ...
        enum class Value {
            ...
            IN_ALARM,
            EVALUATING,
            /** An enum member indicating that [CustomerStatus] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerAlert && alert == other.alert && customerStatus == other.customerStatus && triggeredBy == other.triggeredBy && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerAlert{alert=$alert, customerStatus=$customerStatus, triggeredBy=$triggeredBy, additionalProperties=$additionalProperties}"
}
