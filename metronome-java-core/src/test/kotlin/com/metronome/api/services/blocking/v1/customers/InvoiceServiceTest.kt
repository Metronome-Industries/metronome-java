...
internal class InvoiceServiceTest {
    ...
    fun retrieve() {
      ...
      val invoice = invoiceService.retrieve(InvoiceRetrieveParams.builder()
    ...
    fun list() {
      ...
      val page = invoiceService.list(InvoiceListParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .build())
    ...
    fun addCharge() {
      ...
      val response = invoiceService.addCharge(InvoiceAddChargeParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun listBreakdowns() {
      ...
      val page = invoiceService.listBreakdowns(InvoiceListBreakdownsParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun retrievePdf(wmRuntimeInfo: WireMockRuntimeInfo) {
      ...
      val response = invoiceService.retrievePdf(InvoiceRetrievePdfParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .invoiceId("6a37bb88-8538-48c5-b37b-a41c836328bd")
          .build())
