...
class LifecycleEventOffsetNotificationConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("environment_type") @ExcludeMissing environmentType: JsonField<String> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LifecycleEventOffsetNotificationConfig].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lifecycleEventOffsetNotificationConfig: LifecycleEventOffsetNotificationConfig) =
            apply {
                ...
                additionalProperties = lifecycleEventOffsetNotificationConfig.additionalProperties.toMutableMap()
            }
         ...
         *
         */
        fun environmentType(environmentType: String) = environmentType(JsonField.of(environmentType))

        /**
         * Sets [Builder.environmentType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.environmentType] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun environmentType(environmentType: JsonField<String>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): LifecycleEventOffsetNotificationConfig =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (archivedAt.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (environmentType.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (policy.asKnown().getOrNull()?.validity() ?: 0) + (if (type.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is LifecycleEventOffsetNotificationConfig && id == other.id && archivedAt == other.archivedAt && createdAt == other.createdAt && createdBy == other.createdBy && environmentType == other.environmentType && name == other.name && policy == other.policy && type == other.type && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, archivedAt, createdAt, createdBy, environmentType, name, policy, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "LifecycleEventOffsetNotificationConfig{id=$id, archivedAt=$archivedAt, createdAt=$createdAt, createdBy=$createdBy, environmentType=$environmentType, name=$name, policy=$policy, type=$type, additionalProperties=$additionalProperties}"
}
