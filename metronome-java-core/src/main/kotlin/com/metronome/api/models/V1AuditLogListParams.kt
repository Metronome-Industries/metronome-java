...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1AuditLogListParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1AuditLogListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1AuditLogListParams: V1AuditLogListParams) = apply {
            endingBefore = v1AuditLogListParams.endingBefore
            limit = v1AuditLogListParams.limit
            nextPage = v1AuditLogListParams.nextPage
            resourceId = v1AuditLogListParams.resourceId
            resourceType = v1AuditLogListParams.resourceType
            sort = v1AuditLogListParams.sort
            startingOn = v1AuditLogListParams.startingOn
            additionalHeaders = v1AuditLogListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1AuditLogListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1AuditLogListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1AuditLogListParams && endingBefore == other.endingBefore && limit == other.limit && nextPage == other.nextPage && resourceId == other.resourceId && resourceType == other.resourceType && sort == other.sort && startingOn == other.startingOn && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1AuditLogListParams{endingBefore=$endingBefore, limit=$limit, nextPage=$nextPage, resourceId=$resourceId, resourceType=$resourceType, sort=$sort, startingOn=$startingOn, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
