...
interface NamedScheduleService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/getNamedSchedule`, but is otherwise the             same as [NamedScheduleService.retrieve]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/updateNamedSchedule`, but is otherwise the             same as [NamedScheduleService.update]. */
        @MustBeClosed
