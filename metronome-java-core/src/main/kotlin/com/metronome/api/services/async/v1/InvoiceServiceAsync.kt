...
interface InvoiceServiceAsync {
    ...
    /** @see regenerate */
    fun regenerate(params: InvoiceRegenerateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceRegenerateResponse>
    ...
    /** @see void_ */
    fun void_(params: InvoiceVoidParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceVoidResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/invoices/regenerate`, but is otherwise the             same as [InvoiceServiceAsync.regenerate]. */
        fun regenerate(params: InvoiceRegenerateParams): CompletableFuture<HttpResponseFor<InvoiceRegenerateResponse>> =
            regenerate(
              params, RequestOptions.none()
            )

        /** @see regenerate */
        fun regenerate(params: InvoiceRegenerateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceRegenerateResponse>>

        /** Returns a raw HTTP response for `post /v1/invoices/void`, but is otherwise the             same as [InvoiceServiceAsync.void_]. */
        fun void_(params: InvoiceVoidParams): CompletableFuture<HttpResponseFor<InvoiceVoidResponse>> =
            void_(
              params, RequestOptions.none()
            )

        /** @see void_ */
        fun void_(params: InvoiceVoidParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceVoidResponse>>
    }
}
