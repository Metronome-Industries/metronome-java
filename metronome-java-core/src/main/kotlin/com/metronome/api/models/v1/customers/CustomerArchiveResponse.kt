...
class CustomerArchiveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerArchiveResponse].
         *
    ...
    /** A builder for [CustomerArchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerArchiveResponse: CustomerArchiveResponse) =
            apply {
                data = customerArchiveResponse.data
                additionalProperties = customerArchiveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomerArchiveResponse].
         *
         ...
         */
        fun build(): CustomerArchiveResponse =
     ...
     *   expected type.
     */
    fun validate(): CustomerArchiveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerArchiveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerArchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
