 ...
 *
 */
class BillingProviderListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): BillingProviderListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BillingProviderListParams]. */
        @JvmStatic
        fun builder() = Builder()
    }

    /** A builder for [BillingProviderListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingProviderListParams: BillingProviderListParams) =
            apply {
                body = billingProviderListParams.body.toBuilder()
                additionalHeaders = billingProviderListParams.additionalHeaders.toBuilder()
                additionalQueryParams = billingProviderListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BillingProviderListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BillingProviderListParams =
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Body =
                Body(
                  nextPage, additionalProperties.toMutableMap()
                )
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (nextPage.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && nextPage == other.nextPage && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(nextPage, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{nextPage=$nextPage, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillingProviderListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "BillingProviderListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
