...
internal class OverrideTest {
    ...
    fun create() {
        ...
        assertThat(override.tiers().getOrNull())
            .containsExactly(Override.Tier.builder().price(0.0).size(0.0).build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedOverride =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(override),
                jacksonTypeRef<Override>(),
            )

        assertThat(roundtrippedOverride).isEqualTo(override)
    }
}
