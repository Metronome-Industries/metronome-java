...
import com.metronome.api.models.ContractWithoutAmendments
...
class ContractWithoutAmendments @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private val prepaidBalanceThresholdConfiguration: JsonField<PrepaidBalanceThresholdConfiguration>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("commits") @ExcludeMissing commits: JsonField<List<Commit>> = JsonMissing.of(),
        ...
        @JsonProperty("overrides") @ExcludeMissing overrides: JsonField<List<Override>> = JsonMissing.of(),
        @JsonProperty("scheduled_charges") @ExcludeMissing scheduledCharges: JsonField<List<ScheduledCharge>> = JsonMissing.of(),
        @JsonProperty("starting_at") @ExcludeMissing startingAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("transitions") @ExcludeMissing transitions: JsonField<List<Transition>> = JsonMissing.of(),
        @JsonProperty("usage_statement_schedule") @ExcludeMissing usageStatementSchedule: JsonField<UsageStatementSchedule> = JsonMissing.of(),
        @JsonProperty("credits") @ExcludeMissing credits: JsonField<List<Credit>> = JsonMissing.of(),
        ...
        @JsonProperty("hierarchy_configuration") @ExcludeMissing hierarchyConfiguration: JsonField<HierarchyConfiguration> = JsonMissing.of(),
        ...
        @JsonProperty("prepaid_balance_threshold_configuration") @ExcludeMissing prepaidBalanceThresholdConfiguration: JsonField<PrepaidBalanceThresholdConfiguration> = JsonMissing.of(),
        @JsonProperty("professional_services") @ExcludeMissing professionalServices: JsonField<List<ProService>> = JsonMissing.of(),
        @JsonProperty("rate_card_id") @ExcludeMissing rateCardId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("recurring_commits") @ExcludeMissing recurringCommits: JsonField<List<RecurringCommit>> = JsonMissing.of(),
        @JsonProperty("recurring_credits") @ExcludeMissing recurringCredits: JsonField<List<RecurringCredit>> = JsonMissing.of(),
        @JsonProperty("reseller_royalties") @ExcludeMissing resellerRoyalties: JsonField<List<ResellerRoyalty>> = JsonMissing.of(),
        @JsonProperty("salesforce_opportunity_id") @ExcludeMissing salesforceOpportunityId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("scheduled_charges_on_usage_invoices") @ExcludeMissing scheduledChargesOnUsageInvoices: JsonField<ScheduledChargesOnUsageInvoices> = JsonMissing.of(),
        @JsonProperty("spend_threshold_configuration") @ExcludeMissing spendThresholdConfiguration: JsonField<SpendThresholdConfiguration> = JsonMissing.of(),
        @JsonProperty("spend_trackers") @ExcludeMissing spendTrackers: JsonField<List<SpendTracker>> = JsonMissing.of(),
        @JsonProperty("total_contract_value") @ExcludeMissing totalContractValue: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("usage_filter") @ExcludeMissing usageFilter: JsonField<UsageFilter> = JsonMissing.of()
    ) : this(
      commits,
      createdAt,
      createdBy,
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    fun scheduledCharges(): List<ScheduledCharge> = scheduledCharges.getRequired("scheduled_charges")
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    fun usageStatementSchedule(): UsageStatementSchedule = usageStatementSchedule.getRequired("usage_statement_schedule")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun hierarchyConfiguration(): Optional<HierarchyConfiguration> = hierarchyConfiguration.getOptional("hierarchy_configuration")
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun prepaidBalanceThresholdConfiguration(): Optional<PrepaidBalanceThresholdConfiguration> = prepaidBalanceThresholdConfiguration.getOptional("prepaid_balance_threshold_configuration")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun professionalServices(): Optional<List<ProService>> = professionalServices.getOptional("professional_services")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun rateCardId(): Optional<String> = rateCardId.getOptional("rate_card_id")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun recurringCommits(): Optional<List<RecurringCommit>> = recurringCommits.getOptional("recurring_commits")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun resellerRoyalties(): Optional<List<ResellerRoyalty>> = resellerRoyalties.getOptional("reseller_royalties")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun scheduledChargesOnUsageInvoices(): Optional<ScheduledChargesOnUsageInvoices> = scheduledChargesOnUsageInvoices.getOptional("scheduled_charges_on_usage_invoices")

    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun spendThresholdConfiguration(): Optional<SpendThresholdConfiguration> = spendThresholdConfiguration.getOptional("spend_threshold_configuration")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun totalContractValue(): Optional<Double> = totalContractValue.getOptional("total_contract_value")
     ...
     *
     * Unlike [scheduledCharges], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [usageStatementSchedule], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [prepaidBalanceThresholdConfiguration], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("prepaid_balance_threshold_configuration")
    @ExcludeMissing
    fun _prepaidBalanceThresholdConfiguration(): JsonField<PrepaidBalanceThresholdConfiguration> = prepaidBalanceThresholdConfiguration

    /**
     * Returns the raw JSON value of [professionalServices].
     *
     * Unlike [professionalServices], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [recurringCommits], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [resellerRoyalties], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [scheduledChargesOnUsageInvoices], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("scheduled_charges_on_usage_invoices")
    @ExcludeMissing
    fun _scheduledChargesOnUsageInvoices(): JsonField<ScheduledChargesOnUsageInvoices> = scheduledChargesOnUsageInvoices

    /**
     * Returns the raw JSON value of [spendThresholdConfiguration].
     *
     * Unlike [spendThresholdConfiguration], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("spend_threshold_configuration")
    @ExcludeMissing
    fun _spendThresholdConfiguration(): JsonField<SpendThresholdConfiguration> = spendThresholdConfiguration
     ...
     *
     * Unlike [totalContractValue], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        private var prepaidBalanceThresholdConfiguration: JsonField<PrepaidBalanceThresholdConfiguration> = JsonMissing.of()
        ...
        private var scheduledChargesOnUsageInvoices: JsonField<ScheduledChargesOnUsageInvoices> = JsonMissing.of()
        private var spendThresholdConfiguration: JsonField<SpendThresholdConfiguration> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(contractWithoutAmendments: ContractWithoutAmendments) =
            apply {
                ...
                prepaidBalanceThresholdConfiguration = contractWithoutAmendments.prepaidBalanceThresholdConfiguration
                professionalServices = contractWithoutAmendments.professionalServices.map { it.toMutableList() }
                ...
                resellerRoyalties = contractWithoutAmendments.resellerRoyalties.map { it.toMutableList() }
                salesforceOpportunityId = contractWithoutAmendments.salesforceOpportunityId
                scheduledChargesOnUsageInvoices = contractWithoutAmendments.scheduledChargesOnUsageInvoices
                spendThresholdConfiguration = contractWithoutAmendments.spendThresholdConfiguration
                spendTrackers = contractWithoutAmendments.spendTrackers.map { it.toMutableList() }
         ...
         *
         * You should usually call [Builder.commits] with a well-typed `List<Commit>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun commits(commits: JsonField<List<Commit>>) =
            apply {
        ...
        fun addCommit(commit: Commit) =
            apply {
                commits = (commits ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.overrides] with a well-typed `List<Override>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun overrides(overrides: JsonField<List<Override>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addOverride(override: Override) =
            apply {
                overrides = (overrides ?: JsonField.of(mutableListOf())).also {
                    checkKnown("overrides", it).add(override)
                }
            }

        fun scheduledCharges(scheduledCharges: List<ScheduledCharge>) = scheduledCharges(JsonField.of(scheduledCharges))

        /**
         * Sets [Builder.scheduledCharges] to an arbitrary JSON value.
         *
         * You should usually call [Builder.scheduledCharges] with a well-typed `List<ScheduledCharge>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scheduledCharges(scheduledCharges: JsonField<List<ScheduledCharge>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addScheduledCharge(scheduledCharge: ScheduledCharge) =
            apply {
                scheduledCharges = (scheduledCharges ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.transitions] with a well-typed `List<Transition>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun transitions(transitions: JsonField<List<Transition>>) =
            apply {
        ...
        fun addTransition(transition: Transition) =
            apply {
                transitions = (transitions ?: JsonField.of(mutableListOf())).also {
                    checkKnown("transitions", it).add(transition)
                }
            }

        fun usageStatementSchedule(usageStatementSchedule: UsageStatementSchedule) = usageStatementSchedule(JsonField.of(usageStatementSchedule))

        /**
         * Sets [Builder.usageStatementSchedule] to an arbitrary JSON value.
         *
         * You should usually call [Builder.usageStatementSchedule] with a well-typed [UsageStatementSchedule] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         *
         * You should usually call [Builder.credits] with a well-typed `List<Credit>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun credits(credits: JsonField<List<Credit>>) =
            apply {
        ...
        fun addCredit(credit: Credit) =
            apply {
                credits = (credits ?: JsonField.of(mutableListOf())).also {
         ...
         *
         */
        fun hierarchyConfiguration(hierarchyConfiguration: HierarchyConfiguration) = hierarchyConfiguration(JsonField.of(hierarchyConfiguration))

        /**
         * Sets [Builder.hierarchyConfiguration] to an arbitrary JSON value.
         *
         * You should usually call [Builder.hierarchyConfiguration] with a well-typed [HierarchyConfiguration] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Alias for calling [hierarchyConfiguration] with `HierarchyConfiguration.ofParent(parent)`. */
        fun hierarchyConfiguration(parent: HierarchyConfiguration.ParentHierarchyConfiguration) = hierarchyConfiguration(HierarchyConfiguration.ofParent(parent))

        /** Alias for calling [hierarchyConfiguration] with `HierarchyConfiguration.ofChild(child)`. */
        fun hierarchyConfiguration(child: HierarchyConfiguration.ChildHierarchyConfiguration) = hierarchyConfiguration(HierarchyConfiguration.ofChild(child))
        ...
        fun prepaidBalanceThresholdConfiguration(prepaidBalanceThresholdConfiguration: PrepaidBalanceThresholdConfiguration) = prepaidBalanceThresholdConfiguration(JsonField.of(prepaidBalanceThresholdConfiguration))

        /**
         * Sets [Builder.prepaidBalanceThresholdConfiguration] to an arbitrary JSON value.
         *
         * You should usually call [Builder.prepaidBalanceThresholdConfiguration] with a well-typed [PrepaidBalanceThresholdConfiguration] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun prepaidBalanceThresholdConfiguration(prepaidBalanceThresholdConfiguration: JsonField<PrepaidBalanceThresholdConfiguration>) =
            apply {
                this.prepaidBalanceThresholdConfiguration = prepaidBalanceThresholdConfiguration
            }

        /** This field's availability is dependent on your client's configuration. */
        fun professionalServices(professionalServices: List<ProService>) = professionalServices(JsonField.of(professionalServices))

        /**
         * Sets [Builder.professionalServices] to an arbitrary JSON value.
         *
         * You should usually call [Builder.professionalServices] with a well-typed `List<ProService>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addProfessionalService(professionalService: ProService) =
            apply {
                professionalServices = (professionalServices ?: JsonField.of(mutableListOf())).also {
        ...
        fun recurringCommits(recurringCommits: List<RecurringCommit>) = recurringCommits(JsonField.of(recurringCommits))

        /**
         * Sets [Builder.recurringCommits] to an arbitrary JSON value.
         *
         * You should usually call [Builder.recurringCommits] with a well-typed `List<RecurringCommit>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recurringCommits(recurringCommits: JsonField<List<RecurringCommit>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRecurringCommit(recurringCommit: RecurringCommit) =
            apply {
                recurringCommits = (recurringCommits ?: JsonField.of(mutableListOf())).also {
                    checkKnown("recurringCommits", it).add(recurringCommit)
                }
            }

        fun recurringCredits(recurringCredits: List<RecurringCredit>) = recurringCredits(JsonField.of(recurringCredits))
        ...
        /** This field's availability is dependent on your client's configuration. */
        fun resellerRoyalties(resellerRoyalties: List<ResellerRoyalty>) = resellerRoyalties(JsonField.of(resellerRoyalties))

        /**
         * Sets [Builder.resellerRoyalties] to an arbitrary JSON value.
         *
         * You should usually call [Builder.resellerRoyalties] with a well-typed `List<ResellerRoyalty>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun resellerRoyalties(resellerRoyalties: JsonField<List<ResellerRoyalty>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResellerRoyalty(resellerRoyalty: ResellerRoyalty) =
            apply {
                resellerRoyalties = (resellerRoyalties ?: JsonField.of(mutableListOf())).also {
        ...
        /** Determines which scheduled and commit charges to consolidate onto the Contract's usage invoice. The charge's `timestamp` must match the usage invoice's `ending_before` date for consolidation to occur. This field cannot be modified after a Contract has been created. If this field is omitted, charges will appear on a separate invoice from usage charges. */
        fun scheduledChargesOnUsageInvoices(scheduledChargesOnUsageInvoices: ScheduledChargesOnUsageInvoices) = scheduledChargesOnUsageInvoices(JsonField.of(scheduledChargesOnUsageInvoices))

        /**
         * Sets [Builder.scheduledChargesOnUsageInvoices] to an arbitrary JSON value.
         *
         * You should usually call [Builder.scheduledChargesOnUsageInvoices] with a well-typed [ScheduledChargesOnUsageInvoices] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun scheduledChargesOnUsageInvoices(scheduledChargesOnUsageInvoices: JsonField<ScheduledChargesOnUsageInvoices>) =
            apply {
                this.scheduledChargesOnUsageInvoices = scheduledChargesOnUsageInvoices
            }

        fun spendThresholdConfiguration(spendThresholdConfiguration: SpendThresholdConfiguration) = spendThresholdConfiguration(JsonField.of(spendThresholdConfiguration))

        /**
         * Sets [Builder.spendThresholdConfiguration] to an arbitrary JSON value.
         *
         * You should usually call [Builder.spendThresholdConfiguration] with a well-typed [SpendThresholdConfiguration] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spendThresholdConfiguration(spendThresholdConfiguration: JsonField<SpendThresholdConfiguration>) =
            apply {
                this.spendThresholdConfiguration = spendThresholdConfiguration
            }

        /** Spend trackers attached to this contract. */
        fun spendTrackers(spendTrackers: List<SpendTracker>) = spendTrackers(JsonField.of(spendTrackers))

        /**
         * Sets [Builder.spendTrackers] to an arbitrary JSON value.
         *
         * You should usually call [Builder.spendTrackers] with a well-typed `List<SpendTracker>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun spendTrackers(spendTrackers: JsonField<List<SpendTracker>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSpendTracker(spendTracker: SpendTracker) =
            apply {
                spendTrackers = (spendTrackers ?: JsonField.of(mutableListOf())).also {
                    checkKnown("spendTrackers", it).add(spendTracker)
                }
            }

        /** This field's availability is dependent on your client's configuration. */
        fun totalContractValue(totalContractValue: Double) = totalContractValue(JsonField.of(totalContractValue))

        /**
         * Sets [Builder.totalContractValue] to an arbitrary JSON value.
         *
         * You should usually call [Builder.totalContractValue] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun totalContractValue(totalContractValue: JsonField<Double>) =
            apply {
         ...
         *
         * You should usually call [Builder.usageFilter] with a well-typed [UsageFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun usageFilter(usageFilter: JsonField<UsageFilter>) =
            apply {
        ...
        fun build(): ContractWithoutAmendments =
            ContractWithoutAmendments(
              ...
              checkRequired(
                "usageStatementSchedule", usageStatementSchedule
              ),
     ...
     *   expected type.
     */
    fun validate(): ContractWithoutAmendments =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (commits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (overrides.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (scheduledCharges.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (transitions.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (usageStatementSchedule.asKnown().getOrNull()?.validity() ?: 0) + (credits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (discounts.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (hierarchyConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (netPaymentTermsDays.asKnown().isPresent) 1 else 0) + (if (netsuiteSalesOrderId.asKnown().isPresent) 1 else 0) + (prepaidBalanceThresholdConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (professionalServices.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (rateCardId.asKnown().isPresent) 1 else 0) + (recurringCommits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (recurringCredits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (resellerRoyalties.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (salesforceOpportunityId.asKnown().isPresent) 1 else 0) + (scheduledChargesOnUsageInvoices.asKnown().getOrNull()?.validity() ?: 0) + (spendThresholdConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (spendTrackers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (totalContractValue.asKnown().isPresent) 1 else 0) + (usageFilter.asKnown().getOrNull()?.validity() ?: 0)

    class Transition @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("from_contract_id") @ExcludeMissing fromContractId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("to_contract_id") @ExcludeMissing toContractId: JsonField<String> = JsonMissing.of(),
         ...
         *
         * Unlike [fromContractId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [toContractId], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(transition: Transition) =
                apply {
            ...
            fun fromContractId(fromContractId: String) = fromContractId(JsonField.of(fromContractId))

            /**
             * Sets [Builder.fromContractId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fromContractId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fromContractId(fromContractId: JsonField<String>) =
                apply {
             ...
             *
             * You should usually call [Builder.toContractId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun toContractId(toContractId: JsonField<String>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (fromContractId.asKnown().isPresent) 1 else 0) + (if (toContractId.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Transition && fromContractId == other.fromContractId && toContractId == other.toContractId && type == other.type && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Transition{fromContractId=$fromContractId, toContractId=$toContractId, type=$type, additionalProperties=$additionalProperties}"
    }

    class UsageStatementSchedule @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("billing_anchor_date") @ExcludeMissing billingAnchorDate: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun billingAnchorDate(): OffsetDateTime = billingAnchorDate.getRequired("billing_anchor_date")
         ...
         *
         * Unlike [billingAnchorDate], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(usageStatementSchedule: UsageStatementSchedule) =
                apply {
            ...
            /** Contract usage statements follow a selected cadence based on this date. */
            fun billingAnchorDate(billingAnchorDate: OffsetDateTime) = billingAnchorDate(JsonField.of(billingAnchorDate))

            /**
             * Sets [Builder.billingAnchorDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.billingAnchorDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun billingAnchorDate(billingAnchorDate: JsonField<OffsetDateTime>) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): UsageStatementSchedule =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (billingAnchorDate.asKnown().isPresent) 1 else 0) + (frequency.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is UsageStatementSchedule && billingAnchorDate == other.billingAnchorDate && frequency == other.frequency && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "UsageStatementSchedule{billingAnchorDate=$billingAnchorDate, frequency=$frequency, additionalProperties=$additionalProperties}"
    }

    class RecurringCommit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("access_amount") @ExcludeMissing accessAmount: JsonField<AccessAmount> = JsonMissing.of(),
            @JsonProperty("commit_duration") @ExcludeMissing commitDuration: JsonField<CommitDuration> = JsonMissing.of(),
            ...
            @JsonProperty("invoice_amount") @ExcludeMissing invoiceAmount: JsonField<InvoiceAmount> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("netsuite_sales_order_id") @ExcludeMissing netsuiteSalesOrderId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("proration") @ExcludeMissing proration: JsonField<Proration> = JsonMissing.of(),
            @JsonProperty("proration_rounding") @ExcludeMissing prorationRounding: JsonField<ProrationRounding> = JsonMissing.of(),
            @JsonProperty("recurrence_frequency") @ExcludeMissing recurrenceFrequency: JsonField<RecurrenceFrequency> = JsonMissing.of(),
            ...
            @JsonProperty("subscription_config") @ExcludeMissing subscriptionConfig: JsonField<RecurringCommitSubscriptionConfig> = JsonMissing.of()
        ) : this(
          id,
          accessAmount,
          commitDuration,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun prorationRounding(): Optional<ProrationRounding> = prorationRounding.getOptional("proration_rounding")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun recurrenceFrequency(): Optional<RecurrenceFrequency> = recurrenceFrequency.getOptional("recurrence_frequency")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun subscriptionConfig(): Optional<RecurringCommitSubscriptionConfig> = subscriptionConfig.getOptional("subscription_config")
         ...
         *
         * Unlike [accessAmount], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [commitDuration], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [invoiceAmount], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [prorationRounding], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [recurrenceFrequency], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var subscriptionConfig: JsonField<RecurringCommitSubscriptionConfig> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(recurringCommit: RecurringCommit) =
                apply {
                    ...
                    applicableProductIds = recurringCommit.applicableProductIds.map { it.toMutableList() }
                    applicableProductTags = recurringCommit.applicableProductTags.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.accessAmount] with a well-typed [AccessAmount] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun accessAmount(accessAmount: JsonField<AccessAmount>) =
                apply {
                    this.accessAmount = accessAmount
                }

            /** The amount of time the created commits will be valid for */
            fun commitDuration(commitDuration: CommitDuration) = commitDuration(JsonField.of(commitDuration))

            /**
             * Sets [Builder.commitDuration] to an arbitrary JSON value.
             *
             * You should usually call [Builder.commitDuration] with a well-typed [CommitDuration] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun commitDuration(commitDuration: JsonField<CommitDuration>) =
                apply {
            ...
            /** The amount the customer should be billed for the commit. Not required. */
            fun invoiceAmount(invoiceAmount: InvoiceAmount) = invoiceAmount(JsonField.of(invoiceAmount))

            /**
             * Sets [Builder.invoiceAmount] to an arbitrary JSON value.
             *
             * You should usually call [Builder.invoiceAmount] with a well-typed [InvoiceAmount] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun invoiceAmount(invoiceAmount: JsonField<InvoiceAmount>) =
                apply {
             ...
             *
             * You should usually call [Builder.proration] with a well-typed [Proration] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun proration(proration: JsonField<Proration>) =
                apply {
                    this.proration = proration
                }

            /** Rounding configuration for prorated recurring commit amounts. */
            fun prorationRounding(prorationRounding: ProrationRounding?) = prorationRounding(JsonField.ofNullable(prorationRounding))

            /** Alias for calling [Builder.prorationRounding] with `prorationRounding.orElse(null)`. */
            fun prorationRounding(prorationRounding: Optional<ProrationRounding>) = prorationRounding(prorationRounding.getOrNull())

            /**
             * Sets [Builder.prorationRounding] to an arbitrary JSON value.
             *
             * You should usually call [Builder.prorationRounding] with a well-typed [ProrationRounding] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun prorationRounding(prorationRounding: JsonField<ProrationRounding>) =
                apply {
                    this.prorationRounding = prorationRounding
                }

            /** The frequency at which the recurring commits will be created. If not provided: - The commits will be created on the usage invoice frequency. If provided: - The period defined in the duration will correspond to this frequency. - Commits will be created aligned with the recurring commit's starting_at rather than the usage invoice dates. - Daily recurring commits have a limit of one per contract, and are unable to be created with seat-based subscriptions */
            fun recurrenceFrequency(recurrenceFrequency: RecurrenceFrequency) = recurrenceFrequency(JsonField.of(recurrenceFrequency))

            /**
             * Sets [Builder.recurrenceFrequency] to an arbitrary JSON value.
             *
             * You should usually call [Builder.recurrenceFrequency] with a well-typed [RecurrenceFrequency] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /** Attach a subscription to the recurring commit/credit. */
            fun subscriptionConfig(subscriptionConfig: RecurringCommitSubscriptionConfig) = subscriptionConfig(JsonField.of(subscriptionConfig))

            /**
             * Sets [Builder.subscriptionConfig] to an arbitrary JSON value.
             *
             * You should usually call [Builder.subscriptionConfig] with a well-typed [RecurringCommitSubscriptionConfig] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun subscriptionConfig(subscriptionConfig: JsonField<RecurringCommitSubscriptionConfig>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (accessAmount.asKnown().getOrNull()?.validity() ?: 0) + (commitDuration.asKnown().getOrNull()?.validity() ?: 0) + (if (priority.asKnown().isPresent) 1 else 0) + (product.asKnown().getOrNull()?.validity() ?: 0) + (rateType.asKnown().getOrNull()?.validity() ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (applicableProductIds.asKnown().getOrNull()?.size ?: 0) + (applicableProductTags.asKnown().getOrNull()?.size ?: 0) + (contract.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (hierarchyConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (invoiceAmount.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (netsuiteSalesOrderId.asKnown().isPresent) 1 else 0) + (proration.asKnown().getOrNull()?.validity() ?: 0) + (prorationRounding.asKnown().getOrNull()?.validity() ?: 0) + (recurrenceFrequency.asKnown().getOrNull()?.validity() ?: 0) + (if (rolloverFraction.asKnown().isPresent) 1 else 0) + (specifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (subscriptionConfig.asKnown().getOrNull()?.validity() ?: 0)

        /** The amount of commit to grant. */
        class AccessAmount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(accessAmount: AccessAmount) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (creditTypeId.asKnown().isPresent) 1 else 0) + (if (unitPrice.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is AccessAmount && creditTypeId == other.creditTypeId && unitPrice == other.unitPrice && quantity == other.quantity && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "AccessAmount{creditTypeId=$creditTypeId, unitPrice=$unitPrice, quantity=$quantity, additionalProperties=$additionalProperties}"
        }

        /** The amount of time the created commits will be valid for */
        class CommitDuration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(commitDuration: CommitDuration) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.value] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.unit] with a well-typed [Unit] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (value.asKnown().isPresent) 1 else 0) + (unit.asKnown().getOrNull()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is CommitDuration && value == other.value && unit == other.unit && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "CommitDuration{value=$value, unit=$unit, additionalProperties=$additionalProperties}"
        }
        ...
        /** The amount the customer should be billed for the commit. Not required. */
        class InvoiceAmount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val creditTypeId: JsonField<String>,
            private val quantity: JsonField<Double>,
            private val unitPrice: JsonField<Double>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(invoiceAmount: InvoiceAmount) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (creditTypeId.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (if (unitPrice.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is InvoiceAmount && creditTypeId == other.creditTypeId && quantity == other.quantity && unitPrice == other.unitPrice && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "InvoiceAmount{creditTypeId=$creditTypeId, quantity=$quantity, unitPrice=$unitPrice, additionalProperties=$additionalProperties}"
        }

        /** Determines whether the first and last commit will be prorated.  If not provided, the default is FIRST_AND_LAST (i.e. prorate both the first and last commits). */
        class Proration @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            enum class Value {
                ...
                LAST,
                FIRST_AND_LAST,
                /** An enum member indicating that [Proration] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        /** Rounding configuration for prorated recurring commit amounts. */
        class ProrationRounding @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prorationRounding: ProrationRounding) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.access] with a well-typed [Access] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun access(access: JsonField<Access>) =
                    apply {
                        this.access = access
                    }
                 ...
                 *
                 * You should usually call [Builder.invoice] with a well-typed [Invoice] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             *   expected type.
             */
            fun validate(): ProrationRounding =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (access.asKnown().getOrNull()?.validity() ?: 0) + (invoice.asKnown().getOrNull()?.validity() ?: 0)

            class Access @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("decimal_places") @ExcludeMissing decimalPlaces: JsonField<Double> = JsonMissing.of(),
                    @JsonProperty("rounding_method") @ExcludeMissing roundingMethod: JsonField<RoundingMethod> = JsonMissing.of()
                ) : this(
                  decimalPlaces,
                  roundingMethod,
                  mutableMapOf(),
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(access: Access) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.decimalPlaces] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun decimalPlaces(decimalPlaces: JsonField<Double>) =
                        apply {
                            this.decimalPlaces = decimalPlaces
                        }

                    fun roundingMethod(roundingMethod: RoundingMethod) = roundingMethod(JsonField.of(roundingMethod))

                    /**
                     * Sets [Builder.roundingMethod] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.roundingMethod] with a well-typed [RoundingMethod] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun roundingMethod(roundingMethod: JsonField<RoundingMethod>) =
                        apply {
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (decimalPlaces.asKnown().isPresent) 1 else 0) + (roundingMethod.asKnown().getOrNull()?.validity() ?: 0)

                class RoundingMethod @JsonCreator private constructor(
                    private val value: JsonField<String>,
                    ...
                    enum class Value {
                        ...
                        FLOOR,
                        CEILING,
                        /** An enum member indicating that [RoundingMethod] was instantiated with an unknown value. */
                        _UNKNOWN,
                    }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Access && decimalPlaces == other.decimalPlaces && roundingMethod == other.roundingMethod && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "Access{decimalPlaces=$decimalPlaces, roundingMethod=$roundingMethod, additionalProperties=$additionalProperties}"
            }
            ...
            class Invoice @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is Invoice && decimalPlaces == other.decimalPlaces && roundingMethod == other.roundingMethod && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "Invoice{decimalPlaces=$decimalPlaces, roundingMethod=$roundingMethod, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ProrationRounding && access == other.access && invoice == other.invoice && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(access, invoice, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "ProrationRounding{access=$access, invoice=$invoice, additionalProperties=$additionalProperties}"
        }

        /** The frequency at which the recurring commits will be created. If not provided: - The commits will be created on the usage invoice frequency. If provided: - The period defined in the duration will correspond to this frequency. - Commits will be created aligned with the recurring commit's starting_at rather than the usage invoice dates. - Daily recurring commits have a limit of one per contract, and are unable to be created with seat-based subscriptions */
        class RecurrenceFrequency @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            /**
             * An enum containing [RecurrenceFrequency]'s known values, as well as an [_UNKNOWN] member.
             *
             * An instance of [RecurrenceFrequency] can contain an unknown value in a couple of cases:
             *
             * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
             *   an older version than the API, then the API may respond with new members that the SDK is unaware
             *   of.
            ...
            enum class Value {
                ...
                WEEKLY,
                DAILY,
                /** An enum member indicating that [RecurrenceFrequency] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    WEEKLY -> Known.WEEKLY
                    DAILY -> Known.DAILY
                    else -> throw MetronomeInvalidDataException("Unknown RecurrenceFrequency: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): RecurrenceFrequency =
                apply {
                    if (validated) {
                      return@apply
                    }
        ...
        override fun toString() = "RecurringCommit{id=$id, accessAmount=$accessAmount, commitDuration=$commitDuration, priority=$priority, product=$product, rateType=$rateType, startingAt=$startingAt, applicableProductIds=$applicableProductIds, applicableProductTags=$applicableProductTags, contract=$contract, description=$description, endingBefore=$endingBefore, hierarchyConfiguration=$hierarchyConfiguration, invoiceAmount=$invoiceAmount, name=$name, netsuiteSalesOrderId=$netsuiteSalesOrderId, proration=$proration, prorationRounding=$prorationRounding, recurrenceFrequency=$recurrenceFrequency, rolloverFraction=$rolloverFraction, specifiers=$specifiers, subscriptionConfig=$subscriptionConfig, additionalProperties=$additionalProperties}"
    }
    ...
    class RecurringCredit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(recurringCredit: RecurringCredit) =
                apply {
                    ...
                    applicableProductIds = recurringCredit.applicableProductIds.map { it.toMutableList() }
                    applicableProductTags = recurringCredit.applicableProductTags.map { it.toMutableList() }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (accessAmount.asKnown().getOrNull()?.validity() ?: 0) + (commitDuration.asKnown().getOrNull()?.validity() ?: 0) + (if (priority.asKnown().isPresent) 1 else 0) + (product.asKnown().getOrNull()?.validity() ?: 0) + (rateType.asKnown().getOrNull()?.validity() ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (applicableProductIds.asKnown().getOrNull()?.size ?: 0) + (applicableProductTags.asKnown().getOrNull()?.size ?: 0) + (contract.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (hierarchyConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (netsuiteSalesOrderId.asKnown().isPresent) 1 else 0) + (proration.asKnown().getOrNull()?.validity() ?: 0) + (prorationRounding.asKnown().getOrNull()?.validity() ?: 0) + (recurrenceFrequency.asKnown().getOrNull()?.validity() ?: 0) + (if (rolloverFraction.asKnown().isPresent) 1 else 0) + (specifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (subscriptionConfig.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class ProrationRounding @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                fun build(): ProrationRounding =
                    ProrationRounding(
                      access, additionalProperties.toMutableMap()
                    )
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ProrationRounding && access == other.access && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "ProrationRounding{access=$access, additionalProperties=$additionalProperties}"
        }
    ...
    class ResellerRoyalty @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("fraction") @ExcludeMissing fraction: JsonField<Double> = JsonMissing.of(),
            ...
            @JsonProperty("reseller_contract_value") @ExcludeMissing resellerContractValue: JsonField<Double> = JsonMissing.of()
        ) : this(
          fraction,
          netsuiteResellerId,
          resellerType,
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun resellerContractValue(): Optional<Double> = resellerContractValue.getOptional("reseller_contract_value")
         ...
         *
         * Unlike [resellerContractValue], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            internal fun from(resellerRoyalty: ResellerRoyalty) =
                apply {
                    ...
                    applicableProductIds = resellerRoyalty.applicableProductIds.map { it.toMutableList() }
                    applicableProductTags = resellerRoyalty.applicableProductTags.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.fraction] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fraction(fraction: JsonField<Double>) =
                apply {
            ...
            fun resellerContractValue(resellerContractValue: Double) = resellerContractValue(JsonField.of(resellerContractValue))

            /**
             * Sets [Builder.resellerContractValue] to an arbitrary JSON value.
             *
             * You should usually call [Builder.resellerContractValue] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resellerContractValue(resellerContractValue: JsonField<Double>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (fraction.asKnown().isPresent) 1 else 0) + (if (netsuiteResellerId.asKnown().isPresent) 1 else 0) + (resellerType.asKnown().getOrNull()?.validity() ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (applicableProductIds.asKnown().getOrNull()?.size ?: 0) + (applicableProductTags.asKnown().getOrNull()?.size ?: 0) + (if (awsAccountNumber.asKnown().isPresent) 1 else 0) + (if (awsOfferId.asKnown().isPresent) 1 else 0) + (if (awsPayerReferenceId.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (gcpAccountId.asKnown().isPresent) 1 else 0) + (if (gcpOfferId.asKnown().isPresent) 1 else 0) + (if (resellerContractValue.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ResellerRoyalty && fraction == other.fraction && netsuiteResellerId == other.netsuiteResellerId && resellerType == other.resellerType && startingAt == other.startingAt && applicableProductIds == other.applicableProductIds && applicableProductTags == other.applicableProductTags && awsAccountNumber == other.awsAccountNumber && awsOfferId == other.awsOfferId && awsPayerReferenceId == other.awsPayerReferenceId && endingBefore == other.endingBefore && gcpAccountId == other.gcpAccountId && gcpOfferId == other.gcpOfferId && resellerContractValue == other.resellerContractValue && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ResellerRoyalty{fraction=$fraction, netsuiteResellerId=$netsuiteResellerId, resellerType=$resellerType, startingAt=$startingAt, applicableProductIds=$applicableProductIds, applicableProductTags=$applicableProductTags, awsAccountNumber=$awsAccountNumber, awsOfferId=$awsOfferId, awsPayerReferenceId=$awsPayerReferenceId, endingBefore=$endingBefore, gcpAccountId=$gcpAccountId, gcpOfferId=$gcpOfferId, resellerContractValue=$resellerContractValue, additionalProperties=$additionalProperties}"
    }

    /** Determines which scheduled and commit charges to consolidate onto the Contract's usage invoice. The charge's `timestamp` must match the usage invoice's `ending_before` date for consolidation to occur. This field cannot be modified after a Contract has been created. If this field is omitted, charges will appear on a separate invoice from usage charges. */
    class ScheduledChargesOnUsageInvoices @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [ScheduledChargesOnUsageInvoices]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [ScheduledChargesOnUsageInvoices] can contain an unknown value in a couple of cases:
         *
         * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
         *   an older version than the API, then the API may respond with new members that the SDK is unaware
         *   of.
        ...
        enum class Value {
            ALL,
            /** An enum member indicating that [ScheduledChargesOnUsageInvoices] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ALL -> Known.ALL
                else -> throw MetronomeInvalidDataException("Unknown ScheduledChargesOnUsageInvoices: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): ScheduledChargesOnUsageInvoices =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    class SpendTracker @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("applicable_spend_specifiers") @ExcludeMissing applicableSpendSpecifiers: JsonField<List<ApplicableSpendSpecifier>> = JsonMissing.of(),
            @JsonProperty("credit_type_id") @ExcludeMissing creditTypeId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("reset_frequency") @ExcludeMissing resetFrequency: JsonField<ResetFrequency> = JsonMissing.of(),
            @JsonProperty("accumulated_spend") @ExcludeMissing accumulatedSpend: JsonField<AccumulatedSpend> = JsonMissing.of()
        ) : this(
          alias,
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun applicableSpendSpecifiers(): List<ApplicableSpendSpecifier> = applicableSpendSpecifiers.getRequired("applicable_spend_specifiers")
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun accumulatedSpend(): Optional<AccumulatedSpend> = accumulatedSpend.getOptional("accumulated_spend")
         ...
         *
         * Unlike [applicableSpendSpecifiers], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("applicable_spend_specifiers")
        @ExcludeMissing
        fun _applicableSpendSpecifiers(): JsonField<List<ApplicableSpendSpecifier>> = applicableSpendSpecifiers
         ...
         *
         * Unlike [resetFrequency], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [accumulatedSpend], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            private var applicableSpendSpecifiers: JsonField<MutableList<ApplicableSpendSpecifier>>? = null
            private var creditTypeId: JsonField<String>? = null
            ...
            @JvmSynthetic
            internal fun from(spendTracker: SpendTracker) =
                apply {
                    alias = spendTracker.alias
                    applicableSpendSpecifiers = spendTracker.applicableSpendSpecifiers.map { it.toMutableList() }
            ...
            fun applicableSpendSpecifiers(applicableSpendSpecifiers: List<ApplicableSpendSpecifier>) = applicableSpendSpecifiers(JsonField.of(applicableSpendSpecifiers))

            /**
             * Sets [Builder.applicableSpendSpecifiers] to an arbitrary JSON value.
             *
             * You should usually call [Builder.applicableSpendSpecifiers] with a well-typed `List<ApplicableSpendSpecifier>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun applicableSpendSpecifiers(applicableSpendSpecifiers: JsonField<List<ApplicableSpendSpecifier>>) =
                apply {
                    this.applicableSpendSpecifiers = applicableSpendSpecifiers.map { it.toMutableList() }
                }
            ...
            fun addApplicableSpendSpecifier(applicableSpendSpecifier: ApplicableSpendSpecifier) =
                apply {
                    applicableSpendSpecifiers = (applicableSpendSpecifiers ?: JsonField.of(mutableListOf())).also {
                        checkKnown("applicableSpendSpecifiers", it).add(applicableSpendSpecifier)
                    }
                }
            ...
            fun resetFrequency(resetFrequency: ResetFrequency) = resetFrequency(JsonField.of(resetFrequency))

            /**
             * Sets [Builder.resetFrequency] to an arbitrary JSON value.
             *
             * You should usually call [Builder.resetFrequency] with a well-typed [ResetFrequency] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun resetFrequency(resetFrequency: JsonField<ResetFrequency>) =
                apply {
                    this.resetFrequency = resetFrequency
                }

            fun accumulatedSpend(accumulatedSpend: AccumulatedSpend) = accumulatedSpend(JsonField.of(accumulatedSpend))

            /**
             * Sets [Builder.accumulatedSpend] to an arbitrary JSON value.
             *
             * You should usually call [Builder.accumulatedSpend] with a well-typed [AccumulatedSpend] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun accumulatedSpend(accumulatedSpend: JsonField<AccumulatedSpend>) =
                apply {
            ...
            fun build(): SpendTracker =
                SpendTracker(
                  ...
                  checkRequired(
                    "applicableSpendSpecifiers", applicableSpendSpecifiers
                  ).map { it.toImmutable() },
                  checkRequired(
                    "creditTypeId", creditTypeId
                  ),
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (alias.asKnown().isPresent) 1 else 0) + (applicableSpendSpecifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (creditTypeId.asKnown().isPresent) 1 else 0) + (resetFrequency.asKnown().getOrNull()?.validity() ?: 0) + (accumulatedSpend.asKnown().getOrNull()?.validity() ?: 0)

        class ApplicableSpendSpecifier @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("sources") @ExcludeMissing sources: JsonField<List<Source>> = JsonMissing.of(),
                @JsonProperty("spend_type") @ExcludeMissing spendType: JsonField<SpendType> = JsonMissing.of(),
                @JsonProperty("discounted") @ExcludeMissing discounted: JsonField<Discounted> = JsonMissing.of()
            ) : this(
              sources,
              spendType,
              discounted,
             ...
             *
             * Unlike [spendType], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [discounted], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [ApplicableSpendSpecifier].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(applicableSpendSpecifier: ApplicableSpendSpecifier) =
                    apply {
                        ...
                        additionalProperties = applicableSpendSpecifier.additionalProperties.toMutableMap()
                    }
                 ...
                 *
                 * You should usually call [Builder.sources] with a well-typed `List<Source>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun sources(sources: JsonField<List<Source>>) =
                    apply {
                ...
                fun addSource(source: Source) =
                    apply {
                        sources = (sources ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.spendType] with a well-typed [SpendType] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun spendType(spendType: JsonField<SpendType>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.discounted] with a well-typed [Discounted] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun discounted(discounted: JsonField<Discounted>) =
                    apply {
             ...
             *   expected type.
             */
            fun validate(): ApplicableSpendSpecifier =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (sources.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (spendType.asKnown().getOrNull()?.validity() ?: 0) + (discounted.asKnown().getOrNull()?.validity() ?: 0)
            ...
            class SpendType @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                enum class Value {
                    COMMIT_PURCHASE,
                    /** An enum member indicating that [SpendType] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
            ...
            class Discounted @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                enum class Value {
                    ...
                    DISCOUNTED_ONLY,
                    UNDISCOUNTED_ONLY,
                    /** An enum member indicating that [Discounted] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ApplicableSpendSpecifier && sources == other.sources && spendType == other.spendType && discounted == other.discounted && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(sources, spendType, discounted, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "ApplicableSpendSpecifier{sources=$sources, spendType=$spendType, discounted=$discounted, additionalProperties=$additionalProperties}"
        }

        class ResetFrequency @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            enum class Value {
                BILLING_PERIOD,
                /** An enum member indicating that [ResetFrequency] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        class AccumulatedSpend @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("period_ending_before") @ExcludeMissing periodEndingBefore: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("period_starting_at") @ExcludeMissing periodStartingAt: JsonField<OffsetDateTime> = JsonMissing.of()
            ) : this(
              amount,
              periodEndingBefore,
              periodStartingAt,
            ...
            /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun periodEndingBefore(): OffsetDateTime = periodEndingBefore.getRequired("period_ending_before")

            /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
            fun periodStartingAt(): OffsetDateTime = periodStartingAt.getRequired("period_starting_at")
             ...
             *
             * Unlike [periodEndingBefore], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [periodStartingAt], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(accumulatedSpend: AccumulatedSpend) =
                    apply {
                ...
                fun periodEndingBefore(periodEndingBefore: OffsetDateTime) = periodEndingBefore(JsonField.of(periodEndingBefore))

                /**
                 * Sets [Builder.periodEndingBefore] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.periodEndingBefore] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun periodEndingBefore(periodEndingBefore: JsonField<OffsetDateTime>) =
                    apply {
                        this.periodEndingBefore = periodEndingBefore
                    }

                fun periodStartingAt(periodStartingAt: OffsetDateTime) = periodStartingAt(JsonField.of(periodStartingAt))

                /**
                 * Sets [Builder.periodStartingAt] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.periodStartingAt] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun periodStartingAt(periodStartingAt: JsonField<OffsetDateTime>) =
                    apply {
                ...
                fun build(): AccumulatedSpend =
                    AccumulatedSpend(
                      ...
                      checkRequired(
                        "periodEndingBefore", periodEndingBefore
                      ),
                      checkRequired(
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (periodEndingBefore.asKnown().isPresent) 1 else 0) + (if (periodStartingAt.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is AccumulatedSpend && amount == other.amount && periodEndingBefore == other.periodEndingBefore && periodStartingAt == other.periodStartingAt && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(amount, periodEndingBefore, periodStartingAt, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "AccumulatedSpend{amount=$amount, periodEndingBefore=$periodEndingBefore, periodStartingAt=$periodStartingAt, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is SpendTracker && alias == other.alias && applicableSpendSpecifiers == other.applicableSpendSpecifiers && creditTypeId == other.creditTypeId && resetFrequency == other.resetFrequency && accumulatedSpend == other.accumulatedSpend && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(alias, applicableSpendSpecifiers, creditTypeId, resetFrequency, accumulatedSpend, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "SpendTracker{alias=$alias, applicableSpendSpecifiers=$applicableSpendSpecifiers, creditTypeId=$creditTypeId, resetFrequency=$resetFrequency, accumulatedSpend=$accumulatedSpend, additionalProperties=$additionalProperties}"
    }

    class UsageFilter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("current") @ExcludeMissing current: JsonField<BaseUsageFilter> = JsonMissing.of(),
            @JsonProperty("initial") @ExcludeMissing initial: JsonField<BaseUsageFilter> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(usageFilter: UsageFilter) =
                apply {
             ...
             *
             * You should usually call [Builder.current] with a well-typed [BaseUsageFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun current(current: JsonField<BaseUsageFilter>) =
                apply {
             ...
             *
             * You should usually call [Builder.initial] with a well-typed [BaseUsageFilter] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun initial(initial: JsonField<BaseUsageFilter>) =
                apply {
             ...
             *
             * You should usually call [Builder.updates] with a well-typed `List<Update>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (current.asKnown().getOrNull()?.validity() ?: 0) + (initial.asKnown().getOrNull()?.validity() ?: 0) + (updates.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)

        class Update @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Update && groupKey == other.groupKey && groupValues == other.groupValues && startingAt == other.startingAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Update{groupKey=$groupKey, groupValues=$groupValues, startingAt=$startingAt, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is UsageFilter && current == other.current && initial == other.initial && updates == other.updates && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "UsageFilter{current=$current, initial=$initial, updates=$updates, additionalProperties=$additionalProperties}"
    }
