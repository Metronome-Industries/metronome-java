 ...
 * that are entitled.
 */
class V1ContractRetrieveRateScheduleParams
private constructor(
    ...
    /** A builder for [V1ContractRetrieveRateScheduleParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRetrieveRateScheduleParams: V1ContractRetrieveRateScheduleParams
        ) = apply {
            limit = v1ContractRetrieveRateScheduleParams.limit
            nextPage = v1ContractRetrieveRateScheduleParams.nextPage
            body = v1ContractRetrieveRateScheduleParams.body.toBuilder()
            additionalHeaders = v1ContractRetrieveRateScheduleParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRetrieveRateScheduleParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRetrieveRateScheduleParams =
            V1ContractRetrieveRateScheduleParams(
                limit,
                nextPage,
                body.build(),
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Selector && billingFrequency == other.billingFrequency && partialPricingGroupValues == other.partialPricingGroupValues && pricingGroupValues == other.pricingGroupValues && productId == other.productId && productTags == other.productTags && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRetrieveRateScheduleParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRetrieveRateScheduleParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
