...
constructor(
    ...
    @JsonDeserialize(builder = CustomerNamedScheduleRetrieveBody.Builder::class)
    @NoAutoDetect
    ...
    internal constructor(
        ...
        class Builder {
            ...
            internal fun from(
                ...
                this.customerId = customerNamedScheduleRetrieveBody.customerId
                this.scheduleName = customerNamedScheduleRetrieveBody.scheduleName
                this.coveringDate = customerNamedScheduleRetrieveBody.coveringDate
                additionalProperties(customerNamedScheduleRetrieveBody.additionalProperties)
            }
    ...
    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(customerId, scheduleName, coveringDate, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "CustomerNamedScheduleRetrieveParams{customerId=$customerId, scheduleName=$scheduleName, coveringDate=$coveringDate, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.customerId = customerNamedScheduleRetrieveParams.customerId
            this.scheduleName = customerNamedScheduleRetrieveParams.scheduleName
            this.coveringDate = customerNamedScheduleRetrieveParams.coveringDate
            additionalQueryParams(customerNamedScheduleRetrieveParams.additionalQueryParams)
            additionalHeaders(customerNamedScheduleRetrieveParams.additionalHeaders)
            additionalBodyProperties(customerNamedScheduleRetrieveParams.additionalBodyProperties)
        }
