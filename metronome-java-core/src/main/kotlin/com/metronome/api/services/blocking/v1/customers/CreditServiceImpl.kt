...
class CreditServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listHandler: Handler<V1CustomerCreditListPage.Response> =
        jsonHandler<V1CustomerCreditListPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun list(
        ...
        return response
            ...
            .let { V1CustomerCreditListPage.of(this, params, it) }
    }
