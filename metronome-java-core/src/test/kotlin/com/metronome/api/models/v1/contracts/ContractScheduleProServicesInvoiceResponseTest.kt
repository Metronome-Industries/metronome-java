...
internal class ContractScheduleProServicesInvoiceResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedContractScheduleProServicesInvoiceResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(contractScheduleProServicesInvoiceResponse),
                jacksonTypeRef<ContractScheduleProServicesInvoiceResponse>(),
            )

        assertThat(roundtrippedContractScheduleProServicesInvoiceResponse)
            .isEqualTo(contractScheduleProServicesInvoiceResponse)
    }
}
