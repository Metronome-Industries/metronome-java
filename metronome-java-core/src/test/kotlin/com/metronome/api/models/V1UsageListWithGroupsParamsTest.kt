...
class V1UsageListWithGroupsParamsTest {
    ...
    fun create() {
        V1UsageListWithGroupsParams.builder()
            ...
            .groupBy(
                V1UsageListWithGroupsParams.GroupBy.builder()
                    .key("region")
    ...
    fun body() {
        ...
        assertThat(body.windowSize()).isEqualTo(V1UsageListWithGroupsParams.WindowSize.HOUR)
