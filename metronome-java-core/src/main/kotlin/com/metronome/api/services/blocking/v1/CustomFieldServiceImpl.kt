...
class CustomFieldServiceImpl internal constructor(private val clientOptions: ClientOptions) :
     ...
     */
    override fun addKey(params: V1CustomFieldAddKeyParams, requestOptions: RequestOptions) {
        val request =
            HttpRequest.builder()
    ...
    private val listKeysHandler: Handler<V1CustomFieldListKeysPage.Response> =
        jsonHandler<V1CustomFieldListKeysPage.Response>(clientOptions.jsonMapper)
    ...
    override fun listKeys(
        ...
        return response
            ...
            .let { V1CustomFieldListKeysPage.of(this, params, it) }
    }
     ...
     */
    override fun removeKey(params: V1CustomFieldRemoveKeyParams, requestOptions: RequestOptions) {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
     ...
     */
    override fun setValues(params: V1CustomFieldSetValuesParams, requestOptions: RequestOptions) {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
