...
/**
 * A client for interacting with the Metronome REST API synchronously.
...
interface MetronomeClient {
    ...
    /** A view of [MetronomeClient] that provides access to raw HTTP responses for each method. */
