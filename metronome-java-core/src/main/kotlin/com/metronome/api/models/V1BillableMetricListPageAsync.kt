 ...
 */
class V1BillableMetricListPageAsync
private constructor(
    private val billableMetricsService: BillableMetricServiceAsync,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1BillableMetricListPageAsync && billableMetricsService == other.billableMetricsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(billableMetricsService, params, response) /* spotless:on */

    override fun toString() =
        "V1BillableMetricListPageAsync{billableMetricsService=$billableMetricsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<V1BillableMetricListPageAsync>> {
        return getNextPageParams()
            .map { billableMetricsService.list(it).thenApply { Optional.of(it) } }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1BillableMetricListPageAsync(billableMetricsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1BillableMetricListPageAsync) {

        fun forEach(
            action: Predicate<V1BillableMetricListResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V1BillableMetricListPageAsync>>.forEach(
                action: (V1BillableMetricListResponse) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<V1BillableMetricListResponse>> {
            val values = mutableListOf<V1BillableMetricListResponse>()
