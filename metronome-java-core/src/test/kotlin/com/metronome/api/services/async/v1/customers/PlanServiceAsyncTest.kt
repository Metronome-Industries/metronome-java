...
internal class PlanServiceAsyncTest {
    ...
    fun list() {
      ...
      val pageFuture = planServiceAsync.list(PlanListParams.builder()
    ...
    fun add() {
      ...
      val responseFuture = planServiceAsync.add(PlanAddParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun end() {
      ...
      val responseFuture = planServiceAsync.end(PlanEndParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun listPriceAdjustments() {
      ...
      val pageFuture = planServiceAsync.listPriceAdjustments(PlanListPriceAdjustmentsParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .customerPlanId("7aa11640-0703-4600-8eb9-293f535a6b74")
          .build())
