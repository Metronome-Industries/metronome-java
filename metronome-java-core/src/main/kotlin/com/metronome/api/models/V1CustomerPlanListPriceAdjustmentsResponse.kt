...
@NoAutoDetect
class V1CustomerPlanListPriceAdjustmentsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CustomerPlanListPriceAdjustmentsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerPlanListPriceAdjustmentsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerPlanListPriceAdjustmentsResponse: V1CustomerPlanListPriceAdjustmentsResponse
        ) = apply {
            chargeId = v1CustomerPlanListPriceAdjustmentsResponse.chargeId
            chargeType = v1CustomerPlanListPriceAdjustmentsResponse.chargeType
            prices = v1CustomerPlanListPriceAdjustmentsResponse.prices.map { it.toMutableList() }
            startPeriod = v1CustomerPlanListPriceAdjustmentsResponse.startPeriod
            quantity = v1CustomerPlanListPriceAdjustmentsResponse.quantity
            additionalProperties =
                v1CustomerPlanListPriceAdjustmentsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerPlanListPriceAdjustmentsResponse =
            V1CustomerPlanListPriceAdjustmentsResponse(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Price && adjustmentType == other.adjustmentType && quantity == other.quantity && tier == other.tier && value == other.value && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerPlanListPriceAdjustmentsResponse && chargeId == other.chargeId && chargeType == other.chargeType && prices == other.prices && startPeriod == other.startPeriod && quantity == other.quantity && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerPlanListPriceAdjustmentsResponse{chargeId=$chargeId, chargeType=$chargeType, prices=$prices, startPeriod=$startPeriod, quantity=$quantity, additionalProperties=$additionalProperties}"
}
