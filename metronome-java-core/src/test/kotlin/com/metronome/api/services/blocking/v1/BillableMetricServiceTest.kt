...
internal class BillableMetricServiceTest {
    ...
    fun create() {
      ...
      val billableMetric = billableMetricService.create(BillableMetricCreateParams.builder()
          .name("CPU Hours")
    ...
    fun retrieve() {
      ...
      val billableMetric = billableMetricService.retrieve(BillableMetricRetrieveParams.builder()
    ...
    fun archive() {
      ...
      val response = billableMetricService.archive(Id.builder()
