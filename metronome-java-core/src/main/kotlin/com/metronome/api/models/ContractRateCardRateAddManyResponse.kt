...
@JsonDeserialize(builder = ContractRateCardRateAddManyResponse.Builder::class)
@NoAutoDetect
class ContractRateCardRateAddManyResponse
private constructor(
    ...
    class Builder {
        ...
        fun build(): ContractRateCardRateAddManyResponse =
            ContractRateCardRateAddManyResponse(data, additionalProperties.toUnmodifiable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardRateAddManyResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ContractRateCardRateAddManyResponse{data=$data, additionalProperties=$additionalProperties}"
}
