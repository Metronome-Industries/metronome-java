...
@NoAutoDetect
class V1ContractRateCardRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1ContractRateCardRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractRateCardRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardRetrieveResponse: V1ContractRateCardRetrieveResponse) =
            apply {
                data = v1ContractRateCardRetrieveResponse.data
                additionalProperties =
                    v1ContractRateCardRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): V1ContractRateCardRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRateCardRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
