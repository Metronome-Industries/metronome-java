...
class V1ServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : V1ServiceAsync {

    private val withRawResponse: V1ServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    private val creditGrants: CreditGrantServiceAsync by lazy { CreditGrantServiceAsyncImpl(clientOptions) }

    private val pricingUnits: PricingUnitServiceAsync by lazy { PricingUnitServiceAsyncImpl(clientOptions) }

    private val customers: CustomerServiceAsync by lazy { CustomerServiceAsyncImpl(clientOptions) }

    private val dashboards: DashboardServiceAsync by lazy { DashboardServiceAsyncImpl(clientOptions) }
    ...
    private val customFields: CustomFieldServiceAsync by lazy { CustomFieldServiceAsyncImpl(clientOptions) }

    private val billableMetrics: BillableMetricServiceAsync by lazy { BillableMetricServiceAsyncImpl(clientOptions) }
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V1ServiceAsync = V1ServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val creditGrants: CreditGrantServiceAsync.WithRawResponse by lazy { CreditGrantServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val pricingUnits: PricingUnitServiceAsync.WithRawResponse by lazy { PricingUnitServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val dashboards: DashboardServiceAsync.WithRawResponse by lazy { DashboardServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val usage: UsageServiceAsync.WithRawResponse by lazy { UsageServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val auditLogs: AuditLogServiceAsync.WithRawResponse by lazy { AuditLogServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val customFields: CustomFieldServiceAsync.WithRawResponse by lazy { CustomFieldServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val billableMetrics: BillableMetricServiceAsync.WithRawResponse by lazy { BillableMetricServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        private val services: ServiceServiceAsync.WithRawResponse by lazy { ServiceServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        private val packages: PackageServiceAsync.WithRawResponse by lazy { PackageServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): V1ServiceAsync.WithRawResponse = V1ServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
