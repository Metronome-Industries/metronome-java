...
interface BillingConfigService {
     ...
     *
     */
    fun create(params: BillingConfigCreateParams) =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: BillingConfigCreateParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: BillingConfigRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): BillingConfigRetrieveResponse
     ...
     *
     */
    fun delete(params: BillingConfigDeleteParams) =
        delete(
          params, RequestOptions.none()
        )

    /** @see delete */
    fun delete(params: BillingConfigDeleteParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BillingConfigService.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/billing-config/{billing_provider_type}`, but is otherwise the             same as [BillingConfigService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: BillingConfigCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/billing-config/{billing_provider_type}`, but is otherwise the             same as [BillingConfigService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: BillingConfigRetrieveParams): HttpResponseFor<BillingConfigRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: BillingConfigRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<BillingConfigRetrieveResponse>

        /** Returns a raw HTTP response for `delete /v1/customers/{customer_id}/billing-config/{billing_provider_type}`, but is otherwise the             same as [BillingConfigService.delete]. */
        @MustBeClosed
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(params: BillingConfigDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
