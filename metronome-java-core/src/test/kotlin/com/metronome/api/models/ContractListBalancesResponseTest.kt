...
class ContractListBalancesResponseTest {

    @Test
    fun createContractListBalancesResponse() {
        val contractListBalancesResponse =
            ContractListBalancesResponse.builder()
                .data(
                    listOf(
                        ContractListBalancesResponse.Data.ofCommit(
                            Commit.builder()
                ...
                .nextPage("next_page")
                .build()
        assertThat(contractListBalancesResponse).isNotNull
        assertThat(contractListBalancesResponse.data())
            .containsExactly(
                ContractListBalancesResponse.Data.ofCommit(
                    Commit.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(contractListBalancesResponse.nextPage()).contains("next_page")
    }
}
