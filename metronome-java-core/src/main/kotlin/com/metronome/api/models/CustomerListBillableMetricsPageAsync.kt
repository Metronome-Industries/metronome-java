...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListBillableMetricsPageAsync && customersService == other.customersService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = CustomerListBillableMetricsPageAsync(customersService, params, response)
    }
    ...
    constructor(
        ...
        @JsonProperty("data")
        private val data: JsonField<List<CustomerListBillableMetricsResponse>> = JsonMissing.of(),
        @JsonAnySetter
    ...
    class AutoPager(private val firstPage: CustomerListBillableMetricsPageAsync) {
