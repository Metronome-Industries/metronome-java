...
internal class CustomFieldServiceTest {
    ...
    fun addKey() {
      ...
      customFieldService.addKey(CustomFieldAddKeyParams.builder()
    ...
    fun deleteValues() {
      ...
      customFieldService.deleteValues(CustomFieldDeleteValuesParams.builder()
    ...
    fun removeKey() {
      ...
      customFieldService.removeKey(CustomFieldRemoveKeyParams.builder()
    ...
    fun setValues() {
      ...
      customFieldService.setValues(CustomFieldSetValuesParams.builder()
