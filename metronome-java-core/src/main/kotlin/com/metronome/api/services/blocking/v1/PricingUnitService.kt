...
interface PricingUnitService {
    ...
    /** @see list */
    fun list(params: PricingUnitListParams = PricingUnitListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): PricingUnitListPage
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): PricingUnitService.WithRawResponse

        /** Returns a raw HTTP response for `get /v1/credit-types/list`, but is otherwise the             same as [PricingUnitService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<PricingUnitListPage> = list(PricingUnitListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: PricingUnitListParams = PricingUnitListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PricingUnitListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: PricingUnitListParams = PricingUnitListParams.none()): HttpResponseFor<PricingUnitListPage> =
            list(
              params, RequestOptions.none()
            )
