...
private constructor(
    ...
    /** A builder for [PaymentAttemptParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentAttemptParams: PaymentAttemptParams) = apply {
            body = paymentAttemptParams.body.toBuilder()
            additionalHeaders = paymentAttemptParams.additionalHeaders.toBuilder()
            additionalQueryParams = paymentAttemptParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentAttemptParams].
         *
         ...
         */
        fun build(): PaymentAttemptParams =
    ...
    private constructor(
        ...
        ) : this(customerId, invoiceId, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(customerId, invoiceId, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentAttemptParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PaymentAttemptParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
