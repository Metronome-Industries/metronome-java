 ...
 * AWS Marketplace customers. This is a Plans (deprecated) endpoint. New clients should implement
 * using Contracts.
 */
class V1CustomerBillingConfigDeleteParams
private constructor(
    ...
    /** A builder for [V1CustomerBillingConfigDeleteParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerBillingConfigDeleteParams: V1CustomerBillingConfigDeleteParams
        ) = apply {
            customerId = v1CustomerBillingConfigDeleteParams.customerId
            billingProviderType = v1CustomerBillingConfigDeleteParams.billingProviderType
            additionalHeaders = v1CustomerBillingConfigDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerBillingConfigDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                v1CustomerBillingConfigDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerBillingConfigDeleteParams =
            V1CustomerBillingConfigDeleteParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerBillingConfigDeleteParams && customerId == other.customerId && billingProviderType == other.billingProviderType && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerBillingConfigDeleteParams{customerId=$customerId, billingProviderType=$billingProviderType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
