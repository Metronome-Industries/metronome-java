...
class AlertServiceImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AlertService = AlertServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(params: AlertCreateParams, requestOptions: RequestOptions): AlertCreateResponse =
        // post /v1/alerts/create
        withRawResponse().create(params, requestOptions).parse()

    override fun archive(params: AlertArchiveParams, requestOptions: RequestOptions): AlertArchiveResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AlertService.WithRawResponse = AlertServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val createHandler: Handler<AlertCreateResponse> = jsonHandler<AlertCreateResponse>(clientOptions.jsonMapper)

        override fun create(params: AlertCreateParams, requestOptions: RequestOptions): HttpResponseFor<AlertCreateResponse> {
        ...
        override fun archive(params: AlertArchiveParams, requestOptions: RequestOptions): HttpResponseFor<AlertArchiveResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
