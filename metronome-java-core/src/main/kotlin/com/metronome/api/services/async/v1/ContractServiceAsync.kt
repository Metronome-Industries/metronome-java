...
interface ContractServiceAsync {
    ...
    /** @see create */
    fun create(params: ContractCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractCreateResponse>
    ...
    /** @see retrieve */
    fun retrieve(params: ContractRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractRetrieveResponse>
    ...
    /** @see list */
    fun list(params: ContractListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractListResponse>
     ...
     *
     */
    fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams): CompletableFuture<Void?> =
        addManualBalanceEntry(
          params, RequestOptions.none()
        )

    /** @see addManualBalanceEntry */
    fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see amend */
    fun amend(params: ContractAmendParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractAmendResponse>
    ...
    /** @see archive */
    fun archive(params: ContractArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractArchiveResponse>
     ...
     *
     */
    fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams): CompletableFuture<ContractCreateHistoricalInvoicesResponse> =
        createHistoricalInvoices(
          params, RequestOptions.none()
        )

    /** @see createHistoricalInvoices */
    fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractCreateHistoricalInvoicesResponse>
     ...
     *
     */
    fun getNetBalance(params: ContractGetNetBalanceParams): CompletableFuture<ContractGetNetBalanceResponse> =
        getNetBalance(
          params, RequestOptions.none()
        )

    /** @see getNetBalance */
    fun getNetBalance(params: ContractGetNetBalanceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractGetNetBalanceResponse>
     ...
     *
     */
    fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams): CompletableFuture<ContractGetSubscriptionSeatsHistoryResponse> =
        getSubscriptionSeatsHistory(
          params, RequestOptions.none()
        )

    /** @see getSubscriptionSeatsHistory */
    fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractGetSubscriptionSeatsHistoryResponse>
     ...
     *
     */
    fun listBalances(params: ContractListBalancesParams): CompletableFuture<ContractListBalancesPageAsync> =
        listBalances(
          params, RequestOptions.none()
        )

    /** @see listBalances */
    fun listBalances(params: ContractListBalancesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractListBalancesPageAsync>
     ...
     *
     */
    fun listSeatBalances(params: ContractListSeatBalancesParams): CompletableFuture<ContractListSeatBalancesResponse> =
        listSeatBalances(
          params, RequestOptions.none()
        )

    /** @see listSeatBalances */
    fun listSeatBalances(params: ContractListSeatBalancesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractListSeatBalancesResponse>
     ...
     *
     */
    fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams): CompletableFuture<ContractRetrieveRateScheduleResponse> =
        retrieveRateSchedule(
          params, RequestOptions.none()
        )

    /** @see retrieveRateSchedule */
    fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractRetrieveRateScheduleResponse>
     ...
     *
     */
    fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams): CompletableFuture<ContractRetrieveSubscriptionQuantityHistoryResponse> =
        retrieveSubscriptionQuantityHistory(
          params, RequestOptions.none()
        )

    /** @see retrieveSubscriptionQuantityHistory */
    fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractRetrieveSubscriptionQuantityHistoryResponse>
     ...
     *
     */
    fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams): CompletableFuture<ContractScheduleProServicesInvoiceResponse> =
        scheduleProServicesInvoice(
          params, RequestOptions.none()
        )

    /** @see scheduleProServicesInvoice */
    fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractScheduleProServicesInvoiceResponse>
    ...
    /** @see setUsageFilter */
    fun setUsageFilter(params: ContractSetUsageFilterParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
     ...
     *
     */
    fun updateEndDate(params: ContractUpdateEndDateParams): CompletableFuture<ContractUpdateEndDateResponse> =
        updateEndDate(
          params, RequestOptions.none()
        )

    /** @see updateEndDate */
    fun updateEndDate(params: ContractUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ContractUpdateEndDateResponse>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ContractServiceAsync.WithRawResponse
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/create`, but is otherwise the             same as [ContractServiceAsync.create]. */
        fun create(params: ContractCreateParams): CompletableFuture<HttpResponseFor<ContractCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: ContractCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/get`, but is otherwise the             same as [ContractServiceAsync.retrieve]. */
        fun retrieve(params: ContractRetrieveParams): CompletableFuture<HttpResponseFor<ContractRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: ContractRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractRetrieveResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/list`, but is otherwise the             same as [ContractServiceAsync.list]. */
        fun list(params: ContractListParams): CompletableFuture<HttpResponseFor<ContractListResponse>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(params: ContractListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractListResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/addManualBalanceLedgerEntry`, but is otherwise the             same as [ContractServiceAsync.addManualBalanceEntry]. */
        fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams): CompletableFuture<HttpResponse> =
            addManualBalanceEntry(
              params, RequestOptions.none()
            )

        /** @see addManualBalanceEntry */
        fun addManualBalanceEntry(params: ContractAddManualBalanceEntryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/contracts/amend`, but is otherwise the             same as [ContractServiceAsync.amend]. */
        fun amend(params: ContractAmendParams): CompletableFuture<HttpResponseFor<ContractAmendResponse>> =
            amend(
              params, RequestOptions.none()
            )

        /** @see amend */
        fun amend(params: ContractAmendParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractAmendResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/archive`, but is otherwise the             same as [ContractServiceAsync.archive]. */
        fun archive(params: ContractArchiveParams): CompletableFuture<HttpResponseFor<ContractArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: ContractArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractArchiveResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/createHistoricalInvoices`, but is otherwise the             same as [ContractServiceAsync.createHistoricalInvoices]. */
        fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams): CompletableFuture<HttpResponseFor<ContractCreateHistoricalInvoicesResponse>> =
            createHistoricalInvoices(
              params, RequestOptions.none()
            )

        /** @see createHistoricalInvoices */
        fun createHistoricalInvoices(params: ContractCreateHistoricalInvoicesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractCreateHistoricalInvoicesResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/customerBalances/getNetBalance`, but is otherwise the             same as [ContractServiceAsync.getNetBalance]. */
        fun getNetBalance(params: ContractGetNetBalanceParams): CompletableFuture<HttpResponseFor<ContractGetNetBalanceResponse>> =
            getNetBalance(
              params, RequestOptions.none()
            )

        /** @see getNetBalance */
        fun getNetBalance(params: ContractGetNetBalanceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractGetNetBalanceResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/getSubscriptionSeatsHistory`, but is otherwise the             same as [ContractServiceAsync.getSubscriptionSeatsHistory]. */
        fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams): CompletableFuture<HttpResponseFor<ContractGetSubscriptionSeatsHistoryResponse>> =
            getSubscriptionSeatsHistory(
              params, RequestOptions.none()
            )

        /** @see getSubscriptionSeatsHistory */
        fun getSubscriptionSeatsHistory(params: ContractGetSubscriptionSeatsHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractGetSubscriptionSeatsHistoryResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/customerBalances/list`, but is otherwise the             same as [ContractServiceAsync.listBalances]. */
        fun listBalances(params: ContractListBalancesParams): CompletableFuture<HttpResponseFor<ContractListBalancesPageAsync>> =
            listBalances(
              params, RequestOptions.none()
            )

        /** @see listBalances */
        fun listBalances(params: ContractListBalancesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractListBalancesPageAsync>>

        /** Returns a raw HTTP response for `post /v1/contracts/seatBalances/list`, but is otherwise the             same as [ContractServiceAsync.listSeatBalances]. */
        fun listSeatBalances(params: ContractListSeatBalancesParams): CompletableFuture<HttpResponseFor<ContractListSeatBalancesResponse>> =
            listSeatBalances(
              params, RequestOptions.none()
            )

        /** @see listSeatBalances */
        fun listSeatBalances(params: ContractListSeatBalancesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractListSeatBalancesResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/getContractRateSchedule`, but is otherwise the             same as [ContractServiceAsync.retrieveRateSchedule]. */
        fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams): CompletableFuture<HttpResponseFor<ContractRetrieveRateScheduleResponse>> =
            retrieveRateSchedule(
              params, RequestOptions.none()
            )

        /** @see retrieveRateSchedule */
        fun retrieveRateSchedule(params: ContractRetrieveRateScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractRetrieveRateScheduleResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/getSubscriptionQuantityHistory`, but is otherwise the             same as [ContractServiceAsync.retrieveSubscriptionQuantityHistory]. */
        fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams): CompletableFuture<HttpResponseFor<ContractRetrieveSubscriptionQuantityHistoryResponse>> =
            retrieveSubscriptionQuantityHistory(
              params, RequestOptions.none()
            )

        /** @see retrieveSubscriptionQuantityHistory */
        fun retrieveSubscriptionQuantityHistory(params: ContractRetrieveSubscriptionQuantityHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractRetrieveSubscriptionQuantityHistoryResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/scheduleProServicesInvoice`, but is otherwise the             same as [ContractServiceAsync.scheduleProServicesInvoice]. */
        fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams): CompletableFuture<HttpResponseFor<ContractScheduleProServicesInvoiceResponse>> =
            scheduleProServicesInvoice(
              params, RequestOptions.none()
            )

        /** @see scheduleProServicesInvoice */
        fun scheduleProServicesInvoice(params: ContractScheduleProServicesInvoiceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractScheduleProServicesInvoiceResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/setUsageFilter`, but is otherwise the             same as [ContractServiceAsync.setUsageFilter]. */
        ...
        /** @see setUsageFilter */
        fun setUsageFilter(params: ContractSetUsageFilterParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/contracts/updateEndDate`, but is otherwise the             same as [ContractServiceAsync.updateEndDate]. */
        fun updateEndDate(params: ContractUpdateEndDateParams): CompletableFuture<HttpResponseFor<ContractUpdateEndDateResponse>> =
            updateEndDate(
              params, RequestOptions.none()
            )

        /** @see updateEndDate */
        fun updateEndDate(params: ContractUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ContractUpdateEndDateResponse>>
    }
}
