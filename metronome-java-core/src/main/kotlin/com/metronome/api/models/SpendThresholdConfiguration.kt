...
class SpendThresholdConfiguration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spendThresholdConfiguration: SpendThresholdConfiguration) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): SpendThresholdConfiguration =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SpendThresholdConfiguration && commit == other.commit && isEnabled == other.isEnabled && paymentGateConfig == other.paymentGateConfig && thresholdAmount == other.thresholdAmount && discountConfiguration == other.discountConfiguration && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SpendThresholdConfiguration{commit=$commit, isEnabled=$isEnabled, paymentGateConfig=$paymentGateConfig, thresholdAmount=$thresholdAmount, discountConfiguration=$discountConfiguration, additionalProperties=$additionalProperties}"
}
