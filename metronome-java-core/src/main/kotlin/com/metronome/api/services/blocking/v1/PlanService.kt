...
interface PlanService {
    ...
    /** @see getDetails */
    fun getDetails(params: PlanGetDetailsParams, requestOptions: RequestOptions = RequestOptions.none()): PlanGetDetailsResponse
    ...
    /** @see listCharges */
    fun listCharges(params: PlanListChargesParams, requestOptions: RequestOptions = RequestOptions.none()): PlanListChargesPage
    ...
    /** @see listCustomers */
    fun listCustomers(params: PlanListCustomersParams, requestOptions: RequestOptions = RequestOptions.none()): PlanListCustomersPage
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /v1/plans`, but is otherwise the             same as [PlanService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `get /v1/planDetails/{plan_id}`, but is otherwise the             same as [PlanService.getDetails]. */
        @MustBeClosed
        ...
        /** @see getDetails */
        @MustBeClosed
        fun getDetails(params: PlanGetDetailsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanGetDetailsResponse>

        /** Returns a raw HTTP response for `get /v1/planDetails/{plan_id}/charges`, but is otherwise the             same as [PlanService.listCharges]. */
        @MustBeClosed
        ...
        /** @see listCharges */
        @MustBeClosed
        fun listCharges(params: PlanListChargesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanListChargesPage>

        /** Returns a raw HTTP response for `get /v1/planDetails/{plan_id}/customers`, but is otherwise the             same as [PlanService.listCustomers]. */
        @MustBeClosed
        ...
        /** @see listCustomers */
        @MustBeClosed
        fun listCustomers(params: PlanListCustomersParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanListCustomersPage>
    }
}
