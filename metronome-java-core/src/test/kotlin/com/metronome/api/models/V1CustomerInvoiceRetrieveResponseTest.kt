...
class V1CustomerInvoiceRetrieveResponseTest {

    @Test
    fun createV1CustomerInvoiceRetrieveResponse() {
        val v1CustomerInvoiceRetrieveResponse =
            V1CustomerInvoiceRetrieveResponse.builder()
                .data(
                    Invoice.builder()
                ...
                .build()
        assertThat(v1CustomerInvoiceRetrieveResponse).isNotNull
        assertThat(v1CustomerInvoiceRetrieveResponse.data())
            .isEqualTo(
                Invoice.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
