...
interface ServiceServiceAsync {
    ...
    /** @see list */
    fun list(params: ServiceListParams = ServiceListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ServiceListResponse>

    /** @see list */
    fun list(params: ServiceListParams = ServiceListParams.none()): CompletableFuture<ServiceListResponse> =
        list(
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ServiceServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `get /v1/services`, but is otherwise the             same as [ServiceServiceAsync.list]. */
        fun list(): CompletableFuture<HttpResponseFor<ServiceListResponse>> = list(ServiceListParams.none())

        /** @see list */
        fun list(params: ServiceListParams = ServiceListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ServiceListResponse>>

        /** @see list */
        fun list(params: ServiceListParams = ServiceListParams.none()): CompletableFuture<HttpResponseFor<ServiceListResponse>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ServiceListResponse>> =
            list(
              ServiceListParams.none(), requestOptions
            )
    }
