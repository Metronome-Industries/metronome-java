...
interface CustomerServiceAsync {
    ...
    /** @see create */
    fun create(params: CustomerCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerCreateResponse>
    ...
    /** @see retrieve */
    fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerRetrieveResponse>
    ...
    /** @see archive */
    fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerArchiveResponse>

    /** @see archive */
    fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerArchiveResponse> =
        archive(
     ...
     *
     */
    fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams): CompletableFuture<CustomerArchiveBillingConfigurationsResponse> =
        archiveBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see archiveBillingConfigurations */
    fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerArchiveBillingConfigurationsResponse>
     ...
     *
     */
    fun listBillableMetrics(params: CustomerListBillableMetricsParams): CompletableFuture<CustomerListBillableMetricsPageAsync> =
        listBillableMetrics(
          params, RequestOptions.none()
        )

    /** @see listBillableMetrics */
    fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerListBillableMetricsPageAsync>
    ...
    /** @see listCosts */
    fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerListCostsPageAsync>
     ...
     *
     */
    fun previewEvents(params: CustomerPreviewEventsParams): CompletableFuture<CustomerPreviewEventsResponse> =
        previewEvents(
          params, RequestOptions.none()
        )

    /** @see previewEvents */
    fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerPreviewEventsResponse>
     ...
     *
     */
    fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams): CompletableFuture<CustomerRetrieveBillingConfigurationsResponse> =
        retrieveBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see retrieveBillingConfigurations */
    fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerRetrieveBillingConfigurationsResponse>
     ...
     *
     */
    fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams): CompletableFuture<CustomerSetBillingConfigurationsResponse> =
        setBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see setBillingConfigurations */
    fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerSetBillingConfigurationsResponse>
    ...
    fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see setName */
    fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomerSetNameResponse>
    ...
    /** @see updateConfig */
    fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/customers`, but is otherwise the             same as [CustomerServiceAsync.create]. */
        fun create(params: CustomerCreateParams): CompletableFuture<HttpResponseFor<CustomerCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: CustomerCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerCreateResponse>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}`, but is otherwise the             same as [CustomerServiceAsync.retrieve]. */
        fun retrieve(params: CustomerRetrieveParams): CompletableFuture<HttpResponseFor<CustomerRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerRetrieveResponse>>

        /** Returns a raw HTTP response for `get /v1/customers`, but is otherwise the             same as [CustomerServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `post /v1/customers/archive`, but is otherwise the             same as [CustomerServiceAsync.archive]. */
        fun archive(params: CustomerArchiveParams): CompletableFuture<HttpResponseFor<CustomerArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerArchiveResponse>>

        /** @see archive */
        fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerArchiveResponse>> =
            archive(
              CustomerArchiveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/archiveCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerServiceAsync.archiveBillingConfigurations]. */
        fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams): CompletableFuture<HttpResponseFor<CustomerArchiveBillingConfigurationsResponse>> =
            archiveBillingConfigurations(
              params, RequestOptions.none()
            )

        /** @see archiveBillingConfigurations */
        fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerArchiveBillingConfigurationsResponse>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/billable-metrics`, but is otherwise the             same as [CustomerServiceAsync.listBillableMetrics]. */
        fun listBillableMetrics(params: CustomerListBillableMetricsParams): CompletableFuture<HttpResponseFor<CustomerListBillableMetricsPageAsync>> =
            listBillableMetrics(
              params, RequestOptions.none()
            )

        /** @see listBillableMetrics */
        fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerListBillableMetricsPageAsync>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/costs`, but is otherwise the             same as [CustomerServiceAsync.listCosts]. */
        fun listCosts(params: CustomerListCostsParams): CompletableFuture<HttpResponseFor<CustomerListCostsPageAsync>> =
            listCosts(
              params, RequestOptions.none()
            )

        /** @see listCosts */
        fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerListCostsPageAsync>>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/previewEvents`, but is otherwise the             same as [CustomerServiceAsync.previewEvents]. */
        fun previewEvents(params: CustomerPreviewEventsParams): CompletableFuture<HttpResponseFor<CustomerPreviewEventsResponse>> =
            previewEvents(
              params, RequestOptions.none()
            )

        /** @see previewEvents */
        fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerPreviewEventsResponse>>

        /** Returns a raw HTTP response for `post /v1/getCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerServiceAsync.retrieveBillingConfigurations]. */
        fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams): CompletableFuture<HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse>> =
            retrieveBillingConfigurations(
              params, RequestOptions.none()
            )

        /** @see retrieveBillingConfigurations */
        fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse>>

        /** Returns a raw HTTP response for `post /v1/setCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerServiceAsync.setBillingConfigurations]. */
        fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams): CompletableFuture<HttpResponseFor<CustomerSetBillingConfigurationsResponse>> =
            setBillingConfigurations(
              params, RequestOptions.none()
            )

        /** @see setBillingConfigurations */
        fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerSetBillingConfigurationsResponse>>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/setIngestAliases`, but is otherwise the             same as [CustomerServiceAsync.setIngestAliases]. */
        fun setIngestAliases(params: CustomerSetIngestAliasesParams): CompletableFuture<HttpResponse> =
            setIngestAliases(
              params, RequestOptions.none()
            )

        /** @see setIngestAliases */
        fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/setName`, but is otherwise the             same as [CustomerServiceAsync.setName]. */
        fun setName(params: CustomerSetNameParams): CompletableFuture<HttpResponseFor<CustomerSetNameResponse>> =
            setName(
              params, RequestOptions.none()
            )

        /** @see setName */
        fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomerSetNameResponse>>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/updateConfig`, but is otherwise the             same as [CustomerServiceAsync.updateConfig]. */
        ...
        /** @see updateConfig */
        fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
