...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanListChargesPageAsync && plansService == other.plansService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(plansService: PlanServiceAsync, params: PlanListChargesParams, response: Response) =
            PlanListChargesPageAsync(plansService, params, response)
    }
    ...
    class AutoPager(private val firstPage: PlanListChargesPageAsync) {
