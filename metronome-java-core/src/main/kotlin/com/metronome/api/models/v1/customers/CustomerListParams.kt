...
class CustomerListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Filter the customer list by ingest_alias */
        fun ingestAlias(ingestAlias: String?) =
            apply {
                this.ingestAlias = ingestAlias
            }
        ...
        /** Filter the customer list to only return archived customers. By default, only active customers are returned. */
        fun onlyArchived(onlyArchived: Boolean?) =
            apply {
        ...
        /** Filter the customer list by salesforce_account_id.  Up to 100 ids can be provided. */
        fun salesforceAccountIds(salesforceAccountIds: List<String>?) =
            apply {
                this.salesforceAccountIds = salesforceAccountIds?.toMutableList()
            }

        /** Alias for calling [Builder.salesforceAccountIds] with `salesforceAccountIds.orElse(null)`. */
        fun salesforceAccountIds(salesforceAccountIds: Optional<List<String>>) = salesforceAccountIds(salesforceAccountIds.getOrNull())
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addSalesforceAccountId(salesforceAccountId: String) =
            apply {
                salesforceAccountIds = (salesforceAccountIds ?: mutableListOf()).apply { add(salesforceAccountId) }
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerListParams && customerIds == other.customerIds && ingestAlias == other.ingestAlias && limit == other.limit && nextPage == other.nextPage && onlyArchived == other.onlyArchived && salesforceAccountIds == other.salesforceAccountIds && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerIds, ingestAlias, limit, nextPage, onlyArchived, salesforceAccountIds, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerListParams{customerIds=$customerIds, ingestAlias=$ingestAlias, limit=$limit, nextPage=$nextPage, onlyArchived=$onlyArchived, salesforceAccountIds=$salesforceAccountIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
