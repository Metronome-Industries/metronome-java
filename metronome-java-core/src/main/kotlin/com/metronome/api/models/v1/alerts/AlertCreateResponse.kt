...
class AlertCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlertCreateResponse].
         *
    ...
    /** A builder for [AlertCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(alertCreateResponse: AlertCreateResponse) =
            apply {
                data = alertCreateResponse.data
                additionalProperties = alertCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AlertCreateResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): AlertCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AlertCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AlertCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
