 ...
 */
class V1CustomerSetIngestAliasesParams
private constructor(
    ...
    /** A builder for [V1CustomerSetIngestAliasesParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerSetIngestAliasesParams: V1CustomerSetIngestAliasesParams) =
            apply {
                customerId = v1CustomerSetIngestAliasesParams.customerId
                body = v1CustomerSetIngestAliasesParams.body.toBuilder()
                additionalHeaders = v1CustomerSetIngestAliasesParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v1CustomerSetIngestAliasesParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): V1CustomerSetIngestAliasesParams =
            V1CustomerSetIngestAliasesParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerSetIngestAliasesParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(customerId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerSetIngestAliasesParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
