...
internal class ProServiceTest {
    ...
    @Test
    fun create() {
      val proService = ProService.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .maxAmount(0.0)
          .productId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .quantity(0.0)
          .unitPrice(0.0)
          .customFields(ProService.CustomFields.builder()
      ...
      assertThat(proService.customFields()).contains(ProService.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedProService = jsonMapper.readValue(jsonMapper.writeValueAsString(proService), jacksonTypeRef<ProService>())
