...
/** Add new rates */
class V1ContractRateCardRateAddManyParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && rateCardId == other.rateCardId && rates == other.rates && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1ContractRateCardRateAddManyParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRateCardRateAddManyParams: V1ContractRateCardRateAddManyParams
        ) = apply {
            body = v1ContractRateCardRateAddManyParams.body.toBuilder()
            additionalHeaders = v1ContractRateCardRateAddManyParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRateCardRateAddManyParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardRateAddManyParams =
            V1ContractRateCardRateAddManyParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateAddManyParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardRateAddManyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
