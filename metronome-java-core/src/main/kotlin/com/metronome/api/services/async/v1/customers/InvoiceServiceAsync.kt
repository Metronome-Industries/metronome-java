...
interface InvoiceServiceAsync {
    ...
    /** @see retrieve */
    fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceRetrieveResponse>
    ...
    /** @see addCharge */
    fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceAddChargeResponse>
     ...
     */
    fun listBreakdowns(params: InvoiceListBreakdownsParams): CompletableFuture<InvoiceListBreakdownsPageAsync> =
        listBreakdowns(
          params, RequestOptions.none()
        )

    /** @see listBreakdowns */
    fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InvoiceListBreakdownsPageAsync>
    ...
    /** @see retrievePdf */
    fun retrievePdf(params: InvoiceRetrievePdfParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/{invoice_id}`, but is otherwise the             same as [InvoiceServiceAsync.retrieve]. */
        fun retrieve(params: InvoiceRetrieveParams): CompletableFuture<HttpResponseFor<InvoiceRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceRetrieveResponse>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices`, but is otherwise the             same as [InvoiceServiceAsync.list]. */
        fun list(params: InvoiceListParams): CompletableFuture<HttpResponseFor<InvoiceListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(params: InvoiceListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceListPageAsync>>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/addCharge`, but is otherwise the             same as [InvoiceServiceAsync.addCharge]. */
        fun addCharge(params: InvoiceAddChargeParams): CompletableFuture<HttpResponseFor<InvoiceAddChargeResponse>> =
            addCharge(
              params, RequestOptions.none()
            )

        /** @see addCharge */
        fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceAddChargeResponse>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/breakdowns`, but is otherwise the             same as [InvoiceServiceAsync.listBreakdowns]. */
        fun listBreakdowns(params: InvoiceListBreakdownsParams): CompletableFuture<HttpResponseFor<InvoiceListBreakdownsPageAsync>> =
            listBreakdowns(
              params, RequestOptions.none()
            )

        /** @see listBreakdowns */
        fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<InvoiceListBreakdownsPageAsync>>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/invoices/{invoice_id}/pdf`, but is otherwise the             same as [InvoiceServiceAsync.retrievePdf]. */
        fun retrievePdf(params: InvoiceRetrievePdfParams): CompletableFuture<HttpResponse> =
            retrievePdf(
              params, RequestOptions.none()
            )
