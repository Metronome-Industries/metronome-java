...
@NoAutoDetect
class V1ContractProductListResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1ContractProductListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractProductListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractProductListResponse: V1ContractProductListResponse) = apply {
            id = v1ContractProductListResponse.id
            current = v1ContractProductListResponse.current
            initial = v1ContractProductListResponse.initial
            type = v1ContractProductListResponse.type
            updates = v1ContractProductListResponse.updates.map { it.toMutableList() }
            archivedAt = v1ContractProductListResponse.archivedAt
            customFields = v1ContractProductListResponse.customFields
            additionalProperties = v1ContractProductListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ContractProductListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractProductListResponse && id == other.id && current == other.current && initial == other.initial && type == other.type && updates == other.updates && archivedAt == other.archivedAt && customFields == other.customFields && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractProductListResponse{id=$id, current=$current, initial=$initial, type=$type, updates=$updates, archivedAt=$archivedAt, customFields=$customFields, additionalProperties=$additionalProperties}"
}
