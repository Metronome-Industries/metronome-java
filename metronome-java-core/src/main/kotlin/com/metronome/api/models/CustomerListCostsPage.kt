...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListCostsPage && customersService == other.customersService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = CustomerListCostsPage(customersService, params, response)
    }
    ...
    class AutoPager(private val firstPage: CustomerListCostsPage) :
