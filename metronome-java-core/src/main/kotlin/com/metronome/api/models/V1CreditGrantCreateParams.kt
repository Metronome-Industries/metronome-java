 ...
 * using Contracts.
 */
class V1CreditGrantCreateParams
private constructor(
    ...
    /** A builder for [V1CreditGrantCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantCreateParams: V1CreditGrantCreateParams) = apply {
            body = v1CreditGrantCreateParams.body.toBuilder()
            additionalHeaders = v1CreditGrantCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreditGrantCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CreditGrantCreateParams =
            V1CreditGrantCreateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantCreateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CreditGrantCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
