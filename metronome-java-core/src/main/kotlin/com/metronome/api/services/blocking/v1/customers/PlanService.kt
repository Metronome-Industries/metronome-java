...
interface PlanService {
     ...
     *
     */
    fun list(params: PlanListParams): PlanListPage =
        list(
     ...
     *
     */
    fun add(params: PlanAddParams): PlanAddResponse =
        add(
          params, RequestOptions.none()
        )

    /** @see add */
    fun add(params: PlanAddParams, requestOptions: RequestOptions = RequestOptions.none()): PlanAddResponse
     ...
     *
     */
    fun end(params: PlanEndParams): PlanEndResponse =
        end(
          params, RequestOptions.none()
        )

    /** @see end */
    fun end(params: PlanEndParams, requestOptions: RequestOptions = RequestOptions.none()): PlanEndResponse
    ...
    fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions = RequestOptions.none()): PlanListPriceAdjustmentsPage
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/plans`, but is otherwise the             same as [PlanService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: PlanListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanListPage>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/plans/add`, but is otherwise the             same as [PlanService.add]. */
        @MustBeClosed
        ...
        /** @see add */
        @MustBeClosed
        fun add(params: PlanAddParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanAddResponse>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/plans/{customer_plan_id}/end`, but is otherwise the             same as [PlanService.end]. */
        @MustBeClosed
        ...
        /** @see end */
        @MustBeClosed
        fun end(params: PlanEndParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanEndResponse>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/plans/{customer_plan_id}/priceAdjustments`, but is otherwise the             same as [PlanService.listPriceAdjustments]. */
        @MustBeClosed
        fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams): HttpResponseFor<PlanListPriceAdjustmentsPage> =
            listPriceAdjustments(
              params, RequestOptions.none()
            )
        ...
        /** @see listPriceAdjustments */
        @MustBeClosed
        fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<PlanListPriceAdjustmentsPage>
    }
}
