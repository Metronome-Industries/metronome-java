...
@NoAutoDetect
class V1CustomFieldListKeysResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CustomFieldListKeysResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomFieldListKeysResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomFieldListKeysResponse: V1CustomFieldListKeysResponse) = apply {
            enforceUniqueness = v1CustomFieldListKeysResponse.enforceUniqueness
            entity = v1CustomFieldListKeysResponse.entity
            key = v1CustomFieldListKeysResponse.key
            additionalProperties = v1CustomFieldListKeysResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomFieldListKeysResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomFieldListKeysResponse && enforceUniqueness == other.enforceUniqueness && entity == other.entity && key == other.key && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomFieldListKeysResponse{enforceUniqueness=$enforceUniqueness, entity=$entity, key=$key, additionalProperties=$additionalProperties}"
}
