 ...
 *
 */
class ContractRetrieveRateScheduleParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractRetrieveRateScheduleParams].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractRetrieveRateScheduleParams: ContractRetrieveRateScheduleParams) =
            apply {
                ...
                additionalQueryParams = contractRetrieveRateScheduleParams.additionalQueryParams.toBuilder()
            }
         ...
         *
         * You should usually call [Builder.at] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun at(at: JsonField<OffsetDateTime>) =
            apply {
                body.at(at)
            }

        /** List of rate selectors, rates matching ANY of the selectors will be included in the response. Passing no selectors will result in all rates being returned. */
        fun selectors(selectors: List<Selector>) =
            apply {
         ...
         *
         * You should usually call [Builder.selectors] with a well-typed `List<Selector>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun selectors(selectors: JsonField<List<Selector>>) =
            apply {
                body.selectors(selectors)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("selectors") @ExcludeMissing selectors: JsonField<List<Selector>> = JsonMissing.of()
        ) : this(
          contractId,
          customerId,
          at,
        ...
        @JsonProperty("at")
        @ExcludeMissing
        fun _at(): JsonField<OffsetDateTime> = at
        ...
        class Builder internal constructor() {
            ...
            fun addSelector(selector: Selector) =
                apply {
                    selectors = (selectors ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (at.asKnown().isPresent) 1 else 0) + (selectors.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && at == other.at && selectors == other.selectors && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, at=$at, selectors=$selectors, additionalProperties=$additionalProperties}"
    }

    class Selector @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("partial_pricing_group_values") @ExcludeMissing partialPricingGroupValues: JsonField<PartialPricingGroupValues> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun partialPricingGroupValues(): Optional<PartialPricingGroupValues> = partialPricingGroupValues.getOptional("partial_pricing_group_values")
         ...
         *
         * Unlike [partialPricingGroupValues], this method doesn't throw if the JSON field has an unexpected type.
         */
        @JsonProperty("partial_pricing_group_values")
        @ExcludeMissing
        fun _partialPricingGroupValues(): JsonField<PartialPricingGroupValues> = partialPricingGroupValues
        ...
        class Builder internal constructor() {
            ...
            private var partialPricingGroupValues: JsonField<PartialPricingGroupValues> = JsonMissing.of()
            ...
            @JvmSynthetic
            internal fun from(selector: Selector) =
                apply {
            ...
            /** List of pricing group key value pairs, rates containing the matching key / value pairs will be included in the response. */
            fun partialPricingGroupValues(partialPricingGroupValues: PartialPricingGroupValues) = partialPricingGroupValues(JsonField.of(partialPricingGroupValues))

            /**
             * Sets [Builder.partialPricingGroupValues] to an arbitrary JSON value.
             *
             * You should usually call [Builder.partialPricingGroupValues] with a well-typed [PartialPricingGroupValues] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun partialPricingGroupValues(partialPricingGroupValues: JsonField<PartialPricingGroupValues>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (billingFrequency.asKnown().getOrNull()?.validity() ?: 0) + (partialPricingGroupValues.asKnown().getOrNull()?.validity() ?: 0) + (pricingGroupValues.asKnown().getOrNull()?.validity() ?: 0) + (if (productId.asKnown().isPresent) 1 else 0) + (productTags.asKnown().getOrNull()?.size ?: 0)
        ...
        /** List of pricing group key value pairs, rates containing the matching key / value pairs will be included in the response. */
        class PartialPricingGroupValues @JsonCreator private constructor(
            ...
            companion object {
                ...
                /** Returns a mutable builder for constructing an instance of [PartialPricingGroupValues]. */
                @JvmStatic
                fun builder() = Builder()
            }
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(partialPricingGroupValues: PartialPricingGroupValues) =
                    apply {
                        additionalProperties = partialPricingGroupValues.additionalProperties.toMutableMap()
                    }
                 ...
                 * Further updates to this [Builder] will not mutate the returned instance.
                 */
                fun build(): PartialPricingGroupValues = PartialPricingGroupValues(additionalProperties.toImmutable())
            }
             ...
             *   expected type.
             */
            fun validate(): PartialPricingGroupValues =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PartialPricingGroupValues && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PartialPricingGroupValues{additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Selector && billingFrequency == other.billingFrequency && partialPricingGroupValues == other.partialPricingGroupValues && pricingGroupValues == other.pricingGroupValues && productId == other.productId && productTags == other.productTags && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(billingFrequency, partialPricingGroupValues, pricingGroupValues, productId, productTags, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Selector{billingFrequency=$billingFrequency, partialPricingGroupValues=$partialPricingGroupValues, pricingGroupValues=$pricingGroupValues, productId=$productId, productTags=$productTags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractRetrieveRateScheduleParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractRetrieveRateScheduleParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
