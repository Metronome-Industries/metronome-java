...
interface CustomFieldService {
     ...
     *
     */
    fun addKey(params: CustomFieldAddKeyParams) =
        addKey(
          params, RequestOptions.none()
        )

    /** @see addKey */
    fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see deleteValues */
    fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see listKeys */
    fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CustomFieldListKeysPage

    /** @see listKeys */
    fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none()): CustomFieldListKeysPage =
        listKeys(
          params, RequestOptions.none()
        )
     ...
     *
     */
    fun removeKey(params: CustomFieldRemoveKeyParams) =
        removeKey(
          params, RequestOptions.none()
        )

    /** @see removeKey */
    fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions = RequestOptions.none())
     ...
     *
     */
    fun setValues(params: CustomFieldSetValuesParams) =
        setValues(
          params, RequestOptions.none()
        )

    /** @see setValues */
    fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldService.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/customFields/addKey`, but is otherwise the             same as [CustomFieldService.addKey]. */
        @MustBeClosed
        ...
        /** @see addKey */
        @MustBeClosed
        fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /v1/customFields/deleteValues`, but is otherwise the             same as [CustomFieldService.deleteValues]. */
        @MustBeClosed
        ...
        /** @see deleteValues */
        @MustBeClosed
        fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /v1/customFields/listKeys`, but is otherwise the             same as [CustomFieldService.listKeys]. */
        @MustBeClosed
        fun listKeys(): HttpResponseFor<CustomFieldListKeysPage> = listKeys(CustomFieldListKeysParams.none())

        /** @see listKeys */
        @MustBeClosed
        fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomFieldListKeysPage>

        /** @see listKeys */
        @MustBeClosed
        fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none()): HttpResponseFor<CustomFieldListKeysPage> =
            listKeys(
              params, RequestOptions.none()
            )
        ...
        /** Returns a raw HTTP response for `post /v1/customFields/removeKey`, but is otherwise the             same as [CustomFieldService.removeKey]. */
        @MustBeClosed
        ...
        /** @see removeKey */
        @MustBeClosed
        fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /v1/customFields/setValues`, but is otherwise the             same as [CustomFieldService.setValues]. */
        @MustBeClosed
        ...
        /** @see setValues */
        @MustBeClosed
        fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
