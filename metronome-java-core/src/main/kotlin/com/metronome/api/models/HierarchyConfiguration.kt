...
class HierarchyConfiguration private constructor(
     ...
     *   expected type.
     */
    fun validate(): HierarchyConfiguration =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** An interface that defines how to map each variant of [HierarchyConfiguration] to a value of type [T]. */
    interface Visitor<out T> {
         ...
         *
         * An instance of [HierarchyConfiguration] can contain an unknown variant if it was deserialized from data
    ...
    internal class Deserializer : BaseDeserializer<HierarchyConfiguration>(HierarchyConfiguration::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): HierarchyConfiguration {
          ...
          val bestMatches = sequenceOf(
                  ...
                  tryDeserialize(node, jacksonTypeRef<ChildHierarchyConfiguration>())
                      ?.let {
    ...
    internal class Serializer : BaseSerializer<HierarchyConfiguration>(HierarchyConfiguration::class) {

        override fun serialize(value: HierarchyConfiguration, generator: JsonGenerator, provider: SerializerProvider) {
          when {
    ...
    class ParentHierarchyConfiguration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("children") @ExcludeMissing children: JsonField<List<Child>> = JsonMissing.of(),
            @JsonProperty("parent_behavior") @ExcludeMissing parentBehavior: JsonField<ParentBehavior> = JsonMissing.of()
        ) : this(
          children,
          parentBehavior,
          mutableMapOf(),
        ...
        fun parentBehavior(): Optional<ParentBehavior> = parentBehavior.getOptional("parent_behavior")
         ...
         *
         * Unlike [parentBehavior], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ParentHierarchyConfiguration].
             *
        ...
        class Builder internal constructor() {
            ...
            internal fun from(parentHierarchyConfiguration: ParentHierarchyConfiguration) =
                apply {
                    ...
                    additionalProperties = parentHierarchyConfiguration.additionalProperties.toMutableMap()
                }
             ...
             *
             * You should usually call [Builder.children] with a well-typed `List<Child>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            fun parentBehavior(parentBehavior: ParentBehavior) = parentBehavior(JsonField.of(parentBehavior))

            /**
             * Sets [Builder.parentBehavior] to an arbitrary JSON value.
             *
             * You should usually call [Builder.parentBehavior] with a well-typed [ParentBehavior] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun parentBehavior(parentBehavior: JsonField<ParentBehavior>) =
                apply {
         ...
         *   expected type.
         */
        fun validate(): ParentHierarchyConfiguration =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (children.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (parentBehavior.asKnown().getOrNull()?.validity() ?: 0)

        class Child @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Child && contractId == other.contractId && customerId == other.customerId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Child{contractId=$contractId, customerId=$customerId, additionalProperties=$additionalProperties}"
        }

        class ParentBehavior @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("invoice_consolidation_type") @ExcludeMissing invoiceConsolidationType: JsonField<InvoiceConsolidationType> = JsonMissing.of()
            ) : this(
              invoiceConsolidationType, mutableMapOf()
            )
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun invoiceConsolidationType(): Optional<InvoiceConsolidationType> = invoiceConsolidationType.getOptional("invoice_consolidation_type")

            /**
             * Returns the raw JSON value of [invoiceConsolidationType].
             *
             * Unlike [invoiceConsolidationType], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("invoice_consolidation_type")
            @ExcludeMissing
            fun _invoiceConsolidationType(): JsonField<InvoiceConsolidationType> = invoiceConsolidationType
            ...
            class Builder internal constructor() {
                ...
                private var invoiceConsolidationType: JsonField<InvoiceConsolidationType> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                @JvmSynthetic
                internal fun from(parentBehavior: ParentBehavior) =
                    apply {
                 ...
                 * **NONE**: Do not generate consolidated invoices
                 */
                fun invoiceConsolidationType(invoiceConsolidationType: InvoiceConsolidationType) = invoiceConsolidationType(JsonField.of(invoiceConsolidationType))

                /**
                 * Sets [Builder.invoiceConsolidationType] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.invoiceConsolidationType] with a well-typed [InvoiceConsolidationType] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun invoiceConsolidationType(invoiceConsolidationType: JsonField<InvoiceConsolidationType>) =
                    apply {
                        this.invoiceConsolidationType = invoiceConsolidationType
                    }
                ...
                fun build(): ParentBehavior =
                    ParentBehavior(
                      invoiceConsolidationType, additionalProperties.toMutableMap()
                    )
            }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (invoiceConsolidationType.asKnown().getOrNull()?.validity() ?: 0)
             ...
             * **NONE**: Do not generate consolidated invoices
             */
            class InvoiceConsolidationType @JsonCreator private constructor(
                ...
                /**
                 * An enum containing [InvoiceConsolidationType]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [InvoiceConsolidationType] can contain an unknown value in a couple of cases:
                 *
                ...
                enum class Value {
                    CONCATENATE,
                    NONE,
                    /** An enum member indicating that [InvoiceConsolidationType] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        NONE -> Known.NONE
                        else -> throw MetronomeInvalidDataException("Unknown InvoiceConsolidationType: $value")
                    }
                 ...
                 *   expected type.
                 */
                fun validate(): InvoiceConsolidationType =
                    apply {
                        if (validated) {
                          return@apply
                        }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is ParentBehavior && invoiceConsolidationType == other.invoiceConsolidationType && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "ParentBehavior{invoiceConsolidationType=$invoiceConsolidationType, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ParentHierarchyConfiguration && children == other.children && parentBehavior == other.parentBehavior && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ParentHierarchyConfiguration{children=$children, parentBehavior=$parentBehavior, additionalProperties=$additionalProperties}"
    }

    class ChildHierarchyConfiguration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("usage_statement_behavior") @ExcludeMissing usageStatementBehavior: JsonField<UsageStatementBehavior> = JsonMissing.of()
        ) : this(
          parent,
          payer,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun usageStatementBehavior(): Optional<UsageStatementBehavior> = usageStatementBehavior.getOptional("usage_statement_behavior")
         ...
         *
         * Unlike [usageStatementBehavior], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [ChildHierarchyConfiguration].
             *
             * The following fields are required:
             *
             * ```java
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(childHierarchyConfiguration: ChildHierarchyConfiguration) =
                apply {
                    ...
                    additionalProperties = childHierarchyConfiguration.additionalProperties.toMutableMap()
                }
             ...
             *
             * You should usually call [Builder.parent] with a well-typed [Parent] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * **SEPARATE**: Child's invoice statements will appear not appear on parent's consolidated invoices
             */
            fun usageStatementBehavior(usageStatementBehavior: UsageStatementBehavior) = usageStatementBehavior(JsonField.of(usageStatementBehavior))

            /**
             * Sets [Builder.usageStatementBehavior] to an arbitrary JSON value.
             *
             * You should usually call [Builder.usageStatementBehavior] with a well-typed [UsageStatementBehavior] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
         ...
         *   expected type.
         */
        fun validate(): ChildHierarchyConfiguration =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (parent.asKnown().getOrNull()?.validity() ?: 0) + (payer.asKnown().getOrNull()?.validity() ?: 0) + (usageStatementBehavior.asKnown().getOrNull()?.validity() ?: 0)

        /** The single parent contract/customer for this child. */
        class Parent @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val contractId: JsonField<String>,
            private val customerId: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Parent && contractId == other.contractId && customerId == other.customerId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Parent{contractId=$contractId, customerId=$customerId, additionalProperties=$additionalProperties}"
        }
         ...
         * **PARENT**: The parent pays for the child's invoice charges
         */
        class Payer @JsonCreator private constructor(
            private val value: JsonField<String>,
         ...
         * **SEPARATE**: Child's invoice statements will appear not appear on parent's consolidated invoices
         */
        class UsageStatementBehavior @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            /**
             * An enum containing [UsageStatementBehavior]'s known values, as well as an [_UNKNOWN] member.
             *
             * An instance of [UsageStatementBehavior] can contain an unknown value in a couple of cases:
             *
             * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
             *   an older version than the API, then the API may respond with new members that the SDK is unaware
             *   of.
            ...
            enum class Value {
                CONSOLIDATE,
                SEPARATE,
                /** An enum member indicating that [UsageStatementBehavior] was instantiated with an unknown value. */
                _UNKNOWN,
            }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw MetronomeInvalidDataException("Unknown UsageStatementBehavior: $value")
                }
             ...
             *   expected type.
             */
            fun validate(): UsageStatementBehavior =
                apply {
                    if (validated) {
                      return@apply
                    }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is ChildHierarchyConfiguration && parent == other.parent && payer == other.payer && usageStatementBehavior == other.usageStatementBehavior && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "ChildHierarchyConfiguration{parent=$parent, payer=$payer, usageStatementBehavior=$usageStatementBehavior, additionalProperties=$additionalProperties}"
    }
}
