...
internal class BillingConfigServiceTest {
    ...
    fun create() {
      ...
      billingConfigService.create(BillingConfigCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val billingConfig = billingConfigService.retrieve(BillingConfigRetrieveParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun delete() {
      ...
      billingConfigService.delete(BillingConfigDeleteParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
