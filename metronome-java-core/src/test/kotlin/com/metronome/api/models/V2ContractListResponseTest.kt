...
class V2ContractListResponseTest {

    @Test
    fun createV2ContractListResponse() {
        val v2ContractListResponse =
            V2ContractListResponse.builder()
                .addData(
                    ContractV2.builder()
                ...
                .build()
        assertThat(v2ContractListResponse).isNotNull
        assertThat(v2ContractListResponse.data())
            .containsExactly(
                ContractV2.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .addCommit(
