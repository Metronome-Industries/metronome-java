...
interface CreditServiceAsync {
    ...
    /** @see create */
    fun create(params: CreditCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CreditCreateResponse>
    ...
    /** @see list */
    fun list(params: CreditListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CreditListPageAsync>
     ...
     *
     */
    fun updateEndDate(params: CreditUpdateEndDateParams): CompletableFuture<CreditUpdateEndDateResponse> =
        updateEndDate(
          params, RequestOptions.none()
        )

    /** @see updateEndDate */
    fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CreditUpdateEndDateResponse>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CreditServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/create`, but is otherwise the             same as [CreditServiceAsync.create]. */
        fun create(params: CreditCreateParams): CompletableFuture<HttpResponseFor<CreditCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: CreditCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CreditCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/list`, but is otherwise the             same as [CreditServiceAsync.list]. */
        fun list(params: CreditListParams): CompletableFuture<HttpResponseFor<CreditListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(params: CreditListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CreditListPageAsync>>

        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/updateEndDate`, but is otherwise the             same as [CreditServiceAsync.updateEndDate]. */
        fun updateEndDate(params: CreditUpdateEndDateParams): CompletableFuture<HttpResponseFor<CreditUpdateEndDateResponse>> =
            updateEndDate(
              params, RequestOptions.none()
            )

        /** @see updateEndDate */
        fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CreditUpdateEndDateResponse>>
    }
}
