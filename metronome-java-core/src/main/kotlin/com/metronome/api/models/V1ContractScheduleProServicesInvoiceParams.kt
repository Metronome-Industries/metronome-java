 ...
 */
class V1ContractScheduleProServicesInvoiceParams
private constructor(
    ...
    /** A builder for [V1ContractScheduleProServicesInvoiceParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractScheduleProServicesInvoiceParams: V1ContractScheduleProServicesInvoiceParams
        ) = apply {
            body = v1ContractScheduleProServicesInvoiceParams.body.toBuilder()
            additionalHeaders =
                v1ContractScheduleProServicesInvoiceParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractScheduleProServicesInvoiceParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractScheduleProServicesInvoiceParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractScheduleProServicesInvoiceParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractScheduleProServicesInvoiceParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
