...
class ContractListSeatBalancesResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("pagination") @ExcludeMissing pagination: JsonField<Pagination> = JsonMissing.of()
    ) : this(
      data,
      pagination,
      mutableMapOf(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractListSeatBalancesResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractListSeatBalancesResponse: ContractListSeatBalancesResponse) =
            apply {
                ...
                additionalProperties = contractListSeatBalancesResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.pagination] with a well-typed [Pagination] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pagination(pagination: JsonField<Pagination>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ContractListSeatBalancesResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (pagination.asKnown().getOrNull()?.validity() ?: 0)
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @ExcludeMissing
        fun _seatId(): JsonField<String> = seatId
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.seatId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun seatId(seatId: JsonField<String>) =
                apply {
                    this.seatId = seatId
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (balances.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (seatId.asKnown().isPresent) 1 else 0) + (commits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (credits.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        class Balance @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("starting_balance") @ExcludeMissing startingBalance: JsonField<Double> = JsonMissing.of()
            ) : this(
              balance,
              creditTypeId,
              startingBalance,
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.startingBalance] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (balance.asKnown().isPresent) 1 else 0) + (if (creditTypeId.asKnown().isPresent) 1 else 0) + (if (startingBalance.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Balance && balance == other.balance && creditTypeId == other.creditTypeId && startingBalance == other.startingBalance && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(balance, creditTypeId, startingBalance, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Balance{balance=$balance, creditTypeId=$creditTypeId, startingBalance=$startingBalance, additionalProperties=$additionalProperties}"
        }
        ...
        class Commit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            /**
             * Transaction history for this commit for this seat (only included if include_ledgers=true)
             *
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun ledgerEntries(): Optional<List<LedgerEntry>> = ledgerEntries.getOptional("ledger_entries")
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (balance.asKnown().isPresent) 1 else 0) + (if (startDate.asKnown().isPresent) 1 else 0) + (if (endDate.asKnown().isPresent) 1 else 0) + (ledgerEntries.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
            ...
            class LedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is LedgerEntry && amount == other.amount && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "LedgerEntry{amount=$amount, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Commit && id == other.id && balance == other.balance && startDate == other.startDate && endDate == other.endDate && ledgerEntries == other.ledgerEntries && additionalProperties == other.additionalProperties
            }

            private val hashCode: Int by lazy { Objects.hash(id, balance, startDate, endDate, ledgerEntries, additionalProperties) }

            override fun hashCode(): Int = hashCode

            override fun toString() = "Commit{id=$id, balance=$balance, startDate=$startDate, endDate=$endDate, ledgerEntries=$ledgerEntries, additionalProperties=$additionalProperties}"
        }
        ...
        class Credit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Credit && id == other.id && balance == other.balance && startDate == other.startDate && endDate == other.endDate && ledgerEntries == other.ledgerEntries && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Credit{id=$id, balance=$balance, startDate=$startDate, endDate=$endDate, ledgerEntries=$ledgerEntries, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && balances == other.balances && seatId == other.seatId && commits == other.commits && credits == other.credits && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(balances, seatId, commits, credits, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Data{balances=$balances, seatId=$seatId, commits=$commits, credits=$credits, additionalProperties=$additionalProperties}"
    }

    class Pagination @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("seats_available_for_next_page") @ExcludeMissing seatsAvailableForNextPage: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("seats_included") @ExcludeMissing seatsIncluded: JsonField<Double> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun seatsAvailableForNextPage(): Double = seatsAvailableForNextPage.getRequired("seats_available_for_next_page")
         ...
         *
         * Unlike [seatsAvailableForNextPage], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [seatsIncluded], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(pagination: Pagination) =
                apply {
            ...
            /** Number of seats available to fetch in the next page */
            fun seatsAvailableForNextPage(seatsAvailableForNextPage: Double) = seatsAvailableForNextPage(JsonField.of(seatsAvailableForNextPage))

            /**
             * Sets [Builder.seatsAvailableForNextPage] to an arbitrary JSON value.
             *
             * You should usually call [Builder.seatsAvailableForNextPage] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun seatsAvailableForNextPage(seatsAvailableForNextPage: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.seatsIncluded] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun seatsIncluded(seatsIncluded: JsonField<Double>) =
                apply {
            ...
            fun build(): Pagination =
                Pagination(
                  checkRequired(
                    "seatsAvailableForNextPage", seatsAvailableForNextPage
                  ),
                  checkRequired(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (seatsAvailableForNextPage.asKnown().isPresent) 1 else 0) + (if (seatsIncluded.asKnown().isPresent) 1 else 0) + (if (nextPage.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Pagination && seatsAvailableForNextPage == other.seatsAvailableForNextPage && seatsIncluded == other.seatsIncluded && nextPage == other.nextPage && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(seatsAvailableForNextPage, seatsIncluded, nextPage, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Pagination{seatsAvailableForNextPage=$seatsAvailableForNextPage, seatsIncluded=$seatsIncluded, nextPage=$nextPage, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractListSeatBalancesResponse && data == other.data && pagination == other.pagination && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractListSeatBalancesResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
