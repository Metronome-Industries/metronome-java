...
class ProductOrderSetResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductOrderSetResponse].
         *
    ...
    /** A builder for [ProductOrderSetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productOrderSetResponse: ProductOrderSetResponse) =
            apply {
                data = productOrderSetResponse.data
                additionalProperties = productOrderSetResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductOrderSetResponse].
         *
         ...
         */
        fun build(): ProductOrderSetResponse =
     ...
     *   expected type.
     */
    fun validate(): ProductOrderSetResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductOrderSetResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductOrderSetResponse{data=$data, additionalProperties=$additionalProperties}"
}
