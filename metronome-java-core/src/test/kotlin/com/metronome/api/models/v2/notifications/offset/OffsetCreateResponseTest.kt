...
internal class OffsetCreateResponseTest {
    ...
    @Test
    fun create() {
        val offsetCreateResponse =
            OffsetCreateResponse.builder()
                .data(
        ...
        assertThat(offsetCreateResponse.data())
            .isEqualTo(
                LifecycleEventOffsetNotificationConfig.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .archivedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOffsetCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(offsetCreateResponse),
                jacksonTypeRef<OffsetCreateResponse>(),
            )
