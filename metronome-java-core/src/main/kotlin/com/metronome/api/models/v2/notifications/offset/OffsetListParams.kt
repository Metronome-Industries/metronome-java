 ...
 *
 */
class OffsetListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): OffsetListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(offsetListParams: OffsetListParams) =
            apply {
         ...
         *
         * You should usually call [Builder.limit] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun limit(limit: JsonField<Double>) =
            apply {
                body.limit(limit)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonProperty("limit")
        @ExcludeMissing
        fun _limit(): JsonField<Double> = limit
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (archiveFilter.asKnown().getOrNull()?.validity() ?: 0) + (if (cursor.asKnown().isPresent) 1 else 0) + (if (limit.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && archiveFilter == other.archiveFilter && cursor == other.cursor && limit == other.limit && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(archiveFilter, cursor, limit, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{archiveFilter=$archiveFilter, cursor=$cursor, limit=$limit, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OffsetListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "OffsetListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
