...
private constructor(
    ...
    /** A builder for [CustomerCreditUpdateEndDateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = customerCreditUpdateEndDateResponse.data
            additionalProperties =
                customerCreditUpdateEndDateResponse.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerCreditUpdateEndDateResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
