...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        private val statuses: JsonField<List<PaymentStatus>> = JsonMissing.of(),
        @JsonAnySetter
        ...
        fun statuses(): Optional<List<PaymentStatus>> =
            Optional.ofNullable(statuses.getNullable("statuses"))
        ...
        class Builder internal constructor() {
            ...
            fun addStatus(status: PaymentStatus) = apply {
                statuses =
                    (statuses ?: JsonField.of(mutableListOf())).apply {
                        asKnown()
                            .orElseThrow {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && customerId == other.customerId && invoiceId == other.invoiceId && limit == other.limit && nextPage == other.nextPage && statuses == other.statuses && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(customerId, invoiceId, limit, nextPage, statuses, additionalProperties) }
        /* spotless:on */
    ...
    /** A builder for [V1PaymentListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1PaymentListParams: V1PaymentListParams) = apply {
            body = v1PaymentListParams.body.toBuilder()
            additionalHeaders = v1PaymentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1PaymentListParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1PaymentListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1PaymentListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
