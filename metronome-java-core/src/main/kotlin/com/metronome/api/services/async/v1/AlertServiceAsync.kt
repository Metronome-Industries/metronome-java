...
interface AlertServiceAsync {
     ...
     *
     */
    fun create(params: AlertCreateParams): CompletableFuture<AlertCreateResponse> =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: AlertCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AlertCreateResponse>
     ...
     *
     */
    fun archive(params: AlertArchiveParams): CompletableFuture<AlertArchiveResponse> =
        archive(
          params, RequestOptions.none()
        )

    /** @see archive */
    fun archive(params: AlertArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<AlertArchiveResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/alerts/create`, but is otherwise the             same as [AlertServiceAsync.create]. */
        fun create(params: AlertCreateParams): CompletableFuture<HttpResponseFor<AlertCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: AlertCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AlertCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/alerts/archive`, but is otherwise the             same as [AlertServiceAsync.archive]. */
        fun archive(params: AlertArchiveParams): CompletableFuture<HttpResponseFor<AlertArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: AlertArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<AlertArchiveResponse>>
    }
}
