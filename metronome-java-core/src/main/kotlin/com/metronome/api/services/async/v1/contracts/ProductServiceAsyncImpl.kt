...
import com.metronome.api.models.V1ContractProductListPageAsync
...
class ProductServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    ): CompletableFuture<V1ContractProductCreateResponse> {
        val request =
            HttpRequest.builder()
    ...
    override fun retrieve(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1ContractProductRetrieveResponse> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
    ...
    override fun update(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1ContractProductUpdateResponse> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
    ...
    private val listHandler: Handler<V1ContractProductListPageAsync.Response> =
        jsonHandler<V1ContractProductListPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1ContractProductListPageAsync> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1ContractProductListPageAsync.of(this, params, it) }
            }
    }
    ...
    override fun archive(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1ContractProductArchiveResponse> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
