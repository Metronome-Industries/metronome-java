...
internal class ContractServiceAsyncTest {
                ...
                ContractAmendParams.builder()
                    ...
                    .addCommit(
                        ContractAmendParams.Commit.builder()
                            ...
                            .spendTrackerAttributes(
                                ContractAmendParams.Commit.SpendTrackerAttributes.builder()
                                    .countsAsDiscounted(true)
                                    .build()
                            )
                            .temporaryId("temporary_id")
    ...
    fun getNetBalance() {
        ...
        val responseFuture =
            contractServiceAsync.getNetBalance(
    ...
    fun getSubscriptionSeatsHistory() {
        ...
        val responseFuture =
            contractServiceAsync.getSubscriptionSeatsHistory(
    ...
    fun listSeatBalances() {
        ...
        val responseFuture =
            contractServiceAsync.listSeatBalances(
    ...
    fun retrieveSubscriptionQuantityHistory() {
        ...
        val responseFuture =
            contractServiceAsync.retrieveSubscriptionQuantityHistory(
