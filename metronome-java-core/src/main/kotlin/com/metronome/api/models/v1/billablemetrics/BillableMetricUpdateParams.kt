 ...
 * apply standardized naming conventions across all billable metrics. Returns the billable metric ID
 ...
 */
class BillableMetricUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricUpdateParams].
         *
    ...
    /** A builder for [BillableMetricUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricUpdateParams: BillableMetricUpdateParams) = apply {
            billableMetricId = billableMetricUpdateParams.billableMetricId
            body = billableMetricUpdateParams.body.toBuilder()
            additionalHeaders = billableMetricUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = billableMetricUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BillableMetricUpdateParams].
         *
         ...
         */
        fun build(): BillableMetricUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillableMetricUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(billableMetricId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "BillableMetricUpdateParams{billableMetricId=$billableMetricId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
