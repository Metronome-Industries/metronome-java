...
class ServiceListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("services") @ExcludeMissing services: JsonField<List<Service>> = JsonMissing.of()
    ) : this(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serviceListResponse: ServiceListResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.services] with a well-typed `List<Service>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun services(services: JsonField<List<Service>>) =
            apply {
        ...
        fun addService(service: Service) =
            apply {
                services = (services ?: JsonField.of(mutableListOf())).also {
     ...
     *   expected type.
     */
    fun validate(): ServiceListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (services.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)

    class Service @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonProperty("ips")
        @ExcludeMissing
        fun _ips(): JsonField<List<String>> = ips
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(service: Service) =
                apply {
             ...
             *
             * You should usually call [Builder.ips] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun ips(ips: JsonField<List<String>>) =
                apply {
            ...
            fun addIp(ip: String) =
                apply {
                    ips = (ips ?: JsonField.of(mutableListOf())).also {
                        checkKnown("ips", it).add(ip)
                    }
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (ips.asKnown().getOrNull()?.size ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (usage.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Service && ips == other.ips && name == other.name && usage == other.usage && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Service{ips=$ips, name=$name, usage=$usage, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ServiceListResponse && services == other.services && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ServiceListResponse{services=$services, additionalProperties=$additionalProperties}"
}
