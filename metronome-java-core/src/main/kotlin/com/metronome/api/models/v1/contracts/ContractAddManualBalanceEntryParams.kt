 ...
 *
 */
class ContractAddManualBalanceEntryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractAddManualBalanceEntryParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractAddManualBalanceEntryParams: ContractAddManualBalanceEntryParams) =
            apply {
                ...
                additionalQueryParams = contractAddManualBalanceEntryParams.additionalQueryParams.toBuilder()
            }
        ...
        /** ID of the segment to update. */
        fun segmentId(segmentId: String) =
            apply {
         ...
         *
         * You should usually call [Builder.perGroupAmounts] with a well-typed [PerGroupAmounts] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun perGroupAmounts(perGroupAmounts: JsonField<PerGroupAmounts>) =
            apply {
                body.perGroupAmounts(perGroupAmounts)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("per_group_amounts") @ExcludeMissing perGroupAmounts: JsonField<PerGroupAmounts> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun perGroupAmounts(): Optional<PerGroupAmounts> = perGroupAmounts.getOptional("per_group_amounts")
        ...
        class Builder internal constructor() {
            ...
            /** If using individually configured commits/credits attached to seat managed subscriptions, the amount to add for each seat. Must sum to total amount. */
            fun perGroupAmounts(perGroupAmounts: PerGroupAmounts) = perGroupAmounts(JsonField.of(perGroupAmounts))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (amount.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (reason.asKnown().isPresent) 1 else 0) + (if (segmentId.asKnown().isPresent) 1 else 0) + (if (contractId.asKnown().isPresent) 1 else 0) + (perGroupAmounts.asKnown().getOrNull()?.validity() ?: 0) + (if (timestamp.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && id == other.id && amount == other.amount && customerId == other.customerId && reason == other.reason && segmentId == other.segmentId && contractId == other.contractId && perGroupAmounts == other.perGroupAmounts && timestamp == other.timestamp && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{id=$id, amount=$amount, customerId=$customerId, reason=$reason, segmentId=$segmentId, contractId=$contractId, perGroupAmounts=$perGroupAmounts, timestamp=$timestamp, additionalProperties=$additionalProperties}"
    }

    /** If using individually configured commits/credits attached to seat managed subscriptions, the amount to add for each seat. Must sum to total amount. */
    class PerGroupAmounts @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(perGroupAmounts: PerGroupAmounts) =
                apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractAddManualBalanceEntryParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractAddManualBalanceEntryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
