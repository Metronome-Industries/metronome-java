...
class AlertListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CustomerAlert>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CustomerAlert>> = data
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(alertListPageResponse: AlertListPageResponse) =
            apply {
                data = alertListPageResponse.data.map { it.toMutableList() }
                nextPage = alertListPageResponse.nextPage
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CustomerAlert>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CustomerAlert>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [CustomerAlert] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CustomerAlert) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): AlertListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AlertListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "AlertListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
