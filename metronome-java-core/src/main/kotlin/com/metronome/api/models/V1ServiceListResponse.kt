...
private constructor(
    ...
    fun validate(): V1ServiceListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ServiceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ServiceListResponse: V1ServiceListResponse) = apply {
            services = v1ServiceListResponse.services.map { it.toMutableList() }
            additionalProperties = v1ServiceListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ServiceListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ServiceListResponse && services == other.services && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ServiceListResponse{services=$services, additionalProperties=$additionalProperties}"
}
