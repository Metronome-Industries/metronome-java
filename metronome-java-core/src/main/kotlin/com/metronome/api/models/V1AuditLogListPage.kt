 ...
 */
class V1AuditLogListPage
private constructor(
    private val auditLogsService: AuditLogService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1AuditLogListPage && auditLogsService == other.auditLogsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(auditLogsService, params, response) /* spotless:on */

    override fun toString() =
        "V1AuditLogListPage{auditLogsService=$auditLogsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1AuditLogListPage> {
        return getNextPageParams().map { auditLogsService.list(it) }
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1AuditLogListPage(auditLogsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1AuditLogListPage) : Iterable<V1AuditLogListResponse> {

        override fun iterator(): Iterator<V1AuditLogListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<V1AuditLogListResponse> {
