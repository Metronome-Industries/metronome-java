...
class ContractRetrieveParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Optional RFC 3339 timestamp. Return the contract as of this date. Cannot be used with include_ledgers parameter. */
        fun asOfDate(asOfDate: OffsetDateTime) =
            apply {
         ...
         *
         * You should usually call [Builder.asOfDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun asOfDate(asOfDate: JsonField<OffsetDateTime>) =
            apply {
                body.asOfDate(asOfDate)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private val asOfDate: JsonField<OffsetDateTime>,
        ...
        private constructor(
            ...
            @JsonProperty("as_of_date") @ExcludeMissing asOfDate: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun asOfDate(): Optional<OffsetDateTime> = asOfDate.getOptional("as_of_date")
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (asOfDate.asKnown().isPresent) 1 else 0) + (if (includeBalance.asKnown().isPresent) 1 else 0) + (if (includeLedgers.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && asOfDate == other.asOfDate && includeBalance == other.includeBalance && includeLedgers == other.includeLedgers && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, asOfDate=$asOfDate, includeBalance=$includeBalance, includeLedgers=$includeLedgers, additionalProperties=$additionalProperties}"
    }
