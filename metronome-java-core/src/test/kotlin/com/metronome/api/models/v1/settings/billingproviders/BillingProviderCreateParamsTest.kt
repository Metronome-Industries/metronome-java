...
internal class BillingProviderCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = BillingProviderCreateParams.builder()
          .billingProvider(BillingProviderCreateParams.BillingProvider.AWS_MARKETPLACE)
          .configuration(BillingProviderCreateParams.Configuration.builder()
              .putAdditionalProperty("aws_external_id", JsonValue.from("bar"))
              .putAdditionalProperty("aws_iam_role_arn", JsonValue.from("bar"))
      ...
      assertThat(body.billingProvider()).isEqualTo(BillingProviderCreateParams.BillingProvider.AWS_MARKETPLACE)
      assertThat(body.configuration()).isEqualTo(BillingProviderCreateParams.Configuration.builder()
          .putAdditionalProperty("aws_external_id", JsonValue.from("bar"))
          .putAdditionalProperty("aws_iam_role_arn", JsonValue.from("bar"))
          .build())
      assertThat(body.deliveryMethod()).isEqualTo(BillingProviderCreateParams.DeliveryMethod.DIRECT_TO_BILLING_PROVIDER)
    }
}
