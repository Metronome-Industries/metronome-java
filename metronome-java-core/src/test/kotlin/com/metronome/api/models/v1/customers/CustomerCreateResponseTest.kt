...
internal class CustomerCreateResponseTest {
    ...
    @Test
    fun create() {
      val customerCreateResponse = CustomerCreateResponse.builder()
      ...
      assertThat(customerCreateResponse.data()).isEqualTo(Customer.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .externalId("external_id")
          .addIngestAlias("string")
          .name("name")
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerCreateResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(customerCreateResponse), jacksonTypeRef<CustomerCreateResponse>())
