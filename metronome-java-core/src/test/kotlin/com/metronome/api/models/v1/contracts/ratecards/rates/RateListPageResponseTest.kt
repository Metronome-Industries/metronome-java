...
internal class RateListPageResponseTest {
    ...
    @Test
    fun create() {
      val rateListPageResponse = RateListPageResponse.builder()
          .addData(RateListResponse.builder()
              .entitled(true)
      ...
      assertThat(rateListPageResponse.data()).containsExactly(RateListResponse.builder()
          .entitled(true)
          .productCustomFields(RateListResponse.ProductCustomFields.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedRateListPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(rateListPageResponse), jacksonTypeRef<RateListPageResponse>())
