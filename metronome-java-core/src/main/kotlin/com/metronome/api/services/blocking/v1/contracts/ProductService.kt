...
interface ProductService {
    ...
    /** @see create */
    fun create(params: ProductCreateParams, requestOptions: RequestOptions = RequestOptions.none()): ProductCreateResponse
    ...
    /** @see retrieve */
    fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): ProductRetrieveResponse

    /** @see retrieve */
    fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): ProductRetrieveResponse =
        retrieve(
    ...
    /** @see retrieve */
    fun retrieve(id: Id): ProductRetrieveResponse =
        retrieve(
    ...
    /** @see update */
    fun update(params: ProductUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): ProductUpdateResponse
    ...
    /** @see archive */
    fun archive(params: ProductArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): ProductArchiveResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/create`, but is otherwise the             same as [ProductService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: ProductCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ProductCreateResponse>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/get`, but is otherwise the             same as [ProductService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ProductRetrieveResponse>

        /** @see retrieve */
        @MustBeClosed
        fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ProductRetrieveResponse> =
            retrieve(
              ProductRetrieveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/update`, but is otherwise the             same as [ProductService.update]. */
        @MustBeClosed
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: ProductUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ProductUpdateResponse>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/list`, but is otherwise the             same as [ProductService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/archive`, but is otherwise the             same as [ProductService.archive]. */
        @MustBeClosed
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: ProductArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ProductArchiveResponse>
    }
}
