 ...
 */
class V1ContractNamedScheduleRetrieveParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && rateCardId == other.rateCardId && scheduleName == other.scheduleName && coveringDate == other.coveringDate && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() =
            "Body{rateCardId=$rateCardId, scheduleName=$scheduleName, coveringDate=$coveringDate, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [V1ContractNamedScheduleRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractNamedScheduleRetrieveParams: V1ContractNamedScheduleRetrieveParams
        ) = apply {
            body = v1ContractNamedScheduleRetrieveParams.body.toBuilder()
            additionalHeaders = v1ContractNamedScheduleRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractNamedScheduleRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractNamedScheduleRetrieveParams =
            V1ContractNamedScheduleRetrieveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractNamedScheduleRetrieveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractNamedScheduleRetrieveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
