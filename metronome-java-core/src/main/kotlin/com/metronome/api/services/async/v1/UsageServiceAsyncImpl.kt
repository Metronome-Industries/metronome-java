...
class UsageServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : UsageServiceAsync {

    private val withRawResponse: UsageServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): UsageServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageServiceAsync = UsageServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: UsageListParams, requestOptions: RequestOptions): CompletableFuture<UsageListPageAsync> =
        // post /v1/usage
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun ingest(params: UsageIngestParams, requestOptions: RequestOptions): CompletableFuture<Void?> =
        // post /v1/ingest
        withRawResponse().ingest(params, requestOptions).thenAccept {}

    override fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions): CompletableFuture<UsageListWithGroupsPageAsync> =
        // post /v1/usage/groups
        withRawResponse().listWithGroups(params, requestOptions).thenApply { it.parse() }

    override fun search(params: UsageSearchParams, requestOptions: RequestOptions): CompletableFuture<List<UsageSearchResponse>> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): UsageServiceAsync.WithRawResponse = UsageServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val listHandler: Handler<UsageListPageResponse> = jsonHandler<UsageListPageResponse>(clientOptions.jsonMapper)

        override fun list(params: UsageListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UsageListPageAsync>> {
        ...
        override fun ingest(params: UsageIngestParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listWithGroups(params: UsageListWithGroupsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UsageListWithGroupsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun search(params: UsageSearchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<List<UsageSearchResponse>>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
