...
@NoAutoDetect
class V1PlanListChargesResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1PlanListChargesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1PlanListChargesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1PlanListChargesResponse: V1PlanListChargesResponse) = apply {
            id = v1PlanListChargesResponse.id
            chargeType = v1PlanListChargesResponse.chargeType
            creditType = v1PlanListChargesResponse.creditType
            customFields = v1PlanListChargesResponse.customFields
            name = v1PlanListChargesResponse.name
            prices = v1PlanListChargesResponse.prices.map { it.toMutableList() }
            productId = v1PlanListChargesResponse.productId
            productName = v1PlanListChargesResponse.productName
            quantity = v1PlanListChargesResponse.quantity
            startPeriod = v1PlanListChargesResponse.startPeriod
            tierResetFrequency = v1PlanListChargesResponse.tierResetFrequency
            unitConversion = v1PlanListChargesResponse.unitConversion
            additionalProperties = v1PlanListChargesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1PlanListChargesResponse =
    ...
    override fun toString() =
        "V1PlanListChargesResponse{id=$id, chargeType=$chargeType, creditType=$creditType, customFields=$customFields, name=$name, prices=$prices, productId=$productId, productName=$productName, quantity=$quantity, startPeriod=$startPeriod, tierResetFrequency=$tierResetFrequency, unitConversion=$unitConversion, additionalProperties=$additionalProperties}"
}
