 ...
 */
class V1BillableMetricListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1BillableMetricListParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1BillableMetricListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1BillableMetricListParams: V1BillableMetricListParams) = apply {
            includeArchived = v1BillableMetricListParams.includeArchived
            limit = v1BillableMetricListParams.limit
            nextPage = v1BillableMetricListParams.nextPage
            additionalHeaders = v1BillableMetricListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1BillableMetricListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1BillableMetricListParams =
            V1BillableMetricListParams(
                includeArchived,
                limit,
                nextPage,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1BillableMetricListParams && includeArchived == other.includeArchived && limit == other.limit && nextPage == other.nextPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1BillableMetricListParams{includeArchived=$includeArchived, limit=$limit, nextPage=$nextPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
