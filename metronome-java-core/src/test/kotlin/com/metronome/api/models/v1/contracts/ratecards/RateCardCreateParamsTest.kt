...
internal class RateCardCreateParamsTest {
    ...
    @Test
    fun body() {
      val params = RateCardCreateParams.builder()
          .name("My Rate Card")
          .addAlias(RateCardCreateParams.Alias.builder()
              .name("my-rate-card")
              .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(body.aliases().getOrNull()).containsExactly(RateCardCreateParams.Alias.builder()
          .name("my-rate-card")
          .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .startingAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(body.creditTypeConversions().getOrNull()).containsExactly(RateCardCreateParams.CreditTypeConversion.builder()
          .customCreditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
          .fiatPerCustomCredit(2.0)
          .build())
      assertThat(body.customFields()).contains(RateCardCreateParams.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
