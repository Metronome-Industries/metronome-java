...
class RolloverAmountMaxPercentage @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RolloverAmountMaxPercentage].
         *
    ...
    /** A builder for [RolloverAmountMaxPercentage]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RolloverAmountMaxPercentage].
         *
     ...
     *   expected type.
     */
    fun validate(): RolloverAmountMaxPercentage =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RolloverAmountMaxPercentage && type == other.type && value == other.value && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RolloverAmountMaxPercentage{type=$type, value=$value, additionalProperties=$additionalProperties}"
}
