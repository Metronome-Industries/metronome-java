...
internal class UsageListWithGroupsParamsTest {
    ...
    fun create() {
      UsageListWithGroupsParams.builder()
          ...
          .groupBy(UsageListWithGroupsParams.GroupBy.builder()
              .key("key")
              .addValue("x")
              .build())
          .groupFilters(UsageListWithGroupsParams.GroupFilters.builder()
              .putAdditionalProperty("region", JsonValue.from(listOf(
                "us-east1", "us-west1"
              )))
              .build())
          .addGroupKey("region")
    ...
    @Test
    fun queryParams() {
      val params = UsageListWithGroupsParams.builder()
          .limit(1L)
          .nextPage("next_page")
          .billableMetricId("222796fd-d29c-429e-89b2-549fabda4ed6")
          .customerId("04ca7e72-4229-4a6e-ab11-9f7376fccbcb")
    ...
    fun body() {
      ...
      assertThat(body.groupBy()).contains(UsageListWithGroupsParams.GroupBy.builder()
          .key("key")
          .addValue("x")
          .build())
      assertThat(body.groupFilters()).contains(UsageListWithGroupsParams.GroupFilters.builder()
          .putAdditionalProperty("region", JsonValue.from(listOf(
            "us-east1", "us-west1"
          )))
          .build())
