...
interface NamedScheduleService {
    ...
    /** @see retrieve */
    fun retrieve(params: NamedScheduleRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): NamedScheduleRetrieveResponse

    /** Update a named schedule for the given rate card. This endpoint's availability is dependent on your client's configuration. */
    fun update(params: NamedScheduleUpdateParams) =
        update(
          params, RequestOptions.none()
        )

    /** @see update */
    fun update(params: NamedScheduleUpdateParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): NamedScheduleService.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/getNamedSchedule`, but is otherwise the             same as [NamedScheduleService.retrieve]. */
        @MustBeClosed
        fun retrieve(params: NamedScheduleRetrieveParams): HttpResponseFor<NamedScheduleRetrieveResponse> =
            retrieve(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: NamedScheduleRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<NamedScheduleRetrieveResponse>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/updateNamedSchedule`, but is otherwise the             same as [NamedScheduleService.update]. */
        @MustBeClosed
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: NamedScheduleUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
