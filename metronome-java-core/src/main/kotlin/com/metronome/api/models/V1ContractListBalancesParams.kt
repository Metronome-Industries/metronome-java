 ...
 */
class V1ContractListBalancesParams
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        private val excludeZeroBalances: JsonField<Boolean> = JsonMissing.of(),
        ...
        fun excludeZeroBalances(): Optional<Boolean> =
            Optional.ofNullable(excludeZeroBalances.getNullable("exclude_zero_balances"))
    ...
    /** A builder for [V1ContractListBalancesParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractListBalancesParams: V1ContractListBalancesParams) = apply {
            body = v1ContractListBalancesParams.body.toBuilder()
            additionalHeaders = v1ContractListBalancesParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractListBalancesParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractListBalancesParams =
            V1ContractListBalancesParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractListBalancesParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractListBalancesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
