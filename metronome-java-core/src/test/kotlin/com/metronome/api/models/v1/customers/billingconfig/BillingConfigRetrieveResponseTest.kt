...
internal class BillingConfigRetrieveResponseTest {
    ...
    @Test
    fun create() {
      val billingConfigRetrieveResponse = BillingConfigRetrieveResponse.builder()
          .data(BillingConfigRetrieveResponse.Data.builder()
              ...
              .azureSubscriptionStatus(BillingConfigRetrieveResponse.Data.AzureSubscriptionStatus.SUBSCRIBED)
              .billingProviderCustomerId("billing_provider_customer_id")
              .stripeCollectionMethod(BillingConfigRetrieveResponse.Data.StripeCollectionMethod.CHARGE_AUTOMATICALLY)
              .build())
          .build()

      assertThat(billingConfigRetrieveResponse.data()).isEqualTo(BillingConfigRetrieveResponse.Data.builder()
          .awsCustomerAccountId("aws_customer_account_id")
          .awsCustomerId("aws_customer_id")
          .awsExpirationDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .awsIsSubscriptionProduct(true)
    ...
    fun roundtrip() {
      ...
      val roundtrippedBillingConfigRetrieveResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(billingConfigRetrieveResponse), jacksonTypeRef<BillingConfigRetrieveResponse>())

      assertThat(roundtrippedBillingConfigRetrieveResponse).isEqualTo(billingConfigRetrieveResponse)
    }
}
