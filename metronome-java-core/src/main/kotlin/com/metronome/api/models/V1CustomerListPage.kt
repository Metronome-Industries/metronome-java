...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerListPage && customersService == other.customersService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(customersService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerListPage{customersService=$customersService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1CustomerListPage> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1CustomerListPage(customersService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerListPage) : Iterable<CustomerDetail> {
