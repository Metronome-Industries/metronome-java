 ...
 */
class V1CustomerRetrieveBillingConfigurationsParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && customerId == other.customerId && includeArchived == other.includeArchived && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1CustomerRetrieveBillingConfigurationsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerRetrieveBillingConfigurationsParams:
                V1CustomerRetrieveBillingConfigurationsParams
        ) = apply {
            body = v1CustomerRetrieveBillingConfigurationsParams.body.toBuilder()
            additionalHeaders =
                v1CustomerRetrieveBillingConfigurationsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerRetrieveBillingConfigurationsParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerRetrieveBillingConfigurationsParams =
            V1CustomerRetrieveBillingConfigurationsParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerRetrieveBillingConfigurationsParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerRetrieveBillingConfigurationsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
