...
@NoAutoDetect
class V1ContractRateCardListResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1ContractRateCardListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractRateCardListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardListResponse: V1ContractRateCardListResponse) = apply {
            id = v1ContractRateCardListResponse.id
            createdAt = v1ContractRateCardListResponse.createdAt
            createdBy = v1ContractRateCardListResponse.createdBy
            name = v1ContractRateCardListResponse.name
            aliases = v1ContractRateCardListResponse.aliases.map { it.toMutableList() }
            creditTypeConversions =
                v1ContractRateCardListResponse.creditTypeConversions.map { it.toMutableList() }
            customFields = v1ContractRateCardListResponse.customFields
            description = v1ContractRateCardListResponse.description
            fiatCreditType = v1ContractRateCardListResponse.fiatCreditType
            additionalProperties =
                v1ContractRateCardListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ContractRateCardListResponse =
    ...
    override fun toString() =
        "V1ContractRateCardListResponse{id=$id, createdAt=$createdAt, createdBy=$createdBy, name=$name, aliases=$aliases, creditTypeConversions=$creditTypeConversions, customFields=$customFields, description=$description, fiatCreditType=$fiatCreditType, additionalProperties=$additionalProperties}"
}
