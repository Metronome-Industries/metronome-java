 ...
 *
 */
class CreditListParams private constructor(
     ...
     *
     * Unlike [includeContractCredits], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditListParams: CreditListParams) =
            apply {
         ...
         *
         * You should usually call [Builder.includeContractCredits] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun includeContractCredits(includeContractCredits: JsonField<Boolean>) =
            apply {
                body.includeContractCredits(includeContractCredits)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("include_contract_credits") @ExcludeMissing includeContractCredits: JsonField<Boolean> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun includeContractCredits(): Optional<Boolean> = includeContractCredits.getOptional("include_contract_credits")
        ...
        class Builder internal constructor() {
            ...
            /** Include credits on the contract level. */
            fun includeContractCredits(includeContractCredits: Boolean) = includeContractCredits(JsonField.of(includeContractCredits))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (customerId.asKnown().isPresent) 1 else 0) + (if (coveringDate.asKnown().isPresent) 1 else 0) + (if (creditId.asKnown().isPresent) 1 else 0) + (if (effectiveBefore.asKnown().isPresent) 1 else 0) + (if (includeArchived.asKnown().isPresent) 1 else 0) + (if (includeBalance.asKnown().isPresent) 1 else 0) + (if (includeContractCredits.asKnown().isPresent) 1 else 0) + (if (includeLedgers.asKnown().isPresent) 1 else 0) + (if (limit.asKnown().isPresent) 1 else 0) + (if (nextPage.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && customerId == other.customerId && coveringDate == other.coveringDate && creditId == other.creditId && effectiveBefore == other.effectiveBefore && includeArchived == other.includeArchived && includeBalance == other.includeBalance && includeContractCredits == other.includeContractCredits && includeLedgers == other.includeLedgers && limit == other.limit && nextPage == other.nextPage && startingAt == other.startingAt && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{customerId=$customerId, coveringDate=$coveringDate, creditId=$creditId, effectiveBefore=$effectiveBefore, includeArchived=$includeArchived, includeBalance=$includeBalance, includeContractCredits=$includeContractCredits, includeLedgers=$includeLedgers, limit=$limit, nextPage=$nextPage, startingAt=$startingAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
