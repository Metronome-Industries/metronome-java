...
interface AuditLogService {
    ...
    /** @see list */
    fun list(params: AuditLogListParams = AuditLogListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AuditLogListPage
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `get /v1/auditLogs`, but is otherwise the             same as [AuditLogService.list]. */
        @MustBeClosed
        fun list(): HttpResponseFor<AuditLogListPage> = list(AuditLogListParams.none())

        /** @see list */
        @MustBeClosed
        fun list(params: AuditLogListParams = AuditLogListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AuditLogListPage>

        /** @see list */
        @MustBeClosed
        fun list(params: AuditLogListParams = AuditLogListParams.none()): HttpResponseFor<AuditLogListPage> =
            list(
              params, RequestOptions.none()
            )
