...
internal class QuantityConversionTest {
    ...
    @Test
    fun create() {
      val quantityConversion = QuantityConversion.builder()
    ...
    fun roundtrip() {
      ...
      val roundtrippedQuantityConversion = jsonMapper.readValue(jsonMapper.writeValueAsString(quantityConversion), jacksonTypeRef<QuantityConversion>())
