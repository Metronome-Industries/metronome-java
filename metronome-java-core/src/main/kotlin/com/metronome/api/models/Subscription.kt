...
class Subscription @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("billing_periods") @ExcludeMissing billingPeriods: JsonField<BillingPeriods> = JsonMissing.of(),
        @JsonProperty("collection_schedule") @ExcludeMissing collectionSchedule: JsonField<CollectionSchedule> = JsonMissing.of(),
        @JsonProperty("proration") @ExcludeMissing proration: JsonField<Proration> = JsonMissing.of(),
        @JsonProperty("quantity_management_mode") @ExcludeMissing quantityManagementMode: JsonField<QuantityManagementMode> = JsonMissing.of(),
        @JsonProperty("quantity_schedule") @ExcludeMissing quantitySchedule: JsonField<List<QuantitySchedule>> = JsonMissing.of(),
        @JsonProperty("starting_at") @ExcludeMissing startingAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("subscription_rate") @ExcludeMissing subscriptionRate: JsonField<SubscriptionRate> = JsonMissing.of(),
        @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
        @JsonProperty("billing_cycle_config") @ExcludeMissing billingCycleConfig: JsonField<BillingCycleConfig> = JsonMissing.of(),
        ...
        @JsonProperty("fiat_credit_type_id") @ExcludeMissing fiatCreditTypeId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        @JsonProperty("seat_config") @ExcludeMissing seatConfig: JsonField<SeatConfig> = JsonMissing.of()
    ) : this(
      billingPeriods,
      collectionSchedule,
      proration,
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
    fun collectionSchedule(): CollectionSchedule = collectionSchedule.getRequired("collection_schedule")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun quantityManagementMode(): QuantityManagementMode = quantityManagementMode.getRequired("quantity_management_mode")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun quantitySchedule(): List<QuantitySchedule> = quantitySchedule.getRequired("quantity_schedule")
    ...
    /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
    fun billingCycleConfig(): Optional<BillingCycleConfig> = billingCycleConfig.getOptional("billing_cycle_config")
     ...
     *
     * Unlike [collectionSchedule], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [quantityManagementMode], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [quantitySchedule], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [subscriptionRate], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [billingCycleConfig], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [fiatCreditTypeId], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        /** Previous, current, and next billing periods for the subscription. */
        fun billingPeriods(billingPeriods: BillingPeriods) = billingPeriods(JsonField.of(billingPeriods))

        /**
         * Sets [Builder.billingPeriods] to an arbitrary JSON value.
         *
         * You should usually call [Builder.billingPeriods] with a well-typed [BillingPeriods] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun billingPeriods(billingPeriods: JsonField<BillingPeriods>) =
            apply {
                this.billingPeriods = billingPeriods
            }

        fun collectionSchedule(collectionSchedule: CollectionSchedule) = collectionSchedule(JsonField.of(collectionSchedule))

        /**
         * Sets [Builder.collectionSchedule] to an arbitrary JSON value.
         *
         * You should usually call [Builder.collectionSchedule] with a well-typed [CollectionSchedule] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun collectionSchedule(collectionSchedule: JsonField<CollectionSchedule>) =
            apply {
        ...
        /** Determines how the subscription's quantity is controlled. Defaults to QUANTITY_ONLY. **QUANTITY_ONLY**: The subscription quantity is specified directly on the subscription. `initial_quantity` must be provided with this option. Compatible with recurring commits/credits that use POOLED allocation. **SEAT_BASED**: Use when you want to pass specific seat identifiers (e.g. add user_123) to increment and decrement a subscription quantity, rather than directly providing the quantity. You must use a **SEAT_BASED** subscription to use a linked recurring credit with an allocation per seat. `seat_config` must be provided with this option. */
        fun quantityManagementMode(quantityManagementMode: QuantityManagementMode) = quantityManagementMode(JsonField.of(quantityManagementMode))

        /**
         * Sets [Builder.quantityManagementMode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.quantityManagementMode] with a well-typed [QuantityManagementMode] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** List of quantity schedule items for the subscription. Only includes the current quantity and future quantity changes. */
        fun quantitySchedule(quantitySchedule: List<QuantitySchedule>) = quantitySchedule(JsonField.of(quantitySchedule))

        /**
         * Sets [Builder.quantitySchedule] to an arbitrary JSON value.
         *
         * You should usually call [Builder.quantitySchedule] with a well-typed `List<QuantitySchedule>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun quantitySchedule(quantitySchedule: JsonField<List<QuantitySchedule>>) =
            apply {
         ...
         */
        fun addQuantitySchedule(quantitySchedule: QuantitySchedule) =
            apply {
                this.quantitySchedule = (this.quantitySchedule ?: JsonField.of(mutableListOf())).also {
        ...
        fun subscriptionRate(subscriptionRate: SubscriptionRate) = subscriptionRate(JsonField.of(subscriptionRate))

        /**
         * Sets [Builder.subscriptionRate] to an arbitrary JSON value.
         *
         * You should usually call [Builder.subscriptionRate] with a well-typed [SubscriptionRate] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun subscriptionRate(subscriptionRate: JsonField<SubscriptionRate>) =
            apply {
        ...
        fun billingCycleConfig(billingCycleConfig: BillingCycleConfig) = billingCycleConfig(JsonField.of(billingCycleConfig))

        /**
         * Sets [Builder.billingCycleConfig] to an arbitrary JSON value.
         *
         * You should usually call [Builder.billingCycleConfig] with a well-typed [BillingCycleConfig] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun billingCycleConfig(billingCycleConfig: JsonField<BillingCycleConfig>) =
            apply {
        ...
        fun fiatCreditTypeId(fiatCreditTypeId: String) = fiatCreditTypeId(JsonField.of(fiatCreditTypeId))

        /**
         * Sets [Builder.fiatCreditTypeId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.fiatCreditTypeId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun fiatCreditTypeId(fiatCreditTypeId: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.seatConfig] with a well-typed [SeatConfig] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun seatConfig(seatConfig: JsonField<SeatConfig>) =
            apply {
        ...
        fun build(): Subscription =
            Subscription(
              ...
              checkRequired(
                "quantityManagementMode", quantityManagementMode
              ),
              checkRequired(
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (billingPeriods.asKnown().getOrNull()?.validity() ?: 0) + (collectionSchedule.asKnown().getOrNull()?.validity() ?: 0) + (proration.asKnown().getOrNull()?.validity() ?: 0) + (quantityManagementMode.asKnown().getOrNull()?.validity() ?: 0) + (quantitySchedule.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (subscriptionRate.asKnown().getOrNull()?.validity() ?: 0) + (if (id.asKnown().isPresent) 1 else 0) + (billingCycleConfig.asKnown().getOrNull()?.validity() ?: 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (fiatCreditTypeId.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (seatConfig.asKnown().getOrNull()?.validity() ?: 0)

    /** Previous, current, and next billing periods for the subscription. */
    class BillingPeriods @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("previous") @ExcludeMissing previous: JsonField<Previous> = JsonMissing.of()
        ) : this(
          current,
          next,
          previous,
        ...
        @ExcludeMissing
        fun _current(): JsonField<Current> = current
        ...
        @ExcludeMissing
        fun _previous(): JsonField<Previous> = previous
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(billingPeriods: BillingPeriods) =
                apply {
             ...
             *
             * You should usually call [Builder.current] with a well-typed [Current] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun current(current: JsonField<Current>) =
                apply {
             ...
             *
             * You should usually call [Builder.next] with a well-typed [Next] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun next(next: JsonField<Next>) =
                apply {
                    this.next = next
                }
             ...
             *
             * You should usually call [Builder.previous] with a well-typed [Previous] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun previous(previous: JsonField<Previous>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (current.asKnown().getOrNull()?.validity() ?: 0) + (next.asKnown().getOrNull()?.validity() ?: 0) + (previous.asKnown().getOrNull()?.validity() ?: 0)

        class Current @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val endingBefore: JsonField<OffsetDateTime>,
            private val startingAt: JsonField<OffsetDateTime>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(current: Current) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Current && endingBefore == other.endingBefore && startingAt == other.startingAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Current{endingBefore=$endingBefore, startingAt=$startingAt, additionalProperties=$additionalProperties}"
        }

        class Next @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val endingBefore: JsonField<OffsetDateTime>,
            private val startingAt: JsonField<OffsetDateTime>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Next && endingBefore == other.endingBefore && startingAt == other.startingAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Next{endingBefore=$endingBefore, startingAt=$startingAt, additionalProperties=$additionalProperties}"
        }

        class Previous @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val endingBefore: JsonField<OffsetDateTime>,
            private val startingAt: JsonField<OffsetDateTime>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(previous: Previous) =
                    apply {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Previous && endingBefore == other.endingBefore && startingAt == other.startingAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Previous{endingBefore=$endingBefore, startingAt=$startingAt, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is BillingPeriods && current == other.current && next == other.next && previous == other.previous && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "BillingPeriods{current=$current, next=$next, previous=$previous, additionalProperties=$additionalProperties}"
    }

    class CollectionSchedule @JsonCreator private constructor(
        ...
        enum class Value {
            ADVANCE,
            ARREARS,
            /** An enum member indicating that [CollectionSchedule] was instantiated with an unknown value. */
            _UNKNOWN,
        }
         ...
         *   expected type.
         */
        fun validate(): CollectionSchedule =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    class Proration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("invoice_behavior") @ExcludeMissing invoiceBehavior: JsonField<InvoiceBehavior> = JsonMissing.of(),
         ...
         *
         * Unlike [invoiceBehavior], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        @ExcludeMissing
        fun _rounding(): JsonField<Rounding> = rounding
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(proration: Proration) =
                apply {
            ...
            fun invoiceBehavior(invoiceBehavior: InvoiceBehavior) = invoiceBehavior(JsonField.of(invoiceBehavior))

            /**
             * Sets [Builder.invoiceBehavior] to an arbitrary JSON value.
             *
             * You should usually call [Builder.invoiceBehavior] with a well-typed [InvoiceBehavior] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun invoiceBehavior(invoiceBehavior: JsonField<InvoiceBehavior>) =
                apply {
             ...
             *
             * You should usually call [Builder.rounding] with a well-typed [Rounding] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun rounding(rounding: JsonField<Rounding>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (invoiceBehavior.asKnown().getOrNull()?.validity() ?: 0) + (if (isProrated.asKnown().isPresent) 1 else 0) + (rounding.asKnown().getOrNull()?.validity() ?: 0)

        class InvoiceBehavior @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            enum class Value {
                BILL_IMMEDIATELY,
                BILL_ON_NEXT_COLLECTION_DATE,
                /** An enum member indicating that [InvoiceBehavior] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        class Rounding @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(rounding: Rounding) =
                    apply {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Rounding && decimalPlaces == other.decimalPlaces && roundingMethod == other.roundingMethod && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "Rounding{decimalPlaces=$decimalPlaces, roundingMethod=$roundingMethod, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Proration && invoiceBehavior == other.invoiceBehavior && isProrated == other.isProrated && rounding == other.rounding && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(invoiceBehavior, isProrated, rounding, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Proration{invoiceBehavior=$invoiceBehavior, isProrated=$isProrated, rounding=$rounding, additionalProperties=$additionalProperties}"
    }

    /** Determines how the subscription's quantity is controlled. Defaults to QUANTITY_ONLY. **QUANTITY_ONLY**: The subscription quantity is specified directly on the subscription. `initial_quantity` must be provided with this option. Compatible with recurring commits/credits that use POOLED allocation. **SEAT_BASED**: Use when you want to pass specific seat identifiers (e.g. add user_123) to increment and decrement a subscription quantity, rather than directly providing the quantity. You must use a **SEAT_BASED** subscription to use a linked recurring credit with an allocation per seat. `seat_config` must be provided with this option. */
    class QuantityManagementMode @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        /**
         * An enum containing [QuantityManagementMode]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [QuantityManagementMode] can contain an unknown value in a couple of cases:
         *
         * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
         *   an older version than the API, then the API may respond with new members that the SDK is unaware
         *   of.
        ...
        enum class Value {
            SEAT_BASED,
            QUANTITY_ONLY,
            /** An enum member indicating that [QuantityManagementMode] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw MetronomeInvalidDataException("Unknown QuantityManagementMode: $value")
            }
         ...
         *   expected type.
         */
        fun validate(): QuantityManagementMode =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    class QuantitySchedule @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(quantitySchedule: QuantitySchedule) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (quantity.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is QuantitySchedule && quantity == other.quantity && startingAt == other.startingAt && endingBefore == other.endingBefore && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "QuantitySchedule{quantity=$quantity, startingAt=$startingAt, endingBefore=$endingBefore, additionalProperties=$additionalProperties}"
    }

    class SubscriptionRate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(subscriptionRate: SubscriptionRate) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (billingFrequency.asKnown().getOrNull()?.validity() ?: 0) + (product.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is SubscriptionRate && billingFrequency == other.billingFrequency && product == other.product && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "SubscriptionRate{billingFrequency=$billingFrequency, product=$product, additionalProperties=$additionalProperties}"
    }

    class BillingCycleConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("anchor_date") @ExcludeMissing anchorDate: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("invoice_placement") @ExcludeMissing invoicePlacement: JsonField<InvoicePlacement> = JsonMissing.of()
        ) : this(
          anchorDate,
          invoicePlacement,
          mutableMapOf(),
         ...
         *
         * Unlike [invoicePlacement], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(billingCycleConfig: BillingCycleConfig) =
                apply {
             ...
             *
             * You should usually call [Builder.anchorDate] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun anchorDate(anchorDate: JsonField<OffsetDateTime>) =
                apply {
                    this.anchorDate = anchorDate
                }

            /** Controls whether this subscription consolidates onto usage invoices or gets its own scheduled invoice. */
            fun invoicePlacement(invoicePlacement: InvoicePlacement) = invoicePlacement(JsonField.of(invoicePlacement))

            /**
             * Sets [Builder.invoicePlacement] to an arbitrary JSON value.
             *
             * You should usually call [Builder.invoicePlacement] with a well-typed [InvoicePlacement] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun invoicePlacement(invoicePlacement: JsonField<InvoicePlacement>) =
                apply {
            ...
            fun build(): BillingCycleConfig =
                BillingCycleConfig(
                  ...
                  checkRequired(
                    "invoicePlacement", invoicePlacement
                  ),
                  additionalProperties.toMutableMap(),
                )
        }
         ...
         *   expected type.
         */
        fun validate(): BillingCycleConfig =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (anchorDate.asKnown().isPresent) 1 else 0) + (invoicePlacement.asKnown().getOrNull()?.validity() ?: 0)

        /** Controls whether this subscription consolidates onto usage invoices or gets its own scheduled invoice. */
        class InvoicePlacement @JsonCreator private constructor(
            private val value: JsonField<String>,
            ...
            /**
             * An enum containing [InvoicePlacement]'s known values, as well as an [_UNKNOWN] member.
             *
            ...
            enum class Value {
                ON_SCHEDULED_INVOICE,
                ON_USAGE_INVOICE,
                /** An enum member indicating that [InvoicePlacement] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is BillingCycleConfig && anchorDate == other.anchorDate && invoicePlacement == other.invoicePlacement && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(anchorDate, invoicePlacement, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "BillingCycleConfig{anchorDate=$anchorDate, invoicePlacement=$invoicePlacement, additionalProperties=$additionalProperties}"
    }
    ...
    class SeatConfig @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("seat_group_key") @ExcludeMissing seatGroupKey: JsonField<String> = JsonMissing.of()
        ) : this(
          seatGroupKey, mutableMapOf()
        )
         ...
         *
         * Unlike [seatGroupKey], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(seatConfig: SeatConfig) =
                apply {
             ...
             *
             * You should usually call [Builder.seatGroupKey] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun seatGroupKey(seatGroupKey: JsonField<String>) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is SeatConfig && seatGroupKey == other.seatGroupKey && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "SeatConfig{seatGroupKey=$seatGroupKey, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is Subscription && billingPeriods == other.billingPeriods && collectionSchedule == other.collectionSchedule && proration == other.proration && quantityManagementMode == other.quantityManagementMode && quantitySchedule == other.quantitySchedule && startingAt == other.startingAt && subscriptionRate == other.subscriptionRate && id == other.id && billingCycleConfig == other.billingCycleConfig && customFields == other.customFields && description == other.description && endingBefore == other.endingBefore && fiatCreditTypeId == other.fiatCreditTypeId && name == other.name && seatConfig == other.seatConfig && additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(billingPeriods, collectionSchedule, proration, quantityManagementMode, quantitySchedule, startingAt, subscriptionRate, id, billingCycleConfig, customFields, description, endingBefore, fiatCreditTypeId, name, seatConfig, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() = "Subscription{billingPeriods=$billingPeriods, collectionSchedule=$collectionSchedule, proration=$proration, quantityManagementMode=$quantityManagementMode, quantitySchedule=$quantitySchedule, startingAt=$startingAt, subscriptionRate=$subscriptionRate, id=$id, billingCycleConfig=$billingCycleConfig, customFields=$customFields, description=$description, endingBefore=$endingBefore, fiatCreditTypeId=$fiatCreditTypeId, name=$name, seatConfig=$seatConfig, additionalProperties=$additionalProperties}"
}
