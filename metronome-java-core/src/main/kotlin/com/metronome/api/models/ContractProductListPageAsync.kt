...
/** List products */
class ContractProductListPageAsync
private constructor(
    ...
    fun getNextPage(): CompletableFuture<Optional<ContractProductListPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = ContractProductListPageAsync(productsService, params, response)
    }
    ...
    constructor(
        ...
        @JsonProperty("data")
        private val data: JsonField<List<ContractProductListResponse>> = JsonMissing.of(),
        @JsonAnySetter
    ...
    class AutoPager(private val firstPage: ContractProductListPageAsync) {

        fun forEach(
            action: Predicate<ContractProductListResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<ContractProductListPageAsync>>.forEach(
                action: (ContractProductListResponse) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<ContractProductListResponse>> {
            val values = mutableListOf<ContractProductListResponse>()
