...
class RateServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : RateServiceAsync {

    private val withRawResponse: RateServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): RateServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RateServiceAsync = RateServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: RateListParams, requestOptions: RequestOptions): CompletableFuture<RateListPageAsync> =
        // post /v1/contract-pricing/rate-cards/getRates
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun add(params: RateAddParams, requestOptions: RequestOptions): CompletableFuture<RateAddResponse> =
        // post /v1/contract-pricing/rate-cards/addRate
        withRawResponse().add(params, requestOptions).thenApply { it.parse() }

    override fun addMany(params: RateAddManyParams, requestOptions: RequestOptions): CompletableFuture<RateAddManyResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): RateServiceAsync.WithRawResponse = RateServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val listHandler: Handler<RateListPageResponse> = jsonHandler<RateListPageResponse>(clientOptions.jsonMapper)

        override fun list(params: RateListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateListPageAsync>> {
        ...
        override fun add(params: RateAddParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateAddResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun addMany(params: RateAddManyParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RateAddManyResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
