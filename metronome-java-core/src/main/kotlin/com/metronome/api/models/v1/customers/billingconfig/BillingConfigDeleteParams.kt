 ...
 *
 */
class BillingConfigDeleteParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillingConfigDeleteParams].
         *
    ...
    /** A builder for [BillingConfigDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billingConfigDeleteParams: BillingConfigDeleteParams) =
            apply {
                customerId = billingConfigDeleteParams.customerId
                billingProviderType = billingConfigDeleteParams.billingProviderType
                additionalHeaders = billingConfigDeleteParams.additionalHeaders.toBuilder()
                additionalQueryParams = billingConfigDeleteParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = billingConfigDeleteParams.additionalBodyProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BillingConfigDeleteParams].
         *
         ...
         */
        fun build(): BillingConfigDeleteParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillingConfigDeleteParams && customerId == other.customerId && billingProviderType == other.billingProviderType && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams && additionalBodyProperties == other.additionalBodyProperties
    }

    override fun hashCode(): Int = Objects.hash(customerId, billingProviderType, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() = "BillingConfigDeleteParams{customerId=$customerId, billingProviderType=$billingProviderType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
