...
private constructor(
    ...
    /** A builder for [V1CreditGrantEditParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantEditParams: V1CreditGrantEditParams) = apply {
            body = v1CreditGrantEditParams.body.toBuilder()
            additionalHeaders = v1CreditGrantEditParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreditGrantEditParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CreditGrantEditParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantEditParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CreditGrantEditParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
