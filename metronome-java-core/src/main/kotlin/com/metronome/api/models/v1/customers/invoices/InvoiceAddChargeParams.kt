 ...
 *
 */
class InvoiceAddChargeParams private constructor(
     ...
     *
     * Unlike [invoiceStartTimestamp], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceAddChargeParams: InvoiceAddChargeParams) =
            apply {
         ...
         *
         * You should usually call [Builder.invoiceStartTimestamp] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoiceStartTimestamp(invoiceStartTimestamp: JsonField<OffsetDateTime>) =
            apply {
                body.invoiceStartTimestamp(invoiceStartTimestamp)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("invoice_start_timestamp") @ExcludeMissing invoiceStartTimestamp: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun invoiceStartTimestamp(): OffsetDateTime = invoiceStartTimestamp.getRequired("invoice_start_timestamp")
        ...
        class Builder internal constructor() {
            ...
            /** The start_timestamp of the invoice to add the charge to. */
            fun invoiceStartTimestamp(invoiceStartTimestamp: OffsetDateTime) = invoiceStartTimestamp(JsonField.of(invoiceStartTimestamp))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (chargeId.asKnown().isPresent) 1 else 0) + (if (customerPlanId.asKnown().isPresent) 1 else 0) + (if (description.asKnown().isPresent) 1 else 0) + (if (invoiceStartTimestamp.asKnown().isPresent) 1 else 0) + (if (price.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && chargeId == other.chargeId && customerPlanId == other.customerPlanId && description == other.description && invoiceStartTimestamp == other.invoiceStartTimestamp && price == other.price && quantity == other.quantity && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{chargeId=$chargeId, customerPlanId=$customerPlanId, description=$description, invoiceStartTimestamp=$invoiceStartTimestamp, price=$price, quantity=$quantity, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceAddChargeParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceAddChargeParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
