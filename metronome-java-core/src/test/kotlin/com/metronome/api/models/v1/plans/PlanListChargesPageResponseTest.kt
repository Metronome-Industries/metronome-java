...
internal class PlanListChargesPageResponseTest {
    ...
    @Test
    fun create() {
      val planListChargesPageResponse = PlanListChargesPageResponse.builder()
          .addData(PlanListChargesResponse.builder()
      ...
      assertThat(planListChargesPageResponse.data()).containsExactly(PlanListChargesResponse.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .chargeType(PlanListChargesResponse.ChargeType.USAGE)
          .creditType(CreditTypeData.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun roundtrip() {
      ...
      val roundtrippedPlanListChargesPageResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(planListChargesPageResponse), jacksonTypeRef<PlanListChargesPageResponse>())
