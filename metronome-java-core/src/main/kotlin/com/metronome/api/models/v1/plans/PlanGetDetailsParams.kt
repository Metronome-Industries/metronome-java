 ...
 *
 */
class PlanGetDetailsParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planGetDetailsParams: PlanGetDetailsParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanGetDetailsParams && planId == other.planId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(planId, additionalHeaders, additionalQueryParams)

    override fun toString() = "PlanGetDetailsParams{planId=$planId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
