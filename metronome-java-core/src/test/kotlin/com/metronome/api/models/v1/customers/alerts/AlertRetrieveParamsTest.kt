...
internal class AlertRetrieveParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.alertSpecifiers().getOrNull()).containsExactly(AlertRetrieveParams.AlertSpecifier.builder()
          .addCustomFieldFilter(AlertRetrieveParams.AlertSpecifier.CustomFieldFilter.builder()
              .entity(AlertRetrieveParams.AlertSpecifier.CustomFieldFilter.Entity.CONTRACT)
              .key("key")
              .value("value")
          ...
          .addExclude(AlertRetrieveParams.AlertSpecifier.Exclude.builder()
              ...
              .build())
          .build())
      assertThat(body.groupValues().getOrNull()).containsExactly(AlertRetrieveParams.GroupValue.builder()
          .key("key")
          .value("value")
          .build())
      assertThat(body.plansOrContracts()).contains(AlertRetrieveParams.PlansOrContracts.PLANS)
      assertThat(body.seatFilter()).contains(AlertRetrieveParams.SeatFilter.builder()
          .seatGroupKey("seat_group_key")
          .seatGroupValue("seat_group_value")
          .build())
    }
