...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1CreditGrantListParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1CreditGrantListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantListParams: V1CreditGrantListParams) = apply {
            limit = v1CreditGrantListParams.limit
            nextPage = v1CreditGrantListParams.nextPage
            body = v1CreditGrantListParams.body.toBuilder()
            additionalHeaders = v1CreditGrantListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreditGrantListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CreditGrantListParams =
            V1CreditGrantListParams(
                limit,
                nextPage,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CreditGrantListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
