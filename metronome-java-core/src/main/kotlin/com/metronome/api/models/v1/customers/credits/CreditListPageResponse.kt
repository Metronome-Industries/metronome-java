...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditListPageResponse: CreditListPageResponse) = apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Credit>` value instead.
     ...
     *   expected type.
     */
    fun validate(): CreditListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CreditListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
