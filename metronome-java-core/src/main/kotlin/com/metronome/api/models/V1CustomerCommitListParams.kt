 ...
 */
class V1CustomerCommitListParams
private constructor(
    ...
    /** A builder for [V1CustomerCommitListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerCommitListParams: V1CustomerCommitListParams) = apply {
            body = v1CustomerCommitListParams.body.toBuilder()
            additionalHeaders = v1CustomerCommitListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerCommitListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerCommitListParams =
            V1CustomerCommitListParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerCommitListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerCommitListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
