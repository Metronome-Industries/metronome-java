...
import com.metronome.api.models.v1.contracts.products.ProductListItemState
...
class ProductRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productRetrieveResponse: ProductRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ProductRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("current") @ExcludeMissing current: JsonField<ProductListItemState> = JsonMissing.of(),
            @JsonProperty("initial") @ExcludeMissing initial: JsonField<ProductListItemState> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.current] with a well-typed [ProductListItemState] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun current(current: JsonField<ProductListItemState>) =
                apply {
             ...
             *
             * You should usually call [Builder.initial] with a well-typed [ProductListItemState] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun initial(initial: JsonField<ProductListItemState>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (current.asKnown().getOrNull()?.validity() ?: 0) + (initial.asKnown().getOrNull()?.validity() ?: 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (updates.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (archivedAt.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class Update @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("composite_product_ids") @ExcludeMissing compositeProductIds: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("composite_tags") @ExcludeMissing compositeTags: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("exclude_free_usage") @ExcludeMissing excludeFreeUsage: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("is_refundable") @ExcludeMissing isRefundable: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
                @JsonProperty("netsuite_internal_item_id") @ExcludeMissing netsuiteInternalItemId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("netsuite_overage_item_id") @ExcludeMissing netsuiteOverageItemId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("presentation_group_key") @ExcludeMissing presentationGroupKey: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("pricing_group_key") @ExcludeMissing pricingGroupKey: JsonField<List<String>> = JsonMissing.of(),
                @JsonProperty("quantity_conversion") @ExcludeMissing quantityConversion: JsonField<QuantityConversion> = JsonMissing.of(),
                @JsonProperty("quantity_rounding") @ExcludeMissing quantityRounding: JsonField<QuantityRounding> = JsonMissing.of(),
            ...
            /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun compositeProductIds(): Optional<List<String>> = compositeProductIds.getOptional("composite_product_ids")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun netsuiteInternalItemId(): Optional<String> = netsuiteInternalItemId.getOptional("netsuite_internal_item_id")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun netsuiteOverageItemId(): Optional<String> = netsuiteOverageItemId.getOptional("netsuite_overage_item_id")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun presentationGroupKey(): Optional<List<String>> = presentationGroupKey.getOptional("presentation_group_key")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun quantityConversion(): Optional<QuantityConversion> = quantityConversion.getOptional("quantity_conversion")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun quantityRounding(): Optional<QuantityRounding> = quantityRounding.getOptional("quantity_rounding")
             ...
             *
             * Unlike [compositeProductIds], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [excludeFreeUsage], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [netsuiteInternalItemId], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [netsuiteOverageItemId], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [presentationGroupKey], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [quantityConversion], this method doesn't throw if the JSON field has an unexpected type.
             */
             ...
             *
             * Unlike [quantityRounding], this method doesn't throw if the JSON field has an unexpected type.
             */
            ...
            class Builder internal constructor() {
                ...
                fun compositeProductIds(compositeProductIds: List<String>) = compositeProductIds(JsonField.of(compositeProductIds))

                /**
                 * Sets [Builder.compositeProductIds] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.compositeProductIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun compositeProductIds(compositeProductIds: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addCompositeProductId(compositeProductId: String) =
                    apply {
                        compositeProductIds = (compositeProductIds ?: JsonField.of(mutableListOf())).also {
                 ...
                 *
                 * You should usually call [Builder.compositeTags] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun compositeTags(compositeTags: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addCompositeTag(compositeTag: String) =
                    apply {
                        compositeTags = (compositeTags ?: JsonField.of(mutableListOf())).also {
                            checkKnown("compositeTags", it).add(compositeTag)
                        }
                    }

                fun excludeFreeUsage(excludeFreeUsage: Boolean) = excludeFreeUsage(JsonField.of(excludeFreeUsage))

                /**
                 * Sets [Builder.excludeFreeUsage] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.excludeFreeUsage] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun excludeFreeUsage(excludeFreeUsage: JsonField<Boolean>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.isRefundable] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun isRefundable(isRefundable: JsonField<Boolean>) =
                    apply {
                ...
                /** This field's availability is dependent on your client's configuration. */
                fun netsuiteInternalItemId(netsuiteInternalItemId: String) = netsuiteInternalItemId(JsonField.of(netsuiteInternalItemId))

                /**
                 * Sets [Builder.netsuiteInternalItemId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.netsuiteInternalItemId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun netsuiteInternalItemId(netsuiteInternalItemId: JsonField<String>) =
                    apply {
                        this.netsuiteInternalItemId = netsuiteInternalItemId
                    }

                /** This field's availability is dependent on your client's configuration. */
                fun netsuiteOverageItemId(netsuiteOverageItemId: String) = netsuiteOverageItemId(JsonField.of(netsuiteOverageItemId))

                /**
                 * Sets [Builder.netsuiteOverageItemId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.netsuiteOverageItemId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun netsuiteOverageItemId(netsuiteOverageItemId: JsonField<String>) =
                    apply {
                        this.netsuiteOverageItemId = netsuiteOverageItemId
                    }

                /** For USAGE products only. Groups usage line items on invoices. The superset of values in the pricing group key and presentation group key must be set as one compound group key on the billable metric. */
                fun presentationGroupKey(presentationGroupKey: List<String>) = presentationGroupKey(JsonField.of(presentationGroupKey))

                /**
                 * Sets [Builder.presentationGroupKey] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.presentationGroupKey] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun presentationGroupKey(presentationGroupKey: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addPresentationGroupKey(presentationGroupKey: String) =
                    apply {
                        this.presentationGroupKey = (this.presentationGroupKey ?: JsonField.of(mutableListOf())).also {
                            checkKnown("presentationGroupKey", it).add(presentationGroupKey)
                        }
                    }

                /** For USAGE products only. If set, pricing for this product will be determined for each pricing_group_key value, as opposed to the product as a whole. The superset of values in the pricing group key and presentation group key must be set as one compound group key on the billable metric. */
                fun pricingGroupKey(pricingGroupKey: List<String>) = pricingGroupKey(JsonField.of(pricingGroupKey))

                /**
                 * Sets [Builder.pricingGroupKey] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.pricingGroupKey] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun pricingGroupKey(pricingGroupKey: JsonField<List<String>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addPricingGroupKey(pricingGroupKey: String) =
                    apply {
                        this.pricingGroupKey = (this.pricingGroupKey ?: JsonField.of(mutableListOf())).also {
                            checkKnown("pricingGroupKey", it).add(pricingGroupKey)
                        }
                    }

                /** Optional. Only valid for USAGE products. If provided, the quantity will be converted using the provided conversion factor and operation. For example, if the operation is "multiply" and the conversion factor is 100, then the quantity will be multiplied by 100. This can be used in cases where data is sent in one unit and priced in another.  For example, data could be sent in MB and priced in GB. In this case, the conversion factor would be 1024 and the operation would be "divide". */
                fun quantityConversion(quantityConversion: QuantityConversion?) = quantityConversion(JsonField.ofNullable(quantityConversion))

                /** Alias for calling [Builder.quantityConversion] with `quantityConversion.orElse(null)`. */
                fun quantityConversion(quantityConversion: Optional<QuantityConversion>) = quantityConversion(quantityConversion.getOrNull())

                /**
                 * Sets [Builder.quantityConversion] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.quantityConversion] with a well-typed [QuantityConversion] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun quantityConversion(quantityConversion: JsonField<QuantityConversion>) =
                    apply {
                        this.quantityConversion = quantityConversion
                    }

                /** Optional. Only valid for USAGE products. If provided, the quantity will be rounded using the provided rounding method and decimal places. For example, if the method is "round up" and the decimal places is 0, then the quantity will be rounded up to the nearest integer. */
                fun quantityRounding(quantityRounding: QuantityRounding?) = quantityRounding(JsonField.ofNullable(quantityRounding))

                /** Alias for calling [Builder.quantityRounding] with `quantityRounding.orElse(null)`. */
                fun quantityRounding(quantityRounding: Optional<QuantityRounding>) = quantityRounding(quantityRounding.getOrNull())

                /**
                 * Sets [Builder.quantityRounding] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.quantityRounding] with a well-typed [QuantityRounding] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun quantityRounding(quantityRounding: JsonField<QuantityRounding>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (createdAt.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (if (billableMetricId.asKnown().isPresent) 1 else 0) + (compositeProductIds.asKnown().getOrNull()?.size ?: 0) + (compositeTags.asKnown().getOrNull()?.size ?: 0) + (if (excludeFreeUsage.asKnown().isPresent) 1 else 0) + (if (isRefundable.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (netsuiteInternalItemId.asKnown().isPresent) 1 else 0) + (if (netsuiteOverageItemId.asKnown().isPresent) 1 else 0) + (presentationGroupKey.asKnown().getOrNull()?.size ?: 0) + (pricingGroupKey.asKnown().getOrNull()?.size ?: 0) + (quantityConversion.asKnown().getOrNull()?.validity() ?: 0) + (quantityRounding.asKnown().getOrNull()?.validity() ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (tags.asKnown().getOrNull()?.size ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Update && createdAt == other.createdAt && createdBy == other.createdBy && billableMetricId == other.billableMetricId && compositeProductIds == other.compositeProductIds && compositeTags == other.compositeTags && excludeFreeUsage == other.excludeFreeUsage && isRefundable == other.isRefundable && name == other.name && netsuiteInternalItemId == other.netsuiteInternalItemId && netsuiteOverageItemId == other.netsuiteOverageItemId && presentationGroupKey == other.presentationGroupKey && pricingGroupKey == other.pricingGroupKey && quantityConversion == other.quantityConversion && quantityRounding == other.quantityRounding && startingAt == other.startingAt && tags == other.tags && additionalProperties == other.additionalProperties
            }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && id == other.id && current == other.current && initial == other.initial && type == other.type && updates == other.updates && archivedAt == other.archivedAt && customFields == other.customFields && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{id=$id, current=$current, initial=$initial, type=$type, updates=$updates, archivedAt=$archivedAt, customFields=$customFields, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ProductRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ProductRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
