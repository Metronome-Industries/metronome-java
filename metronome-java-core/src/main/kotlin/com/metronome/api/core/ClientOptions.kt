...
private constructor(
     ...
     *
     * Use the one published in `metronome-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.metronome.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [com.metronome.api.core.jsonMapper]. The default is usually sufficient and
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("metronome.bearerToken") ?: System.getenv("METRONOME_BEARER_TOKEN"))
                ?.let { bearerToken(it) }
            (System.getProperty("metronome.webhookSecret")
                    ?: System.getenv("METRONOME_WEBHOOK_SECRET"))
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "metronome-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
