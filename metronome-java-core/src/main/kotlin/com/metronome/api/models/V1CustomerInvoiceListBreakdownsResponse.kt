...
@NoAutoDetect
class V1CustomerInvoiceListBreakdownsResponse
@JsonCreator
private constructor(
    ...
    @ExcludeMissing
    private val constituentInvoices: JsonField<List<Invoice.ConstituentInvoice>> = JsonMissing.of(),
    ...
    @JsonProperty("payer")
    @ExcludeMissing
    private val payer: JsonField<Invoice.Payer> = JsonMissing.of(),
     ...
     */
    fun payer(): Optional<Invoice.Payer> = Optional.ofNullable(payer.getNullable("payer"))
    ...
    fun validate(): V1CustomerInvoiceListBreakdownsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerInvoiceListBreakdownsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerInvoiceListBreakdownsResponse: V1CustomerInvoiceListBreakdownsResponse
        ) = apply {
            id = v1CustomerInvoiceListBreakdownsResponse.id
            creditType = v1CustomerInvoiceListBreakdownsResponse.creditType
            customerId = v1CustomerInvoiceListBreakdownsResponse.customerId
            lineItems = v1CustomerInvoiceListBreakdownsResponse.lineItems.map { it.toMutableList() }
            status = v1CustomerInvoiceListBreakdownsResponse.status
            total = v1CustomerInvoiceListBreakdownsResponse.total
            type = v1CustomerInvoiceListBreakdownsResponse.type
            amendmentId = v1CustomerInvoiceListBreakdownsResponse.amendmentId
            billableStatus = v1CustomerInvoiceListBreakdownsResponse.billableStatus
            constituentInvoices =
                v1CustomerInvoiceListBreakdownsResponse.constituentInvoices.map {
                    it.toMutableList()
                }
            contractCustomFields = v1CustomerInvoiceListBreakdownsResponse.contractCustomFields
            contractId = v1CustomerInvoiceListBreakdownsResponse.contractId
            correctionRecord = v1CustomerInvoiceListBreakdownsResponse.correctionRecord
            createdAt = v1CustomerInvoiceListBreakdownsResponse.createdAt
            customFields = v1CustomerInvoiceListBreakdownsResponse.customFields
            customerCustomFields = v1CustomerInvoiceListBreakdownsResponse.customerCustomFields
            endTimestamp = v1CustomerInvoiceListBreakdownsResponse.endTimestamp
            externalInvoice = v1CustomerInvoiceListBreakdownsResponse.externalInvoice
            invoiceAdjustments =
                v1CustomerInvoiceListBreakdownsResponse.invoiceAdjustments.map {
                    it.toMutableList()
                }
            issuedAt = v1CustomerInvoiceListBreakdownsResponse.issuedAt
            netPaymentTermsDays = v1CustomerInvoiceListBreakdownsResponse.netPaymentTermsDays
            netsuiteSalesOrderId = v1CustomerInvoiceListBreakdownsResponse.netsuiteSalesOrderId
            payer = v1CustomerInvoiceListBreakdownsResponse.payer
            planCustomFields = v1CustomerInvoiceListBreakdownsResponse.planCustomFields
            planId = v1CustomerInvoiceListBreakdownsResponse.planId
            planName = v1CustomerInvoiceListBreakdownsResponse.planName
            resellerRoyalty = v1CustomerInvoiceListBreakdownsResponse.resellerRoyalty
            revenueSystemInvoices =
                v1CustomerInvoiceListBreakdownsResponse.revenueSystemInvoices.map {
                    it.toMutableList()
                }
            salesforceOpportunityId =
                v1CustomerInvoiceListBreakdownsResponse.salesforceOpportunityId
            startTimestamp = v1CustomerInvoiceListBreakdownsResponse.startTimestamp
            subtotal = v1CustomerInvoiceListBreakdownsResponse.subtotal
            breakdownEndTimestamp = v1CustomerInvoiceListBreakdownsResponse.breakdownEndTimestamp
            breakdownStartTimestamp =
                v1CustomerInvoiceListBreakdownsResponse.breakdownStartTimestamp
            additionalProperties =
                v1CustomerInvoiceListBreakdownsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerInvoiceListBreakdownsResponse =
            V1CustomerInvoiceListBreakdownsResponse(
                checkRequired("id", id),
