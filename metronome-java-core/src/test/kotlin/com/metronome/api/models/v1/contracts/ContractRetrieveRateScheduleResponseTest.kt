...
internal class ContractRetrieveRateScheduleResponseTest {
            ...
            ContractRetrieveRateScheduleResponse.builder()
                .addData(
                    ContractRetrieveRateScheduleResponse.Data.builder()
                        ...
                        .billingFrequency(
                            ContractRetrieveRateScheduleResponse.Data.BillingFrequency.MONTHLY
                        )
                        .commitRate(
                            CommitRate.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedContractRetrieveRateScheduleResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(contractRetrieveRateScheduleResponse),
                jacksonTypeRef<ContractRetrieveRateScheduleResponse>(),
            )

        assertThat(roundtrippedContractRetrieveRateScheduleResponse)
            .isEqualTo(contractRetrieveRateScheduleResponse)
    }
}
