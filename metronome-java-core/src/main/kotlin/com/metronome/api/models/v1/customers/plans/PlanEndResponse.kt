...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): PlanEndResponse = PlanEndResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun toString() = "PlanEndResponse{additionalProperties=$additionalProperties}"
}
