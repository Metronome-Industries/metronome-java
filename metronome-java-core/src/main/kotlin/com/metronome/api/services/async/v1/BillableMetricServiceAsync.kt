...
interface BillableMetricServiceAsync {
     ...
     *
     */
    fun create(params: BillableMetricCreateParams): CompletableFuture<BillableMetricCreateResponse> =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: BillableMetricCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BillableMetricCreateResponse>
     ...
     *
     */
    fun retrieve(params: BillableMetricRetrieveParams): CompletableFuture<BillableMetricRetrieveResponse> =
        retrieve(
          params, RequestOptions.none()
        )

    /** @see retrieve */
    fun retrieve(params: BillableMetricRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BillableMetricRetrieveResponse>
     ...
     *
     */
    fun list(): CompletableFuture<BillableMetricListPageAsync> = list(BillableMetricListParams.none())

    /** @see list */
    fun list(params: BillableMetricListParams = BillableMetricListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BillableMetricListPageAsync>

    /** @see list */
    fun list(params: BillableMetricListParams = BillableMetricListParams.none()): CompletableFuture<BillableMetricListPageAsync> =
        list(
          params, RequestOptions.none()
        )
    ...
    fun list(requestOptions: RequestOptions): CompletableFuture<BillableMetricListPageAsync> =
        list(
          BillableMetricListParams.none(), requestOptions
        )
     ...
     *
     */
    fun archive(params: BillableMetricArchiveParams): CompletableFuture<BillableMetricArchiveResponse> =
        archive(
          params, RequestOptions.none()
        )

    /** @see archive */
    fun archive(params: BillableMetricArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BillableMetricArchiveResponse>

    /** @see archive */
    fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<BillableMetricArchiveResponse> =
        archive(
    ...
    /** A view of [BillableMetricServiceAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): BillableMetricServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/billable-metrics/create`, but is otherwise the             same as [BillableMetricServiceAsync.create]. */
        fun create(params: BillableMetricCreateParams): CompletableFuture<HttpResponseFor<BillableMetricCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: BillableMetricCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BillableMetricCreateResponse>>

        /** Returns a raw HTTP response for `get /v1/billable-metrics/{billable_metric_id}`, but is otherwise the             same as [BillableMetricServiceAsync.retrieve]. */
        fun retrieve(params: BillableMetricRetrieveParams): CompletableFuture<HttpResponseFor<BillableMetricRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: BillableMetricRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BillableMetricRetrieveResponse>>

        /** Returns a raw HTTP response for `get /v1/billable-metrics`, but is otherwise the             same as [BillableMetricServiceAsync.list]. */
        fun list(): CompletableFuture<HttpResponseFor<BillableMetricListPageAsync>> = list(BillableMetricListParams.none())

        /** @see list */
        fun list(params: BillableMetricListParams = BillableMetricListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BillableMetricListPageAsync>>

        /** @see list */
        fun list(params: BillableMetricListParams = BillableMetricListParams.none()): CompletableFuture<HttpResponseFor<BillableMetricListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<BillableMetricListPageAsync>> =
            list(
              BillableMetricListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /v1/billable-metrics/archive`, but is otherwise the             same as [BillableMetricServiceAsync.archive]. */
        fun archive(params: BillableMetricArchiveParams): CompletableFuture<HttpResponseFor<BillableMetricArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: BillableMetricArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BillableMetricArchiveResponse>>

        /** @see archive */
        fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<BillableMetricArchiveResponse>> =
            archive(
              BillableMetricArchiveParams.builder()
                  .id(id)
                  .build(), requestOptions
