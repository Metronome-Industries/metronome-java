...
/**
 * Lists all packages with details including name, aliases, duration, and terms. To view contracts
 * on a specific package, use the `listContractsOnPackage` endpoint.
 */
class PackageListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PackageListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(packageListParams: PackageListParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PackageListParams &&
            limit == other.limit &&
    ...
    override fun toString() =
        "PackageListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
