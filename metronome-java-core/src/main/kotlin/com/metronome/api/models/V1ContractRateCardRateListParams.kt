 ...
 */
class V1ContractRateCardRateListParams
private constructor(
    ...
    /** A builder for [V1ContractRateCardRateListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardRateListParams: V1ContractRateCardRateListParams) =
            apply {
                limit = v1ContractRateCardRateListParams.limit
                nextPage = v1ContractRateCardRateListParams.nextPage
                body = v1ContractRateCardRateListParams.body.toBuilder()
                additionalHeaders = v1ContractRateCardRateListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v1ContractRateCardRateListParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): V1ContractRateCardRateListParams =
            V1ContractRateCardRateListParams(
                limit,
                nextPage,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRateCardRateListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
