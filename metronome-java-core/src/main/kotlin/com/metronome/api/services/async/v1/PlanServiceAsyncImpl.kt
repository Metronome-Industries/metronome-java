...
class PlanServiceAsyncImpl internal constructor(
    ...
    override fun getDetails(params: PlanGetDetailsParams, requestOptions: RequestOptions): CompletableFuture<PlanGetDetailsResponse> =
        // get /v1/planDetails/{plan_id}
        withRawResponse().getDetails(params, requestOptions).thenApply { it.parse() }

    override fun listCharges(params: PlanListChargesParams, requestOptions: RequestOptions): CompletableFuture<PlanListChargesPageAsync> =
        // get /v1/planDetails/{plan_id}/charges
        withRawResponse().listCharges(params, requestOptions).thenApply { it.parse() }

    override fun listCustomers(params: PlanListCustomersParams, requestOptions: RequestOptions): CompletableFuture<PlanListCustomersPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val getDetailsHandler: Handler<PlanGetDetailsResponse> = jsonHandler<PlanGetDetailsResponse>(clientOptions.jsonMapper)

        override fun getDetails(params: PlanGetDetailsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanGetDetailsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val listChargesHandler: Handler<PlanListChargesPageResponse> = jsonHandler<PlanListChargesPageResponse>(clientOptions.jsonMapper)

        override fun listCharges(params: PlanListChargesParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanListChargesPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
        ...
        private val listCustomersHandler: Handler<PlanListCustomersPageResponse> = jsonHandler<PlanListCustomersPageResponse>(clientOptions.jsonMapper)

        override fun listCustomers(params: PlanListCustomersParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanListCustomersPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  listCustomersHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
