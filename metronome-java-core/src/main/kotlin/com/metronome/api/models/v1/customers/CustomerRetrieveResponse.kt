...
class CustomerRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<CustomerDetail> = JsonMissing.of()
    ) : this(
      data, mutableMapOf()
    )
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<CustomerDetail> = data
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerRetrieveResponse: CustomerRetrieveResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.data] with a well-typed [CustomerDetail] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CustomerDetail>) =
            apply {
                this.data = data
            }
     ...
     *   expected type.
     */
    fun validate(): CustomerRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
