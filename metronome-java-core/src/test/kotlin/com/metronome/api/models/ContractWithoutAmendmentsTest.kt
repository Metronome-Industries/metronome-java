...
internal class ContractWithoutAmendmentsTest {
    ...
    fun create() {
                    ...
                    ContractWithoutAmendments.RecurringCommit.builder()
                        ...
                        .commitDuration(
                            ContractWithoutAmendments.RecurringCommit.CommitDuration.builder()
                                .value(0.0)
                                .unit(
                                    ContractWithoutAmendments.RecurringCommit.CommitDuration.Unit
                                        .PERIODS
                                )
                                .build()
                        )
                    ...
                    ContractWithoutAmendments.RecurringCredit.builder()
                        ...
                        .commitDuration(
                            ContractWithoutAmendments.RecurringCredit.CommitDuration.builder()
                                .value(0.0)
                                .unit(
                                    ContractWithoutAmendments.RecurringCredit.CommitDuration.Unit
                                        .PERIODS
                                )
                                .build()
                        )
        ...
        assertThat(contractWithoutAmendments.credits().getOrNull())
            .containsExactly(
                Credit.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .product(
        ...
        assertThat(contractWithoutAmendments.discounts().getOrNull())
            .containsExactly(
                Discount.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .product(
        ...
        assertThat(contractWithoutAmendments.hierarchyConfiguration())
            .contains(
        ...
        assertThat(contractWithoutAmendments.prepaidBalanceThresholdConfiguration())
            .contains(
                PrepaidBalanceThresholdConfiguration.builder()
                    .commit(
                        PrepaidBalanceThresholdConfiguration.Commit.builder()
        ...
        assertThat(contractWithoutAmendments.recurringCommits().getOrNull())
            .containsExactly(
                ContractWithoutAmendments.RecurringCommit.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .accessAmount(
        ...
        assertThat(contractWithoutAmendments.recurringCredits().getOrNull())
            .containsExactly(
                ContractWithoutAmendments.RecurringCredit.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .accessAmount(
        ...
        assertThat(contractWithoutAmendments.resellerRoyalties().getOrNull())
            .containsExactly(
                ContractWithoutAmendments.ResellerRoyalty.builder()
                    .fraction(0.0)
                    .netsuiteResellerId("netsuite_reseller_id")
        ...
        assertThat(contractWithoutAmendments.spendThresholdConfiguration())
            .contains(
                SpendThresholdConfiguration.builder()
                    .commit(
                        BaseThresholdCommit.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedContractWithoutAmendments =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(contractWithoutAmendments),
                jacksonTypeRef<ContractWithoutAmendments>(),
            )
