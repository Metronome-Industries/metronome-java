 ...
 */
class V1UsageListWithGroupsParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && billableMetricId == other.billableMetricId && customerId == other.customerId && windowSize == other.windowSize && currentPeriod == other.currentPeriod && endingBefore == other.endingBefore && groupBy == other.groupBy && startingOn == other.startingOn && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1UsageListWithGroupsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1UsageListWithGroupsParams: V1UsageListWithGroupsParams) = apply {
            limit = v1UsageListWithGroupsParams.limit
            nextPage = v1UsageListWithGroupsParams.nextPage
            body = v1UsageListWithGroupsParams.body.toBuilder()
            additionalHeaders = v1UsageListWithGroupsParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1UsageListWithGroupsParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1UsageListWithGroupsParams =
            V1UsageListWithGroupsParams(
                limit,
                nextPage,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1UsageListWithGroupsParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1UsageListWithGroupsParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
