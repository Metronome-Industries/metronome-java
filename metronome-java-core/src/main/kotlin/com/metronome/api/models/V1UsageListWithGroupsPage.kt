 ...
 */
class V1UsageListWithGroupsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1UsageListWithGroupsPage && usageService == other.usageService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(usageService, params, response) /* spotless:on */

    override fun toString() =
        "V1UsageListWithGroupsPage{usageService=$usageService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1UsageListWithGroupsPage> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1UsageListWithGroupsPage(usageService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1UsageListWithGroupsPage) :
        Iterable<V1UsageListWithGroupsResponse> {

        override fun iterator(): Iterator<V1UsageListWithGroupsResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<V1UsageListWithGroupsResponse> {
