...
class PlanAddResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlanAddResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planAddResponse: PlanAddResponse) =
            apply {
                data = planAddResponse.data
                additionalProperties = planAddResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PlanAddResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanAddResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PlanAddResponse{data=$data, additionalProperties=$additionalProperties}"
}
