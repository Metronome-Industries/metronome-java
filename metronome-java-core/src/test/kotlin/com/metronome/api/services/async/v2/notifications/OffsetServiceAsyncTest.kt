...
internal class OffsetServiceAsyncTest {
    ...
    fun create() {
      ...
      val offsetFuture = offsetServiceAsync.create(OffsetCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val offsetFuture = offsetServiceAsync.retrieve(OffsetRetrieveParams.builder()
    ...
    fun archive() {
      ...
      val responseFuture = offsetServiceAsync.archive(OffsetArchiveParams.builder()
          .id("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .build())
    ...
    fun edit() {
      ...
      val responseFuture = offsetServiceAsync.edit(OffsetEditParams.builder()
