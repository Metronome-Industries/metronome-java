 ...
 *
 */
class CommitUpdateEndDateParams private constructor(
     ...
     *
     * Unlike [invoicesEndingBefore], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commitUpdateEndDateParams: CommitUpdateEndDateParams) =
            apply {
         ...
         *
         * You should usually call [Builder.invoicesEndingBefore] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoicesEndingBefore(invoicesEndingBefore: JsonField<OffsetDateTime>) =
            apply {
                body.invoicesEndingBefore(invoicesEndingBefore)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("invoices_ending_before") @ExcludeMissing invoicesEndingBefore: JsonField<OffsetDateTime> = JsonMissing.of()
        ) : this(
          commitId,
          customerId,
          accessEndingBefore,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun accessEndingBefore(): Optional<OffsetDateTime> = accessEndingBefore.getOptional("access_ending_before")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun invoicesEndingBefore(): Optional<OffsetDateTime> = invoicesEndingBefore.getOptional("invoices_ending_before")
        ...
        class Builder internal constructor() {
            ...
            /** RFC 3339 timestamp indicating when the commit will stop being invoiced (exclusive). If not provided, the invoice schedule will not be updated. */
            fun invoicesEndingBefore(invoicesEndingBefore: OffsetDateTime) = invoicesEndingBefore(JsonField.of(invoicesEndingBefore))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (commitId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (accessEndingBefore.asKnown().isPresent) 1 else 0) + (if (invoicesEndingBefore.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && commitId == other.commitId && customerId == other.customerId && accessEndingBefore == other.accessEndingBefore && invoicesEndingBefore == other.invoicesEndingBefore && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{commitId=$commitId, customerId=$customerId, accessEndingBefore=$accessEndingBefore, invoicesEndingBefore=$invoicesEndingBefore, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CommitUpdateEndDateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CommitUpdateEndDateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
