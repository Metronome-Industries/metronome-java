...
class PricingUnitListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("is_currency") @ExcludeMissing isCurrency: JsonField<Boolean> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _isCurrency(): JsonField<Boolean> = isCurrency
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pricingUnitListResponse: PricingUnitListResponse) =
            apply {
         ...
         *
         * You should usually call [Builder.isCurrency] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isCurrency(isCurrency: JsonField<Boolean>) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PricingUnitListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (isCurrency.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PricingUnitListResponse && id == other.id && isCurrency == other.isCurrency && name == other.name && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PricingUnitListResponse{id=$id, isCurrency=$isCurrency, name=$name, additionalProperties=$additionalProperties}"
}
