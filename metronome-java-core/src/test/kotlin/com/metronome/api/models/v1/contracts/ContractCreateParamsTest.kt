                ...
                ContractCreateParams.Commit.builder()
                    ...
                    .accessSchedule(
                        ContractCreateParams.Commit.AccessSchedule.builder()
                            ...
                            .accessType(ContractCreateParams.Commit.AccessSchedule.AccessType.SPEND)
                ...
                ContractCreateParams.Credit.builder()
                    .accessSchedule(
                        ContractCreateParams.Credit.AccessSchedule.builder()
                            ...
                            .accessType(ContractCreateParams.Credit.AccessSchedule.AccessType.SPEND)
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .build()
                    )
                    .productId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                ...
                ContractCreateParams.RecurringCommit.builder()
                    .accessAmount(
                        ContractCreateParams.RecurringCommit.AccessAmount.builder()
                            .unitPrice(0.0)
                            .accessType(
                                ContractCreateParams.RecurringCommit.AccessAmount.AccessType.SPEND
                            )
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .quantity(0.0)
                            .build()
                    ...
                    .prorationRounding(
                        ContractCreateParams.RecurringCommit.ProrationRounding.builder()
                            .access(
                                ContractCreateParams.RecurringCommit.ProrationRounding.Access
                                    .builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
                            ...
                            .invoice(
                                ContractCreateParams.RecurringCommit.ProrationRounding.Invoice
                                    .builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
                                        ContractCreateParams.RecurringCommit.ProrationRounding
                ...
                ContractCreateParams.RecurringCredit.builder()
                    .accessAmount(
                        ContractCreateParams.RecurringCredit.AccessAmount.builder()
                            .unitPrice(0.0)
                            .accessType(
                                ContractCreateParams.RecurringCredit.AccessAmount.AccessType.SPEND
                            )
                            .creditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                            .quantity(0.0)
                            .build()
                    ...
                    .prorationRounding(
                        ContractCreateParams.RecurringCredit.ProrationRounding.builder()
                            .access(
                                ContractCreateParams.RecurringCredit.ProrationRounding.Access
                                    .builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
                ...
                ContractCreateParams.SpendTracker.builder()
                    ...
                    .addApplicableSpendSpecifier(
                        ContractCreateParams.SpendTracker.ApplicableSpendSpecifier.builder()
                            .addSource(
                                ContractCreateParams.SpendTracker.ApplicableSpendSpecifier.Source
                                    .THRESHOLD_RECHARGE
                            )
                            .spendType(
                                ContractCreateParams.SpendTracker.ApplicableSpendSpecifier.SpendType
                                    .COMMIT_PURCHASE
                            )
                            .discounted(
                ...
                ContractCreateParams.Subscription.builder()
                    ...
                    .proration(
                        ContractCreateParams.Subscription.Proration.builder()
                            ...
                            .isProrated(true)
                            .rounding(
                                ContractCreateParams.Subscription.Proration.Rounding.builder()
                                    .decimalPlaces(-5.0)
                                    .roundingMethod(
