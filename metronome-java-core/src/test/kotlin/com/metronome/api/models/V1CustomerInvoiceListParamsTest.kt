...
class V1CustomerInvoiceListParamsTest {
    ...
    fun create() {
        V1CustomerInvoiceListParams.builder()
            ...
            .sort(V1CustomerInvoiceListParams.Sort.DATE_ASC)
    ...
    fun queryParams() {
        ...
        expected.put("sort", V1CustomerInvoiceListParams.Sort.DATE_ASC.toString())
