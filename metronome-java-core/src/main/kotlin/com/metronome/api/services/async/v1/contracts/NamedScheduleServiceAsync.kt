...
interface NamedScheduleServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/getNamedSchedule`,
         * but is otherwise the same as [NamedScheduleServiceAsync.retrieve].
         */
        fun retrieve(
            params: NamedScheduleRetrieveParams
         ...
         * /v1/contract-pricing/rate-cards/updateNamedSchedule`, but is otherwise the same as
