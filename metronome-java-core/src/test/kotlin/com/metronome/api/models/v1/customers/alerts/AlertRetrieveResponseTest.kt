...
internal class AlertRetrieveResponseTest {

    @Test
    fun create() {
        val alertRetrieveResponse =
            AlertRetrieveResponse.builder()
                .data(
        ...
        assertThat(alertRetrieveResponse.data())
            .isEqualTo(
                CustomerAlert.builder()
                    .alert(
                        CustomerAlert.Alert.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedAlertRetrieveResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(alertRetrieveResponse),
                jacksonTypeRef<AlertRetrieveResponse>(),
            )

        assertThat(roundtrippedAlertRetrieveResponse).isEqualTo(alertRetrieveResponse)
    }
}
