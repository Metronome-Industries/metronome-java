...
class RateCardRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateCardRetrieveResponse: RateCardRetrieveResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): RateCardRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun toString() = "Data{id=$id, createdAt=$createdAt, createdBy=$createdBy, name=$name, aliases=$aliases, creditTypeConversions=$creditTypeConversions, customFields=$customFields, description=$description, fiatCreditType=$fiatCreditType, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RateCardRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RateCardRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
