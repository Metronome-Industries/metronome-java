...
class CustomerPreviewEventsResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerPreviewEventsResponse: CustomerPreviewEventsResponse) = apply {
    ...
    fun validate(): CustomerPreviewEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerPreviewEventsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CustomerPreviewEventsResponse{data=$data, additionalProperties=$additionalProperties}"
}
