...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1PaymentListPage && paymentsService == other.paymentsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(paymentsService, params, response) /* spotless:on */

    override fun toString() =
        "V1PaymentListPage{paymentsService=$paymentsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1PaymentListPage> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(paymentsService: PaymentService, params: V1PaymentListParams, response: Response) =
            V1PaymentListPage(paymentsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1PaymentListPage) : Iterable<Payment> {
