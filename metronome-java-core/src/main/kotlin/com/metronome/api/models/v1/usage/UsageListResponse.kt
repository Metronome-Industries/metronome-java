...
class UsageListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("billable_metric_name") @ExcludeMissing billableMetricName: JsonField<String> = JsonMissing.of(),
     ...
     *
     * Unlike [billableMetricName], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    @JsonProperty("groups")
    @ExcludeMissing
    fun _groups(): JsonField<Groups> = groups
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageListResponse: UsageListResponse) =
            apply {
        ...
        fun billableMetricName(billableMetricName: String) = billableMetricName(JsonField.of(billableMetricName))

        /**
         * Sets [Builder.billableMetricName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.billableMetricName] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun billableMetricName(billableMetricName: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.groups] with a well-typed [Groups] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groups(groups: JsonField<Groups>) =
            apply {
                this.groups = groups
            }
        ...
        fun build(): UsageListResponse =
            UsageListResponse(
              ...
              checkRequired(
                "billableMetricName", billableMetricName
              ),
              checkRequired(
     ...
     *   expected type.
     */
    fun validate(): UsageListResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (billableMetricId.asKnown().isPresent) 1 else 0) + (if (billableMetricName.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (endTimestamp.asKnown().isPresent) 1 else 0) + (if (startTimestamp.asKnown().isPresent) 1 else 0) + (if (value.asKnown().isPresent) 1 else 0) + (groups.asKnown().getOrNull()?.validity() ?: 0)

    /** Values will be either a number or null. Null indicates that there were no matches for the group_by value. */
    class Groups @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(groups: Groups) =
                apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UsageListResponse && billableMetricId == other.billableMetricId && billableMetricName == other.billableMetricName && customerId == other.customerId && endTimestamp == other.endTimestamp && startTimestamp == other.startTimestamp && value == other.value && groups == other.groups && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "UsageListResponse{billableMetricId=$billableMetricId, billableMetricName=$billableMetricName, customerId=$customerId, endTimestamp=$endTimestamp, startTimestamp=$startTimestamp, value=$value, groups=$groups, additionalProperties=$additionalProperties}"
}
