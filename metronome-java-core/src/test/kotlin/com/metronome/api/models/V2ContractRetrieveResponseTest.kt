...
class V2ContractRetrieveResponseTest {

    @Test
    fun createV2ContractRetrieveResponse() {
        val v2ContractRetrieveResponse =
            V2ContractRetrieveResponse.builder()
                .data(
                    ContractV2.builder()
                ...
                .build()
        assertThat(v2ContractRetrieveResponse).isNotNull
        assertThat(v2ContractRetrieveResponse.data())
            .isEqualTo(
                ContractV2.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .addCommit(
