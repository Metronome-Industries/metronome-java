...
internal class ContractScheduleProServicesInvoiceParamsTest {
    ...
    @Test
    fun body() {
      val params = ContractScheduleProServicesInvoiceParams.builder()
          .contractId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .customerId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .issuedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addLineItem(ContractScheduleProServicesInvoiceParams.LineItem.builder()
      ...
      assertThat(body.lineItems()).containsExactly(ContractScheduleProServicesInvoiceParams.LineItem.builder()
          .professionalServiceId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amendmentId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .amount(0.0)
          .metadata("metadata")
          ...
          .unitPrice(0.0)
          .build())
      assertThat(body.netsuiteInvoiceHeaderEnd()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(body.netsuiteInvoiceHeaderStart()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
