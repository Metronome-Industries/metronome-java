...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditGrantListPageAsync && creditGrantsService == other.creditGrantsService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = CreditGrantListPageAsync(creditGrantsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: CreditGrantListPageAsync) {
