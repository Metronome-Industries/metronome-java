 ...
 *
 */
class CustomerArchiveParams private constructor(
    private val id: Id,
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerArchiveParams: CustomerArchiveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerArchiveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerArchiveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
