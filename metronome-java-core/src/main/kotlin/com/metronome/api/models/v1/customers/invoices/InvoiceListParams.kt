...
class InvoiceListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Indicates that this API request was triggered by a webhook notification with the provided ID. */
        fun webhookNotificationId(webhookNotificationId: String?) =
            apply {
                this.webhookNotificationId = webhookNotificationId
            }

        /** Alias for calling [Builder.webhookNotificationId] with `webhookNotificationId.orElse(null)`. */
        fun webhookNotificationId(webhookNotificationId: Optional<String>) = webhookNotificationId(webhookNotificationId.getOrNull())
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceListParams && customerId == other.customerId && contractId == other.contractId && creditTypeId == other.creditTypeId && endingBefore == other.endingBefore && limit == other.limit && nextPage == other.nextPage && skipZeroQtyLineItems == other.skipZeroQtyLineItems && sort == other.sort && startingOn == other.startingOn && status == other.status && type == other.type && webhookNotificationId == other.webhookNotificationId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, contractId, creditTypeId, endingBefore, limit, nextPage, skipZeroQtyLineItems, sort, startingOn, status, type, webhookNotificationId, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceListParams{customerId=$customerId, contractId=$contractId, creditTypeId=$creditTypeId, endingBefore=$endingBefore, limit=$limit, nextPage=$nextPage, skipZeroQtyLineItems=$skipZeroQtyLineItems, sort=$sort, startingOn=$startingOn, status=$status, type=$type, webhookNotificationId=$webhookNotificationId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
