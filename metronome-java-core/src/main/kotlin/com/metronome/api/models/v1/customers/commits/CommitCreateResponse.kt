...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CommitCreateResponse =
            CommitCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "CommitCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
