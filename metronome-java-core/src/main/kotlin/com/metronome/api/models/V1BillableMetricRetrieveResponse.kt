...
@NoAutoDetect
class V1BillableMetricRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1BillableMetricRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1BillableMetricRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1BillableMetricRetrieveResponse: V1BillableMetricRetrieveResponse) =
            apply {
                data = v1BillableMetricRetrieveResponse.data
                additionalProperties =
                    v1BillableMetricRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): V1BillableMetricRetrieveResponse =
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && id == other.id && name == other.name && aggregationKey == other.aggregationKey && aggregationType == other.aggregationType && archivedAt == other.archivedAt && customFields == other.customFields && eventTypeFilter == other.eventTypeFilter && groupKeys == other.groupKeys && propertyFilters == other.propertyFilters && sql == other.sql && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1BillableMetricRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1BillableMetricRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
