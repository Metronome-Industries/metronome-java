...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRateCardListPageAsync && this.rateCardsService == other.rateCardsService && this.params == other.params && this.response == other.response /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(rateCardsService, params, response) /* spotless:on */
    }

    override fun toString() =
        "ContractRateCardListPageAsync{rateCardsService=$rateCardsService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<ContractRateCardListPageAsync>> {
    ...
    constructor(
        ...
        private val data: JsonField<List<ContractRateCardListResponse>>,
        ...
        override fun toString() =
            "ContractRateCardListPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: ContractRateCardListPageAsync,
    ) {

        fun forEach(
            action: Predicate<ContractRateCardListResponse>,
            executor: Executor
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<ContractRateCardListPageAsync>>.forEach(
                action: (ContractRateCardListResponse) -> Boolean,
                executor: Executor
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<ContractRateCardListResponse>> {
            val values = mutableListOf<ContractRateCardListResponse>()
