...
private constructor(
    ...
    /** A builder for [V1ContractAmendParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractAmendParams: V1ContractAmendParams) = apply {
            body = v1ContractAmendParams.body.toBuilder()
            additionalHeaders = v1ContractAmendParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractAmendParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractAmendParams =
            V1ContractAmendParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractAmendParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractAmendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
