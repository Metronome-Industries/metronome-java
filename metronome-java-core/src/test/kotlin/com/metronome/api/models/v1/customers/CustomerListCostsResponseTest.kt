...
internal class CustomerListCostsResponseTest {
    ...
    @Test
    fun create() {
      val customerListCostsResponse = CustomerListCostsResponse.builder()
      ...
      assertThat(customerListCostsResponse.creditTypes()).isEqualTo(CustomerListCostsResponse.CreditTypes.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "cost" to 0,
            "line_item_breakdown" to listOf(mapOf(
              "cost" to 0,
          ...
          .build())
      assertThat(customerListCostsResponse.endTimestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(customerListCostsResponse.startTimestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerListCostsResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(customerListCostsResponse), jacksonTypeRef<CustomerListCostsResponse>())
