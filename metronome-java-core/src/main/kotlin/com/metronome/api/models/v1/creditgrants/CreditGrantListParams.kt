 ...
 *
 */
class CreditGrantListParams private constructor(
     ...
     *
     * Unlike [notExpiringBefore], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): CreditGrantListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantListParams: CreditGrantListParams) =
            apply {
         ...
         *
         * You should usually call [Builder.creditGrantIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun creditGrantIds(creditGrantIds: JsonField<List<String>>) =
            apply {
                body.creditGrantIds(creditGrantIds)
            }
         ...
         */
        fun addCreditGrantId(creditGrantId: String) =
            apply {
                body.addCreditGrantId(creditGrantId)
            }
         ...
         *
         * You should usually call [Builder.creditTypeIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun creditTypeIds(creditTypeIds: JsonField<List<String>>) =
            apply {
                body.creditTypeIds(creditTypeIds)
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCreditTypeId(creditTypeId: String) =
            apply {
                body.addCreditTypeId(creditTypeId)
            }

        /** An array of Metronome customer IDs. This must not be specified if credit_grant_ids is specified. */
        fun customerIds(customerIds: List<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.customerIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun customerIds(customerIds: JsonField<List<String>>) =
            apply {
                body.customerIds(customerIds)
            }
         ...
         *
         * You should usually call [Builder.notExpiringBefore] with a well-typed [OffsetDateTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun notExpiringBefore(notExpiringBefore: JsonField<OffsetDateTime>) =
            apply {
                body.notExpiringBefore(notExpiringBefore)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("credit_grant_ids") @ExcludeMissing creditGrantIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("credit_type_ids") @ExcludeMissing creditTypeIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("customer_ids") @ExcludeMissing customerIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("effective_before") @ExcludeMissing effectiveBefore: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("not_expiring_before") @ExcludeMissing notExpiringBefore: JsonField<OffsetDateTime> = JsonMissing.of()
        ) : this(
          creditGrantIds,
          creditTypeIds,
          customerIds,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun creditGrantIds(): Optional<List<String>> = creditGrantIds.getOptional("credit_grant_ids")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun notExpiringBefore(): Optional<OffsetDateTime> = notExpiringBefore.getOptional("not_expiring_before")
        ...
        class Builder internal constructor() {
            ...
            /** An array of credit grant IDs. If this is specified, neither credit_type_ids nor customer_ids may be specified. */
            fun creditGrantIds(creditGrantIds: List<String>) = creditGrantIds(JsonField.of(creditGrantIds))
            ...
            fun addCreditGrantId(creditGrantId: String) =
                apply {
                    creditGrantIds = (creditGrantIds ?: JsonField.of(mutableListOf())).also {
                        checkKnown("creditGrantIds", it).add(creditGrantId)
                    }
                }

            /** An array of credit type IDs. This must not be specified if credit_grant_ids is specified. */
            fun creditTypeIds(creditTypeIds: List<String>) = creditTypeIds(JsonField.of(creditTypeIds))
            ...
            fun addCreditTypeId(creditTypeId: String) =
                apply {
                    creditTypeIds = (creditTypeIds ?: JsonField.of(mutableListOf())).also {
            ...
            fun addCustomerId(customerId: String) =
                apply {
                    customerIds = (customerIds ?: JsonField.of(mutableListOf())).also {
            ...
            /** Only return credit grants that expire at or after this timestamp. */
            fun notExpiringBefore(notExpiringBefore: OffsetDateTime) = notExpiringBefore(JsonField.of(notExpiringBefore))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditGrantIds.asKnown().getOrNull()?.size ?: 0) + (creditTypeIds.asKnown().getOrNull()?.size ?: 0) + (customerIds.asKnown().getOrNull()?.size ?: 0) + (if (effectiveBefore.asKnown().isPresent) 1 else 0) + (if (notExpiringBefore.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && creditGrantIds == other.creditGrantIds && creditTypeIds == other.creditTypeIds && customerIds == other.customerIds && effectiveBefore == other.effectiveBefore && notExpiringBefore == other.notExpiringBefore && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{creditGrantIds=$creditGrantIds, creditTypeIds=$creditTypeIds, customerIds=$customerIds, effectiveBefore=$effectiveBefore, notExpiringBefore=$notExpiringBefore, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CreditGrantListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
