...
import com.metronome.api.models.V1CustomerCommitListPageAsync
...
class CommitServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    ): CompletableFuture<V1CustomerCommitCreateResponse> {
        val request =
            HttpRequest.builder()
    ...
    private val listHandler: Handler<V1CustomerCommitListPageAsync.Response> =
        jsonHandler<V1CustomerCommitListPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1CustomerCommitListPageAsync> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1CustomerCommitListPageAsync.of(this, params, it) }
            }
    }
    ...
    override fun updateEndDate(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1CustomerCommitUpdateEndDateResponse> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
