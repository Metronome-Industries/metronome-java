 ...
 *
 */
class CustomerSetBillingConfigurationsParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerSetBillingConfigurationsParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerSetBillingConfigurationsParams: CustomerSetBillingConfigurationsParams) =
            apply {
                ...
                additionalQueryParams = customerSetBillingConfigurationsParams.additionalQueryParams.toBuilder()
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && data == other.data && additionalProperties == other.additionalProperties
        }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (billingProvider.asKnown().getOrNull()?.validity() ?: 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (configuration.asKnown().getOrNull()?.validity() ?: 0) + (deliveryMethod.asKnown().getOrNull()?.validity() ?: 0) + (if (deliveryMethodId.asKnown().isPresent) 1 else 0) + (taxProvider.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && billingProvider == other.billingProvider && customerId == other.customerId && configuration == other.configuration && deliveryMethod == other.deliveryMethod && deliveryMethodId == other.deliveryMethodId && taxProvider == other.taxProvider && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{billingProvider=$billingProvider, customerId=$customerId, configuration=$configuration, deliveryMethod=$deliveryMethod, deliveryMethodId=$deliveryMethodId, taxProvider=$taxProvider, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerSetBillingConfigurationsParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerSetBillingConfigurationsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
