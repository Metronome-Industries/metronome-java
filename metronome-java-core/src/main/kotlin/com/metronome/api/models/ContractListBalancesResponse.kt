...
@JsonDeserialize(builder = ContractListBalancesResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(contractListBalancesResponse: ContractListBalancesResponse) = apply {
            this.data = contractListBalancesResponse.data
            this.nextPage = contractListBalancesResponse.nextPage
            additionalProperties(contractListBalancesResponse.additionalProperties)
        }
