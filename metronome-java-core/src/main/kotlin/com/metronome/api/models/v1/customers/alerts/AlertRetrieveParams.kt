...
class AlertRetrieveParams private constructor(
     ...
     *
     * Unlike [plansOrContracts], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.alertId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertId(alertId: JsonField<String>) =
            apply {
                body.alertId(alertId)
            }
         ...
         *
         * You should usually call [Builder.plansOrContracts] with a well-typed [PlansOrContracts] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun plansOrContracts(plansOrContracts: JsonField<PlansOrContracts>) =
            apply {
                body.plansOrContracts(plansOrContracts)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("plans_or_contracts") @ExcludeMissing plansOrContracts: JsonField<PlansOrContracts> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun plansOrContracts(): Optional<PlansOrContracts> = plansOrContracts.getOptional("plans_or_contracts")
        ...
        @ExcludeMissing
        fun _alertId(): JsonField<String> = alertId
        ...
        class Builder internal constructor() {
            ...
            /** When parallel threshold notifications are enabled during migration, this flag denotes whether to fetch notifications for plans or contracts. */
            fun plansOrContracts(plansOrContracts: PlansOrContracts) = plansOrContracts(JsonField.of(plansOrContracts))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (alertId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (alertSpecifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (groupValues.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (plansOrContracts.asKnown().getOrNull()?.validity() ?: 0) + (seatFilter.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && alertId == other.alertId && customerId == other.customerId && alertSpecifiers == other.alertSpecifiers && groupValues == other.groupValues && plansOrContracts == other.plansOrContracts && seatFilter == other.seatFilter && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(alertId, customerId, alertSpecifiers, groupValues, plansOrContracts, seatFilter, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{alertId=$alertId, customerId=$customerId, alertSpecifiers=$alertSpecifiers, groupValues=$groupValues, plansOrContracts=$plansOrContracts, seatFilter=$seatFilter, additionalProperties=$additionalProperties}"
    }
    ...
    /** When parallel threshold notifications are enabled during migration, this flag denotes whether to fetch notifications for plans or contracts. */
    class PlansOrContracts @JsonCreator private constructor(
        private val value: JsonField<String>,
        ...
        enum class Value {
            PLANS,
            CONTRACTS,
            /** An enum member indicating that [PlansOrContracts] was instantiated with an unknown value. */
            _UNKNOWN,
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AlertRetrieveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "AlertRetrieveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
