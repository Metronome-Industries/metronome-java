 ...
 *
 */
class CustomerSetNameParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerSetNameParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerSetNameParams: CustomerSetNameParams) =
            apply {
                customerId = customerSetNameParams.customerId
                body = customerSetNameParams.body.toBuilder()
        ...
        /**
         * Returns an immutable instance of [CustomerSetNameParams].
         *
         ...
         */
        fun build(): CustomerSetNameParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerSetNameParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomerSetNameParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
