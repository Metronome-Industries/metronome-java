...
class PlanServiceAsyncImpl internal constructor(
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PlanServiceAsync = PlanServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun add(params: PlanAddParams, requestOptions: RequestOptions): CompletableFuture<PlanAddResponse> =
        // post /v1/customers/{customer_id}/plans/add
        withRawResponse().add(params, requestOptions).thenApply { it.parse() }

    override fun end(params: PlanEndParams, requestOptions: RequestOptions): CompletableFuture<PlanEndResponse> =
        // post /v1/customers/{customer_id}/plans/{customer_plan_id}/end
        withRawResponse().end(params, requestOptions).thenApply { it.parse() }

    override fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions): CompletableFuture<PlanListPriceAdjustmentsPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PlanServiceAsync.WithRawResponse = PlanServiceAsyncImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val listHandler: Handler<PlanListPageResponse> = jsonHandler<PlanListPageResponse>(clientOptions.jsonMapper)
        ...
        private val addHandler: Handler<PlanAddResponse> = jsonHandler<PlanAddResponse>(clientOptions.jsonMapper)

        override fun add(params: PlanAddParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanAddResponse>> {
          val request = HttpRequest.builder()
        ...
        private val endHandler: Handler<PlanEndResponse> = jsonHandler<PlanEndResponse>(clientOptions.jsonMapper)

        override fun end(params: PlanEndParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanEndResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("v1", "customers", params._pathParam(0), "plans", params._pathParam(1), "end")
            .body(json(clientOptions.jsonMapper, params._body()))
            .build()
            .prepareAsync(
              clientOptions, params
        ...
        private val listPriceAdjustmentsHandler: Handler<PlanListPriceAdjustmentsPageResponse> = jsonHandler<PlanListPriceAdjustmentsPageResponse>(clientOptions.jsonMapper)

        override fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PlanListPriceAdjustmentsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("v1", "customers", params._pathParam(0), "plans", params._pathParam(1), "priceAdjustments")
            .build()
            .prepareAsync(
              clientOptions, params
            )
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  listPriceAdjustmentsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
