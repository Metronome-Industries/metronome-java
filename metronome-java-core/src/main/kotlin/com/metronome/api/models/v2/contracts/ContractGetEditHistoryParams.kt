 ...
 *
 */
class ContractGetEditHistoryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractGetEditHistoryParams].
         *
    ...
    /** A builder for [ContractGetEditHistoryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractGetEditHistoryParams: ContractGetEditHistoryParams) =
            apply {
                body = contractGetEditHistoryParams.body.toBuilder()
                additionalHeaders = contractGetEditHistoryParams.additionalHeaders.toBuilder()
                additionalQueryParams = contractGetEditHistoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ContractGetEditHistoryParams].
         *
         ...
         */
        fun build(): ContractGetEditHistoryParams =
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractGetEditHistoryParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractGetEditHistoryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
