...
internal class AuditLogListResponseTest {
    ...
    @Test
    fun create() {
      val auditLogListResponse = AuditLogListResponse.builder()
          .id("id")
          .request(AuditLogListResponse.Request.builder()
              .id("id")
              .ip("ip")
          ...
          .action("action")
          .actor(AuditLogListResponse.Actor.builder()
              .id("id")
              .name("name")
              .email("email")
              .build())
      ...
      assertThat(auditLogListResponse.request()).isEqualTo(AuditLogListResponse.Request.builder()
          .id("id")
          .ip("ip")
          .userAgent("user_agent")
          .build())
      assertThat(auditLogListResponse.timestamp()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(auditLogListResponse.action()).contains("action")
      assertThat(auditLogListResponse.actor()).contains(AuditLogListResponse.Actor.builder()
          .id("id")
          .name("name")
          .email("email")
          .build())
    ...
    fun roundtrip() {
      ...
      val roundtrippedAuditLogListResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(auditLogListResponse), jacksonTypeRef<AuditLogListResponse>())
