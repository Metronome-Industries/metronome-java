 ...
 *
 */
class SettingUpsertAvalaraCredentialsParams private constructor(
     ...
     *
     * Unlike [avalaraEnvironment], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [deliveryMethodIds], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [commitTransactions], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SettingUpsertAvalaraCredentialsParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(settingUpsertAvalaraCredentialsParams: SettingUpsertAvalaraCredentialsParams) =
            apply {
                ...
                additionalQueryParams = settingUpsertAvalaraCredentialsParams.additionalQueryParams.toBuilder()
            }
         ...
         *
         * You should usually call [Builder.avalaraEnvironment] with a well-typed [AvalaraEnvironment] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avalaraEnvironment(avalaraEnvironment: JsonField<AvalaraEnvironment>) =
            apply {
                body.avalaraEnvironment(avalaraEnvironment)
            }
         ...
         *
         * You should usually call [Builder.avalaraPassword] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avalaraPassword(avalaraPassword: JsonField<String>) =
            apply {
                body.avalaraPassword(avalaraPassword)
            }
         ...
         *
         * You should usually call [Builder.avalaraUsername] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun avalaraUsername(avalaraUsername: JsonField<String>) =
            apply {
                body.avalaraUsername(avalaraUsername)
            }
         ...
         *
         * You should usually call [Builder.deliveryMethodIds] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun deliveryMethodIds(deliveryMethodIds: JsonField<List<String>>) =
            apply {
                body.deliveryMethodIds(deliveryMethodIds)
            }
         ...
         */
        fun addDeliveryMethodId(deliveryMethodId: String) =
            apply {
         ...
         *
         * You should usually call [Builder.commitTransactions] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun commitTransactions(commitTransactions: JsonField<Boolean>) =
            apply {
                body.commitTransactions(commitTransactions)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("avalara_environment") @ExcludeMissing avalaraEnvironment: JsonField<AvalaraEnvironment> = JsonMissing.of(),
            @JsonProperty("avalara_password") @ExcludeMissing avalaraPassword: JsonField<String> = JsonMissing.of(),
            @JsonProperty("avalara_username") @ExcludeMissing avalaraUsername: JsonField<String> = JsonMissing.of(),
            @JsonProperty("delivery_method_ids") @ExcludeMissing deliveryMethodIds: JsonField<List<String>> = JsonMissing.of(),
            @JsonProperty("commit_transactions") @ExcludeMissing commitTransactions: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          avalaraEnvironment,
          avalaraPassword,
          avalaraUsername,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun avalaraEnvironment(): AvalaraEnvironment = avalaraEnvironment.getRequired("avalara_environment")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun commitTransactions(): Optional<Boolean> = commitTransactions.getOptional("commit_transactions")
        ...
        class Builder internal constructor() {
            ...
            /** The Avalara environment to use (SANDBOX or PRODUCTION). */
            fun avalaraEnvironment(avalaraEnvironment: AvalaraEnvironment) = avalaraEnvironment(JsonField.of(avalaraEnvironment))
            ...
            /** The password for the Avalara account. */
            fun avalaraPassword(avalaraPassword: String) = avalaraPassword(JsonField.of(avalaraPassword))
            ...
            /** The username for the Avalara account. */
            fun avalaraUsername(avalaraUsername: String) = avalaraUsername(JsonField.of(avalaraUsername))
            ...
            /** The delivery method IDs of the billing provider configurations to update, can be found in the response of the `/listConfiguredBillingProviders` endpoint. */
            fun deliveryMethodIds(deliveryMethodIds: List<String>) = deliveryMethodIds(JsonField.of(deliveryMethodIds))
            ...
            fun addDeliveryMethodId(deliveryMethodId: String) =
                apply {
                    deliveryMethodIds = (deliveryMethodIds ?: JsonField.of(mutableListOf())).also {
                        checkKnown("deliveryMethodIds", it).add(deliveryMethodId)
                    }
                }

            /** Commit transactions if you want Metronome tax calculations used for reporting and tax filings. */
            fun commitTransactions(commitTransactions: Boolean) = commitTransactions(JsonField.of(commitTransactions))
            ...
            fun build(): Body =
                Body(
                  checkRequired(
                    "avalaraEnvironment", avalaraEnvironment
                  ),
                  checkRequired(
                    "avalaraPassword", avalaraPassword
                  ),
                  checkRequired(
                    "avalaraUsername", avalaraUsername
                  ),
                  checkRequired(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (avalaraEnvironment.asKnown().getOrNull()?.validity() ?: 0) + (if (avalaraPassword.asKnown().isPresent) 1 else 0) + (if (avalaraUsername.asKnown().isPresent) 1 else 0) + (deliveryMethodIds.asKnown().getOrNull()?.size ?: 0) + (if (commitTransactions.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && avalaraEnvironment == other.avalaraEnvironment && avalaraPassword == other.avalaraPassword && avalaraUsername == other.avalaraUsername && deliveryMethodIds == other.deliveryMethodIds && commitTransactions == other.commitTransactions && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{avalaraEnvironment=$avalaraEnvironment, avalaraPassword=$avalaraPassword, avalaraUsername=$avalaraUsername, deliveryMethodIds=$deliveryMethodIds, commitTransactions=$commitTransactions, additionalProperties=$additionalProperties}"
    }

    /** The Avalara environment to use (SANDBOX or PRODUCTION). */
    class AvalaraEnvironment @JsonCreator private constructor(
        ...
        enum class Value {
            PRODUCTION,
            SANDBOX,
            /** An enum member indicating that [AvalaraEnvironment] was instantiated with an unknown value. */
            _UNKNOWN,
        }
         ...
         *   expected type.
         */
        fun validate(): AvalaraEnvironment =
            apply {
                if (validated) {
                  return@apply
                }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is SettingUpsertAvalaraCredentialsParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "SettingUpsertAvalaraCredentialsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
