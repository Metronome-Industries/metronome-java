...
internal class ContractCreateHistoricalInvoicesResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedContractCreateHistoricalInvoicesResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(contractCreateHistoricalInvoicesResponse),
                jacksonTypeRef<ContractCreateHistoricalInvoicesResponse>(),
            )

        assertThat(roundtrippedContractCreateHistoricalInvoicesResponse)
            .isEqualTo(contractCreateHistoricalInvoicesResponse)
    }
}
