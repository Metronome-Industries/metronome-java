...
class BillableMetricCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricCreateResponse].
         *
    ...
    /** A builder for [BillableMetricCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricCreateResponse: BillableMetricCreateResponse) =
            apply {
                data = billableMetricCreateResponse.data
                additionalProperties = billableMetricCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BillableMetricCreateResponse].
         *
         ...
         */
        fun build(): BillableMetricCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): BillableMetricCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BillableMetricCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
