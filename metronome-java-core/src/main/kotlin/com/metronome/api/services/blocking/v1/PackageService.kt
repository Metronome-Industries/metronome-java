...
interface PackageService {
    ...
    ): PackageListContractsOnPackagePage = listContractsOnPackage(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * [PackageService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<PackageListPage> = list(PackageListParams.none())
        ...
        fun list(
            params: PackageListParams = PackageListParams.none()
        ): HttpResponseFor<PackageListPage> = list(params, RequestOptions.none())
         ...
         * otherwise the same as [PackageService.listContractsOnPackage].
         */
        @MustBeClosed
        fun listContractsOnPackage(
            params: PackageListContractsOnPackageParams
