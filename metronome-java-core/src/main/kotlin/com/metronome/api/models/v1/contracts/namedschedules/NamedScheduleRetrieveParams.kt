...
class NamedScheduleRetrieveParams private constructor(
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (rateCardId.asKnown().isPresent) 1 else 0) + (if (scheduleName.asKnown().isPresent) 1 else 0) + (if (coveringDate.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && rateCardId == other.rateCardId && scheduleName == other.scheduleName && coveringDate == other.coveringDate && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{rateCardId=$rateCardId, scheduleName=$scheduleName, coveringDate=$coveringDate, additionalProperties=$additionalProperties}"
    }
