...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = contractListBalancesResponse.accept(new ContractListBalancesResponse.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitCommit(Commit commit) {
     *         return Optional.of(commit.toString());
     *     }
     *
     *     // ...
     *
