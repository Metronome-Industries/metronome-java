...
interface ContractService {
     ...
     *
     */
    fun edit(params: ContractEditParams): ContractEditResponse =
        edit(
          params, RequestOptions.none()
        )

    /** @see edit */
    fun edit(params: ContractEditParams, requestOptions: RequestOptions = RequestOptions.none()): ContractEditResponse
    ...
    /** @see editCommit */
    fun editCommit(params: ContractEditCommitParams, requestOptions: RequestOptions = RequestOptions.none()): ContractEditCommitResponse
    ...
    /** @see editCredit */
    fun editCredit(params: ContractEditCreditParams, requestOptions: RequestOptions = RequestOptions.none()): ContractEditCreditResponse
    ...
    /** @see getEditHistory */
    fun getEditHistory(params: ContractGetEditHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): ContractGetEditHistoryResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v2/contracts/get`, but is otherwise the             same as [ContractService.retrieve]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v2/contracts/list`, but is otherwise the             same as [ContractService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v2/contracts/edit`, but is otherwise the             same as [ContractService.edit]. */
        @MustBeClosed
        ...
        /** @see edit */
        @MustBeClosed
        fun edit(params: ContractEditParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ContractEditResponse>

        /** Returns a raw HTTP response for `post /v2/contracts/commits/edit`, but is otherwise the             same as [ContractService.editCommit]. */
        @MustBeClosed
        fun editCommit(params: ContractEditCommitParams): HttpResponseFor<ContractEditCommitResponse> =
            editCommit(
              params, RequestOptions.none()
            )
        ...
        /** @see editCommit */
        @MustBeClosed
        fun editCommit(params: ContractEditCommitParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ContractEditCommitResponse>

        /** Returns a raw HTTP response for `post /v2/contracts/credits/edit`, but is otherwise the             same as [ContractService.editCredit]. */
        @MustBeClosed
        fun editCredit(params: ContractEditCreditParams): HttpResponseFor<ContractEditCreditResponse> =
            editCredit(
              params, RequestOptions.none()
            )
        ...
        /** @see editCredit */
        @MustBeClosed
        fun editCredit(params: ContractEditCreditParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ContractEditCreditResponse>

        /** Returns a raw HTTP response for `post /v2/contracts/getEditHistory`, but is otherwise the             same as [ContractService.getEditHistory]. */
        @MustBeClosed
        fun getEditHistory(params: ContractGetEditHistoryParams): HttpResponseFor<ContractGetEditHistoryResponse> =
            getEditHistory(
              params, RequestOptions.none()
            )
        ...
        /** @see getEditHistory */
        @MustBeClosed
        fun getEditHistory(params: ContractGetEditHistoryParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<ContractGetEditHistoryResponse>
    }
}
