...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(customerRetrieveResponse: CustomerRetrieveResponse) = apply {
            this.data = customerRetrieveResponse.data
            additionalProperties(customerRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): CustomerRetrieveResponse =
            CustomerRetrieveResponse(data, additionalProperties.toUnmodifiable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerRetrieveResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
