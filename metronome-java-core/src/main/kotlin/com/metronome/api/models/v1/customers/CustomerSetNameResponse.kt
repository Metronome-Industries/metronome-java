...
class CustomerSetNameResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerSetNameResponse].
         *
    ...
    /** A builder for [CustomerSetNameResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerSetNameResponse: CustomerSetNameResponse) =
            apply {
                data = customerSetNameResponse.data
                additionalProperties = customerSetNameResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomerSetNameResponse].
         *
         ...
         */
        fun build(): CustomerSetNameResponse =
     ...
     *   expected type.
     */
    fun validate(): CustomerSetNameResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerSetNameResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerSetNameResponse{data=$data, additionalProperties=$additionalProperties}"
}
