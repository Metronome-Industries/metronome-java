...
internal class QuantityRoundingTest {
    ...
    @Test
    fun create() {
      val quantityRounding = QuantityRounding.builder()
          .decimalPlaces(0.0)
          .roundingMethod(QuantityRounding.RoundingMethod.ROUND_UP)
          .build()

      assertThat(quantityRounding.decimalPlaces()).isEqualTo(0.0)
      assertThat(quantityRounding.roundingMethod()).isEqualTo(QuantityRounding.RoundingMethod.ROUND_UP)
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedQuantityRounding = jsonMapper.readValue(jsonMapper.writeValueAsString(quantityRounding), jacksonTypeRef<QuantityRounding>())
