...
import com.metronome.api.models.V1CustomerInvoiceListBreakdownsPage
import com.metronome.api.models.V1CustomerInvoiceListBreakdownsParams
import com.metronome.api.models.V1CustomerInvoiceListPage
...
class InvoiceServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val retrieveHandler: Handler<V1CustomerInvoiceRetrieveResponse> =
        jsonHandler<V1CustomerInvoiceRetrieveResponse>(clientOptions.jsonMapper)
    ...
    private val listHandler: Handler<V1CustomerInvoiceListPage.Response> =
        jsonHandler<V1CustomerInvoiceListPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): V1CustomerInvoiceListPage {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
                .addPathSegments("v1", "customers", params.getPathParam(0), "invoices")
                .build()
                .prepare(clientOptions, params)
        val response = clientOptions.httpClient.execute(request, requestOptions)
        return response
            ...
            .let { V1CustomerInvoiceListPage.of(this, params, it) }
    }

    private val addChargeHandler: Handler<V1CustomerInvoiceAddChargeResponse> =
        jsonHandler<V1CustomerInvoiceAddChargeResponse>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun addCharge(
        ...
        val request =
            HttpRequest.builder()
                ...
                .addPathSegments("v1", "customers", params.getPathParam(0), "addCharge")
    ...
    private val listBreakdownsHandler: Handler<V1CustomerInvoiceListBreakdownsPage.Response> =
        jsonHandler<V1CustomerInvoiceListBreakdownsPage.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun listBreakdowns(
        ...
        requestOptions: RequestOptions,
    ): V1CustomerInvoiceListBreakdownsPage {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.GET)
                .addPathSegments(
        ...
        return response
            ...
            .let { V1CustomerInvoiceListBreakdownsPage.of(this, params, it) }
    }
