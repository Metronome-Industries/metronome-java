...
interface CustomerService {
    ...
    /** @see create */
    fun create(params: CustomerCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreateResponse
    ...
    /** @see retrieve */
    fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerRetrieveResponse
    ...
    /** @see archive */
    fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerArchiveResponse

    /** @see archive */
    fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CustomerArchiveResponse =
        archive(
    ...
    /** @see archive */
    fun archive(id: Id): CustomerArchiveResponse =
        archive(
     ...
     *
     */
    fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams): CustomerArchiveBillingConfigurationsResponse =
        archiveBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see archiveBillingConfigurations */
    fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerArchiveBillingConfigurationsResponse
     ...
     *
     */
    fun listBillableMetrics(params: CustomerListBillableMetricsParams): CustomerListBillableMetricsPage =
        listBillableMetrics(
          params, RequestOptions.none()
        )

    /** @see listBillableMetrics */
    fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerListBillableMetricsPage
    ...
    /** @see listCosts */
    fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerListCostsPage
    ...
    /** @see previewEvents */
    fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerPreviewEventsResponse
     ...
     *
     */
    fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams): CustomerRetrieveBillingConfigurationsResponse =
        retrieveBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see retrieveBillingConfigurations */
    fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerRetrieveBillingConfigurationsResponse
     ...
     *
     */
    fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams): CustomerSetBillingConfigurationsResponse =
        setBillingConfigurations(
          params, RequestOptions.none()
        )

    /** @see setBillingConfigurations */
    fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerSetBillingConfigurationsResponse
    ...
    fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    /** @see setName */
    fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerSetNameResponse
    ...
    /** @see updateConfig */
    fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions = RequestOptions.none())
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/customers`, but is otherwise the             same as [CustomerService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: CustomerCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreateResponse>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}`, but is otherwise the             same as [CustomerService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: CustomerRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerRetrieveResponse>

        /** Returns a raw HTTP response for `get /v1/customers`, but is otherwise the             same as [CustomerService.list]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v1/customers/archive`, but is otherwise the             same as [CustomerService.archive]. */
        @MustBeClosed
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: CustomerArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerArchiveResponse>

        /** @see archive */
        @MustBeClosed
        fun archive(id: Id, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerArchiveResponse> =
            archive(
              CustomerArchiveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/archiveCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerService.archiveBillingConfigurations]. */
        @MustBeClosed
        fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams): HttpResponseFor<CustomerArchiveBillingConfigurationsResponse> =
            archiveBillingConfigurations(
              params, RequestOptions.none()
            )
        ...
        /** @see archiveBillingConfigurations */
        @MustBeClosed
        fun archiveBillingConfigurations(params: CustomerArchiveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerArchiveBillingConfigurationsResponse>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/billable-metrics`, but is otherwise the             same as [CustomerService.listBillableMetrics]. */
        @MustBeClosed
        fun listBillableMetrics(params: CustomerListBillableMetricsParams): HttpResponseFor<CustomerListBillableMetricsPage> =
            listBillableMetrics(
              params, RequestOptions.none()
            )
        ...
        /** @see listBillableMetrics */
        @MustBeClosed
        fun listBillableMetrics(params: CustomerListBillableMetricsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerListBillableMetricsPage>

        /** Returns a raw HTTP response for `get /v1/customers/{customer_id}/costs`, but is otherwise the             same as [CustomerService.listCosts]. */
        @MustBeClosed
        ...
        /** @see listCosts */
        @MustBeClosed
        fun listCosts(params: CustomerListCostsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerListCostsPage>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/previewEvents`, but is otherwise the             same as [CustomerService.previewEvents]. */
        @MustBeClosed
        fun previewEvents(params: CustomerPreviewEventsParams): HttpResponseFor<CustomerPreviewEventsResponse> =
            previewEvents(
              params, RequestOptions.none()
            )
        ...
        /** @see previewEvents */
        @MustBeClosed
        fun previewEvents(params: CustomerPreviewEventsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerPreviewEventsResponse>

        /** Returns a raw HTTP response for `post /v1/getCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerService.retrieveBillingConfigurations]. */
        @MustBeClosed
        fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams): HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse> =
            retrieveBillingConfigurations(
              params, RequestOptions.none()
            )
        ...
        /** @see retrieveBillingConfigurations */
        @MustBeClosed
        fun retrieveBillingConfigurations(params: CustomerRetrieveBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerRetrieveBillingConfigurationsResponse>

        /** Returns a raw HTTP response for `post /v1/setCustomerBillingProviderConfigurations`, but is otherwise the             same as [CustomerService.setBillingConfigurations]. */
        @MustBeClosed
        fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams): HttpResponseFor<CustomerSetBillingConfigurationsResponse> =
            setBillingConfigurations(
              params, RequestOptions.none()
            )
        ...
        /** @see setBillingConfigurations */
        @MustBeClosed
        fun setBillingConfigurations(params: CustomerSetBillingConfigurationsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerSetBillingConfigurationsResponse>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/setIngestAliases`, but is otherwise the             same as [CustomerService.setIngestAliases]. */
        @MustBeClosed
        ...
        /** @see setIngestAliases */
        @MustBeClosed
        fun setIngestAliases(params: CustomerSetIngestAliasesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/setName`, but is otherwise the             same as [CustomerService.setName]. */
        @MustBeClosed
        ...
        /** @see setName */
        @MustBeClosed
        fun setName(params: CustomerSetNameParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerSetNameResponse>

        /** Returns a raw HTTP response for `post /v1/customers/{customer_id}/updateConfig`, but is otherwise the             same as [CustomerService.updateConfig]. */
        @MustBeClosed
        ...
        /** @see updateConfig */
        @MustBeClosed
        fun updateConfig(params: CustomerUpdateConfigParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
