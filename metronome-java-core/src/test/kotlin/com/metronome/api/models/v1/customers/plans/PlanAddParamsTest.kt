...
internal class PlanAddParamsTest {
    ...
    fun create() {
      PlanAddParams.builder()
          ...
          .addOverageRateAdjustment(PlanAddParams.OverageRateAdjustment.builder()
              .customCreditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .fiatCurrencyCreditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .toFiatConversionFactor(0.0)
              .build())
          .addPriceAdjustment(PlanAddParams.PriceAdjustment.builder()
              ...
              .value(0.0)
              .build())
          .trialSpec(PlanAddParams.TrialSpec.builder()
              .lengthInDays(0.0)
              .spendingCap(PlanAddParams.TrialSpec.SpendingCap.builder()
                  .amount(0.0)
    ...
    @Test
    fun pathParams() {
      val params = PlanAddParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .planId("d2c06dae-9549-4d7d-bc04-b78dd3d241b8")
          .startingOn(OffsetDateTime.parse("2021-02-01T00:00:00Z"))
          .build()
    ...
    fun body() {
      ...
      assertThat(body.overageRateAdjustments().getOrNull()).containsExactly(PlanAddParams.OverageRateAdjustment.builder()
          .customCreditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .fiatCurrencyCreditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .toFiatConversionFactor(0.0)
          .build())
      assertThat(body.priceAdjustments().getOrNull()).containsExactly(PlanAddParams.PriceAdjustment.builder()
          .adjustmentType(PlanAddParams.PriceAdjustment.AdjustmentType.PERCENTAGE)
          .chargeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .startPeriod(0.0)
          .quantity(0.0)
          ...
          .value(0.0)
          .build())
      assertThat(body.trialSpec()).contains(PlanAddParams.TrialSpec.builder()
          .lengthInDays(0.0)
          .spendingCap(PlanAddParams.TrialSpec.SpendingCap.builder()
              .amount(0.0)
              .creditTypeId("credit_type_id")
