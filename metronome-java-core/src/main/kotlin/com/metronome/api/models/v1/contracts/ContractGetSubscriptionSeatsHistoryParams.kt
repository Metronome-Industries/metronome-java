 ...
 *
 */
class ContractGetSubscriptionSeatsHistoryParams private constructor(
    ...
    /** A builder for [ContractGetSubscriptionSeatsHistoryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractGetSubscriptionSeatsHistoryParams: ContractGetSubscriptionSeatsHistoryParams) =
            apply {
                body = contractGetSubscriptionSeatsHistoryParams.body.toBuilder()
                additionalHeaders = contractGetSubscriptionSeatsHistoryParams.additionalHeaders.toBuilder()
                additionalQueryParams = contractGetSubscriptionSeatsHistoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /** Alias for calling [Builder.coveringDate] with `coveringDate.orElse(null)`. */
        fun coveringDate(coveringDate: Optional<OffsetDateTime>) = coveringDate(coveringDate.getOrNull())
        ...
        /**
         * Returns an immutable instance of [ContractGetSubscriptionSeatsHistoryParams].
         *
         ...
         */
        fun build(): ContractGetSubscriptionSeatsHistoryParams =
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Get the seats history segment for the covering date. Cannot be used with `starting_at` or `ending_before`. */
            fun coveringDate(coveringDate: OffsetDateTime?) = coveringDate(JsonField.ofNullable(coveringDate))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (subscriptionId.asKnown().isPresent) 1 else 0) + (if (coveringDate.asKnown().isPresent) 1 else 0) + (if (cursor.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (limit.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && subscriptionId == other.subscriptionId && coveringDate == other.coveringDate && cursor == other.cursor && endingBefore == other.endingBefore && limit == other.limit && startingAt == other.startingAt && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(contractId, customerId, subscriptionId, coveringDate, cursor, endingBefore, limit, startingAt, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, subscriptionId=$subscriptionId, coveringDate=$coveringDate, cursor=$cursor, endingBefore=$endingBefore, limit=$limit, startingAt=$startingAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractGetSubscriptionSeatsHistoryParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractGetSubscriptionSeatsHistoryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
