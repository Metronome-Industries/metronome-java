...
internal class CustomerSetBillingConfigurationsParamsTest {
    ...
    @Test
    fun body() {
      val params = CustomerSetBillingConfigurationsParams.builder()
          .data(listOf(
            CustomerSetBillingConfigurationsParams.Data.builder()
                .billingProvider(CustomerSetBillingConfigurationsParams.Data.BillingProvider.STRIPE)
                .customerId("4db51251-61de-4bfe-b9ce-495e244f3491")
      ...
      assertThat(body.data()).containsExactly(CustomerSetBillingConfigurationsParams.Data.builder()
          .billingProvider(CustomerSetBillingConfigurationsParams.Data.BillingProvider.STRIPE)
          .customerId("4db51251-61de-4bfe-b9ce-495e244f3491")
          .configuration(CustomerSetBillingConfigurationsParams.Data.Configuration.builder()
              .putAdditionalProperty("stripe_customer_id", JsonValue.from("bar"))
          ...
          .deliveryMethodId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .taxProvider(CustomerSetBillingConfigurationsParams.Data.TaxProvider.ANROK)
          .build(), CustomerSetBillingConfigurationsParams.Data.builder()
          .billingProvider(CustomerSetBillingConfigurationsParams.Data.BillingProvider.AWS_MARKETPLACE)
          .customerId("4db51251-61de-4bfe-b9ce-495e244f3491")
          .configuration(CustomerSetBillingConfigurationsParams.Data.Configuration.builder()
              .putAdditionalProperty("aws_customer_id", JsonValue.from("bar"))
