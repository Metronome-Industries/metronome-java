    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * supported for Stripe billing provider configurations. When omitted, every invoice
                 * is sent to the billing provider.
                 *
                 * @throws MetronomeInvalidDataException if the JSON field has an unexpected type
                 *   (e.g. if the server responded with an unexpected value).
                 */
                fun unbillableInvoicesConfiguration():
                    Optional<List<UnbillableInvoicesConfiguration>> =
                 ...
                 *
                 * Unlike [unbillableInvoicesConfiguration], this method doesn't throw if the JSON
                 * field has an unexpected type.
                 */
                @JsonProperty("unbillable_invoices_configuration")
                @ExcludeMissing
                fun _unbillableInvoicesConfiguration():
                    JsonField<List<UnbillableInvoicesConfiguration>> =
                    unbillableInvoicesConfiguration
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(
                        ...
                        unbillableInvoicesConfiguration =
                            customerBillingProviderConfiguration.unbillableInvoicesConfiguration
                     ...
                     * Only supported for Stripe billing provider configurations. When omitted,
                     * every invoice is sent to the billing provider.
                     */
                    fun unbillableInvoicesConfiguration(
                        unbillableInvoicesConfiguration: List<UnbillableInvoicesConfiguration>
                    ) =
                        unbillableInvoicesConfiguration(
                            JsonField.of(unbillableInvoicesConfiguration)
                        )

                    /**
                     * Sets [Builder.unbillableInvoicesConfiguration] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.unbillableInvoicesConfiguration] with a
                     * well-typed `List<UnbillableInvoicesConfiguration>` value instead. This method
                    ...
                    fun addUnbillableInvoicesConfiguration(
                        ...
                        this.unbillableInvoicesConfiguration =
                            (this.unbillableInvoicesConfiguration ?: JsonField.of(mutableListOf()))
                                .also {
                    ...
                    fun build(): CustomerBillingProviderConfiguration =
                        CustomerBillingProviderConfiguration(
                            ...
                            (unbillableInvoicesConfiguration ?: JsonMissing.of()).map {
                                it.toImmutable()
                            },
                            additionalProperties.toMutableMap(),
                        )
                 ...
                 * invoices if omitted) and `fiat_credit_type_id` (or all invoices if omitted). Rule
                 * precedence is evaluated from more specific to less specific. This method will
                 * fail with a 400 if multiple rules with the same specificity are included.
                 */
                ...
                private constructor(
                    ...
                    /**
                     * Restricts the rule to invoices in this fiat currency. Omit for a catch-all
                     * rule that applies to every currency of the `invoice_type`. Required when
                     * `max_amount` is set.
                     *
                     * @throws MetronomeInvalidDataException if the JSON field has an unexpected
                    ...
                    /**
                     * A positive decimal, in the units of `fiat_credit_type_id`. Only invoices
                     * whose total is at or below this amount are suppressed; a higher total is
                     * still sent to the billing provider. When omitted, every matching invoice is
                     * suppressed regardless of amount.
                     *
                     * @throws MetronomeInvalidDataException if the JSON field has an unexpected
                     *   type (e.g. if the server responded with an unexpected value).
                     */
                     ...
                     *
                     * Unlike [invoiceType], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("invoice_type")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [maxAmount], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("max_amount")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        /** The type of invoice this rule applies to. */
                        fun invoiceType(invoiceType: InvoiceType) =
                            invoiceType(JsonField.of(invoiceType))

                        /**
                         * Sets [Builder.invoiceType] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.invoiceType] with a well-typed
                         * [InvoiceType] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.fiatCreditTypeId] with a well-typed
                         ...
                         * A positive decimal, in the units of `fiat_credit_type_id`. Only invoices
                         * whose total is at or below this amount are suppressed; a higher total is
                         * still sent to the billing provider. When omitted, every matching invoice
                         * is suppressed regardless of amount.
                         */
                         ...
                         *
                         * You should usually call [Builder.maxAmount] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun maxAmount(maxAmount: JsonField<Double>) = apply {
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        /**
                         * An enum containing [InvoiceType]'s known values, as well as an [_UNKNOWN]
                         * member.
                         *
                         * An instance of [InvoiceType] can contain an unknown value in a couple of
                         * cases:
                         * - It was deserialized from data that doesn't match any known member. For
                        ...
                        enum class Value {
                            ...
                            SCHEDULED,
                            /**
                             * An enum member indicating that [InvoiceType] was instantiated with an
                             * unknown value.
                             */
                            _UNKNOWN,
                        }
                ...
                override fun toString() =
                    "CustomerBillingProviderConfiguration{id=$id, archivedAt=$archivedAt, billingProvider=$billingProvider, configuration=$configuration, customerId=$customerId, deliveryMethod=$deliveryMethod, deliveryMethodConfiguration=$deliveryMethodConfiguration, deliveryMethodId=$deliveryMethodId, unbillableInvoicesConfiguration=$unbillableInvoicesConfiguration, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                 ...
                 *
                 * Unlike [anchorDate], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("anchor_date")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    /** The date this recurring commit's billing periods are anchored to. */
                    fun anchorDate(anchorDate: OffsetDateTime) =
                        anchorDate(JsonField.of(anchorDate))

                    /**
                     * Sets [Builder.anchorDate] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.anchorDate] with a well-typed
                     * [OffsetDateTime] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
