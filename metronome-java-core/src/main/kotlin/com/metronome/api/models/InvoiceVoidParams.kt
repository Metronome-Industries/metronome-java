...
constructor(
    ...
    @JvmSynthetic internal fun getBody(): InvoiceVoidBody = body
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InvoiceVoidParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
