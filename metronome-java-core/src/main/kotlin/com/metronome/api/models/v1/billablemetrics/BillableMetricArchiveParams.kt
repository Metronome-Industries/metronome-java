 ...
 *
 */
class BillableMetricArchiveParams private constructor(
    private val id: Id,
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricArchiveParams: BillableMetricArchiveParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricArchiveParams && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(id, additionalHeaders, additionalQueryParams)

    override fun toString() = "BillableMetricArchiveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
