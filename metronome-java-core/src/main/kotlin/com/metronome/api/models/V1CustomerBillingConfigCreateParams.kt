 ...
 */
class V1CustomerBillingConfigCreateParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && billingProviderCustomerId == other.billingProviderCustomerId && awsCustomerAccountId == other.awsCustomerAccountId && awsCustomerId == other.awsCustomerId && awsProductCode == other.awsProductCode && awsRegion == other.awsRegion && stripeCollectionMethod == other.stripeCollectionMethod && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1CustomerBillingConfigCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerBillingConfigCreateParams: V1CustomerBillingConfigCreateParams
        ) = apply {
            customerId = v1CustomerBillingConfigCreateParams.customerId
            billingProviderType = v1CustomerBillingConfigCreateParams.billingProviderType
            body = v1CustomerBillingConfigCreateParams.body.toBuilder()
            additionalHeaders = v1CustomerBillingConfigCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerBillingConfigCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerBillingConfigCreateParams =
            V1CustomerBillingConfigCreateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerBillingConfigCreateParams && customerId == other.customerId && billingProviderType == other.billingProviderType && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerBillingConfigCreateParams{customerId=$customerId, billingProviderType=$billingProviderType, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
