 ...
 *
 */
class InvoiceRetrievePdfParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvoiceRetrievePdfParams].
         *
    ...
    /** A builder for [InvoiceRetrievePdfParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceRetrievePdfParams: InvoiceRetrievePdfParams) =
            apply {
                customerId = invoiceRetrievePdfParams.customerId
                invoiceId = invoiceRetrievePdfParams.invoiceId
                additionalHeaders = invoiceRetrievePdfParams.additionalHeaders.toBuilder()
                additionalQueryParams = invoiceRetrievePdfParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [InvoiceRetrievePdfParams].
         *
         ...
         */
        fun build(): InvoiceRetrievePdfParams =
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceRetrievePdfParams && customerId == other.customerId && invoiceId == other.invoiceId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, invoiceId, additionalHeaders, additionalQueryParams)

    override fun toString() = "InvoiceRetrievePdfParams{customerId=$customerId, invoiceId=$invoiceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
