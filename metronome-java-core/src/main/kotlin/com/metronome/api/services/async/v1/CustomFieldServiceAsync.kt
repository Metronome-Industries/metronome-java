...
interface CustomFieldServiceAsync {
    ...
    /** @see addKey */
    fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see deleteValues */
    fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
     ...
     *
     */
    fun listKeys(): CompletableFuture<CustomFieldListKeysPageAsync> = listKeys(CustomFieldListKeysParams.none())

    /** @see listKeys */
    fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<CustomFieldListKeysPageAsync>

    /** @see listKeys */
    fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none()): CompletableFuture<CustomFieldListKeysPageAsync> =
        listKeys(
          params, RequestOptions.none()
        )
    ...
    fun listKeys(requestOptions: RequestOptions): CompletableFuture<CustomFieldListKeysPageAsync> =
        listKeys(
          CustomFieldListKeysParams.none(), requestOptions
        )
    ...
    /** @see removeKey */
    fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>
    ...
    /** @see setValues */
    fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Void?>

    /** A view of [CustomFieldServiceAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/customFields/addKey`, but is otherwise the             same as [CustomFieldServiceAsync.addKey]. */
        ...
        /** @see addKey */
        fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/customFields/deleteValues`, but is otherwise the             same as [CustomFieldServiceAsync.deleteValues]. */
        ...
        /** @see deleteValues */
        fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/customFields/listKeys`, but is otherwise the             same as [CustomFieldServiceAsync.listKeys]. */
        fun listKeys(): CompletableFuture<HttpResponseFor<CustomFieldListKeysPageAsync>> = listKeys(CustomFieldListKeysParams.none())

        /** @see listKeys */
        fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<CustomFieldListKeysPageAsync>>

        /** @see listKeys */
        fun listKeys(params: CustomFieldListKeysParams = CustomFieldListKeysParams.none()): CompletableFuture<HttpResponseFor<CustomFieldListKeysPageAsync>> =
            listKeys(
              params, RequestOptions.none()
            )

        /** @see listKeys */
        fun listKeys(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CustomFieldListKeysPageAsync>> =
            listKeys(
              CustomFieldListKeysParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /v1/customFields/removeKey`, but is otherwise the             same as [CustomFieldServiceAsync.removeKey]. */
        ...
        /** @see removeKey */
        fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>

        /** Returns a raw HTTP response for `post /v1/customFields/setValues`, but is otherwise the             same as [CustomFieldServiceAsync.setValues]. */
        ...
        /** @see setValues */
        fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponse>
    }
}
