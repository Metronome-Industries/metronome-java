...
internal class CommitRateTest {
    ...
    @Test
    fun create() {
      val commitRate = CommitRate.builder()
      ...
      assertThat(commitRate.tiers().getOrNull()).containsExactly(CommitRate.Tier.builder()
          .price(0.0)
          .size(0.0)
          .build())
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedCommitRate = jsonMapper.readValue(jsonMapper.writeValueAsString(commitRate), jacksonTypeRef<CommitRate>())
