...
interface SettingServiceAsync {
     ...
     *
     */
    fun upsertAvalaraCredentials(params: SettingUpsertAvalaraCredentialsParams): CompletableFuture<SettingUpsertAvalaraCredentialsResponse> =
        upsertAvalaraCredentials(
          params, RequestOptions.none()
        )

    /** @see upsertAvalaraCredentials */
    fun upsertAvalaraCredentials(params: SettingUpsertAvalaraCredentialsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<SettingUpsertAvalaraCredentialsResponse>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): SettingServiceAsync.WithRawResponse

        /** Use these endpoints to configure a billing API key, a webhook secret, or invoice finalization behavior. */
        fun billingProviders(): BillingProviderServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/upsertAvalaraCredentials`, but is otherwise the             same as [SettingServiceAsync.upsertAvalaraCredentials]. */
        fun upsertAvalaraCredentials(params: SettingUpsertAvalaraCredentialsParams): CompletableFuture<HttpResponseFor<SettingUpsertAvalaraCredentialsResponse>> =
            upsertAvalaraCredentials(
              params, RequestOptions.none()
            )

        /** @see upsertAvalaraCredentials */
        fun upsertAvalaraCredentials(params: SettingUpsertAvalaraCredentialsParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<SettingUpsertAvalaraCredentialsResponse>>
    }
}
