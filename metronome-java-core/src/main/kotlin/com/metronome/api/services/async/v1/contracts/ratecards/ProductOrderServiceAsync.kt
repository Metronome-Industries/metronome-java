...
interface ProductOrderServiceAsync {
    ...
    /** @see update */
    fun update(params: ProductOrderUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductOrderUpdateResponse>
    ...
    /** @see set */
    fun set(params: ProductOrderSetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductOrderSetResponse>

    /** A view of [ProductOrderServiceAsync] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): ProductOrderServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/moveRateCardProducts`, but is otherwise the             same as [ProductOrderServiceAsync.update]. */
        fun update(params: ProductOrderUpdateParams): CompletableFuture<HttpResponseFor<ProductOrderUpdateResponse>> =
            update(
              params, RequestOptions.none()
            )

        /** @see update */
        fun update(params: ProductOrderUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductOrderUpdateResponse>>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/setRateCardProductsOrder`, but is otherwise the             same as [ProductOrderServiceAsync.set]. */
        fun set(params: ProductOrderSetParams): CompletableFuture<HttpResponseFor<ProductOrderSetResponse>> =
            set(
              params, RequestOptions.none()
            )

        /** @see set */
        fun set(params: ProductOrderSetParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductOrderSetResponse>>
    }
}
