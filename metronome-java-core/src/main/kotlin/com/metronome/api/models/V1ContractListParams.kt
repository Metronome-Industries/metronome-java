...
private constructor(
    ...
    /** A builder for [V1ContractListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractListParams: V1ContractListParams) = apply {
            body = v1ContractListParams.body.toBuilder()
            additionalHeaders = v1ContractListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
