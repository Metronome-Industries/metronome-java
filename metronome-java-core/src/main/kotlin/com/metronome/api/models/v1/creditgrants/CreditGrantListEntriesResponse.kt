...
import com.metronome.api.models.v1.creditgrants.CreditGrantListEntriesResponse
...
class CreditGrantListEntriesResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @ExcludeMissing
    fun _ledgers(): JsonField<List<Ledger>> = ledgers
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditGrantListEntriesResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGrantListEntriesResponse: CreditGrantListEntriesResponse) =
            apply {
                customerId = creditGrantListEntriesResponse.customerId
                ledgers = creditGrantListEntriesResponse.ledgers.map { it.toMutableList() }
                additionalProperties = creditGrantListEntriesResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.ledgers] with a well-typed `List<Ledger>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun ledgers(ledgers: JsonField<List<Ledger>>) =
            apply {
        ...
        fun addLedger(ledger: Ledger) =
            apply {
                ledgers = (ledgers ?: JsonField.of(mutableListOf())).also {
     ...
     *   expected type.
     */
    fun validate(): CreditGrantListEntriesResponse =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (customerId.asKnown().isPresent) 1 else 0) + (ledgers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    class Ledger @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("ending_balance") @ExcludeMissing endingBalance: JsonField<EndingBalance> = JsonMissing.of(),
            @JsonProperty("entries") @ExcludeMissing entries: JsonField<List<CreditLedgerEntry>> = JsonMissing.of(),
            @JsonProperty("pending_entries") @ExcludeMissing pendingEntries: JsonField<List<CreditLedgerEntry>> = JsonMissing.of(),
            @JsonProperty("starting_balance") @ExcludeMissing startingBalance: JsonField<StartingBalance> = JsonMissing.of()
        ) : this(
          creditType,
          endingBalance,
          entries,
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun pendingEntries(): List<CreditLedgerEntry> = pendingEntries.getRequired("pending_entries")
         ...
         *
         * Unlike [pendingEntries], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            /** the effective balances at the end of the specified time window */
            fun endingBalance(endingBalance: EndingBalance) = endingBalance(JsonField.of(endingBalance))

            /**
             * Sets [Builder.endingBalance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.endingBalance] with a well-typed [EndingBalance] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun endingBalance(endingBalance: JsonField<EndingBalance>) =
                apply {
             ...
             *
             * You should usually call [Builder.entries] with a well-typed `List<CreditLedgerEntry>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun entries(entries: JsonField<List<CreditLedgerEntry>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addEntry(entry: CreditLedgerEntry) =
                apply {
            ...
            fun pendingEntries(pendingEntries: List<CreditLedgerEntry>) = pendingEntries(JsonField.of(pendingEntries))

            /**
             * Sets [Builder.pendingEntries] to an arbitrary JSON value.
             *
             * You should usually call [Builder.pendingEntries] with a well-typed `List<CreditLedgerEntry>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun pendingEntries(pendingEntries: JsonField<List<CreditLedgerEntry>>) =
                apply {
             ...
             * @throws IllegalStateException if the field was previously set to a non-list.
             */
            fun addPendingEntry(pendingEntry: CreditLedgerEntry) =
                apply {
                    pendingEntries = (pendingEntries ?: JsonField.of(mutableListOf())).also {
                        checkKnown("pendingEntries", it).add(pendingEntry)
                    }
                }

            fun startingBalance(startingBalance: StartingBalance) = startingBalance(JsonField.of(startingBalance))

            /**
             * Sets [Builder.startingBalance] to an arbitrary JSON value.
             *
             * You should usually call [Builder.startingBalance] with a well-typed [StartingBalance] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun startingBalance(startingBalance: JsonField<StartingBalance>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditType.asKnown().getOrNull()?.validity() ?: 0) + (endingBalance.asKnown().getOrNull()?.validity() ?: 0) + (entries.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (pendingEntries.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (startingBalance.asKnown().getOrNull()?.validity() ?: 0)

        /** the effective balances at the end of the specified time window */
        class EndingBalance @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(endingBalance: EndingBalance) =
                    apply {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is EndingBalance && effectiveAt == other.effectiveAt && excludingPending == other.excludingPending && includingPending == other.includingPending && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "EndingBalance{effectiveAt=$effectiveAt, excludingPending=$excludingPending, includingPending=$includingPending, additionalProperties=$additionalProperties}"
        }

        class StartingBalance @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val effectiveAt: JsonField<OffsetDateTime>,
            private val excludingPending: JsonField<Double>,
            private val includingPending: JsonField<Double>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(startingBalance: StartingBalance) =
                    apply {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is StartingBalance && effectiveAt == other.effectiveAt && excludingPending == other.excludingPending && includingPending == other.includingPending && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "StartingBalance{effectiveAt=$effectiveAt, excludingPending=$excludingPending, includingPending=$includingPending, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Ledger && creditType == other.creditType && endingBalance == other.endingBalance && entries == other.entries && pendingEntries == other.pendingEntries && startingBalance == other.startingBalance && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Ledger{creditType=$creditType, endingBalance=$endingBalance, entries=$entries, pendingEntries=$pendingEntries, startingBalance=$startingBalance, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditGrantListEntriesResponse && customerId == other.customerId && ledgers == other.ledgers && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditGrantListEntriesResponse{customerId=$customerId, ledgers=$ledgers, additionalProperties=$additionalProperties}"
}
