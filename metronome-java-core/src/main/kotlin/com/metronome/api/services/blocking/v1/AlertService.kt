...
interface AlertService {
    ...
    /** @see create */
    fun create(params: AlertCreateParams, requestOptions: RequestOptions = RequestOptions.none()): AlertCreateResponse
    ...
    /** @see archive */
    fun archive(params: AlertArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): AlertArchiveResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/alerts/create`, but is otherwise the             same as [AlertService.create]. */
        @MustBeClosed
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: AlertCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertCreateResponse>

        /** Returns a raw HTTP response for `post /v1/alerts/archive`, but is otherwise the             same as [AlertService.archive]. */
        @MustBeClosed
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: AlertArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertArchiveResponse>
    }
}
