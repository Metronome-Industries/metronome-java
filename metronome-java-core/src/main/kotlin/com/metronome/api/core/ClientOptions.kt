...
import com.metronome.api.core.DefaultSleeper
import com.metronome.api.core.LogLevel
import com.metronome.api.core.PhantomReachableExecutorService
import com.metronome.api.core.PhantomReachableSleeper
import com.metronome.api.core.Sleeper
import com.metronome.api.core.Timeout
import com.metronome.api.core.checkJacksonVersionCompatibility
...
import com.metronome.api.core.http.PhantomReachableClosingHttpClient
...
class ClientOptions private constructor(
     ...
     *
     * Use the one published in `metronome-java-client-okhttp` or implement your
     * own.
     *
     ...
     *
     * Defaults to [com.metronome.api.core.jsonMapper]. The default is usually sufficient
     ...
     *
     * Defaults to the production environment: `https://api.metronome.com`.
     */
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() =
            apply {
                ...
                (System.getProperty("metronome.baseUrl") ?: System.getenv("METRONOME_BASE_URL"))?.let {
                    baseUrl(it)
                }
                (System.getProperty("metronome.bearerToken") ?: System.getenv("METRONOME_BEARER_TOKEN"))?.let {
                    bearerToken(it)
                }
                (System.getProperty("metronome.webhookSecret") ?: System.getenv("METRONOME_WEBHOOK_SECRET"))?.let {
                    webhookSecret(it)
                }
                System.getenv("METRONOME_CUSTOM_HEADERS")?.let { customHeadersEnv ->
                  ...
                  object : ThreadFactory {
                      ...
                      override fun newThread(runnable: Runnable): Thread =
                          threadFactory.newThread(runnable).also {
                              it.name = "metronome-stream-handler-thread-${count.getAndIncrement()}"
                          }
                  }
              )
          )
