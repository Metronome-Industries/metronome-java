...
class V1ContractCreateHistoricalInvoicesResponseTest {

    @Test
    fun createV1ContractCreateHistoricalInvoicesResponse() {
        val v1ContractCreateHistoricalInvoicesResponse =
            V1ContractCreateHistoricalInvoicesResponse.builder()
                .addData(
                    Invoice.builder()
                ...
                .build()
        assertThat(v1ContractCreateHistoricalInvoicesResponse).isNotNull
        assertThat(v1ContractCreateHistoricalInvoicesResponse.data())
            .containsExactly(
                Invoice.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
