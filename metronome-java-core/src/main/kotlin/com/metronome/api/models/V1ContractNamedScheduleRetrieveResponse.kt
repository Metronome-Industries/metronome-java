...
@NoAutoDetect
class V1ContractNamedScheduleRetrieveResponse
@JsonCreator
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    ...
    fun validate(): V1ContractNamedScheduleRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractNamedScheduleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractNamedScheduleRetrieveResponse: V1ContractNamedScheduleRetrieveResponse
        ) = apply {
            data = v1ContractNamedScheduleRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties =
                v1ContractNamedScheduleRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ContractNamedScheduleRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractNamedScheduleRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractNamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
