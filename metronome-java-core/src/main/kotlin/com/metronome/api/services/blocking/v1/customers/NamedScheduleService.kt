...
interface NamedScheduleService {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/customers/getNamedSchedule`, but is otherwise the             same as [NamedScheduleService.retrieve]. */
        @MustBeClosed
        ...
        /** Returns a raw HTTP response for `post /v1/customers/updateNamedSchedule`, but is otherwise the             same as [NamedScheduleService.update]. */
        @MustBeClosed
