...
class PlanListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<PlanListResponse>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PlanListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planListPageResponse: PlanListPageResponse) =
            apply {
                data = planListPageResponse.data.map { it.toMutableList() }
                nextPage = planListPageResponse.nextPage
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<PlanListResponse>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PlanListResponse>>) =
            apply {
         ...
         */
        fun addData(data: PlanListResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): PlanListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PlanListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
