...
class InvoiceVoidResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [InvoiceVoidResponse]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceVoidResponse: InvoiceVoidResponse) =
            apply {
        ...
        /**
         * Returns an immutable instance of [InvoiceVoidResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): InvoiceVoidResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is InvoiceVoidResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "InvoiceVoidResponse{data=$data, additionalProperties=$additionalProperties}"
}
