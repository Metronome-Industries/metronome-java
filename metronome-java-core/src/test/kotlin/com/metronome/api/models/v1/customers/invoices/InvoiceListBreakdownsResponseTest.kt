...
internal class InvoiceListBreakdownsResponseTest {
    ...
    @Test
    fun create() {
        val invoiceListBreakdownsResponse =
            InvoiceListBreakdownsResponse.builder()
        ...
        assertThat(invoiceListBreakdownsResponse.id())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse.creditType())
            .isEqualTo(
                CreditTypeData.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .name("name")
        ...
        assertThat(invoiceListBreakdownsResponse.customerId())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse.lineItems())
            .containsExactly(
                Invoice.LineItem.builder()
                    .creditType(
                        CreditTypeData.builder()
        ...
        assertThat(invoiceListBreakdownsResponse.amendmentId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse._billableStatus())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(invoiceListBreakdownsResponse.constituentInvoices().getOrNull())
            .containsExactly(
                Invoice.ConstituentInvoice.builder()
                    .contractId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .customerId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(invoiceListBreakdownsResponse.contractCustomFields())
            .contains(
                Invoice.ContractCustomFields.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(invoiceListBreakdownsResponse.contractId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse.correctionRecord())
            .contains(
                Invoice.CorrectionRecord.builder()
                    .correctedInvoiceId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .memo("memo")
        ...
        assertThat(invoiceListBreakdownsResponse.createdAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceListBreakdownsResponse.customFields())
            .contains(
                Invoice.CustomFields.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
            )
        assertThat(invoiceListBreakdownsResponse.customerCustomFields())
            .contains(
                Invoice.CustomerCustomFields.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(invoiceListBreakdownsResponse.endTimestamp())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceListBreakdownsResponse.externalInvoice())
            .contains(
                Invoice.ExternalInvoice.builder()
                    .billingProviderType(
                        Invoice.ExternalInvoice.BillingProviderType.AWS_MARKETPLACE
        ...
        assertThat(invoiceListBreakdownsResponse.invoiceAdjustments().getOrNull())
            .containsExactly(
                Invoice.InvoiceAdjustment.builder()
                    .creditType(
                        CreditTypeData.builder()
        ...
        assertThat(invoiceListBreakdownsResponse.issuedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceListBreakdownsResponse.netPaymentTermsDays()).contains(0.0)
        assertThat(invoiceListBreakdownsResponse.netsuiteSalesOrderId())
            .contains("netsuite_sales_order_id")
        assertThat(invoiceListBreakdownsResponse.payer())
            .contains(
                Invoice.Payer.builder()
                    .contractId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .customerId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(invoiceListBreakdownsResponse.planCustomFields())
            .contains(
                Invoice.PlanCustomFields.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(invoiceListBreakdownsResponse.planId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse.planName()).contains("plan_name")
        assertThat(invoiceListBreakdownsResponse.regeneratedFromInvoiceId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(invoiceListBreakdownsResponse.resellerRoyalty())
            .contains(
                Invoice.ResellerRoyalty.builder()
                    .fraction("fraction")
                    .netsuiteResellerId("netsuite_reseller_id")
        ...
        assertThat(invoiceListBreakdownsResponse.revenueSystemInvoices().getOrNull())
            .containsExactly(
                Invoice.RevenueSystemInvoice.builder()
                    .revenueSystemExternalEntityType("revenue_system_external_entity_type")
                    .revenueSystemProvider("revenue_system_provider")
        ...
        assertThat(invoiceListBreakdownsResponse.salesforceOpportunityId())
            .contains("salesforce_opportunity_id")
        assertThat(invoiceListBreakdownsResponse.startTimestamp())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceListBreakdownsResponse.subtotal()).contains(0.0)
        assertThat(invoiceListBreakdownsResponse.breakdownEndTimestamp())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(invoiceListBreakdownsResponse.breakdownStartTimestamp())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedInvoiceListBreakdownsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(invoiceListBreakdownsResponse),
                jacksonTypeRef<InvoiceListBreakdownsResponse>(),
            )

        assertThat(roundtrippedInvoiceListBreakdownsResponse)
            .isEqualTo(invoiceListBreakdownsResponse)
    }
}
