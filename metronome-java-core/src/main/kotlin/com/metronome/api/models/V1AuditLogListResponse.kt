...
private constructor(
    ...
    fun validate(): V1AuditLogListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1AuditLogListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1AuditLogListResponse: V1AuditLogListResponse) = apply {
            id = v1AuditLogListResponse.id
            request = v1AuditLogListResponse.request
            timestamp = v1AuditLogListResponse.timestamp
            action = v1AuditLogListResponse.action
            actor = v1AuditLogListResponse.actor
            description = v1AuditLogListResponse.description
            resourceId = v1AuditLogListResponse.resourceId
            resourceType = v1AuditLogListResponse.resourceType
            status = v1AuditLogListResponse.status
            additionalProperties = v1AuditLogListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1AuditLogListResponse =
    ...
    override fun toString() =
        "V1AuditLogListResponse{id=$id, request=$request, timestamp=$timestamp, action=$action, actor=$actor, description=$description, resourceId=$resourceId, resourceType=$resourceType, status=$status, additionalProperties=$additionalProperties}"
}
