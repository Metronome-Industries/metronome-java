...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.metronome.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.metronome.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.metronome.api.** {
    <init>(...);
