...
class NamedScheduleRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NamedScheduleRetrieveResponse].
         *
    ...
    /** A builder for [NamedScheduleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namedScheduleRetrieveResponse: NamedScheduleRetrieveResponse) =
            apply {
                data = namedScheduleRetrieveResponse.data.map { it.toMutableList() }
                additionalProperties = namedScheduleRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NamedScheduleRetrieveResponse].
         *
         ...
         */
        fun build(): NamedScheduleRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): NamedScheduleRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         * ```java
         * MyClass myObject = data.value().convert(MyClass.class);
         * ```
         */
        @JsonProperty("value")
        @ExcludeMissing
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && startingAt == other.startingAt && value == other.value && endingBefore == other.endingBefore && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{startingAt=$startingAt, value=$value, endingBefore=$endingBefore, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is NamedScheduleRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "NamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
