...
internal class CommitCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.accessSchedule()).isEqualTo(CommitCreateParams.AccessSchedule.builder()
          .addScheduleItem(CommitCreateParams.AccessSchedule.ScheduleItem.builder()
              .amount(1000.0)
              .endingBefore(OffsetDateTime.parse("2020-02-01T00:00:00.000Z"))
              .startingAt(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
      ...
      assertThat(body.customFields()).contains(CommitCreateParams.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(body.description()).contains("description")
      assertThat(body.invoiceContractId()).contains("e57d6929-c2f1-4796-a9a8-63cedefe848d")
      assertThat(body.invoiceSchedule()).contains(CommitCreateParams.InvoiceSchedule.builder()
          .creditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
          .doNotInvoice(false)
          .recurringSchedule(CommitCreateParams.InvoiceSchedule.RecurringSchedule.builder()
              .amountDistribution(CommitCreateParams.InvoiceSchedule.RecurringSchedule.AmountDistribution.DIVIDED)
