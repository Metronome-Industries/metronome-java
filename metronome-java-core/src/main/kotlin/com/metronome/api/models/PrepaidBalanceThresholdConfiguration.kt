...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Commit{productId=$productId, description=$description, name=$name, applicableProductIds=$applicableProductIds, applicableProductTags=$applicableProductTags, specifiers=$specifiers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "PrepaidBalanceThresholdConfiguration{commit=$commit, isEnabled=$isEnabled, paymentGateConfig=$paymentGateConfig, rechargeToAmount=$rechargeToAmount, thresholdAmount=$thresholdAmount, customCreditTypeId=$customCreditTypeId, additionalProperties=$additionalProperties}"
}
