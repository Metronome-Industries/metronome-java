...
class InvoiceTest {
    ...
    fun createInvoice() {
        ...
        assertThat(invoice.billableStatus()).isEqualTo(Invoice.BillableStatus.BILLABLE)
        ...
        assertThat(invoice.netsuiteSalesOrderId()).contains("string")
        ...
        assertThat(invoice.planName()).contains("string")
        ...
        assertThat(invoice.salesforceOpportunityId()).contains("string")
