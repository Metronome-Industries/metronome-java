...
class PlanListPriceAdjustmentsPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<PlanListPriceAdjustmentsPageAsync> = service.listPriceAdjustments(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlanListPriceAdjustmentsPageAsync].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanListPriceAdjustmentsPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "PlanListPriceAdjustmentsPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
