...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = childAccess.accept(new ChildAccess.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitCommitHierarchyChildAccessAll(CommitHierarchyChildAccessAll commitHierarchyChildAccessAll) {
         *         return Optional.of(commitHierarchyChildAccessAll.toString());
         *     }
         *
         *     // ...
         *
