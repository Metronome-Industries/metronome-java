...
internal class OffsetListPageResponseTest {
    ...
    @Test
    fun create() {
        val offsetListPageResponse =
            OffsetListPageResponse.builder()
                .addData(
        ...
        assertThat(offsetListPageResponse.data())
            .containsExactly(
                LifecycleEventOffsetNotificationConfig.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .archivedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedOffsetListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(offsetListPageResponse),
                jacksonTypeRef<OffsetListPageResponse>(),
            )
