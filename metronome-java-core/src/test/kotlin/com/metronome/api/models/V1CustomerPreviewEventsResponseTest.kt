...
class V1CustomerPreviewEventsResponseTest {

    @Test
    fun createV1CustomerPreviewEventsResponse() {
        val v1CustomerPreviewEventsResponse =
            V1CustomerPreviewEventsResponse.builder()
                .addData(
                    Invoice.builder()
                ...
                .build()
        assertThat(v1CustomerPreviewEventsResponse).isNotNull
        assertThat(v1CustomerPreviewEventsResponse.data())
            .containsExactly(
                Invoice.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
