 ...
 */
class V1CustomerInvoiceAddChargeParams
private constructor(
    ...
    /** A builder for [V1CustomerInvoiceAddChargeParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerInvoiceAddChargeParams: V1CustomerInvoiceAddChargeParams) =
            apply {
                customerId = v1CustomerInvoiceAddChargeParams.customerId
                body = v1CustomerInvoiceAddChargeParams.body.toBuilder()
                additionalHeaders = v1CustomerInvoiceAddChargeParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v1CustomerInvoiceAddChargeParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): V1CustomerInvoiceAddChargeParams =
            V1CustomerInvoiceAddChargeParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerInvoiceAddChargeParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(customerId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerInvoiceAddChargeParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
