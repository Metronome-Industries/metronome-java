 ...
 */
class V1ContractProductUpdateParams
private constructor(
    ...
    /** A builder for [V1ContractProductUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractProductUpdateParams: V1ContractProductUpdateParams) = apply {
            body = v1ContractProductUpdateParams.body.toBuilder()
            additionalHeaders = v1ContractProductUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractProductUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractProductUpdateParams =
            V1ContractProductUpdateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractProductUpdateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractProductUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
