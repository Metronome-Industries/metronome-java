...
class V1PaymentAttemptResponseTest {

    @Test
    fun createV1PaymentAttemptResponse() {
        val v1PaymentAttemptResponse =
            V1PaymentAttemptResponse.builder()
                .data(
                    Payment.builder()
                ...
                .build()
        assertThat(v1PaymentAttemptResponse).isNotNull
        assertThat(v1PaymentAttemptResponse.data())
            .isEqualTo(
                Payment.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0.0)
