...
interface PackageServiceAsync {
    ...
    /** @see create */
    fun create(params: PackageCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PackageCreateResponse>
    ...
    /** @see retrieve */
    fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PackageRetrieveResponse>
    ...
    /** @see list */
    fun list(params: PackageListParams = PackageListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PackageListPageAsync>

    /** @see list */
    fun list(params: PackageListParams = PackageListParams.none()): CompletableFuture<PackageListPageAsync> =
        list(
          params, RequestOptions.none()
        )
    ...
    /** @see archive */
    fun archive(params: PackageArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PackageArchiveResponse>
     ...
     *
     */
    fun listContractsOnPackage(params: PackageListContractsOnPackageParams): CompletableFuture<PackageListContractsOnPackagePageAsync> =
        listContractsOnPackage(
          params, RequestOptions.none()
        )

    /** @see listContractsOnPackage */
    fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PackageListContractsOnPackagePageAsync>
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): PackageServiceAsync.WithRawResponse

        /** Returns a raw HTTP response for `post /v1/packages/create`, but is otherwise the             same as [PackageServiceAsync.create]. */
        fun create(params: PackageCreateParams): CompletableFuture<HttpResponseFor<PackageCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: PackageCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PackageCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/packages/get`, but is otherwise the             same as [PackageServiceAsync.retrieve]. */
        fun retrieve(params: PackageRetrieveParams): CompletableFuture<HttpResponseFor<PackageRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: PackageRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PackageRetrieveResponse>>

        /** Returns a raw HTTP response for `post /v1/packages/list`, but is otherwise the             same as [PackageServiceAsync.list]. */
        fun list(): CompletableFuture<HttpResponseFor<PackageListPageAsync>> = list(PackageListParams.none())

        /** @see list */
        fun list(params: PackageListParams = PackageListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PackageListPageAsync>>

        /** @see list */
        fun list(params: PackageListParams = PackageListParams.none()): CompletableFuture<HttpResponseFor<PackageListPageAsync>> =
            list(
              params, RequestOptions.none()
            )

        /** @see list */
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PackageListPageAsync>> =
            list(
              PackageListParams.none(), requestOptions
            )

        /** Returns a raw HTTP response for `post /v1/packages/archive`, but is otherwise the             same as [PackageServiceAsync.archive]. */
        fun archive(params: PackageArchiveParams): CompletableFuture<HttpResponseFor<PackageArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: PackageArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PackageArchiveResponse>>

        /** Returns a raw HTTP response for `post /v1/packages/listContractsOnPackage`, but is otherwise the             same as [PackageServiceAsync.listContractsOnPackage]. */
        fun listContractsOnPackage(params: PackageListContractsOnPackageParams): CompletableFuture<HttpResponseFor<PackageListContractsOnPackagePageAsync>> =
            listContractsOnPackage(
              params, RequestOptions.none()
            )

        /** @see listContractsOnPackage */
        fun listContractsOnPackage(params: PackageListContractsOnPackageParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PackageListContractsOnPackagePageAsync>>
    }
}
