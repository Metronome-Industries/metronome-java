...
class InvoiceServiceAsyncImpl internal constructor(
    ...
    override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<InvoiceRetrieveResponse> =
    ...
    override fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions): CompletableFuture<InvoiceAddChargeResponse> =
        // post /v1/customers/{customer_id}/addCharge
        withRawResponse().addCharge(params, requestOptions).thenApply { it.parse() }

    override fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions): CompletableFuture<InvoiceListBreakdownsPageAsync> =
        // get /v1/customers/{customer_id}/invoices/breakdowns
        withRawResponse().listBreakdowns(params, requestOptions).thenApply { it.parse() }

    override fun retrievePdf(params: InvoiceRetrievePdfParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val retrieveHandler: Handler<InvoiceRetrieveResponse> = jsonHandler<InvoiceRetrieveResponse>(clientOptions.jsonMapper)

        override fun retrieve(params: InvoiceRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceRetrieveResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("v1", "customers", params._pathParam(0), "invoices", params._pathParam(1))
            .build()
            .prepareAsync(
        ...
        private val listHandler: Handler<InvoiceListPageResponse> = jsonHandler<InvoiceListPageResponse>(clientOptions.jsonMapper)
        ...
        private val addChargeHandler: Handler<InvoiceAddChargeResponse> = jsonHandler<InvoiceAddChargeResponse>(clientOptions.jsonMapper)

        override fun addCharge(params: InvoiceAddChargeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceAddChargeResponse>> {
          val request = HttpRequest.builder()
        ...
        private val listBreakdownsHandler: Handler<InvoiceListBreakdownsPageResponse> = jsonHandler<InvoiceListBreakdownsPageResponse>(clientOptions.jsonMapper)

        override fun listBreakdowns(params: InvoiceListBreakdownsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InvoiceListBreakdownsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("v1", "customers", params._pathParam(0), "invoices", "breakdowns")
            .build()
            .prepareAsync(
              clientOptions, params
            )
          ...
          return request.thenComposeAsync { clientOptions.httpClient.executeAsync(
            it, requestOptions
              ...
              response.use {
                  listBreakdownsHandler.handle(it)
              }
              .also {
                  if (requestOptions.responseValidation!!) {
                    it.validate()
        ...
        override fun retrievePdf(params: InvoiceRetrievePdfParams, requestOptions: RequestOptions): CompletableFuture<HttpResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
            .addPathSegments("v1", "customers", params._pathParam(0), "invoices", params._pathParam(1), "pdf")
