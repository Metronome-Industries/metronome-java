 ...
 *
 */
class ContractListBalancesParams private constructor(
     ...
     *
     * Unlike [excludeZeroBalances], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [includeContractBalances], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractListBalancesParams: ContractListBalancesParams) =
            apply {
         ...
         *
         * You should usually call [Builder.excludeZeroBalances] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun excludeZeroBalances(excludeZeroBalances: JsonField<Boolean>) =
            apply {
                body.excludeZeroBalances(excludeZeroBalances)
            }
         ...
         *
         * You should usually call [Builder.includeContractBalances] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun includeContractBalances(includeContractBalances: JsonField<Boolean>) =
            apply {
                body.includeContractBalances(includeContractBalances)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("exclude_zero_balances") @ExcludeMissing excludeZeroBalances: JsonField<Boolean> = JsonMissing.of(),
            ...
            @JsonProperty("include_contract_balances") @ExcludeMissing includeContractBalances: JsonField<Boolean> = JsonMissing.of(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun excludeZeroBalances(): Optional<Boolean> = excludeZeroBalances.getOptional("exclude_zero_balances")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun includeContractBalances(): Optional<Boolean> = includeContractBalances.getOptional("include_contract_balances")
        ...
        class Builder internal constructor() {
            ...
            /** Exclude balances with zero amounts from the response. */
            fun excludeZeroBalances(excludeZeroBalances: Boolean) = excludeZeroBalances(JsonField.of(excludeZeroBalances))
            ...
            /** Include balances on the contract level. */
            fun includeContractBalances(includeContractBalances: Boolean) = includeContractBalances(JsonField.of(includeContractBalances))
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (customerId.asKnown().isPresent) 1 else 0) + (if (id.asKnown().isPresent) 1 else 0) + (if (coveringDate.asKnown().isPresent) 1 else 0) + (if (effectiveBefore.asKnown().isPresent) 1 else 0) + (if (excludeZeroBalances.asKnown().isPresent) 1 else 0) + (if (includeArchived.asKnown().isPresent) 1 else 0) + (if (includeBalance.asKnown().isPresent) 1 else 0) + (if (includeContractBalances.asKnown().isPresent) 1 else 0) + (if (includeLedgers.asKnown().isPresent) 1 else 0) + (if (limit.asKnown().isPresent) 1 else 0) + (if (nextPage.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && customerId == other.customerId && id == other.id && coveringDate == other.coveringDate && effectiveBefore == other.effectiveBefore && excludeZeroBalances == other.excludeZeroBalances && includeArchived == other.includeArchived && includeBalance == other.includeBalance && includeContractBalances == other.includeContractBalances && includeLedgers == other.includeLedgers && limit == other.limit && nextPage == other.nextPage && startingAt == other.startingAt && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(customerId, id, coveringDate, effectiveBefore, excludeZeroBalances, includeArchived, includeBalance, includeContractBalances, includeLedgers, limit, nextPage, startingAt, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{customerId=$customerId, id=$id, coveringDate=$coveringDate, effectiveBefore=$effectiveBefore, excludeZeroBalances=$excludeZeroBalances, includeArchived=$includeArchived, includeBalance=$includeBalance, includeContractBalances=$includeContractBalances, includeLedgers=$includeLedgers, limit=$limit, nextPage=$nextPage, startingAt=$startingAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractListBalancesParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractListBalancesParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
