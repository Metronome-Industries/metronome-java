...
@JsonDeserialize(builder = CustomerCreateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(customerCreateResponse: CustomerCreateResponse) = apply {
            this.data = customerCreateResponse.data
            additionalProperties(customerCreateResponse.additionalProperties)
        }
        ...
        fun build(): CustomerCreateResponse =
            CustomerCreateResponse(data, additionalProperties.toUnmodifiable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerCreateResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
