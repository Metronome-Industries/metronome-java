...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerInvoiceListBreakdownsResponse && this.id == other.id && this.customerId == other.customerId && this.customerCustomFields == other.customerCustomFields && this.netsuiteSalesOrderId == other.netsuiteSalesOrderId && this.salesforceOpportunityId == other.salesforceOpportunityId && this.netPaymentTermsDays == other.netPaymentTermsDays && this.creditType == other.creditType && this.invoiceAdjustments == other.invoiceAdjustments && this.lineItems == other.lineItems && this.startTimestamp == other.startTimestamp && this.endTimestamp == other.endTimestamp && this.issuedAt == other.issuedAt && this.createdAt == other.createdAt && this.status == other.status && this.subtotal == other.subtotal && this.total == other.total && this.type == other.type && this.externalInvoice == other.externalInvoice && this.planId == other.planId && this.planName == other.planName && this.planCustomFields == other.planCustomFields && this.contractId == other.contractId && this.contractCustomFields == other.contractCustomFields && this.amendmentId == other.amendmentId && this.correctionRecord == other.correctionRecord && this.resellerRoyalty == other.resellerRoyalty && this.customFields == other.customFields && this.billableStatus == other.billableStatus && this.breakdownStartTimestamp == other.breakdownStartTimestamp && this.breakdownEndTimestamp == other.breakdownEndTimestamp && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
