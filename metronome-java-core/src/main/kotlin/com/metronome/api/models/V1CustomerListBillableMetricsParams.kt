 ...
 */
class V1CustomerListBillableMetricsParams
private constructor(
    ...
    /** A builder for [V1CustomerListBillableMetricsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerListBillableMetricsParams: V1CustomerListBillableMetricsParams
        ) = apply {
            customerId = v1CustomerListBillableMetricsParams.customerId
            includeArchived = v1CustomerListBillableMetricsParams.includeArchived
            limit = v1CustomerListBillableMetricsParams.limit
            nextPage = v1CustomerListBillableMetricsParams.nextPage
            onCurrentPlan = v1CustomerListBillableMetricsParams.onCurrentPlan
            additionalHeaders = v1CustomerListBillableMetricsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerListBillableMetricsParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerListBillableMetricsParams =
            V1CustomerListBillableMetricsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerListBillableMetricsParams && customerId == other.customerId && includeArchived == other.includeArchived && limit == other.limit && nextPage == other.nextPage && onCurrentPlan == other.onCurrentPlan && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerListBillableMetricsParams{customerId=$customerId, includeArchived=$includeArchived, limit=$limit, nextPage=$nextPage, onCurrentPlan=$onCurrentPlan, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
