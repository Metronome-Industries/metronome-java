...
interface ProductServiceAsync {
    ...
    /** @see create */
    fun create(params: ProductCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductCreateResponse>
    ...
    /** @see retrieve */
    fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductRetrieveResponse>

    /** @see retrieve */
    fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductRetrieveResponse> =
        retrieve(
    ...
    /** @see update */
    fun update(params: ProductUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductUpdateResponse>
    ...
    /** @see archive */
    fun archive(params: ProductArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<ProductArchiveResponse>
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/create`, but is otherwise the             same as [ProductServiceAsync.create]. */
        fun create(params: ProductCreateParams): CompletableFuture<HttpResponseFor<ProductCreateResponse>> =
            create(
              params, RequestOptions.none()
            )

        /** @see create */
        fun create(params: ProductCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductCreateResponse>>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/get`, but is otherwise the             same as [ProductServiceAsync.retrieve]. */
        fun retrieve(params: ProductRetrieveParams): CompletableFuture<HttpResponseFor<ProductRetrieveResponse>> =
            retrieve(
              params, RequestOptions.none()
            )

        /** @see retrieve */
        fun retrieve(params: ProductRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductRetrieveResponse>>

        /** @see retrieve */
        fun retrieve(id: Id, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductRetrieveResponse>> =
            retrieve(
              ProductRetrieveParams.builder()
                  .id(id)
                  .build(), requestOptions
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/update`, but is otherwise the             same as [ProductServiceAsync.update]. */
        fun update(params: ProductUpdateParams): CompletableFuture<HttpResponseFor<ProductUpdateResponse>> =
            update(
              params, RequestOptions.none()
            )

        /** @see update */
        fun update(params: ProductUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductUpdateResponse>>

        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/list`, but is otherwise the             same as [ProductServiceAsync.list]. */
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/products/archive`, but is otherwise the             same as [ProductServiceAsync.archive]. */
        fun archive(params: ProductArchiveParams): CompletableFuture<HttpResponseFor<ProductArchiveResponse>> =
            archive(
              params, RequestOptions.none()
            )

        /** @see archive */
        fun archive(params: ProductArchiveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<ProductArchiveResponse>>
    }
}
