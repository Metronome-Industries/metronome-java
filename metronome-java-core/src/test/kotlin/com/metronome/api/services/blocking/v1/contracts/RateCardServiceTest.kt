...
internal class RateCardServiceTest {
    ...
    fun create() {
      ...
      val rateCard = rateCardService.create(RateCardCreateParams.builder()
          .name("My Rate Card")
    ...
    fun retrieve() {
      ...
      val rateCard = rateCardService.retrieve(Id.builder()
    ...
    fun update() {
      ...
      val rateCard = rateCardService.update(RateCardUpdateParams.builder()
    ...
    fun archive() {
      ...
      val response = rateCardService.archive(Id.builder()
    ...
    fun retrieveRateSchedule() {
      ...
      val response = rateCardService.retrieveRateSchedule(RateCardRetrieveRateScheduleParams.builder()
          .limit(1L)
          .nextPage("next_page")
