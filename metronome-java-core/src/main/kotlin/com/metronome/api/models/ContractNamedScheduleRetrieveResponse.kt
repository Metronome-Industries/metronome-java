...
@JsonDeserialize(builder = ContractNamedScheduleRetrieveResponse.Builder::class)
@NoAutoDetect
class ContractNamedScheduleRetrieveResponse
private constructor(
    ...
    fun validate(): ContractNamedScheduleRetrieveResponse = apply {
        if (!validated) {
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(
            contractNamedScheduleRetrieveResponse: ContractNamedScheduleRetrieveResponse
        ) = apply {
            this.data = contractNamedScheduleRetrieveResponse.data
            additionalProperties(contractNamedScheduleRetrieveResponse.additionalProperties)
        }
        ...
        fun build(): ContractNamedScheduleRetrieveResponse =
