...
class InvoiceServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listHandler: Handler<V1CustomerInvoiceListPageAsync.Response> =
        jsonHandler<V1CustomerInvoiceListPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1CustomerInvoiceListPageAsync.of(this, params, it) }
            }
    }
    ...
    private val listBreakdownsHandler: Handler<V1CustomerInvoiceListBreakdownsPageAsync.Response> =
        jsonHandler<V1CustomerInvoiceListBreakdownsPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1CustomerInvoiceListBreakdownsPageAsync.of(this, params, it) }
            }
    }
