...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(customerInvoiceRetrieveResponse: CustomerInvoiceRetrieveResponse) =
            apply {
                this.data = customerInvoiceRetrieveResponse.data
                additionalProperties(customerInvoiceRetrieveResponse.additionalProperties)
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerInvoiceRetrieveResponse && this.data == other.data && this.additionalProperties == other.additionalProperties /* spotless:on */
    }
