...
interface CreditService {
     ...
     *
     */
    fun create(params: CreditCreateParams): CreditCreateResponse =
        create(
          params, RequestOptions.none()
        )

    /** @see create */
    fun create(params: CreditCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CreditCreateResponse
     ...
     *
     */
    fun list(params: CreditListParams): CreditListPage =
        list(
          params, RequestOptions.none()
        )

    /** @see list */
    fun list(params: CreditListParams, requestOptions: RequestOptions = RequestOptions.none()): CreditListPage
     ...
     *
     */
    fun updateEndDate(params: CreditUpdateEndDateParams): CreditUpdateEndDateResponse =
        updateEndDate(
          params, RequestOptions.none()
        )

    /** @see updateEndDate */
    fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): CreditUpdateEndDateResponse
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/create`, but is otherwise the             same as [CreditService.create]. */
        @MustBeClosed
        fun create(params: CreditCreateParams): HttpResponseFor<CreditCreateResponse> =
            create(
              params, RequestOptions.none()
            )
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: CreditCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditCreateResponse>

        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/list`, but is otherwise the             same as [CreditService.list]. */
        @MustBeClosed
        fun list(params: CreditListParams): HttpResponseFor<CreditListPage> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: CreditListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditListPage>

        /** Returns a raw HTTP response for `post /v1/contracts/customerCredits/updateEndDate`, but is otherwise the             same as [CreditService.updateEndDate]. */
        @MustBeClosed
        fun updateEndDate(params: CreditUpdateEndDateParams): HttpResponseFor<CreditUpdateEndDateResponse> =
            updateEndDate(
              params, RequestOptions.none()
            )
        ...
        /** @see updateEndDate */
        @MustBeClosed
        fun updateEndDate(params: CreditUpdateEndDateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditUpdateEndDateResponse>
    }
}
