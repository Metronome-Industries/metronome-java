 ...
 *
 */
class BillableMetricRetrieveParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricRetrieveParams].
         *
    ...
    /** A builder for [BillableMetricRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricRetrieveParams: BillableMetricRetrieveParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [BillableMetricRetrieveParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricRetrieveParams && billableMetricId == other.billableMetricId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(billableMetricId, additionalHeaders, additionalQueryParams)

    override fun toString() = "BillableMetricRetrieveParams{billableMetricId=$billableMetricId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
