...
import com.metronome.api.models.V1CustomerAlertListPageAsync
...
class AlertServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    ): CompletableFuture<V1CustomerAlertRetrieveResponse> {
        val request =
            HttpRequest.builder()
    ...
    private val listHandler: Handler<V1CustomerAlertListPageAsync.Response> =
        jsonHandler<V1CustomerAlertListPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
    ...
    override fun list(
        ...
        requestOptions: RequestOptions,
    ): CompletableFuture<V1CustomerAlertListPageAsync> {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1CustomerAlertListPageAsync.of(this, params, it) }
            }
    }
