...
class RateCardServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listHandler: Handler<V1ContractRateCardListPageAsync.Response> =
        jsonHandler<V1ContractRateCardListPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1ContractRateCardListPageAsync.of(this, params, it) }
            }
    }
