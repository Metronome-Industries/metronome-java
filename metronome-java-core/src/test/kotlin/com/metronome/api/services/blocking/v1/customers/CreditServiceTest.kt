...
internal class CreditServiceTest {
    ...
    fun create() {
      ...
      val credit = creditService.create(CreditCreateParams.builder()
    ...
    fun list() {
      ...
      val page = creditService.list(CreditListParams.builder()
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .build())
    ...
    fun updateEndDate() {
      ...
      val response = creditService.updateEndDate(CreditUpdateEndDateParams.builder()
