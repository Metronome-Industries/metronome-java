...
private constructor(
    ...
    /** A builder for [MetronomeError]. */
    class Builder internal constructor() {

        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(metronomeError: MetronomeError) = apply {
            additionalProperties = metronomeError.additionalProperties.toMutableMap()
        }
