...
class ContractRetrieveSubscriptionQuantityHistoryResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractRetrieveSubscriptionQuantityHistoryResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractRetrieveSubscriptionQuantityHistoryResponse: ContractRetrieveSubscriptionQuantityHistoryResponse) =
            apply {
                data = contractRetrieveSubscriptionQuantityHistoryResponse.data
                additionalProperties = contractRetrieveSubscriptionQuantityHistoryResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ContractRetrieveSubscriptionQuantityHistoryResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("history") @ExcludeMissing history: JsonField<List<History>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _history(): JsonField<List<History>> = history
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.history] with a well-typed `List<History>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun history(history: JsonField<List<History>>) =
                apply {
            ...
            fun addHistory(history: History) =
                apply {
                    this.history = (this.history ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (fiatCreditTypeId.asKnown().isPresent) 1 else 0) + (history.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (subscriptionId.asKnown().isPresent) 1 else 0)

        class History @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("data") @ExcludeMissing data: JsonField<List<InnerData>> = JsonMissing.of(),
            ...
            @JsonProperty("data")
            @ExcludeMissing
            fun _data(): JsonField<List<InnerData>> = data
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(history: History) =
                    apply {
                 ...
                 * Sets [Builder.data] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.data] with a well-typed `List<InnerData>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun data(data: JsonField<List<InnerData>>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (data.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0)

            class InnerData @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (quantity.asKnown().isPresent) 1 else 0) + (if (total.asKnown().isPresent) 1 else 0) + (if (unitPrice.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is InnerData && quantity == other.quantity && total == other.total && unitPrice == other.unitPrice && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "InnerData{quantity=$quantity, total=$total, unitPrice=$unitPrice, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is History && data == other.data && startingAt == other.startingAt && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "History{data=$data, startingAt=$startingAt, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && fiatCreditTypeId == other.fiatCreditTypeId && history == other.history && subscriptionId == other.subscriptionId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{fiatCreditTypeId=$fiatCreditTypeId, history=$history, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractRetrieveSubscriptionQuantityHistoryResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractRetrieveSubscriptionQuantityHistoryResponse{data=$data, additionalProperties=$additionalProperties}"
}
