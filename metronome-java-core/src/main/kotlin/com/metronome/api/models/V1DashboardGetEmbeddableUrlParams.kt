 ...
 */
class V1DashboardGetEmbeddableUrlParams
private constructor(
    ...
    /** A builder for [V1DashboardGetEmbeddableUrlParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1DashboardGetEmbeddableUrlParams: V1DashboardGetEmbeddableUrlParams) =
            apply {
                body = v1DashboardGetEmbeddableUrlParams.body.toBuilder()
                additionalHeaders = v1DashboardGetEmbeddableUrlParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v1DashboardGetEmbeddableUrlParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): V1DashboardGetEmbeddableUrlParams =
            V1DashboardGetEmbeddableUrlParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1DashboardGetEmbeddableUrlParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1DashboardGetEmbeddableUrlParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
