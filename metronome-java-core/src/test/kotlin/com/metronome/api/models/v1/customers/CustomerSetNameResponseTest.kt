...
internal class CustomerSetNameResponseTest {
    ...
    @Test
    fun create() {
      val customerSetNameResponse = CustomerSetNameResponse.builder()
          .data(Customer.builder()
              .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .externalId("external_id")
              .addIngestAlias("string")
              .name("name")
              .customFields(Customer.CustomFields.builder()
                  .putAdditionalProperty("foo", JsonValue.from("string"))
                  .build())
              .build())
          .build()

      assertThat(customerSetNameResponse.data()).isEqualTo(Customer.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .externalId("external_id")
          .addIngestAlias("string")
          .name("name")
    ...
    fun roundtrip() {
      ...
      val roundtrippedCustomerSetNameResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(customerSetNameResponse), jacksonTypeRef<CustomerSetNameResponse>())
