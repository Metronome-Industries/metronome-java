...
internal class RateCardServiceAsyncTest {
    ...
    fun create() {
      ...
      val rateCardFuture = rateCardServiceAsync.create(RateCardCreateParams.builder()
          .name("My Rate Card")
          .addAlias(RateCardCreateParams.Alias.builder()
              .name("my-rate-card")
              .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .startingAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .build())
          .addCreditTypeConversion(RateCardCreateParams.CreditTypeConversion.builder()
              .customCreditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
              .fiatPerCustomCredit(2.0)
              .build())
          .customFields(RateCardCreateParams.CustomFields.builder()
    ...
    fun retrieve() {
      ...
      val rateCardFuture = rateCardServiceAsync.retrieve(Id.builder()
    ...
    fun update() {
      ...
      val rateCardFuture = rateCardServiceAsync.update(RateCardUpdateParams.builder()
          .rateCardId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .addAddCreditTypeConversion(RateCardUpdateParams.AddCreditTypeConversion.builder()
              .customCreditTypeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
              .fiatPerCustomCredit(0.0)
              .build())
          .addAlias(RateCardUpdateParams.Alias.builder()
              .name("name")
              .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .startingAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .build())
    ...
    fun archive() {
      ...
      val responseFuture = rateCardServiceAsync.archive(Id.builder()
    ...
    fun retrieveRateSchedule() {
      ...
      val responseFuture = rateCardServiceAsync.retrieveRateSchedule(RateCardRetrieveRateScheduleParams.builder()
          .limit(1L)
          .nextPage("next_page")
          .rateCardId("f3d51ae8-f283-44e1-9933-a3cf9ad7a6fe")
          .startingAt(OffsetDateTime.parse("2024-01-01T00:00:00.000Z"))
          .endingBefore(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addSelector(RateCardRetrieveRateScheduleParams.Selector.builder()
              .billingFrequency(RateCardRetrieveRateScheduleParams.Selector.BillingFrequency.MONTHLY)
              .partialPricingGroupValues(RateCardRetrieveRateScheduleParams.Selector.PartialPricingGroupValues.builder()
                  .putAdditionalProperty("region", JsonValue.from("us-west-2"))
                  .putAdditionalProperty("cloud", JsonValue.from("aws"))
                  .build())
              .pricingGroupValues(RateCardRetrieveRateScheduleParams.Selector.PricingGroupValues.builder()
                  .putAdditionalProperty("foo", JsonValue.from("string"))
                  .build())
