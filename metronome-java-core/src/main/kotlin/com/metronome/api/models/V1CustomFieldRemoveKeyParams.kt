...
/**
 * Removes a custom field key from the allowlist for a specific entity type, preventing future use
 * of that key across all instances of the entity. Existing values for this key on entity instances
 * will no longer be accessible once the key is removed.
 */
class V1CustomFieldRemoveKeyParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && entity == other.entity && key == other.key && additionalProperties == other.additionalProperties /* spotless:on */
        }

        /* spotless:off */
        private val hashCode: Int by lazy { Objects.hash(entity, key, additionalProperties) }
        /* spotless:on */

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{entity=$entity, key=$key, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [V1CustomFieldRemoveKeyParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomFieldRemoveKeyParams: V1CustomFieldRemoveKeyParams) = apply {
            body = v1CustomFieldRemoveKeyParams.body.toBuilder()
            additionalHeaders = v1CustomFieldRemoveKeyParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomFieldRemoveKeyParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomFieldRemoveKeyParams =
            V1CustomFieldRemoveKeyParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomFieldRemoveKeyParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomFieldRemoveKeyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
