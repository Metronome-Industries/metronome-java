...
class CustomerPreviewEventsResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerPreviewEventsResponse].
         *
    ...
    /** A builder for [CustomerPreviewEventsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerPreviewEventsResponse: CustomerPreviewEventsResponse) =
            apply {
                data = customerPreviewEventsResponse.data.map { it.toMutableList() }
                additionalProperties = customerPreviewEventsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomerPreviewEventsResponse].
         *
         ...
         */
        fun build(): CustomerPreviewEventsResponse =
     ...
     *   expected type.
     */
    fun validate(): CustomerPreviewEventsResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerPreviewEventsResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CustomerPreviewEventsResponse{data=$data, additionalProperties=$additionalProperties}"
}
