...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentCancelResponse].
         *
    ...
    /** A builder for [PaymentCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(paymentCancelResponse: PaymentCancelResponse) = apply {
            data = paymentCancelResponse.data
            additionalProperties = paymentCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentCancelResponse].
         *
         ...
         */
        fun build(): PaymentCancelResponse =
            PaymentCancelResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PaymentCancelResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PaymentCancelResponse{data=$data, additionalProperties=$additionalProperties}"
}
