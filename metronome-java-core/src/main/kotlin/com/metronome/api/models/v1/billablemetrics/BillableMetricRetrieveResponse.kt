...
class BillableMetricRetrieveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricRetrieveResponse: BillableMetricRetrieveResponse) =
            apply {
                data = billableMetricRetrieveResponse.data
                additionalProperties = billableMetricRetrieveResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): BillableMetricRetrieveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (aggregationKey.asKnown().isPresent) 1 else 0) + (aggregationType.asKnown().getOrNull()?.validity() ?: 0) + (if (archivedAt.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (eventTypeFilter.asKnown().getOrNull()?.validity() ?: 0) + (groupKeys.asKnown().getOrNull()?.sumOf { it.size.toInt() } ?: 0) + (propertyFilters.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (sql.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && id == other.id && name == other.name && aggregationKey == other.aggregationKey && aggregationType == other.aggregationType && archivedAt == other.archivedAt && customFields == other.customFields && eventTypeFilter == other.eventTypeFilter && groupKeys == other.groupKeys && propertyFilters == other.propertyFilters && sql == other.sql && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{id=$id, name=$name, aggregationKey=$aggregationKey, aggregationType=$aggregationType, archivedAt=$archivedAt, customFields=$customFields, eventTypeFilter=$eventTypeFilter, groupKeys=$groupKeys, propertyFilters=$propertyFilters, sql=$sql, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BillableMetricRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
