 ...
 */
class V1ContractRateCardNamedScheduleRetrieveParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && contractId == other.contractId && customerId == other.customerId && scheduleName == other.scheduleName && coveringDate == other.coveringDate && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1ContractRateCardNamedScheduleRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRateCardNamedScheduleRetrieveParams:
                V1ContractRateCardNamedScheduleRetrieveParams
        ) = apply {
            body = v1ContractRateCardNamedScheduleRetrieveParams.body.toBuilder()
            additionalHeaders =
                v1ContractRateCardNamedScheduleRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRateCardNamedScheduleRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardNamedScheduleRetrieveParams =
            V1ContractRateCardNamedScheduleRetrieveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardNamedScheduleRetrieveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardNamedScheduleRetrieveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
