...
class V1CustomerCommitCreateParamsTest {
        ...
        V1CustomerCommitCreateParams.builder()
            ...
            .invoiceSchedule(
                V1CustomerCommitCreateParams.InvoiceSchedule.builder()
                    ...
                    .doNotInvoice(false)
                    .recurringSchedule(
                        V1CustomerCommitCreateParams.InvoiceSchedule.RecurringSchedule.builder()
                            .amountDistribution(
    ...
    fun body() {
        ...
        assertThat(body.type()).isEqualTo(V1CustomerCommitCreateParams.Type.PREPAID)
        ...
        assertThat(body.rateType()).contains(V1CustomerCommitCreateParams.RateType.COMMIT_RATE)
