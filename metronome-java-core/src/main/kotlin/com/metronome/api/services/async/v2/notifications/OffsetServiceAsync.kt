...
interface OffsetServiceAsync {
    ...
    /**
     * Create an offset lifecycle event notification configuration. The lifecycle event type is
    ...
    ): CompletableFuture<OffsetCreateResponse>
    ...
    fun retrieve(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OffsetRetrieveResponse>

    /**
     * List offset lifecycle event notification configurations. These are user-created notifications
     * that trigger at a specified time offset relative to lifecycle events. Returns a maximum of
     * 400 results per request.
     */
    fun list(): CompletableFuture<OffsetListPageAsync> = list(OffsetListParams.none())

    /** @see list */
    fun list(
        params: OffsetListParams = OffsetListParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OffsetListPageAsync>

    /** @see list */
    fun list(
        params: OffsetListParams = OffsetListParams.none()
    ): CompletableFuture<OffsetListPageAsync> = list(params, RequestOptions.none())

    /** @see list */
    fun list(requestOptions: RequestOptions): CompletableFuture<OffsetListPageAsync> =
        list(OffsetListParams.none(), requestOptions)

    /**
     * Archive an offset lifecycle event notification configuration. Archived notifications are not
     * processed.
     */
    ...
    fun edit(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<OffsetEditResponse>
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /v2/notifications/create`, but is otherwise the
         * same as [OffsetServiceAsync.create].
         */
        fun create(
            params: OffsetCreateParams
        ): CompletableFuture<HttpResponseFor<OffsetCreateResponse>> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /v2/notifications/get`, but is otherwise the same
         * as [OffsetServiceAsync.retrieve].
         */
        fun retrieve(
            params: OffsetRetrieveParams
        ): CompletableFuture<HttpResponseFor<OffsetRetrieveResponse>> =
            retrieve(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /v2/notifications/offset/list`, but is otherwise
         * the same as [OffsetServiceAsync.list].
         */
        fun list(): CompletableFuture<HttpResponseFor<OffsetListPageAsync>> =
            list(OffsetListParams.none())

        /** @see list */
        fun list(
            params: OffsetListParams = OffsetListParams.none(),
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OffsetListPageAsync>>
        ...
        /**
         * Returns a raw HTTP response for `post /v2/notifications/archive`, but is otherwise the
         * same as [OffsetServiceAsync.archive].
         */
        fun archive(
            params: OffsetArchiveParams
        ): CompletableFuture<HttpResponseFor<OffsetArchiveResponse>> =
            archive(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `post /v2/notifications/edit`, but is otherwise the same
         * as [OffsetServiceAsync.edit].
         */
        ...
        fun edit(
            params: OffsetEditParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): CompletableFuture<HttpResponseFor<OffsetEditResponse>>
    }
}
