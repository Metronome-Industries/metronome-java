...
class V1ContractRetrieveResponseTest {

    @Test
    fun createV1ContractRetrieveResponse() {
        val v1ContractRetrieveResponse =
            V1ContractRetrieveResponse.builder()
                .data(
                    Contract.builder()
                            ...
                            Contract.Amendment.builder()
                                ...
                                .addResellerRoyalty(
                                    Contract.Amendment.ResellerRoyalty.builder()
                                        .resellerType(
                                            Contract.Amendment.ResellerRoyalty.ResellerType.AWS
                                        )
                            ...
                            ContractWithoutAmendments.builder()
                                ...
                                .addRecurringCommit(
                                    ContractWithoutAmendments.RecurringCommit.builder()
                                        ...
                                        .netsuiteSalesOrderId("netsuite_sales_order_id")
                                        .proration(
                                            ContractWithoutAmendments.RecurringCommit.Proration.NONE
                                        )
                                        .recurrenceFrequency(
                                            ContractWithoutAmendments.RecurringCommit
                                                .RecurrenceFrequency
                                ...
                                .addRecurringCredit(
                                    ContractWithoutAmendments.RecurringCredit.builder()
                                        ...
                                        .netsuiteSalesOrderId("netsuite_sales_order_id")
                                        .proration(
                                            ContractWithoutAmendments.RecurringCredit.Proration.NONE
                                        )
                                        .recurrenceFrequency(
                                            ContractWithoutAmendments.RecurringCredit
                                                .RecurrenceFrequency
                ...
                .build()
        assertThat(v1ContractRetrieveResponse).isNotNull
        assertThat(v1ContractRetrieveResponse.data())
            .isEqualTo(
                Contract.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .addAmendment(
