...
class UsageServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val listHandler: Handler<V1UsageListPageAsync.Response> =
        jsonHandler<V1UsageListPageAsync.Response>(clientOptions.jsonMapper)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1UsageListPageAsync.of(this, params, it) }
            }
    }
    ...
    private val listWithGroupsHandler: Handler<V1UsageListWithGroupsPageAsync.Response> =
        jsonHandler<V1UsageListWithGroupsPageAsync.Response>(clientOptions.jsonMapper)
            .withErrorHandler(errorHandler)
        ...
        return request
            ...
            .thenApply { response ->
                response
                    ...
                    .let { V1UsageListWithGroupsPageAsync.of(this, params, it) }
            }
    }
