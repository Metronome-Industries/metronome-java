...
interface NamedScheduleServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/getNamedSchedule`, but is otherwise the             same as [NamedScheduleServiceAsync.retrieve]. */
        ...
        /** Returns a raw HTTP response for `post /v1/contract-pricing/rate-cards/updateNamedSchedule`, but is otherwise the             same as [NamedScheduleServiceAsync.update]. */
