...
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Data && id == other.id && type == other.type && archivedAt == other.archivedAt && initial == other.initial && current == other.current && updates == other.updates && customFields == other.customFields && additionalProperties == other.additionalProperties /* spotless:on */
        }
