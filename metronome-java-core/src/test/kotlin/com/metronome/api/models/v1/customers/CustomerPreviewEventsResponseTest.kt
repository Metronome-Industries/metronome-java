...
internal class CustomerPreviewEventsResponseTest {
    ...
    @Test
    fun create() {
        val customerPreviewEventsResponse =
            CustomerPreviewEventsResponse.builder()
                .addData(
                    Invoice.builder()
        ...
        assertThat(customerPreviewEventsResponse.data())
            .containsExactly(
                Invoice.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
    ...
    fun roundtrip() {
        ...
        val roundtrippedCustomerPreviewEventsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(customerPreviewEventsResponse),
                jacksonTypeRef<CustomerPreviewEventsResponse>(),
            )

        assertThat(roundtrippedCustomerPreviewEventsResponse)
            .isEqualTo(customerPreviewEventsResponse)
    }
}
