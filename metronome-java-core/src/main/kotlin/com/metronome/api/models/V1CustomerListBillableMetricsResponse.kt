...
@NoAutoDetect
class V1CustomerListBillableMetricsResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CustomerListBillableMetricsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerListBillableMetricsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerListBillableMetricsResponse: V1CustomerListBillableMetricsResponse
        ) = apply {
            id = v1CustomerListBillableMetricsResponse.id
            name = v1CustomerListBillableMetricsResponse.name
            aggregate = v1CustomerListBillableMetricsResponse.aggregate
            aggregateKeys =
                v1CustomerListBillableMetricsResponse.aggregateKeys.map { it.toMutableList() }
            aggregationKey = v1CustomerListBillableMetricsResponse.aggregationKey
            aggregationType = v1CustomerListBillableMetricsResponse.aggregationType
            archivedAt = v1CustomerListBillableMetricsResponse.archivedAt
            customFields = v1CustomerListBillableMetricsResponse.customFields
            eventTypeFilter = v1CustomerListBillableMetricsResponse.eventTypeFilter
            filter = v1CustomerListBillableMetricsResponse.filter
            groupBy = v1CustomerListBillableMetricsResponse.groupBy.map { it.toMutableList() }
            groupKeys = v1CustomerListBillableMetricsResponse.groupKeys.map { it.toMutableList() }
            propertyFilters =
                v1CustomerListBillableMetricsResponse.propertyFilters.map { it.toMutableList() }
            sql = v1CustomerListBillableMetricsResponse.sql
            additionalProperties =
                v1CustomerListBillableMetricsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerListBillableMetricsResponse =
            V1CustomerListBillableMetricsResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerListBillableMetricsResponse && id == other.id && name == other.name && aggregate == other.aggregate && aggregateKeys == other.aggregateKeys && aggregationKey == other.aggregationKey && aggregationType == other.aggregationType && archivedAt == other.archivedAt && customFields == other.customFields && eventTypeFilter == other.eventTypeFilter && filter == other.filter && groupBy == other.groupBy && groupKeys == other.groupKeys && propertyFilters == other.propertyFilters && sql == other.sql && additionalProperties == other.additionalProperties /* spotless:on */
    }
