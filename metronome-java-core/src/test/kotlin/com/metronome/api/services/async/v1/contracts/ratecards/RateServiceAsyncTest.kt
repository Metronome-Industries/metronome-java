...
internal class RateServiceAsyncTest {
    ...
    fun list() {
      ...
      val pageFuture = rateServiceAsync.list(RateListParams.builder()
    ...
    fun add() {
      ...
      val responseFuture = rateServiceAsync.add(RateAddParams.builder()
          .entitled(true)
    ...
    fun addMany() {
      ...
      val responseFuture = rateServiceAsync.addMany(RateAddManyParams.builder()
          .rateCardId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
