...
internal class LifecycleEventSystemNotificationConfigTest {
    ...
    @Test
    fun create() {
        val lifecycleEventSystemNotificationConfig =
        ...
        assertThat(lifecycleEventSystemNotificationConfig.policy())
            .isEqualTo(LifecycleEventSystemNotificationConfig.Policy.builder().type("type").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedLifecycleEventSystemNotificationConfig =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(lifecycleEventSystemNotificationConfig),
                jacksonTypeRef<LifecycleEventSystemNotificationConfig>(),
            )

        assertThat(roundtrippedLifecycleEventSystemNotificationConfig)
            .isEqualTo(lifecycleEventSystemNotificationConfig)
    }
}
