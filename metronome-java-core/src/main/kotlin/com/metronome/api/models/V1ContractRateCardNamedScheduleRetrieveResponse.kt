...
@NoAutoDetect
class V1ContractRateCardNamedScheduleRetrieveResponse
@JsonCreator
private constructor(
    @JsonProperty("data")
    @ExcludeMissing
    ...
    fun validate(): V1ContractRateCardNamedScheduleRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractRateCardNamedScheduleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = v1ContractRateCardNamedScheduleRetrieveResponse.data.map { it.toMutableList() }
            additionalProperties =
                v1ContractRateCardNamedScheduleRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1ContractRateCardNamedScheduleRetrieveResponse =
            V1ContractRateCardNamedScheduleRetrieveResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardNamedScheduleRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRateCardNamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
