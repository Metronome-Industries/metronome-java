...
private constructor(
    ...
    /** A builder for [V1ContractArchiveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractArchiveParams: V1ContractArchiveParams) = apply {
            body = v1ContractArchiveParams.body.toBuilder()
            additionalHeaders = v1ContractArchiveParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractArchiveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractArchiveParams =
            V1ContractArchiveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractArchiveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractArchiveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
