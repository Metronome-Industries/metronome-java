...
import com.metronome.api.models.v1.plans.PlanDetail
import java.util.Collections
import java.util.Objects
import java.util.Optional
import kotlin.jvm.optionals.getOrNull

class PlanDetail @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("credit_grants") @ExcludeMissing creditGrants: JsonField<List<CreditGrant>> = JsonMissing.of(),
        @JsonProperty("description") @ExcludeMissing description: JsonField<String> = JsonMissing.of(),
        @JsonProperty("minimums") @ExcludeMissing minimums: JsonField<List<Minimum>> = JsonMissing.of(),
        @JsonProperty("overage_rates") @ExcludeMissing overageRates: JsonField<List<OverageRate>> = JsonMissing.of()
    ) : this(
      id,
      customFields,
      name,
    ...
    @ExcludeMissing
    fun _minimums(): JsonField<List<Minimum>> = minimums
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planDetail: PlanDetail) =
            apply {
                id = planDetail.id
         ...
         *
         * You should usually call [Builder.creditGrants] with a well-typed `List<CreditGrant>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun creditGrants(creditGrants: JsonField<List<CreditGrant>>) =
            apply {
         ...
         */
        fun addCreditGrant(creditGrant: CreditGrant) =
            apply {
                creditGrants = (creditGrants ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.minimums] with a well-typed `List<Minimum>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun minimums(minimums: JsonField<List<Minimum>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addMinimum(minimum: Minimum) =
            apply {
                minimums = (minimums ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.overageRates] with a well-typed `List<OverageRate>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun overageRates(overageRates: JsonField<List<OverageRate>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addOverageRate(overageRate: OverageRate) =
            apply {
                overageRates = (overageRates ?: JsonField.of(mutableListOf())).also {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (creditGrants.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (minimums.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (overageRates.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
    ...
    class CreditGrant @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("amount_granted") @ExcludeMissing amountGranted: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("amount_granted_credit_type") @ExcludeMissing amountGrantedCreditType: JsonField<CreditTypeData> = JsonMissing.of(),
            @JsonProperty("amount_paid") @ExcludeMissing amountPaid: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("amount_paid_credit_type") @ExcludeMissing amountPaidCreditType: JsonField<CreditTypeData> = JsonMissing.of(),
            @JsonProperty("effective_duration") @ExcludeMissing effectiveDuration: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
            @JsonProperty("priority") @ExcludeMissing priority: JsonField<String> = JsonMissing.of(),
            @JsonProperty("send_invoice") @ExcludeMissing sendInvoice: JsonField<Boolean> = JsonMissing.of(),
            @JsonProperty("reason") @ExcludeMissing reason: JsonField<String> = JsonMissing.of(),
            @JsonProperty("recurrence_duration") @ExcludeMissing recurrenceDuration: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("recurrence_interval") @ExcludeMissing recurrenceInterval: JsonField<Double> = JsonMissing.of()
        ) : this(
          amountGranted,
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun amountGrantedCreditType(): CreditTypeData = amountGrantedCreditType.getRequired("amount_granted_credit_type")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun amountPaid(): Double = amountPaid.getRequired("amount_paid")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun amountPaidCreditType(): CreditTypeData = amountPaidCreditType.getRequired("amount_paid_credit_type")
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun recurrenceDuration(): Optional<Double> = recurrenceDuration.getOptional("recurrence_duration")

        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
        fun recurrenceInterval(): Optional<Double> = recurrenceInterval.getOptional("recurrence_interval")

        /**
         * Returns the raw JSON value of [amountGranted].
         *
         * Unlike [amountGranted], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [amountGrantedCreditType], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [amountPaidCreditType], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [effectiveDuration], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [recurrenceDuration], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [recurrenceInterval], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(creditGrant: CreditGrant) =
                apply {
             ...
             *
             * You should usually call [Builder.amountGranted] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun amountGranted(amountGranted: JsonField<Double>) =
                apply {
                    this.amountGranted = amountGranted
                }

            fun amountGrantedCreditType(amountGrantedCreditType: CreditTypeData) = amountGrantedCreditType(JsonField.of(amountGrantedCreditType))

            /**
             * Sets [Builder.amountGrantedCreditType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.amountGrantedCreditType] with a well-typed [CreditTypeData] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.amountPaid] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun amountPaid(amountPaid: JsonField<Double>) =
                apply {
                    this.amountPaid = amountPaid
                }

            fun amountPaidCreditType(amountPaidCreditType: CreditTypeData) = amountPaidCreditType(JsonField.of(amountPaidCreditType))

            /**
             * Sets [Builder.amountPaidCreditType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.amountPaidCreditType] with a well-typed [CreditTypeData] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun amountPaidCreditType(amountPaidCreditType: JsonField<CreditTypeData>) =
                apply {
                    this.amountPaidCreditType = amountPaidCreditType
                }

            fun effectiveDuration(effectiveDuration: Double) = effectiveDuration(JsonField.of(effectiveDuration))

            /**
             * Sets [Builder.effectiveDuration] to an arbitrary JSON value.
             *
             * You should usually call [Builder.effectiveDuration] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun effectiveDuration(effectiveDuration: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.sendInvoice] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun sendInvoice(sendInvoice: JsonField<Boolean>) =
                apply {
            ...
            fun recurrenceDuration(recurrenceDuration: Double) = recurrenceDuration(JsonField.of(recurrenceDuration))

            /**
             * Sets [Builder.recurrenceDuration] to an arbitrary JSON value.
             *
             * You should usually call [Builder.recurrenceDuration] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun recurrenceDuration(recurrenceDuration: JsonField<Double>) =
                apply {
                    this.recurrenceDuration = recurrenceDuration
                }

            fun recurrenceInterval(recurrenceInterval: Double) = recurrenceInterval(JsonField.of(recurrenceInterval))

            /**
             * Sets [Builder.recurrenceInterval] to an arbitrary JSON value.
             *
             * You should usually call [Builder.recurrenceInterval] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun recurrenceInterval(recurrenceInterval: JsonField<Double>) =
                apply {
            ...
            fun build(): CreditGrant =
                CreditGrant(
                  ...
                  checkRequired(
                    "amountGrantedCreditType", amountGrantedCreditType
                  ),
                  checkRequired(
                    "amountPaid", amountPaid
                  ),
                  checkRequired(
                    "amountPaidCreditType", amountPaidCreditType
                  ),
                  checkRequired(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (amountGranted.asKnown().isPresent) 1 else 0) + (amountGrantedCreditType.asKnown().getOrNull()?.validity() ?: 0) + (if (amountPaid.asKnown().isPresent) 1 else 0) + (amountPaidCreditType.asKnown().getOrNull()?.validity() ?: 0) + (if (effectiveDuration.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (if (sendInvoice.asKnown().isPresent) 1 else 0) + (if (reason.asKnown().isPresent) 1 else 0) + (if (recurrenceDuration.asKnown().isPresent) 1 else 0) + (if (recurrenceInterval.asKnown().isPresent) 1 else 0)
        ...
        override fun toString() = "CreditGrant{amountGranted=$amountGranted, amountGrantedCreditType=$amountGrantedCreditType, amountPaid=$amountPaid, amountPaidCreditType=$amountPaidCreditType, effectiveDuration=$effectiveDuration, name=$name, priority=$priority, sendInvoice=$sendInvoice, reason=$reason, recurrenceDuration=$recurrenceDuration, recurrenceInterval=$recurrenceInterval, additionalProperties=$additionalProperties}"
    }

    class Minimum @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditType.asKnown().getOrNull()?.validity() ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (startPeriod.asKnown().isPresent) 1 else 0) + (if (value.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Minimum && creditType == other.creditType && name == other.name && startPeriod == other.startPeriod && value == other.value && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Minimum{creditType=$creditType, name=$name, startPeriod=$startPeriod, value=$value, additionalProperties=$additionalProperties}"
    }

    class OverageRate @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val creditType: JsonField<CreditTypeData>,
        ...
        private constructor(
            @JsonProperty("credit_type") @ExcludeMissing creditType: JsonField<CreditTypeData> = JsonMissing.of(),
            @JsonProperty("fiat_credit_type") @ExcludeMissing fiatCreditType: JsonField<CreditTypeData> = JsonMissing.of(),
            @JsonProperty("start_period") @ExcludeMissing startPeriod: JsonField<Double> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(overageRate: OverageRate) =
                apply {
            ...
            fun fiatCreditType(fiatCreditType: CreditTypeData) = fiatCreditType(JsonField.of(fiatCreditType))

            /**
             * Sets [Builder.fiatCreditType] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fiatCreditType] with a well-typed [CreditTypeData] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fiatCreditType(fiatCreditType: JsonField<CreditTypeData>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (creditType.asKnown().getOrNull()?.validity() ?: 0) + (fiatCreditType.asKnown().getOrNull()?.validity() ?: 0) + (if (startPeriod.asKnown().isPresent) 1 else 0) + (if (toFiatConversionFactor.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is OverageRate && creditType == other.creditType && fiatCreditType == other.fiatCreditType && startPeriod == other.startPeriod && toFiatConversionFactor == other.toFiatConversionFactor && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "OverageRate{creditType=$creditType, fiatCreditType=$fiatCreditType, startPeriod=$startPeriod, toFiatConversionFactor=$toFiatConversionFactor, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanDetail && id == other.id && customFields == other.customFields && name == other.name && creditGrants == other.creditGrants && description == other.description && minimums == other.minimums && overageRates == other.overageRates && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PlanDetail{id=$id, customFields=$customFields, name=$name, creditGrants=$creditGrants, description=$description, minimums=$minimums, overageRates=$overageRates, additionalProperties=$additionalProperties}"
}
