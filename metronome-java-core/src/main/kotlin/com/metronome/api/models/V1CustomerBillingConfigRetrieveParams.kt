 ...
 */
class V1CustomerBillingConfigRetrieveParams
private constructor(
    ...
    /** A builder for [V1CustomerBillingConfigRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerBillingConfigRetrieveParams: V1CustomerBillingConfigRetrieveParams
        ) = apply {
            customerId = v1CustomerBillingConfigRetrieveParams.customerId
            billingProviderType = v1CustomerBillingConfigRetrieveParams.billingProviderType
            additionalHeaders = v1CustomerBillingConfigRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1CustomerBillingConfigRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerBillingConfigRetrieveParams =
            V1CustomerBillingConfigRetrieveParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerBillingConfigRetrieveParams && customerId == other.customerId && billingProviderType == other.billingProviderType && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerBillingConfigRetrieveParams{customerId=$customerId, billingProviderType=$billingProviderType, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
