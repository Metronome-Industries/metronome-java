...
class SystemListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<LifecycleEventSystemNotificationConfig>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<LifecycleEventSystemNotificationConfig>>? = null
