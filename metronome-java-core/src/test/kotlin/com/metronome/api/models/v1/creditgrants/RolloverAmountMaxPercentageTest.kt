...
internal class RolloverAmountMaxPercentageTest {
    ...
    @Test
    fun create() {
      val rolloverAmountMaxPercentage = RolloverAmountMaxPercentage.builder()
          .type(RolloverAmountMaxPercentage.Type.MAX_PERCENTAGE)
          .value(0.0)
          .build()

      assertThat(rolloverAmountMaxPercentage.type()).isEqualTo(RolloverAmountMaxPercentage.Type.MAX_PERCENTAGE)
    ...
    fun roundtrip() {
      ...
      val roundtrippedRolloverAmountMaxPercentage = jsonMapper.readValue(jsonMapper.writeValueAsString(rolloverAmountMaxPercentage), jacksonTypeRef<RolloverAmountMaxPercentage>())
