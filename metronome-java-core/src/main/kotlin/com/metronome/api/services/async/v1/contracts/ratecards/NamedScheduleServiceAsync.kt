...
interface NamedScheduleServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/getNamedSchedule`, but is otherwise the             same as [NamedScheduleServiceAsync.retrieve]. */
        ...
        /** Returns a raw HTTP response for `post /v1/contracts/updateNamedSchedule`, but is otherwise the             same as [NamedScheduleServiceAsync.update]. */
