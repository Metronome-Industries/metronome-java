...
class RolloverAmountMaxAmount @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RolloverAmountMaxAmount].
         *
    ...
    /** A builder for [RolloverAmountMaxAmount]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rolloverAmountMaxAmount: RolloverAmountMaxAmount) =
            apply {
        ...
        /**
         * Returns an immutable instance of [RolloverAmountMaxAmount].
         *
     ...
     *   expected type.
     */
    fun validate(): RolloverAmountMaxAmount =
        apply {
            if (validated) {
              return@apply
            }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (type.asKnown().getOrNull()?.validity() ?: 0) + (if (value.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RolloverAmountMaxAmount && type == other.type && value == other.value && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "RolloverAmountMaxAmount{type=$type, value=$value, additionalProperties=$additionalProperties}"
}
