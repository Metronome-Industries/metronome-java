 ...
 */
class V1ContractRateCardProductOrderUpdateParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && productMoves == other.productMoves && rateCardId == other.rateCardId && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1ContractRateCardProductOrderUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRateCardProductOrderUpdateParams: V1ContractRateCardProductOrderUpdateParams
        ) = apply {
            body = v1ContractRateCardProductOrderUpdateParams.body.toBuilder()
            additionalHeaders =
                v1ContractRateCardProductOrderUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRateCardProductOrderUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardProductOrderUpdateParams =
            V1ContractRateCardProductOrderUpdateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardProductOrderUpdateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardProductOrderUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
