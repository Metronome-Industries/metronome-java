...
class V1ContractScheduleProServicesInvoiceResponseTest {

    @Test
    fun createV1ContractScheduleProServicesInvoiceResponse() {
        val v1ContractScheduleProServicesInvoiceResponse =
            V1ContractScheduleProServicesInvoiceResponse.builder()
                .addData(
                    Invoice.builder()
                ...
                .build()
        assertThat(v1ContractScheduleProServicesInvoiceResponse).isNotNull
        assertThat(v1ContractScheduleProServicesInvoiceResponse.data())
            .containsExactly(
                Invoice.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creditType(
