...
class NotificationServiceImpl internal constructor(
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val offset: OffsetService.WithRawResponse by lazy { OffsetServiceImpl.WithRawResponseImpl(clientOptions) }

        private val system: SystemService.WithRawResponse by lazy { SystemServiceImpl.WithRawResponseImpl(clientOptions) }
