 ...
 *
 */
class CustomFieldRemoveKeyParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomFieldRemoveKeyParams].
         *
    ...
    /** A builder for [CustomFieldRemoveKeyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customFieldRemoveKeyParams: CustomFieldRemoveKeyParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [CustomFieldRemoveKeyParams].
         *
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (entity.asKnown().getOrNull()?.validity() ?: 0) + (if (key.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && entity == other.entity && key == other.key && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{entity=$entity, key=$key, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomFieldRemoveKeyParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "CustomFieldRemoveKeyParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
