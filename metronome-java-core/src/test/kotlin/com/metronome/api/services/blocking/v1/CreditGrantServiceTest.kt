...
internal class CreditGrantServiceTest {
    ...
    fun create() {
      ...
      val creditGrant = creditGrantService.create(CreditGrantCreateParams.builder()
    ...
    fun edit() {
      ...
      val response = creditGrantService.edit(CreditGrantEditParams.builder()
    ...
    fun void_() {
      ...
      val response = creditGrantService.void_(CreditGrantVoidParams.builder()
          .id("9b85c1c1-5238-4f2a-a409-61412905e1e1")
