...
internal class ProductListItemStateTest {
    ...
    @Test
    fun create() {
      val productListItemState = ProductListItemState.builder()
      ...
      assertThat(productListItemState.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(productListItemState.compositeProductIds().getOrNull()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      ...
      assertThat(productListItemState.netsuiteInternalItemId()).contains("netsuite_internal_item_id")
      assertThat(productListItemState.netsuiteOverageItemId()).contains("netsuite_overage_item_id")
      assertThat(productListItemState.presentationGroupKey().getOrNull()).containsExactly("string")
      assertThat(productListItemState.pricingGroupKey().getOrNull()).containsExactly("string")
      assertThat(productListItemState.quantityConversion()).contains(QuantityConversion.builder()
          .conversionFactor(0.0)
          .operation(QuantityConversion.Operation.MULTIPLY)
          .name("name")
          .build())
      assertThat(productListItemState.quantityRounding()).contains(QuantityRounding.builder()
          .decimalPlaces(0.0)
          .roundingMethod(QuantityRounding.RoundingMethod.ROUND_UP)
          .build())
      assertThat(productListItemState.startingAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
      ...
      val roundtrippedProductListItemState = jsonMapper.readValue(jsonMapper.writeValueAsString(productListItemState), jacksonTypeRef<ProductListItemState>())
