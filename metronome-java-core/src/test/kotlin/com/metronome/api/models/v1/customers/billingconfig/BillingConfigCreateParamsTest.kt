...
internal class BillingConfigCreateParamsTest {
    ...
    @Test
    fun pathParams() {
      val params = BillingConfigCreateParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .billingProviderType(BillingConfigCreateParams.BillingProviderType.STRIPE)
          .billingProviderCustomerId("cus_AJ6y20bjkOOayM")
          .build()
    ...
    fun body() {
      ...
      assertThat(body.stripeCollectionMethod()).contains(BillingConfigCreateParams.StripeCollectionMethod.CHARGE_AUTOMATICALLY)
    }
