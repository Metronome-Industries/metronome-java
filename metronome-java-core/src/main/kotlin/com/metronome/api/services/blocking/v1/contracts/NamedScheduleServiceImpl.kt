...
class NamedScheduleServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val retrieveHandler: Handler<V1ContractNamedScheduleRetrieveResponse> =
        jsonHandler<V1ContractNamedScheduleRetrieveResponse>(clientOptions.jsonMapper)
