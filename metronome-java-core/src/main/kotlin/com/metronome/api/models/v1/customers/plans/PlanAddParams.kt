 ...
 *
 */
class PlanAddParams private constructor(
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun overageRateAdjustments(): Optional<List<OverageRateAdjustment>> = body.overageRateAdjustments()
     ...
     *
     * Unlike [overageRateAdjustments], this method doesn't throw if the JSON field has an unexpected type.
     */
    fun _overageRateAdjustments(): JsonField<List<OverageRateAdjustment>> = body._overageRateAdjustments()

    /**
     * Returns the raw JSON value of [priceAdjustments].
     *
     * Unlike [priceAdjustments], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planAddParams: PlanAddParams) =
            apply {
         ...
         *
         * You should usually call [Builder.overageRateAdjustments] with a well-typed `List<OverageRateAdjustment>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
         ...
         */
        fun addOverageRateAdjustment(overageRateAdjustment: OverageRateAdjustment) =
            apply {
         ...
         *
         * You should usually call [Builder.priceAdjustments] with a well-typed `List<PriceAdjustment>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun priceAdjustments(priceAdjustments: JsonField<List<PriceAdjustment>>) =
            apply {
                body.priceAdjustments(priceAdjustments)
            }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPriceAdjustment(priceAdjustment: PriceAdjustment) =
            apply {
                body.addPriceAdjustment(priceAdjustment)
            }

        /** A custom trial can be set for the customer's plan. See the [trial configuration documentation](https://docs.metronome.com/provisioning/configure-trials/) for details. */
        fun trialSpec(trialSpec: TrialSpec) =
            apply {
                body.trialSpec(trialSpec)
            }

        /**
         * Sets [Builder.trialSpec] to an arbitrary JSON value.
         *
         * You should usually call [Builder.trialSpec] with a well-typed [TrialSpec] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun trialSpec(trialSpec: JsonField<TrialSpec>) =
            apply {
                body.trialSpec(trialSpec)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("overage_rate_adjustments") @ExcludeMissing overageRateAdjustments: JsonField<List<OverageRateAdjustment>> = JsonMissing.of(),
            @JsonProperty("price_adjustments") @ExcludeMissing priceAdjustments: JsonField<List<PriceAdjustment>> = JsonMissing.of(),
            @JsonProperty("trial_spec") @ExcludeMissing trialSpec: JsonField<TrialSpec> = JsonMissing.of()
        ) : this(
          planId,
          startingOn,
          endingBefore,
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun overageRateAdjustments(): Optional<List<OverageRateAdjustment>> = overageRateAdjustments.getOptional("overage_rate_adjustments")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun priceAdjustments(): Optional<List<PriceAdjustment>> = priceAdjustments.getOptional("price_adjustments")
        ...
        @ExcludeMissing
        fun _overageRateAdjustments(): JsonField<List<OverageRateAdjustment>> = overageRateAdjustments
        ...
        class Builder internal constructor() {
            ...
            private var overageRateAdjustments: JsonField<MutableList<OverageRateAdjustment>>? = null
            ...
            /** An optional list of overage rates that override the rates of the original plan configuration. These new rates will apply to all pricing ramps. */
            fun overageRateAdjustments(overageRateAdjustments: List<OverageRateAdjustment>) = overageRateAdjustments(JsonField.of(overageRateAdjustments))
            ...
            fun addOverageRateAdjustment(overageRateAdjustment: OverageRateAdjustment) =
                apply {
                    overageRateAdjustments = (overageRateAdjustments ?: JsonField.of(mutableListOf())).also {
                        checkKnown("overageRateAdjustments", it).add(overageRateAdjustment)
                    }
                }

            /** A list of price adjustments can be applied on top of the pricing in the plans. See the [price adjustments documentation](https://plans-docs.metronome.com/pricing/managing-plans/#price-adjustments) for details. */
            fun priceAdjustments(priceAdjustments: List<PriceAdjustment>) = priceAdjustments(JsonField.of(priceAdjustments))
            ...
            fun addPriceAdjustment(priceAdjustment: PriceAdjustment) =
                apply {
                    priceAdjustments = (priceAdjustments ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (planId.asKnown().isPresent) 1 else 0) + (if (startingOn.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (netPaymentTermsDays.asKnown().isPresent) 1 else 0) + (overageRateAdjustments.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (priceAdjustments.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (trialSpec.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && planId == other.planId && startingOn == other.startingOn && endingBefore == other.endingBefore && netPaymentTermsDays == other.netPaymentTermsDays && overageRateAdjustments == other.overageRateAdjustments && priceAdjustments == other.priceAdjustments && trialSpec == other.trialSpec && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{planId=$planId, startingOn=$startingOn, endingBefore=$endingBefore, netPaymentTermsDays=$netPaymentTermsDays, overageRateAdjustments=$overageRateAdjustments, priceAdjustments=$priceAdjustments, trialSpec=$trialSpec, additionalProperties=$additionalProperties}"
    }

    class OverageRateAdjustment @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("fiat_currency_credit_type_id") @ExcludeMissing fiatCurrencyCreditTypeId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("to_fiat_conversion_factor") @ExcludeMissing toFiatConversionFactor: JsonField<Double> = JsonMissing.of()
        ) : this(
          customCreditTypeId,
        ...
        /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value). */
        fun fiatCurrencyCreditTypeId(): String = fiatCurrencyCreditTypeId.getRequired("fiat_currency_credit_type_id")
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun toFiatConversionFactor(): Double = toFiatConversionFactor.getRequired("to_fiat_conversion_factor")
         ...
         *
         * Unlike [fiatCurrencyCreditTypeId], this method doesn't throw if the JSON field has an unexpected type.
         */
         ...
         *
         * Unlike [toFiatConversionFactor], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(overageRateAdjustment: OverageRateAdjustment) =
                apply {
            ...
            fun fiatCurrencyCreditTypeId(fiatCurrencyCreditTypeId: String) = fiatCurrencyCreditTypeId(JsonField.of(fiatCurrencyCreditTypeId))

            /**
             * Sets [Builder.fiatCurrencyCreditTypeId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.fiatCurrencyCreditTypeId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun fiatCurrencyCreditTypeId(fiatCurrencyCreditTypeId: JsonField<String>) =
                apply {
                    this.fiatCurrencyCreditTypeId = fiatCurrencyCreditTypeId
                }

            /** The overage cost in fiat currency for each credit of the custom credit type. */
            fun toFiatConversionFactor(toFiatConversionFactor: Double) = toFiatConversionFactor(JsonField.of(toFiatConversionFactor))

            /**
             * Sets [Builder.toFiatConversionFactor] to an arbitrary JSON value.
             *
             * You should usually call [Builder.toFiatConversionFactor] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun toFiatConversionFactor(toFiatConversionFactor: JsonField<Double>) =
                apply {
            ...
            fun build(): OverageRateAdjustment =
                OverageRateAdjustment(
                  ...
                  checkRequired(
                    "fiatCurrencyCreditTypeId", fiatCurrencyCreditTypeId
                  ),
                  checkRequired(
                    "toFiatConversionFactor", toFiatConversionFactor
                  ),
                  additionalProperties.toMutableMap(),
                )
        }
         ...
         *   expected type.
         */
        fun validate(): OverageRateAdjustment =
            apply {
                if (validated) {
                  return@apply
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (customCreditTypeId.asKnown().isPresent) 1 else 0) + (if (fiatCurrencyCreditTypeId.asKnown().isPresent) 1 else 0) + (if (toFiatConversionFactor.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is OverageRateAdjustment && customCreditTypeId == other.customCreditTypeId && fiatCurrencyCreditTypeId == other.fiatCurrencyCreditTypeId && toFiatConversionFactor == other.toFiatConversionFactor && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "OverageRateAdjustment{customCreditTypeId=$customCreditTypeId, fiatCurrencyCreditTypeId=$fiatCurrencyCreditTypeId, toFiatConversionFactor=$toFiatConversionFactor, additionalProperties=$additionalProperties}"
    }

    class PriceAdjustment @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("adjustment_type") @ExcludeMissing adjustmentType: JsonField<AdjustmentType> = JsonMissing.of(),
            @JsonProperty("charge_id") @ExcludeMissing chargeId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("start_period") @ExcludeMissing startPeriod: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("tier")
        @ExcludeMissing
        fun _tier(): JsonField<Double> = tier
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(priceAdjustment: PriceAdjustment) =
                apply {
             ...
             *
             * You should usually call [Builder.adjustmentType] with a well-typed [AdjustmentType] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.startPeriod] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun startPeriod(startPeriod: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.tier] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun tier(tier: JsonField<Double>) =
                apply {
                    this.tier = tier
                }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (adjustmentType.asKnown().getOrNull()?.validity() ?: 0) + (if (chargeId.asKnown().isPresent) 1 else 0) + (if (startPeriod.asKnown().isPresent) 1 else 0) + (if (quantity.asKnown().isPresent) 1 else 0) + (if (tier.asKnown().isPresent) 1 else 0) + (if (value.asKnown().isPresent) 1 else 0)
        ...
        class AdjustmentType @JsonCreator private constructor(
            ...
            enum class Value {
                ...
                OVERRIDE,
                QUANTITY,
                /** An enum member indicating that [AdjustmentType] was instantiated with an unknown value. */
                _UNKNOWN,
            }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PriceAdjustment && adjustmentType == other.adjustmentType && chargeId == other.chargeId && startPeriod == other.startPeriod && quantity == other.quantity && tier == other.tier && value == other.value && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "PriceAdjustment{adjustmentType=$adjustmentType, chargeId=$chargeId, startPeriod=$startPeriod, quantity=$quantity, tier=$tier, value=$value, additionalProperties=$additionalProperties}"
    }

    /** A custom trial can be set for the customer's plan. See the [trial configuration documentation](https://docs.metronome.com/provisioning/configure-trials/) for details. */
    class TrialSpec @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("length_in_days") @ExcludeMissing lengthInDays: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("spending_cap") @ExcludeMissing spendingCap: JsonField<SpendingCap> = JsonMissing.of()
        ) : this(
          lengthInDays,
          spendingCap,
          mutableMapOf(),
         ...
         *
         * Unlike [lengthInDays], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(trialSpec: TrialSpec) =
                apply {
             ...
             *
             * You should usually call [Builder.lengthInDays] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun lengthInDays(lengthInDays: JsonField<Double>) =
                apply {
             ...
             *
             * You should usually call [Builder.spendingCap] with a well-typed [SpendingCap] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun spendingCap(spendingCap: JsonField<SpendingCap>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (lengthInDays.asKnown().isPresent) 1 else 0) + (spendingCap.asKnown().getOrNull()?.validity() ?: 0)

        class SpendingCap @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(spendingCap: SpendingCap) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (creditTypeId.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is SpendingCap && amount == other.amount && creditTypeId == other.creditTypeId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "SpendingCap{amount=$amount, creditTypeId=$creditTypeId, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is TrialSpec && lengthInDays == other.lengthInDays && spendingCap == other.spendingCap && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "TrialSpec{lengthInDays=$lengthInDays, spendingCap=$spendingCap, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanAddParams && customerId == other.customerId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(customerId, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "PlanAddParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
