...
class AlertListParams private constructor(
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.alertStatuses] with a well-typed `List<AlertStatus>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun alertStatuses(alertStatuses: JsonField<List<AlertStatus>>) =
            apply {
                body.alertStatuses(alertStatuses)
            }
         ...
         */
        fun addAlertStatus(alertStatus: AlertStatus) =
            apply {
                body.addAlertStatus(alertStatus)
            }
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("alert_statuses") @ExcludeMissing alertStatuses: JsonField<List<AlertStatus>> = JsonMissing.of()
        ) : this(
          customerId,
          alertStatuses,
          mutableMapOf(),
         ...
         * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
         */
        fun alertStatuses(): Optional<List<AlertStatus>> = alertStatuses.getOptional("alert_statuses")
        ...
        class Builder internal constructor() {
            ...
            /** Optionally filter by threshold notification status. If absent, only enabled notifications will be returned. */
            fun alertStatuses(alertStatuses: List<AlertStatus>) = alertStatuses(JsonField.of(alertStatuses))
            ...
            fun addAlertStatus(alertStatus: AlertStatus) =
                apply {
                    alertStatuses = (alertStatuses ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (customerId.asKnown().isPresent) 1 else 0) + (alertStatuses.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && customerId == other.customerId && alertStatuses == other.alertStatuses && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{customerId=$customerId, alertStatuses=$alertStatuses, additionalProperties=$additionalProperties}"
    }

    class AlertStatus @JsonCreator private constructor(
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is AlertListParams && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "AlertListParams{nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
