 ...
 */
class V1CustomerListPageAsync
private constructor(
    private val customersService: CustomerServiceAsync,
    private val params: V1CustomerListParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerListPageAsync && customersService == other.customersService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(customersService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerListPageAsync{customersService=$customersService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<V1CustomerListParams> {
        if (!hasNextPage()) {
            return Optional.empty()
        }

        return Optional.of(
            V1CustomerListParams.builder()
                .from(params)
    ...
    fun getNextPage(): CompletableFuture<Optional<V1CustomerListPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1CustomerListPageAsync(customersService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerListPageAsync) {

        fun forEach(
            action: Predicate<CustomerDetail>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V1CustomerListPageAsync>>.forEach(
                action: (CustomerDetail) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(executor: Executor): CompletableFuture<List<CustomerDetail>> {
            val values = mutableListOf<CustomerDetail>()
