...
internal class PlanListCustomersPageResponseTest {
    ...
    @Test
    fun create() {
        val planListCustomersPageResponse =
            PlanListCustomersPageResponse.builder()
                .addData(
        ...
        assertThat(planListCustomersPageResponse.data())
            .containsExactly(
                PlanListCustomersResponse.builder()
                    .customerDetails(
                        CustomerDetail.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedPlanListCustomersPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(planListCustomersPageResponse),
                jacksonTypeRef<PlanListCustomersPageResponse>(),
            )

        assertThat(roundtrippedPlanListCustomersPageResponse)
            .isEqualTo(planListCustomersPageResponse)
    }
}
