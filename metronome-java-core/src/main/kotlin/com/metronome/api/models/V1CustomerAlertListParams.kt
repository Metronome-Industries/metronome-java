 ...
 */
class V1CustomerAlertListParams
private constructor(
    ...
    /** A builder for [V1CustomerAlertListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerAlertListParams: V1CustomerAlertListParams) = apply {
            nextPage = v1CustomerAlertListParams.nextPage
            body = v1CustomerAlertListParams.body.toBuilder()
            additionalHeaders = v1CustomerAlertListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerAlertListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerAlertListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerAlertListParams && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(nextPage, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CustomerAlertListParams{nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
