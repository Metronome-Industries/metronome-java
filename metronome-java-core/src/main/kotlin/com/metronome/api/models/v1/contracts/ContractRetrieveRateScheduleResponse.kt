...
class ContractRetrieveRateScheduleResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractRetrieveRateScheduleResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractRetrieveRateScheduleResponse: ContractRetrieveRateScheduleResponse) =
            apply {
                ...
                additionalProperties = contractRetrieveRateScheduleResponse.additionalProperties.toMutableMap()
            }
     ...
     *   expected type.
     */
    fun validate(): ContractRetrieveRateScheduleResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("override_rate") @ExcludeMissing overrideRate: JsonField<Rate> = JsonMissing.of(),
        ...
        @ExcludeMissing
        fun _listRate(): JsonField<Rate> = listRate
         ...
         *
         * Unlike [overrideRate], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.listRate] with a well-typed [Rate] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun listRate(listRate: JsonField<Rate>) =
                apply {
             ...
             *
             * You should usually call [Builder.overrideRate] with a well-typed [Rate] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun overrideRate(overrideRate: JsonField<Rate>) =
                apply {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (entitled.asKnown().isPresent) 1 else 0) + (listRate.asKnown().getOrNull()?.validity() ?: 0) + (productCustomFields.asKnown().getOrNull()?.validity() ?: 0) + (if (productId.asKnown().isPresent) 1 else 0) + (if (productName.asKnown().isPresent) 1 else 0) + (productTags.asKnown().getOrNull()?.size ?: 0) + (if (rateCardId.asKnown().isPresent) 1 else 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (billingFrequency.asKnown().getOrNull()?.validity() ?: 0) + (commitRate.asKnown().getOrNull()?.validity() ?: 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (overrideRate.asKnown().getOrNull()?.validity() ?: 0) + (pricingGroupValues.asKnown().getOrNull()?.validity() ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && entitled == other.entitled && listRate == other.listRate && productCustomFields == other.productCustomFields && productId == other.productId && productName == other.productName && productTags == other.productTags && rateCardId == other.rateCardId && startingAt == other.startingAt && billingFrequency == other.billingFrequency && commitRate == other.commitRate && endingBefore == other.endingBefore && overrideRate == other.overrideRate && pricingGroupValues == other.pricingGroupValues && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractRetrieveRateScheduleResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractRetrieveRateScheduleResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
