...
class ContractAmendResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractAmendResponse].
         *
    ...
    /** A builder for [ContractAmendResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractAmendResponse: ContractAmendResponse) =
            apply {
                data = contractAmendResponse.data
                additionalProperties = contractAmendResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ContractAmendResponse].
         *
         ...
         */
        fun build(): ContractAmendResponse =
     ...
     *   expected type.
     */
    fun validate(): ContractAmendResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractAmendResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractAmendResponse{data=$data, additionalProperties=$additionalProperties}"
}
