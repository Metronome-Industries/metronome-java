...
@NoAutoDetect
class V1ContractRateCardRateAddResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1ContractRateCardRateAddResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1ContractRateCardRateAddResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardRateAddResponse: V1ContractRateCardRateAddResponse) =
            apply {
                data = v1ContractRateCardRateAddResponse.data
                additionalProperties =
                    v1ContractRateCardRateAddResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): V1ContractRateCardRateAddResponse =
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{rateType=$rateType, commitRate=$commitRate, creditType=$creditType, customRate=$customRate, isProrated=$isProrated, price=$price, pricingGroupValues=$pricingGroupValues, quantity=$quantity, tiers=$tiers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateAddResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractRateCardRateAddResponse{data=$data, additionalProperties=$additionalProperties}"
}
