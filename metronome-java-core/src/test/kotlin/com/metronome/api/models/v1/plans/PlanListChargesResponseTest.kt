...
internal class PlanListChargesResponseTest {
    ...
    @Test
    fun create() {
      val planListChargesResponse = PlanListChargesResponse.builder()
          ...
          .creditType(CreditTypeData.builder()
              ...
              .name("name")
              .build())
          .customFields(PlanListChargesResponse.CustomFields.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
          .name("name")
          .addPrice(PlanListChargesResponse.Price.builder()
              .tier(0.0)
              .value(0.0)
          ...
          .unitConversion(PlanListChargesResponse.UnitConversion.builder()
              .divisionFactor(0.0)
      ...
      assertThat(planListChargesResponse.chargeType()).isEqualTo(PlanListChargesResponse.ChargeType.USAGE)
      assertThat(planListChargesResponse.creditType()).isEqualTo(CreditTypeData.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .name("name")
          .build())
      assertThat(planListChargesResponse.customFields()).isEqualTo(PlanListChargesResponse.CustomFields.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(planListChargesResponse.name()).isEqualTo("name")
      assertThat(planListChargesResponse.prices()).containsExactly(PlanListChargesResponse.Price.builder()
          .tier(0.0)
          .value(0.0)
          .collectionInterval(0.0)
          .collectionSchedule("collection_schedule")
      ...
      assertThat(planListChargesResponse.unitConversion()).contains(PlanListChargesResponse.UnitConversion.builder()
          .divisionFactor(0.0)
          .roundingBehavior(PlanListChargesResponse.UnitConversion.RoundingBehavior.FLOOR)
          .build())
    }
    ...
    fun roundtrip() {
      ...
      val roundtrippedPlanListChargesResponse = jsonMapper.readValue(jsonMapper.writeValueAsString(planListChargesResponse), jacksonTypeRef<PlanListChargesResponse>())
