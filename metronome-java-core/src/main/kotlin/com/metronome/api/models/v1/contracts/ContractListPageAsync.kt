...
private constructor(
     ...
     */
    fun data(): List<Contract> = response._data().getOptional("data").getOrNull() ?: emptyList()

    override fun items(): List<Contract> = data()
    ...
    fun autoPager(): AutoPagerAsync<Contract> = AutoPagerAsync.from(this, streamHandlerExecutor)
