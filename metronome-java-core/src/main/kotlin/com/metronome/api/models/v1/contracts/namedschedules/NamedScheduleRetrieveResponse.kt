...
class NamedScheduleRetrieveResponse
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namedScheduleRetrieveResponse: NamedScheduleRetrieveResponse) = apply {
     ...
     *   expected type.
     */
    fun validate(): NamedScheduleRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(startingAt, value, endingBefore, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(startingAt, value, endingBefore, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamedScheduleRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "NamedScheduleRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
