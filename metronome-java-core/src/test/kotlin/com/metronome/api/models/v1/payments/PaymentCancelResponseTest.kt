...
internal class PaymentCancelResponseTest {

    @Test
    fun create() {
        val paymentCancelResponse =
        ...
        assertThat(paymentCancelResponse.data())
            .isEqualTo(
                Payment.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .amount(0.0)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPaymentCancelResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(paymentCancelResponse),
                jacksonTypeRef<PaymentCancelResponse>(),
            )

        assertThat(roundtrippedPaymentCancelResponse).isEqualTo(paymentCancelResponse)
    }
}
