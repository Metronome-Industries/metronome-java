...
class Commit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("cost_basis") @ExcludeMissing costBasis: JsonField<Double> = JsonMissing.of(),
        ...
        @JsonProperty("invoice_contract") @ExcludeMissing invoiceContract: JsonField<InvoiceContract> = JsonMissing.of(),
        @JsonProperty("invoice_schedule") @ExcludeMissing invoiceSchedule: JsonField<SchedulePointInTime> = JsonMissing.of(),
        ...
        @JsonProperty("recurring_commit_id") @ExcludeMissing recurringCommitId: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("spend_tracker_attributes") @ExcludeMissing spendTrackerAttributes: JsonField<SpendTrackerAttributes> = JsonMissing.of(),
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun invoiceContract(): Optional<InvoiceContract> = invoiceContract.getOptional("invoice_contract")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun invoiceSchedule(): Optional<SchedulePointInTime> = invoiceSchedule.getOptional("invoice_schedule")
     ...
     * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
     */
    fun spendTrackerAttributes(): Optional<SpendTrackerAttributes> = spendTrackerAttributes.getOptional("spend_tracker_attributes")
    ...
    @ExcludeMissing
    fun _costBasis(): JsonField<Double> = costBasis
     ...
     *
     * Unlike [recurringCommitId], this method doesn't throw if the JSON field has an unexpected type.
     */
     ...
     *
     * Unlike [spendTrackerAttributes], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.costBasis] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun costBasis(costBasis: JsonField<Double>) =
            apply {
        ...
        /** The contract that this commit will be billed on. */
        fun invoiceContract(invoiceContract: InvoiceContract) = invoiceContract(JsonField.of(invoiceContract))

        /**
         * Sets [Builder.invoiceContract] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invoiceContract] with a well-typed [InvoiceContract] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoiceContract(invoiceContract: JsonField<InvoiceContract>) =
            apply {
                this.invoiceContract = invoiceContract
            }

        /** The schedule that the customer will be invoiced for this commit. */
        fun invoiceSchedule(invoiceSchedule: SchedulePointInTime) = invoiceSchedule(JsonField.of(invoiceSchedule))

        /**
         * Sets [Builder.invoiceSchedule] to an arbitrary JSON value.
         *
         * You should usually call [Builder.invoiceSchedule] with a well-typed [SchedulePointInTime] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun invoiceSchedule(invoiceSchedule: JsonField<SchedulePointInTime>) =
            apply {
        ...
        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry)`. */
        fun addLedger(prepaidCommitSegmentStartLedgerEntry: Ledger.PrepaidCommitSegmentStartLedgerEntry) = addLedger(Ledger.ofPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry)`. */
        fun addLedger(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: Ledger.PrepaidCommitAutomatedInvoiceDeductionLedgerEntry) = addLedger(Ledger.ofPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry)`. */
        fun addLedger(prepaidCommitRolloverLedgerEntry: Ledger.PrepaidCommitRolloverLedgerEntry) = addLedger(Ledger.ofPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry)`. */
        fun addLedger(prepaidCommitExpirationLedgerEntry: Ledger.PrepaidCommitExpirationLedgerEntry) = addLedger(Ledger.ofPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry)`. */
        fun addLedger(prepaidCommitCanceledLedgerEntry: Ledger.PrepaidCommitCanceledLedgerEntry) = addLedger(Ledger.ofPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry)`. */
        fun addLedger(prepaidCommitCreditedLedgerEntry: Ledger.PrepaidCommitCreditedLedgerEntry) = addLedger(Ledger.ofPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry)`. */
        fun addLedger(prepaidCommitSeatBasedAdjustmentLedgerEntry: Ledger.PrepaidCommitSeatBasedAdjustmentLedgerEntry) = addLedger(Ledger.ofPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry)`. */
        fun addLedger(postpaidCommitInitialBalanceLedgerEntry: Ledger.PostpaidCommitInitialBalanceLedgerEntry) = addLedger(Ledger.ofPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry)`. */
        fun addLedger(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: Ledger.PostpaidCommitAutomatedInvoiceDeductionLedgerEntry) = addLedger(Ledger.ofPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry)`. */
        fun addLedger(postpaidCommitRolloverLedgerEntry: Ledger.PostpaidCommitRolloverLedgerEntry) = addLedger(Ledger.ofPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry)`. */
        fun addLedger(postpaidCommitTrueupLedgerEntry: Ledger.PostpaidCommitTrueupLedgerEntry) = addLedger(Ledger.ofPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry)`. */
        fun addLedger(prepaidCommitManualLedgerEntry: Ledger.PrepaidCommitManualLedgerEntry) = addLedger(Ledger.ofPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry)`. */
        fun addLedger(postpaidCommitManualLedgerEntry: Ledger.PostpaidCommitManualLedgerEntry) = addLedger(Ledger.ofPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry))

        /** Alias for calling [addLedger] with `Ledger.ofPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry)`. */
        fun addLedger(postpaidCommitExpirationLedgerEntry: Ledger.PostpaidCommitExpirationLedgerEntry) = addLedger(Ledger.ofPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry))
        ...
        /** The ID of the recurring commit that this commit was generated from, if applicable. */
        fun recurringCommitId(recurringCommitId: String) = recurringCommitId(JsonField.of(recurringCommitId))

        /**
         * Sets [Builder.recurringCommitId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.recurringCommitId] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun recurringCommitId(recurringCommitId: JsonField<String>) =
            apply {
        ...
        /** Optional attributes controlling how this commit interacts with spend trackers. */
        fun spendTrackerAttributes(spendTrackerAttributes: SpendTrackerAttributes) = spendTrackerAttributes(JsonField.of(spendTrackerAttributes))

        /**
         * Sets [Builder.spendTrackerAttributes] to an arbitrary JSON value.
         *
         * You should usually call [Builder.spendTrackerAttributes] with a well-typed [SpendTrackerAttributes] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (createdAt.asKnown().isPresent) 1 else 0) + (product.asKnown().getOrNull()?.validity() ?: 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (accessSchedule.asKnown().getOrNull()?.validity() ?: 0) + (if (amount.asKnown().isPresent) 1 else 0) + (applicableContractIds.asKnown().getOrNull()?.size ?: 0) + (applicableProductIds.asKnown().getOrNull()?.size ?: 0) + (applicableProductTags.asKnown().getOrNull()?.size ?: 0) + (if (archivedAt.asKnown().isPresent) 1 else 0) + (if (balance.asKnown().isPresent) 1 else 0) + (contract.asKnown().getOrNull()?.validity() ?: 0) + (if (costBasis.asKnown().isPresent) 1 else 0) + (if (createdBy.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (if (description.asKnown().isPresent) 1 else 0) + (hierarchyConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (invoiceContract.asKnown().getOrNull()?.validity() ?: 0) + (invoiceSchedule.asKnown().getOrNull()?.validity() ?: 0) + (ledger.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (if (name.asKnown().isPresent) 1 else 0) + (if (netsuiteSalesOrderId.asKnown().isPresent) 1 else 0) + (if (priority.asKnown().isPresent) 1 else 0) + (rateType.asKnown().getOrNull()?.validity() ?: 0) + (if (recurringCommitId.asKnown().isPresent) 1 else 0) + (rolledOverFrom.asKnown().getOrNull()?.validity() ?: 0) + (if (rolloverFraction.asKnown().isPresent) 1 else 0) + (if (salesforceOpportunityId.asKnown().isPresent) 1 else 0) + (specifiers.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) + (spendTrackerAttributes.asKnown().getOrNull()?.validity() ?: 0) + (subscriptionConfig.asKnown().getOrNull()?.validity() ?: 0) + (if (uniquenessKey.asKnown().isPresent) 1 else 0)
    ...
    /** The contract that this commit will be billed on. */
    class InvoiceContract @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val id: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(invoiceContract: InvoiceContract) =
                apply {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is InvoiceContract && id == other.id && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "InvoiceContract{id=$id, additionalProperties=$additionalProperties}"
    }
    ...
    class Ledger private constructor(
        private val prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry? = null,
        private val prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry? = null,
        ...
        private val prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry? = null,
        private val postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry? = null,
        private val postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry? = null,
        ...
        private val postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry? = null,
        private val _json: JsonValue? = null,

    ) {

        fun prepaidCommitSegmentStartLedgerEntry(): Optional<PrepaidCommitSegmentStartLedgerEntry> = Optional.ofNullable(prepaidCommitSegmentStartLedgerEntry)

        fun prepaidCommitAutomatedInvoiceDeductionLedgerEntry(): Optional<PrepaidCommitAutomatedInvoiceDeductionLedgerEntry> = Optional.ofNullable(prepaidCommitAutomatedInvoiceDeductionLedgerEntry)

        fun prepaidCommitRolloverLedgerEntry(): Optional<PrepaidCommitRolloverLedgerEntry> = Optional.ofNullable(prepaidCommitRolloverLedgerEntry)

        fun prepaidCommitExpirationLedgerEntry(): Optional<PrepaidCommitExpirationLedgerEntry> = Optional.ofNullable(prepaidCommitExpirationLedgerEntry)

        fun prepaidCommitCanceledLedgerEntry(): Optional<PrepaidCommitCanceledLedgerEntry> = Optional.ofNullable(prepaidCommitCanceledLedgerEntry)

        fun prepaidCommitCreditedLedgerEntry(): Optional<PrepaidCommitCreditedLedgerEntry> = Optional.ofNullable(prepaidCommitCreditedLedgerEntry)

        fun prepaidCommitSeatBasedAdjustmentLedgerEntry(): Optional<PrepaidCommitSeatBasedAdjustmentLedgerEntry> = Optional.ofNullable(prepaidCommitSeatBasedAdjustmentLedgerEntry)

        fun postpaidCommitInitialBalanceLedgerEntry(): Optional<PostpaidCommitInitialBalanceLedgerEntry> = Optional.ofNullable(postpaidCommitInitialBalanceLedgerEntry)

        fun postpaidCommitAutomatedInvoiceDeductionLedgerEntry(): Optional<PostpaidCommitAutomatedInvoiceDeductionLedgerEntry> = Optional.ofNullable(postpaidCommitAutomatedInvoiceDeductionLedgerEntry)

        fun postpaidCommitRolloverLedgerEntry(): Optional<PostpaidCommitRolloverLedgerEntry> = Optional.ofNullable(postpaidCommitRolloverLedgerEntry)

        fun postpaidCommitTrueupLedgerEntry(): Optional<PostpaidCommitTrueupLedgerEntry> = Optional.ofNullable(postpaidCommitTrueupLedgerEntry)

        fun prepaidCommitManualLedgerEntry(): Optional<PrepaidCommitManualLedgerEntry> = Optional.ofNullable(prepaidCommitManualLedgerEntry)

        fun postpaidCommitManualLedgerEntry(): Optional<PostpaidCommitManualLedgerEntry> = Optional.ofNullable(postpaidCommitManualLedgerEntry)

        fun postpaidCommitExpirationLedgerEntry(): Optional<PostpaidCommitExpirationLedgerEntry> = Optional.ofNullable(postpaidCommitExpirationLedgerEntry)

        fun isPrepaidCommitSegmentStartLedgerEntry(): Boolean = prepaidCommitSegmentStartLedgerEntry != null

        fun isPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(): Boolean = prepaidCommitAutomatedInvoiceDeductionLedgerEntry != null

        fun isPrepaidCommitRolloverLedgerEntry(): Boolean = prepaidCommitRolloverLedgerEntry != null

        fun isPrepaidCommitExpirationLedgerEntry(): Boolean = prepaidCommitExpirationLedgerEntry != null
        ...
        fun isPrepaidCommitSeatBasedAdjustmentLedgerEntry(): Boolean = prepaidCommitSeatBasedAdjustmentLedgerEntry != null

        fun isPostpaidCommitInitialBalanceLedgerEntry(): Boolean = postpaidCommitInitialBalanceLedgerEntry != null

        fun isPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(): Boolean = postpaidCommitAutomatedInvoiceDeductionLedgerEntry != null

        fun isPostpaidCommitRolloverLedgerEntry(): Boolean = postpaidCommitRolloverLedgerEntry != null
        ...
        fun isPostpaidCommitExpirationLedgerEntry(): Boolean = postpaidCommitExpirationLedgerEntry != null

        fun asPrepaidCommitSegmentStartLedgerEntry(): PrepaidCommitSegmentStartLedgerEntry = prepaidCommitSegmentStartLedgerEntry.getOrThrow("prepaidCommitSegmentStartLedgerEntry")

        fun asPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(): PrepaidCommitAutomatedInvoiceDeductionLedgerEntry = prepaidCommitAutomatedInvoiceDeductionLedgerEntry.getOrThrow("prepaidCommitAutomatedInvoiceDeductionLedgerEntry")

        fun asPrepaidCommitRolloverLedgerEntry(): PrepaidCommitRolloverLedgerEntry = prepaidCommitRolloverLedgerEntry.getOrThrow("prepaidCommitRolloverLedgerEntry")

        fun asPrepaidCommitExpirationLedgerEntry(): PrepaidCommitExpirationLedgerEntry = prepaidCommitExpirationLedgerEntry.getOrThrow("prepaidCommitExpirationLedgerEntry")

        fun asPrepaidCommitCanceledLedgerEntry(): PrepaidCommitCanceledLedgerEntry = prepaidCommitCanceledLedgerEntry.getOrThrow("prepaidCommitCanceledLedgerEntry")

        fun asPrepaidCommitCreditedLedgerEntry(): PrepaidCommitCreditedLedgerEntry = prepaidCommitCreditedLedgerEntry.getOrThrow("prepaidCommitCreditedLedgerEntry")

        fun asPrepaidCommitSeatBasedAdjustmentLedgerEntry(): PrepaidCommitSeatBasedAdjustmentLedgerEntry = prepaidCommitSeatBasedAdjustmentLedgerEntry.getOrThrow("prepaidCommitSeatBasedAdjustmentLedgerEntry")

        fun asPostpaidCommitInitialBalanceLedgerEntry(): PostpaidCommitInitialBalanceLedgerEntry = postpaidCommitInitialBalanceLedgerEntry.getOrThrow("postpaidCommitInitialBalanceLedgerEntry")

        fun asPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(): PostpaidCommitAutomatedInvoiceDeductionLedgerEntry = postpaidCommitAutomatedInvoiceDeductionLedgerEntry.getOrThrow("postpaidCommitAutomatedInvoiceDeductionLedgerEntry")

        fun asPostpaidCommitRolloverLedgerEntry(): PostpaidCommitRolloverLedgerEntry = postpaidCommitRolloverLedgerEntry.getOrThrow("postpaidCommitRolloverLedgerEntry")

        fun asPostpaidCommitTrueupLedgerEntry(): PostpaidCommitTrueupLedgerEntry = postpaidCommitTrueupLedgerEntry.getOrThrow("postpaidCommitTrueupLedgerEntry")

        fun asPrepaidCommitManualLedgerEntry(): PrepaidCommitManualLedgerEntry = prepaidCommitManualLedgerEntry.getOrThrow("prepaidCommitManualLedgerEntry")

        fun asPostpaidCommitManualLedgerEntry(): PostpaidCommitManualLedgerEntry = postpaidCommitManualLedgerEntry.getOrThrow("postpaidCommitManualLedgerEntry")

        fun asPostpaidCommitExpirationLedgerEntry(): PostpaidCommitExpirationLedgerEntry = postpaidCommitExpirationLedgerEntry.getOrThrow("postpaidCommitExpirationLedgerEntry")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                prepaidCommitSegmentStartLedgerEntry != null -> visitor.visitPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry)
                prepaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> visitor.visitPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry)
                prepaidCommitRolloverLedgerEntry != null -> visitor.visitPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry)
                prepaidCommitExpirationLedgerEntry != null -> visitor.visitPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry)
                prepaidCommitCanceledLedgerEntry != null -> visitor.visitPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry)
                prepaidCommitCreditedLedgerEntry != null -> visitor.visitPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry)
                prepaidCommitSeatBasedAdjustmentLedgerEntry != null -> visitor.visitPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry)
                postpaidCommitInitialBalanceLedgerEntry != null -> visitor.visitPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry)
                postpaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> visitor.visitPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry)
                postpaidCommitRolloverLedgerEntry != null -> visitor.visitPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry)
                postpaidCommitTrueupLedgerEntry != null -> visitor.visitPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry)
                prepaidCommitManualLedgerEntry != null -> visitor.visitPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry)
                postpaidCommitManualLedgerEntry != null -> visitor.visitPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry)
                postpaidCommitExpirationLedgerEntry != null -> visitor.visitPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry)
        ...
        fun validate(): Ledger =
            apply {
                ...
                accept(object : Visitor<Unit> {
                    override fun visitPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry) {
                      prepaidCommitSegmentStartLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry) {
                      prepaidCommitAutomatedInvoiceDeductionLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry: PrepaidCommitRolloverLedgerEntry) {
                      prepaidCommitRolloverLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry: PrepaidCommitExpirationLedgerEntry) {
                      prepaidCommitExpirationLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry: PrepaidCommitCanceledLedgerEntry) {
                      prepaidCommitCanceledLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry: PrepaidCommitCreditedLedgerEntry) {
                      prepaidCommitCreditedLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry) {
                      prepaidCommitSeatBasedAdjustmentLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry) {
                      postpaidCommitInitialBalanceLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry) {
                      postpaidCommitAutomatedInvoiceDeductionLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry: PostpaidCommitRolloverLedgerEntry) {
                      postpaidCommitRolloverLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry: PostpaidCommitTrueupLedgerEntry) {
                      postpaidCommitTrueupLedgerEntry.validate()
                    }

                    override fun visitPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry: PrepaidCommitManualLedgerEntry) {
                      prepaidCommitManualLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry: PostpaidCommitManualLedgerEntry) {
                      postpaidCommitManualLedgerEntry.validate()
                    }

                    override fun visitPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry) {
        ...
        internal fun validity(): Int =
            accept(object : Visitor<Int> {
                override fun visitPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry) = prepaidCommitSegmentStartLedgerEntry.validity()

                override fun visitPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry) = prepaidCommitAutomatedInvoiceDeductionLedgerEntry.validity()

                override fun visitPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry: PrepaidCommitRolloverLedgerEntry) = prepaidCommitRolloverLedgerEntry.validity()

                override fun visitPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry: PrepaidCommitExpirationLedgerEntry) = prepaidCommitExpirationLedgerEntry.validity()

                override fun visitPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry: PrepaidCommitCanceledLedgerEntry) = prepaidCommitCanceledLedgerEntry.validity()

                override fun visitPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry: PrepaidCommitCreditedLedgerEntry) = prepaidCommitCreditedLedgerEntry.validity()

                override fun visitPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry) = prepaidCommitSeatBasedAdjustmentLedgerEntry.validity()

                override fun visitPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry) = postpaidCommitInitialBalanceLedgerEntry.validity()

                override fun visitPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry) = postpaidCommitAutomatedInvoiceDeductionLedgerEntry.validity()

                override fun visitPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry: PostpaidCommitRolloverLedgerEntry) = postpaidCommitRolloverLedgerEntry.validity()

                override fun visitPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry: PostpaidCommitTrueupLedgerEntry) = postpaidCommitTrueupLedgerEntry.validity()

                override fun visitPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry: PrepaidCommitManualLedgerEntry) = prepaidCommitManualLedgerEntry.validity()

                override fun visitPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry: PostpaidCommitManualLedgerEntry) = postpaidCommitManualLedgerEntry.validity()

                override fun visitPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry) = postpaidCommitExpirationLedgerEntry.validity()
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Ledger && prepaidCommitSegmentStartLedgerEntry == other.prepaidCommitSegmentStartLedgerEntry && prepaidCommitAutomatedInvoiceDeductionLedgerEntry == other.prepaidCommitAutomatedInvoiceDeductionLedgerEntry && prepaidCommitRolloverLedgerEntry == other.prepaidCommitRolloverLedgerEntry && prepaidCommitExpirationLedgerEntry == other.prepaidCommitExpirationLedgerEntry && prepaidCommitCanceledLedgerEntry == other.prepaidCommitCanceledLedgerEntry && prepaidCommitCreditedLedgerEntry == other.prepaidCommitCreditedLedgerEntry && prepaidCommitSeatBasedAdjustmentLedgerEntry == other.prepaidCommitSeatBasedAdjustmentLedgerEntry && postpaidCommitInitialBalanceLedgerEntry == other.postpaidCommitInitialBalanceLedgerEntry && postpaidCommitAutomatedInvoiceDeductionLedgerEntry == other.postpaidCommitAutomatedInvoiceDeductionLedgerEntry && postpaidCommitRolloverLedgerEntry == other.postpaidCommitRolloverLedgerEntry && postpaidCommitTrueupLedgerEntry == other.postpaidCommitTrueupLedgerEntry && prepaidCommitManualLedgerEntry == other.prepaidCommitManualLedgerEntry && postpaidCommitManualLedgerEntry == other.postpaidCommitManualLedgerEntry && postpaidCommitExpirationLedgerEntry == other.postpaidCommitExpirationLedgerEntry
        }

        override fun hashCode(): Int = Objects.hash(prepaidCommitSegmentStartLedgerEntry, prepaidCommitAutomatedInvoiceDeductionLedgerEntry, prepaidCommitRolloverLedgerEntry, prepaidCommitExpirationLedgerEntry, prepaidCommitCanceledLedgerEntry, prepaidCommitCreditedLedgerEntry, prepaidCommitSeatBasedAdjustmentLedgerEntry, postpaidCommitInitialBalanceLedgerEntry, postpaidCommitAutomatedInvoiceDeductionLedgerEntry, postpaidCommitRolloverLedgerEntry, postpaidCommitTrueupLedgerEntry, prepaidCommitManualLedgerEntry, postpaidCommitManualLedgerEntry, postpaidCommitExpirationLedgerEntry)

        override fun toString(): String =
            when {
                prepaidCommitSegmentStartLedgerEntry != null -> "Ledger{prepaidCommitSegmentStartLedgerEntry=$prepaidCommitSegmentStartLedgerEntry}"
                prepaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> "Ledger{prepaidCommitAutomatedInvoiceDeductionLedgerEntry=$prepaidCommitAutomatedInvoiceDeductionLedgerEntry}"
                prepaidCommitRolloverLedgerEntry != null -> "Ledger{prepaidCommitRolloverLedgerEntry=$prepaidCommitRolloverLedgerEntry}"
                prepaidCommitExpirationLedgerEntry != null -> "Ledger{prepaidCommitExpirationLedgerEntry=$prepaidCommitExpirationLedgerEntry}"
                prepaidCommitCanceledLedgerEntry != null -> "Ledger{prepaidCommitCanceledLedgerEntry=$prepaidCommitCanceledLedgerEntry}"
                prepaidCommitCreditedLedgerEntry != null -> "Ledger{prepaidCommitCreditedLedgerEntry=$prepaidCommitCreditedLedgerEntry}"
                prepaidCommitSeatBasedAdjustmentLedgerEntry != null -> "Ledger{prepaidCommitSeatBasedAdjustmentLedgerEntry=$prepaidCommitSeatBasedAdjustmentLedgerEntry}"
                postpaidCommitInitialBalanceLedgerEntry != null -> "Ledger{postpaidCommitInitialBalanceLedgerEntry=$postpaidCommitInitialBalanceLedgerEntry}"
                postpaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> "Ledger{postpaidCommitAutomatedInvoiceDeductionLedgerEntry=$postpaidCommitAutomatedInvoiceDeductionLedgerEntry}"
                postpaidCommitRolloverLedgerEntry != null -> "Ledger{postpaidCommitRolloverLedgerEntry=$postpaidCommitRolloverLedgerEntry}"
                postpaidCommitTrueupLedgerEntry != null -> "Ledger{postpaidCommitTrueupLedgerEntry=$postpaidCommitTrueupLedgerEntry}"
                prepaidCommitManualLedgerEntry != null -> "Ledger{prepaidCommitManualLedgerEntry=$prepaidCommitManualLedgerEntry}"
                postpaidCommitManualLedgerEntry != null -> "Ledger{postpaidCommitManualLedgerEntry=$postpaidCommitManualLedgerEntry}"
                postpaidCommitExpirationLedgerEntry != null -> "Ledger{postpaidCommitExpirationLedgerEntry=$postpaidCommitExpirationLedgerEntry}"
        ...
        companion object {
            ...
            @JvmStatic
            fun ofPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry) = Ledger(prepaidCommitSegmentStartLedgerEntry = prepaidCommitSegmentStartLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry) = Ledger(prepaidCommitAutomatedInvoiceDeductionLedgerEntry = prepaidCommitAutomatedInvoiceDeductionLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry: PrepaidCommitRolloverLedgerEntry) = Ledger(prepaidCommitRolloverLedgerEntry = prepaidCommitRolloverLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry: PrepaidCommitExpirationLedgerEntry) = Ledger(prepaidCommitExpirationLedgerEntry = prepaidCommitExpirationLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry: PrepaidCommitCanceledLedgerEntry) = Ledger(prepaidCommitCanceledLedgerEntry = prepaidCommitCanceledLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry: PrepaidCommitCreditedLedgerEntry) = Ledger(prepaidCommitCreditedLedgerEntry = prepaidCommitCreditedLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry) = Ledger(prepaidCommitSeatBasedAdjustmentLedgerEntry = prepaidCommitSeatBasedAdjustmentLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry) = Ledger(postpaidCommitInitialBalanceLedgerEntry = postpaidCommitInitialBalanceLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry) = Ledger(postpaidCommitAutomatedInvoiceDeductionLedgerEntry = postpaidCommitAutomatedInvoiceDeductionLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry: PostpaidCommitRolloverLedgerEntry) = Ledger(postpaidCommitRolloverLedgerEntry = postpaidCommitRolloverLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry: PostpaidCommitTrueupLedgerEntry) = Ledger(postpaidCommitTrueupLedgerEntry = postpaidCommitTrueupLedgerEntry)

            @JvmStatic
            fun ofPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry: PrepaidCommitManualLedgerEntry) = Ledger(prepaidCommitManualLedgerEntry = prepaidCommitManualLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry: PostpaidCommitManualLedgerEntry) = Ledger(postpaidCommitManualLedgerEntry = postpaidCommitManualLedgerEntry)

            @JvmStatic
            fun ofPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry) = Ledger(postpaidCommitExpirationLedgerEntry = postpaidCommitExpirationLedgerEntry)
        }

        /** An interface that defines how to map each variant of [Ledger] to a value of type [T]. */
        interface Visitor<out T> {

            fun visitPrepaidCommitSegmentStartLedgerEntry(prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry): T

            fun visitPrepaidCommitAutomatedInvoiceDeductionLedgerEntry(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry): T

            fun visitPrepaidCommitRolloverLedgerEntry(prepaidCommitRolloverLedgerEntry: PrepaidCommitRolloverLedgerEntry): T

            fun visitPrepaidCommitExpirationLedgerEntry(prepaidCommitExpirationLedgerEntry: PrepaidCommitExpirationLedgerEntry): T

            fun visitPrepaidCommitCanceledLedgerEntry(prepaidCommitCanceledLedgerEntry: PrepaidCommitCanceledLedgerEntry): T

            fun visitPrepaidCommitCreditedLedgerEntry(prepaidCommitCreditedLedgerEntry: PrepaidCommitCreditedLedgerEntry): T

            fun visitPrepaidCommitSeatBasedAdjustmentLedgerEntry(prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry): T

            fun visitPostpaidCommitInitialBalanceLedgerEntry(postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry): T

            fun visitPostpaidCommitAutomatedInvoiceDeductionLedgerEntry(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry): T

            fun visitPostpaidCommitRolloverLedgerEntry(postpaidCommitRolloverLedgerEntry: PostpaidCommitRolloverLedgerEntry): T

            fun visitPostpaidCommitTrueupLedgerEntry(postpaidCommitTrueupLedgerEntry: PostpaidCommitTrueupLedgerEntry): T

            fun visitPrepaidCommitManualLedgerEntry(prepaidCommitManualLedgerEntry: PrepaidCommitManualLedgerEntry): T

            fun visitPostpaidCommitManualLedgerEntry(postpaidCommitManualLedgerEntry: PostpaidCommitManualLedgerEntry): T

            fun visitPostpaidCommitExpirationLedgerEntry(postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry): T
        ...
        internal class Deserializer : BaseDeserializer<Ledger>(Ledger::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Ledger {
              ...
              val bestMatches = sequenceOf(
                      ...
                      tryDeserialize(node, jacksonTypeRef<PrepaidCommitAutomatedInvoiceDeductionLedgerEntry>())
                          ?.let {
                              Ledger(prepaidCommitAutomatedInvoiceDeductionLedgerEntry = it, _json = json)
                          },
                      ...
                      tryDeserialize(node, jacksonTypeRef<PrepaidCommitSeatBasedAdjustmentLedgerEntry>())
                          ?.let {
                              Ledger(prepaidCommitSeatBasedAdjustmentLedgerEntry = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<PostpaidCommitInitialBalanceLedgerEntry>())
                          ?.let {
                              Ledger(postpaidCommitInitialBalanceLedgerEntry = it, _json = json)
                          },
                      tryDeserialize(node, jacksonTypeRef<PostpaidCommitAutomatedInvoiceDeductionLedgerEntry>())
                          ?.let {
                              Ledger(postpaidCommitAutomatedInvoiceDeductionLedgerEntry = it, _json = json)
                          },
                      ...
                      tryDeserialize(node, jacksonTypeRef<PrepaidCommitManualLedgerEntry>())
                          ?.let {
                              Ledger(prepaidCommitManualLedgerEntry = it, _json = json)
                          },
        ...
        internal class Serializer : BaseSerializer<Ledger>(Ledger::class) {
            ...
            override fun serialize(value: Ledger, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  value.prepaidCommitSegmentStartLedgerEntry != null -> generator.writeObject(value.prepaidCommitSegmentStartLedgerEntry)
                  value.prepaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> generator.writeObject(value.prepaidCommitAutomatedInvoiceDeductionLedgerEntry)
                  value.prepaidCommitRolloverLedgerEntry != null -> generator.writeObject(value.prepaidCommitRolloverLedgerEntry)
                  value.prepaidCommitExpirationLedgerEntry != null -> generator.writeObject(value.prepaidCommitExpirationLedgerEntry)
                  value.prepaidCommitCanceledLedgerEntry != null -> generator.writeObject(value.prepaidCommitCanceledLedgerEntry)
                  value.prepaidCommitCreditedLedgerEntry != null -> generator.writeObject(value.prepaidCommitCreditedLedgerEntry)
                  value.prepaidCommitSeatBasedAdjustmentLedgerEntry != null -> generator.writeObject(value.prepaidCommitSeatBasedAdjustmentLedgerEntry)
                  value.postpaidCommitInitialBalanceLedgerEntry != null -> generator.writeObject(value.postpaidCommitInitialBalanceLedgerEntry)
                  value.postpaidCommitAutomatedInvoiceDeductionLedgerEntry != null -> generator.writeObject(value.postpaidCommitAutomatedInvoiceDeductionLedgerEntry)
                  value.postpaidCommitRolloverLedgerEntry != null -> generator.writeObject(value.postpaidCommitRolloverLedgerEntry)
                  value.postpaidCommitTrueupLedgerEntry != null -> generator.writeObject(value.postpaidCommitTrueupLedgerEntry)
                  value.prepaidCommitManualLedgerEntry != null -> generator.writeObject(value.prepaidCommitManualLedgerEntry)
                  value.postpaidCommitManualLedgerEntry != null -> generator.writeObject(value.postpaidCommitManualLedgerEntry)
                  value.postpaidCommitExpirationLedgerEntry != null -> generator.writeObject(value.postpaidCommitExpirationLedgerEntry)
        ...
        class PrepaidCommitSegmentStartLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitSegmentStartLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitSegmentStartLedgerEntry: PrepaidCommitSegmentStartLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitSegmentStartLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitSegmentStartLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitSegmentStartLedgerEntry && amount == other.amount && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitSegmentStartLedgerEntry{amount=$amount, segmentId=$segmentId, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitAutomatedInvoiceDeductionLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitAutomatedInvoiceDeductionLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitAutomatedInvoiceDeductionLedgerEntry: PrepaidCommitAutomatedInvoiceDeductionLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitAutomatedInvoiceDeductionLedgerEntry.additionalProperties.toMutableMap()
                    }
                ...
                /**
                 * Returns an immutable instance of [PrepaidCommitAutomatedInvoiceDeductionLedgerEntry].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitAutomatedInvoiceDeductionLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Type @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmField val PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION = of("PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION")
                ...
                fun value(): Value =
                    when (this) {
                        PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION -> Value.PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION -> Known.PREPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION
                        else -> throw MetronomeInvalidDataException("Unknown Type: $value")
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitAutomatedInvoiceDeductionLedgerEntry && amount == other.amount && invoiceId == other.invoiceId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && contractId == other.contractId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitAutomatedInvoiceDeductionLedgerEntry{amount=$amount, invoiceId=$invoiceId, segmentId=$segmentId, timestamp=$timestamp, type=$type, contractId=$contractId, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitRolloverLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitRolloverLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitRolloverLedgerEntry: PrepaidCommitRolloverLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitRolloverLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitRolloverLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitRolloverLedgerEntry && amount == other.amount && newContractId == other.newContractId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitRolloverLedgerEntry{amount=$amount, newContractId=$newContractId, segmentId=$segmentId, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitExpirationLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitExpirationLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitExpirationLedgerEntry: PrepaidCommitExpirationLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitExpirationLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitExpirationLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitExpirationLedgerEntry && amount == other.amount && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitExpirationLedgerEntry{amount=$amount, segmentId=$segmentId, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitCanceledLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val invoiceId: JsonField<String>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitCanceledLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitCanceledLedgerEntry: PrepaidCommitCanceledLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitCanceledLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitCanceledLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitCanceledLedgerEntry && amount == other.amount && invoiceId == other.invoiceId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && contractId == other.contractId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitCanceledLedgerEntry{amount=$amount, invoiceId=$invoiceId, segmentId=$segmentId, timestamp=$timestamp, type=$type, contractId=$contractId, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitCreditedLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val invoiceId: JsonField<String>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitCreditedLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitCreditedLedgerEntry: PrepaidCommitCreditedLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitCreditedLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitCreditedLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitCreditedLedgerEntry && amount == other.amount && invoiceId == other.invoiceId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && contractId == other.contractId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitCreditedLedgerEntry{amount=$amount, invoiceId=$invoiceId, segmentId=$segmentId, timestamp=$timestamp, type=$type, contractId=$contractId, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitSeatBasedAdjustmentLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitSeatBasedAdjustmentLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(prepaidCommitSeatBasedAdjustmentLedgerEntry: PrepaidCommitSeatBasedAdjustmentLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitSeatBasedAdjustmentLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitSeatBasedAdjustmentLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Type @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmField val PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT = of("PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT")
                ...
                fun value(): Value =
                    when (this) {
                        PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT -> Value.PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT -> Known.PREPAID_COMMIT_SEAT_BASED_ADJUSTMENT
                        else -> throw MetronomeInvalidDataException("Unknown Type: $value")
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitSeatBasedAdjustmentLedgerEntry && amount == other.amount && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitSeatBasedAdjustmentLedgerEntry{amount=$amount, segmentId=$segmentId, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitInitialBalanceLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitInitialBalanceLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitInitialBalanceLedgerEntry: PostpaidCommitInitialBalanceLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitInitialBalanceLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitInitialBalanceLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0)
            ...
            class Type @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmField val POSTPAID_COMMIT_INITIAL_BALANCE = of("POSTPAID_COMMIT_INITIAL_BALANCE")
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitInitialBalanceLedgerEntry && amount == other.amount && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitInitialBalanceLedgerEntry{amount=$amount, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitAutomatedInvoiceDeductionLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val invoiceId: JsonField<String>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitAutomatedInvoiceDeductionLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitAutomatedInvoiceDeductionLedgerEntry: PostpaidCommitAutomatedInvoiceDeductionLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitAutomatedInvoiceDeductionLedgerEntry.additionalProperties.toMutableMap()
                    }
                ...
                /**
                 * Returns an immutable instance of [PostpaidCommitAutomatedInvoiceDeductionLedgerEntry].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitAutomatedInvoiceDeductionLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            class Type @JsonCreator private constructor(
                ...
                companion object {
                    ...
                    @JvmField val POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION = of("POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION")
                ...
                fun value(): Value =
                    when (this) {
                        POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION -> Value.POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION -> Known.POSTPAID_COMMIT_AUTOMATED_INVOICE_DEDUCTION
                        else -> throw MetronomeInvalidDataException("Unknown Type: $value")
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitAutomatedInvoiceDeductionLedgerEntry && amount == other.amount && invoiceId == other.invoiceId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && contractId == other.contractId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitAutomatedInvoiceDeductionLedgerEntry{amount=$amount, invoiceId=$invoiceId, segmentId=$segmentId, timestamp=$timestamp, type=$type, contractId=$contractId, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitRolloverLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val newContractId: JsonField<String>,
            private val segmentId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitRolloverLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitRolloverLedgerEntry: PostpaidCommitRolloverLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitRolloverLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitRolloverLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitRolloverLedgerEntry && amount == other.amount && newContractId == other.newContractId && segmentId == other.segmentId && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitRolloverLedgerEntry{amount=$amount, newContractId=$newContractId, segmentId=$segmentId, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitTrueupLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val invoiceId: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitTrueupLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitTrueupLedgerEntry: PostpaidCommitTrueupLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitTrueupLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitTrueupLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (invoiceId.asKnown().isPresent) 1 else 0) + (if (timestamp.asKnown().isPresent) 1 else 0) + (type.asKnown().getOrNull()?.validity() ?: 0) + (if (contractId.asKnown().isPresent) 1 else 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitTrueupLedgerEntry && amount == other.amount && invoiceId == other.invoiceId && timestamp == other.timestamp && type == other.type && contractId == other.contractId && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitTrueupLedgerEntry{amount=$amount, invoiceId=$invoiceId, timestamp=$timestamp, type=$type, contractId=$contractId, additionalProperties=$additionalProperties}"
        }

        class PrepaidCommitManualLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PrepaidCommitManualLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                internal fun from(prepaidCommitManualLedgerEntry: PrepaidCommitManualLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = prepaidCommitManualLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PrepaidCommitManualLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PrepaidCommitManualLedgerEntry && amount == other.amount && reason == other.reason && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PrepaidCommitManualLedgerEntry{amount=$amount, reason=$reason, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitManualLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val reason: JsonField<String>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitManualLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitManualLedgerEntry: PostpaidCommitManualLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitManualLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitManualLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitManualLedgerEntry && amount == other.amount && reason == other.reason && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitManualLedgerEntry{amount=$amount, reason=$reason, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }

        class PostpaidCommitExpirationLedgerEntry @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            private val amount: JsonField<Double>,
            private val timestamp: JsonField<OffsetDateTime>,
            private val type: JsonField<Type>,
            private val additionalProperties: MutableMap<String, JsonValue>,
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [PostpaidCommitExpirationLedgerEntry].
                 *
                 * The following fields are required:
                 *
                 * ```java
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(postpaidCommitExpirationLedgerEntry: PostpaidCommitExpirationLedgerEntry) =
                    apply {
                        ...
                        additionalProperties = postpaidCommitExpirationLedgerEntry.additionalProperties.toMutableMap()
                    }
             ...
             *   expected type.
             */
            fun validate(): PostpaidCommitExpirationLedgerEntry =
                apply {
                    if (validated) {
                      return@apply
                    }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is PostpaidCommitExpirationLedgerEntry && amount == other.amount && timestamp == other.timestamp && type == other.type && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "PostpaidCommitExpirationLedgerEntry{amount=$amount, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
        }
    }
    ...
    class RolledOverFrom @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (commitId.asKnown().isPresent) 1 else 0) + (if (contractId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is RolledOverFrom && commitId == other.commitId && contractId == other.contractId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "RolledOverFrom{commitId=$commitId, contractId=$contractId, additionalProperties=$additionalProperties}"
    }

    /** Optional attributes controlling how this commit interacts with spend trackers. */
    class SpendTrackerAttributes @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("counts_as_discounted") @ExcludeMissing countsAsDiscounted: JsonField<Boolean> = JsonMissing.of()
        ) : this(
          countsAsDiscounted, mutableMapOf()
        )
         ...
         *
         * Unlike [countsAsDiscounted], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(spendTrackerAttributes: SpendTrackerAttributes) =
                apply {
            ...
            /** If true, this commit is included in spend trackers with discounted set to DISCOUNTED_ONLY */
            fun countsAsDiscounted(countsAsDiscounted: Boolean) = countsAsDiscounted(JsonField.of(countsAsDiscounted))

            /**
             * Sets [Builder.countsAsDiscounted] to an arbitrary JSON value.
             *
             * You should usually call [Builder.countsAsDiscounted] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun countsAsDiscounted(countsAsDiscounted: JsonField<Boolean>) =
                apply {
            ...
            fun build(): SpendTrackerAttributes =
                SpendTrackerAttributes(
                  checkRequired(
                    "countsAsDiscounted", countsAsDiscounted
                  ), additionalProperties.toMutableMap()
                )
        }
         ...
         *   expected type.
         */
        fun validate(): SpendTrackerAttributes =
            apply {
                if (validated) {
                  return@apply
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is SpendTrackerAttributes && countsAsDiscounted == other.countsAsDiscounted && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "SpendTrackerAttributes{countsAsDiscounted=$countsAsDiscounted, additionalProperties=$additionalProperties}"
    }
