...
class CreditListPageResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Credit>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<Credit>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditListPageResponse].
         *
    ...
    /** A builder for [CreditListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditListPageResponse: CreditListPageResponse) =
            apply {
                data = creditListPageResponse.data.map { it.toMutableList() }
                nextPage = creditListPageResponse.nextPage
                additionalProperties = creditListPageResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Credit>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Credit>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        /**
         * Adds a single [Credit] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Credit) =
            apply {
        ...
        /**
         * Returns an immutable instance of [CreditListPageResponse].
         *
         ...
         */
        fun build(): CreditListPageResponse =
            CreditListPageResponse(
              checkRequired(
                "data", data
              ).map { it.toImmutable() },
              checkRequired(
     ...
     *   expected type.
     */
    fun validate(): CreditListPageResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CreditListPageResponse && data == other.data && nextPage == other.nextPage && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CreditListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
