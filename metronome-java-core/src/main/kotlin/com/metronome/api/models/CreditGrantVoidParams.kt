...
constructor(
    ...
    @JsonDeserialize(builder = CreditGrantVoidBody.Builder::class)
    @NoAutoDetect
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditGrantVoidParams && this.id == other.id && this.releaseUniquenessKey == other.releaseUniquenessKey && this.voidCreditPurchaseInvoice == other.voidCreditPurchaseInvoice && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(id, releaseUniquenessKey, voidCreditPurchaseInvoice, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "CreditGrantVoidParams{id=$id, releaseUniquenessKey=$releaseUniquenessKey, voidCreditPurchaseInvoice=$voidCreditPurchaseInvoice, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
