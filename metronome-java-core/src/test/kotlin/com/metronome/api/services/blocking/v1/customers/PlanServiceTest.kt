...
internal class PlanServiceTest {
    ...
    fun list() {
      val client = MetronomeOkHttpClient.builder()
          ...
          .build()
      val planService = client.v1().customers().plans()

      val page = planService.list(PlanListParams.builder()
    ...
    fun add() {
      ...
      val response = planService.add(PlanAddParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun end() {
      ...
      val response = planService.end(PlanEndParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
    ...
    fun listPriceAdjustments() {
      ...
      val page = planService.listPriceAdjustments(PlanListPriceAdjustmentsParams.builder()
          .customerId("d7abd0cd-4ae9-4db7-8676-e986a4ebd8dc")
          .customerPlanId("7aa11640-0703-4600-8eb9-293f535a6b74")
          .build())
