 ...
 *
 */
class ContractRetrieveSubscriptionQuantityHistoryParams private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractRetrieveSubscriptionQuantityHistoryParams].
         *
    ...
    /** A builder for [ContractRetrieveSubscriptionQuantityHistoryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractRetrieveSubscriptionQuantityHistoryParams: ContractRetrieveSubscriptionQuantityHistoryParams) =
            apply {
                body = contractRetrieveSubscriptionQuantityHistoryParams.body.toBuilder()
                additionalHeaders = contractRetrieveSubscriptionQuantityHistoryParams.additionalHeaders.toBuilder()
                additionalQueryParams = contractRetrieveSubscriptionQuantityHistoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ContractRetrieveSubscriptionQuantityHistoryParams].
         *
         ...
         */
        fun build(): ContractRetrieveSubscriptionQuantityHistoryParams =
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (contractId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (if (subscriptionId.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && contractId == other.contractId && customerId == other.customerId && subscriptionId == other.subscriptionId && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Body{contractId=$contractId, customerId=$customerId, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractRetrieveSubscriptionQuantityHistoryParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(body, additionalHeaders, additionalQueryParams)

    override fun toString() = "ContractRetrieveSubscriptionQuantityHistoryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
