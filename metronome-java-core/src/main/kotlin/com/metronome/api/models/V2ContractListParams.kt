 ...
 * - Power a page in your end customer experience that shows the customer's history of tiers (e.g.
 *   this customer started out on the Pro Plan, then downgraded to the Starter plan).
 *
 * ### Usage guidelines:
 *
 * Use the `starting_at`, `covering_date`, and `include_archived` parameters to filter the list of
 * returned contracts. For example, to list only currently active contracts, pass `covering_date`
 * equal to the current time.
 */
class V2ContractListParams
private constructor(
    ...
    /**
     * Include commit/credit ledgers in the response. Setting this flag may cause the response to be
     * slower.
     */
    ...
    private constructor(
         ...
         * the response to be slower.
         */
        fun includeBalance(): Optional<Boolean> =
            Optional.ofNullable(includeBalance.getNullable("include_balance"))

        /**
         * Include commit/credit ledgers in the response. Setting this flag may cause the response
         * to be slower.
         */
        ...
        class Builder internal constructor() {
             ...
             * cause the response to be slower.
             */
    ...
    /** A builder for [V2ContractListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v2ContractListParams: V2ContractListParams) = apply {
            body = v2ContractListParams.body.toBuilder()
            additionalHeaders = v2ContractListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v2ContractListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V2ContractListParams =
            V2ContractListParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V2ContractListParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V2ContractListParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
