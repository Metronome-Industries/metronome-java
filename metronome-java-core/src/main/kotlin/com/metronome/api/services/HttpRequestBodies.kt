...
import com.metronome.api.core.MultipartFormValue
    ...
    return object : HttpRequestBody {
        ...
        private fun serialize(): ByteArray {
            ...
            try {
                ...
                throw MetronomeException("Error writing request", e)
            }
        }
            ...
            when (part.value) {
                is JsonValue -> {
                    ...
                    try {
                        ...
                        throw MetronomeException("Error serializing value to json", e)
                    }
