...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditGrantListCreditTypesPageAsync && this.creditGrantsService == other.creditGrantsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    constructor(
        ...
        private val data: JsonField<List<CreditGrantListCreditTypesResponse>>,
        ...
        override fun toString() =
            "CreditGrantListCreditTypesPageAsync.Response{nextPage=$nextPage, data=$data, additionalProperties=$additionalProperties}"
