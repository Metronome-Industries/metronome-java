                        ...
                        ContractEditParams.AddDiscount.builder()
                            ...
                            .schedule(
                                ContractEditParams.AddDiscount.Schedule.builder()
                                    ...
                                    .addScheduleItem(
                                        ContractEditParams.AddDiscount.Schedule.ScheduleItem
                                            .builder()
                                            .timestamp(
                                                OffsetDateTime.parse("2019-12-27T18:11:19.117Z")
                                            )
                                ...
                                ContractEditParams.AddRecurringCommit.ProrationRounding.builder()
                                    .access(
                                        ContractEditParams.AddRecurringCommit.ProrationRounding
                                            ...
                                            .decimalPlaces(-5.0)
                                            .roundingMethod(
                                                ContractEditParams.AddRecurringCommit
                                                    .ProrationRounding
                                                    .Access
                                                    .RoundingMethod
                                                    .HALF_UP
                                ...
                                ContractEditParams.AddRecurringCredit.ProrationRounding.builder()
                                    .access(
                                        ContractEditParams.AddRecurringCredit.ProrationRounding
                                            ...
                                            .decimalPlaces(-5.0)
                                            .roundingMethod(
                                                ContractEditParams.AddRecurringCredit
                                                    .ProrationRounding
                                                    .Access
                                                    .RoundingMethod
                                                    .HALF_UP
                                ...
                                ContractEditParams.AddSubscription.Proration.builder()
                                    ...
                                    .rounding(
                                        ContractEditParams.AddSubscription.Proration.Rounding
                                            ...
                                            .decimalPlaces(-5.0)
                                            .roundingMethod(
                                                ContractEditParams.AddSubscription.Proration
                                                    .Rounding
                                                    .RoundingMethod
                                                    .HALF_UP
                                            )
                ...
                ContractEditCommitParams.builder()
                    ...
                    .invoiceSchedule(
                        ContractEditCommitParams.InvoiceSchedule.builder()
                            ...
                            .addRemoveScheduleItem(
                                ContractEditCommitParams.InvoiceSchedule.RemoveScheduleItem
                                    .builder()
                                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                    .build()
                            )
                            .addUpdateScheduleItem(
                                ContractEditCommitParams.InvoiceSchedule.UpdateScheduleItem
                                    .builder()
                                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                                    .amount(0.0)
                                    .quantity(0.0)
