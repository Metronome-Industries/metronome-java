 ...
 *
 */
class RateCardListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): RateCardListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rateCardListParams: RateCardListParams) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is RateCardListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "RateCardListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
