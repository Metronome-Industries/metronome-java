...
class CommitUpdateEndDateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommitUpdateEndDateResponse].
         *
    ...
    /** A builder for [CommitUpdateEndDateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commitUpdateEndDateResponse: CommitUpdateEndDateResponse) =
            apply {
                data = commitUpdateEndDateResponse.data
                additionalProperties = commitUpdateEndDateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CommitUpdateEndDateResponse].
         *
         ...
         */
        fun build(): CommitUpdateEndDateResponse =
     ...
     *   expected type.
     */
    fun validate(): CommitUpdateEndDateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CommitUpdateEndDateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "CommitUpdateEndDateResponse{data=$data, additionalProperties=$additionalProperties}"
}
