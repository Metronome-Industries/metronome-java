...
class QuantityRounding @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(quantityRounding: QuantityRounding) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is QuantityRounding && decimalPlaces == other.decimalPlaces && roundingMethod == other.roundingMethod && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "QuantityRounding{decimalPlaces=$decimalPlaces, roundingMethod=$roundingMethod, additionalProperties=$additionalProperties}"
}
