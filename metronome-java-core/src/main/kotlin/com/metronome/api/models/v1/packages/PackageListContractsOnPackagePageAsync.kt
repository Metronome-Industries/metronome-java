...
class PackageListContractsOnPackagePageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<PackageListContractsOnPackagePageAsync> = service.listContractsOnPackage(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PackageListContractsOnPackagePageAsync].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(packageListContractsOnPackagePageAsync: PackageListContractsOnPackagePageAsync) =
            apply {
        ...
        fun service(service: PackageServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PackageListContractsOnPackagePageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "PackageListContractsOnPackagePageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
