...
internal class ContractGetNetBalanceParamsTest {
    ...
    fun create() {
      ContractGetNetBalanceParams.builder()
          ...
          .addFilter(BalanceFilter.builder()
    ...
    @Test
    fun body() {
      val params = ContractGetNetBalanceParams.builder()
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .creditTypeId("2714e483-4ff1-48e4-9e25-ac732e8f24f2")
          .addFilter(BalanceFilter.builder()
              .addBalanceType(BalanceFilter.BalanceType.CREDIT)
      ...
      assertThat(body.filters().getOrNull()).containsExactly(BalanceFilter.builder()
          .addBalanceType(BalanceFilter.BalanceType.CREDIT)
          .customFields(BalanceFilter.CustomFields.builder()
              .putAdditionalProperty("campaign", JsonValue.from("free-trial"))
              .build())
          .addId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build(), BalanceFilter.builder()
          .addBalanceType(BalanceFilter.BalanceType.PREPAID_COMMIT)
          .addBalanceType(BalanceFilter.BalanceType.POSTPAID_COMMIT)
          .customFields(BalanceFilter.CustomFields.builder()
              .putAdditionalProperty("campaign", JsonValue.from("signup-promotion"))
          ...
          .addId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      assertThat(body.invoiceInclusionMode()).contains(ContractGetNetBalanceParams.InvoiceInclusionMode.FINALIZED)
    }
