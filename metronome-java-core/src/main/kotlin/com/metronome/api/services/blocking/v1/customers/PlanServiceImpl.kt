...
class PlanServiceImpl internal constructor(
    ...
    override fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions): PlanListPriceAdjustmentsPage =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun add(params: PlanAddParams, requestOptions: RequestOptions): HttpResponseFor<PlanAddResponse> {
          val request = HttpRequest.builder()
        ...
        override fun end(params: PlanEndParams, requestOptions: RequestOptions): HttpResponseFor<PlanEndResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listPriceAdjustments(params: PlanListPriceAdjustmentsParams, requestOptions: RequestOptions): HttpResponseFor<PlanListPriceAdjustmentsPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .baseUrl(clientOptions.baseUrl())
