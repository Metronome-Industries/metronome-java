 ...
 */
class V1ContractProductListPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractProductListPage && productsService == other.productsService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(productsService, params, response) /* spotless:on */

    override fun toString() =
        "V1ContractProductListPage{productsService=$productsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1ContractProductListPage> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1ContractProductListPage(productsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1ContractProductListPage) :
        Iterable<V1ContractProductListResponse> {

        override fun iterator(): Iterator<V1ContractProductListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<V1ContractProductListResponse> {
