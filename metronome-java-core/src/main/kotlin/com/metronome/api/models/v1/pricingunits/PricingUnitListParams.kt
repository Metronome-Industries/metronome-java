 ...
 *
 */
class PricingUnitListParams private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): PricingUnitListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PricingUnitListParams]. */
        @JvmStatic
        fun builder() = Builder()
    }
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pricingUnitListParams: PricingUnitListParams) =
            apply {
        ...
        /**
         * Returns an immutable instance of [PricingUnitListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PricingUnitListParams && limit == other.limit && nextPage == other.nextPage && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, additionalHeaders, additionalQueryParams)

    override fun toString() = "PricingUnitListParams{limit=$limit, nextPage=$nextPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
