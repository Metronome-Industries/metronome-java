 ...
 */
class V1CustomerInvoiceListPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerInvoiceListPageAsync && invoicesService == other.invoicesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(invoicesService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerInvoiceListPageAsync{invoicesService=$invoicesService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<V1CustomerInvoiceListPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1CustomerInvoiceListPageAsync(invoicesService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerInvoiceListPageAsync) {

        fun forEach(action: Predicate<Invoice>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V1CustomerInvoiceListPageAsync>>.forEach(
