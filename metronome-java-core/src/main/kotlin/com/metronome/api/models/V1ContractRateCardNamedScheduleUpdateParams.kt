 ...
 */
class V1ContractRateCardNamedScheduleUpdateParams
private constructor(
    ...
    /** A builder for [V1ContractRateCardNamedScheduleUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1ContractRateCardNamedScheduleUpdateParams: V1ContractRateCardNamedScheduleUpdateParams
        ) = apply {
            body = v1ContractRateCardNamedScheduleUpdateParams.body.toBuilder()
            additionalHeaders =
                v1ContractRateCardNamedScheduleUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                v1ContractRateCardNamedScheduleUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardNamedScheduleUpdateParams =
            V1ContractRateCardNamedScheduleUpdateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardNamedScheduleUpdateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardNamedScheduleUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
