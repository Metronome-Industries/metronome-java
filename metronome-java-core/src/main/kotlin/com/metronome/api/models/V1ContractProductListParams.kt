 ...
 */
class V1ContractProductListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1ContractProductListParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1ContractProductListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractProductListParams: V1ContractProductListParams) = apply {
            limit = v1ContractProductListParams.limit
            nextPage = v1ContractProductListParams.nextPage
            body = v1ContractProductListParams.body.toBuilder()
            additionalHeaders = v1ContractProductListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractProductListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractProductListParams =
            V1ContractProductListParams(
                limit,
                nextPage,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractProductListParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "V1ContractProductListParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
