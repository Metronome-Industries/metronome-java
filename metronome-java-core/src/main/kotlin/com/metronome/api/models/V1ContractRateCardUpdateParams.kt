 ...
 */
class V1ContractRateCardUpdateParams
private constructor(
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is Body && rateCardId == other.rateCardId && aliases == other.aliases && description == other.description && name == other.name && additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    /** A builder for [V1ContractRateCardUpdateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRateCardUpdateParams: V1ContractRateCardUpdateParams) = apply {
            body = v1ContractRateCardUpdateParams.body.toBuilder()
            additionalHeaders = v1ContractRateCardUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractRateCardUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRateCardUpdateParams =
            V1ContractRateCardUpdateParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardUpdateParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardUpdateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
