...
private constructor(
    ...
    fun getNextPage(): CompletableFuture<Optional<BillableMetricListPageAsync>> {
    ...
    class AutoPager(
        ...
        fun toList(executor: Executor): CompletableFuture<List<BillableMetricListResponse>> {
            val values = mutableListOf<BillableMetricListResponse>()
