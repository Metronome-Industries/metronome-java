...
interface BillableMetricService {
     ...
     */
    fun update(params: BillableMetricUpdateParams): BillableMetricUpdateResponse =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [BillableMetricService.update].
         */
        @MustBeClosed
        fun update(
            params: BillableMetricUpdateParams
        ): HttpResponseFor<BillableMetricUpdateResponse> = update(params, RequestOptions.none())
