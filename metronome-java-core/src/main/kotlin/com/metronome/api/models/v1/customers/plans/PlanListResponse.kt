...
import com.metronome.api.models.v1.customers.plans.PlanListResponse
...
class PlanListResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("plan_description") @ExcludeMissing planDescription: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("trial_info") @ExcludeMissing trialInfo: JsonField<TrialInfo> = JsonMissing.of()
    ) : this(
      id,
      customFields,
      planDescription,
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planListResponse: PlanListResponse) =
            apply {
        ...
        fun planDescription(planDescription: String) = planDescription(JsonField.of(planDescription))

        /**
         * Sets [Builder.planDescription] to an arbitrary JSON value.
         *
         * You should usually call [Builder.planDescription] with a well-typed [String] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun planDescription(planDescription: JsonField<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.trialInfo] with a well-typed [TrialInfo] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (customFields.asKnown().getOrNull()?.validity() ?: 0) + (if (planDescription.asKnown().isPresent) 1 else 0) + (if (planId.asKnown().isPresent) 1 else 0) + (if (planName.asKnown().isPresent) 1 else 0) + (if (startingOn.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (if (netPaymentTermsDays.asKnown().isPresent) 1 else 0) + (trialInfo.asKnown().getOrNull()?.validity() ?: 0)
    ...
    class TrialInfo @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        private val endingBefore: JsonField<OffsetDateTime>,
        ...
        private constructor(
            @JsonProperty("ending_before") @ExcludeMissing endingBefore: JsonField<OffsetDateTime> = JsonMissing.of(),
            @JsonProperty("spending_caps") @ExcludeMissing spendingCaps: JsonField<List<SpendingCap>> = JsonMissing.of()
        ) : this(
          endingBefore,
          spendingCaps,
          mutableMapOf(),
         ...
         *
         * Unlike [spendingCaps], this method doesn't throw if the JSON field has an unexpected type.
         */
        ...
        class Builder internal constructor() {
            ...
            fun spendingCaps(spendingCaps: List<SpendingCap>) = spendingCaps(JsonField.of(spendingCaps))

            /**
             * Sets [Builder.spendingCaps] to an arbitrary JSON value.
             *
             * You should usually call [Builder.spendingCaps] with a well-typed `List<SpendingCap>` value instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun spendingCaps(spendingCaps: JsonField<List<SpendingCap>>) =
                apply {
             ...
             */
            fun addSpendingCap(spendingCap: SpendingCap) =
                apply {
                    spendingCaps = (spendingCaps ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (endingBefore.asKnown().isPresent) 1 else 0) + (spendingCaps.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        class SpendingCap @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("amount_remaining") @ExcludeMissing amountRemaining: JsonField<Double> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                ...
                fun amountRemaining(amountRemaining: Double) = amountRemaining(JsonField.of(amountRemaining))

                /**
                 * Sets [Builder.amountRemaining] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.amountRemaining] with a well-typed [Double] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun amountRemaining(amountRemaining: JsonField<Double>) =
                    apply {
             ...
             */
            @JvmSynthetic
            internal fun validity(): Int = (if (amount.asKnown().isPresent) 1 else 0) + (if (amountRemaining.asKnown().isPresent) 1 else 0) + (creditType.asKnown().getOrNull()?.validity() ?: 0)
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is SpendingCap && amount == other.amount && amountRemaining == other.amountRemaining && creditType == other.creditType && additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() = "SpendingCap{amount=$amount, amountRemaining=$amountRemaining, creditType=$creditType, additionalProperties=$additionalProperties}"
        }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is TrialInfo && endingBefore == other.endingBefore && spendingCaps == other.spendingCaps && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "TrialInfo{endingBefore=$endingBefore, spendingCaps=$spendingCaps, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PlanListResponse && id == other.id && customFields == other.customFields && planDescription == other.planDescription && planId == other.planId && planName == other.planName && startingOn == other.startingOn && endingBefore == other.endingBefore && netPaymentTermsDays == other.netPaymentTermsDays && trialInfo == other.trialInfo && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PlanListResponse{id=$id, customFields=$customFields, planDescription=$planDescription, planId=$planId, planName=$planName, startingOn=$startingOn, endingBefore=$endingBefore, netPaymentTermsDays=$netPaymentTermsDays, trialInfo=$trialInfo, additionalProperties=$additionalProperties}"
}
