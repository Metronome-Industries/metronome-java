...
class BillableMetricArchiveResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricArchiveResponse].
         *
    ...
    /** A builder for [BillableMetricArchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricArchiveResponse: BillableMetricArchiveResponse) =
            apply {
                data = billableMetricArchiveResponse.data
                additionalProperties = billableMetricArchiveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BillableMetricArchiveResponse].
         *
         ...
         */
        fun build(): BillableMetricArchiveResponse =
     ...
     *   expected type.
     */
    fun validate(): BillableMetricArchiveResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricArchiveResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "BillableMetricArchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
