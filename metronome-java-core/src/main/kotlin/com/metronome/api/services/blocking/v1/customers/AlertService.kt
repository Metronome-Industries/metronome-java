...
interface AlertService {
    ...
    /** @see retrieve */
    fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): AlertRetrieveResponse
     ...
     *
     */
    fun list(params: AlertListParams): AlertListPage =
        list(
          params, RequestOptions.none()
        )
     ...
     *
     */
    fun reset(params: AlertResetParams) =
        reset(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** Returns a raw HTTP response for `post /v1/customer-alerts/get`, but is otherwise the             same as [AlertService.retrieve]. */
        @MustBeClosed
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertRetrieveResponse>

        /** Returns a raw HTTP response for `post /v1/customer-alerts/list`, but is otherwise the             same as [AlertService.list]. */
        @MustBeClosed
        ...
        /** @see list */
        @MustBeClosed
        fun list(params: AlertListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertListPage>

        /** Returns a raw HTTP response for `post /v1/customer-alerts/reset`, but is otherwise the             same as [AlertService.reset]. */
        @MustBeClosed
        fun reset(params: AlertResetParams): HttpResponse =
            reset(
              params, RequestOptions.none()
            )
        ...
        /** @see reset */
        @MustBeClosed
        fun reset(params: AlertResetParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponse
    }
}
