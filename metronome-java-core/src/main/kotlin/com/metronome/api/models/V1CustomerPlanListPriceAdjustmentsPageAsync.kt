 ...
 */
class V1CustomerPlanListPriceAdjustmentsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerPlanListPriceAdjustmentsPageAsync && plansService == other.plansService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(plansService, params, response) /* spotless:on */

    override fun toString() =
        "V1CustomerPlanListPriceAdjustmentsPageAsync{plansService=$plansService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<V1CustomerPlanListPriceAdjustmentsPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1CustomerPlanListPriceAdjustmentsPageAsync(plansService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1CustomerPlanListPriceAdjustmentsPageAsync) {

        fun forEach(
            action: Predicate<V1CustomerPlanListPriceAdjustmentsResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V1CustomerPlanListPriceAdjustmentsPageAsync>>.forEach(
                action: (V1CustomerPlanListPriceAdjustmentsResponse) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(
            executor: Executor
        ): CompletableFuture<List<V1CustomerPlanListPriceAdjustmentsResponse>> {
            val values = mutableListOf<V1CustomerPlanListPriceAdjustmentsResponse>()
