...
internal class CommitUpdateEndDateParamsTest {
    ...
    @Test
    fun body() {
      val params = CommitUpdateEndDateParams.builder()
          .commitId("6162d87b-e5db-4a33-b7f2-76ce6ead4e85")
          .customerId("13117714-3f05-48e5-a6e9-a66093f13b4d")
          .accessEndingBefore(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
          .invoicesEndingBefore(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
      ...
      assertThat(body.accessEndingBefore()).contains(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
      assertThat(body.invoicesEndingBefore()).contains(OffsetDateTime.parse("2020-01-01T00:00:00.000Z"))
    }
