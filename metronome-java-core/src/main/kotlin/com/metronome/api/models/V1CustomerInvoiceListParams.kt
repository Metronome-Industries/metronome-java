 ...
 */
class V1CustomerInvoiceListParams
private constructor(
    ...
    /** A builder for [V1CustomerInvoiceListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CustomerInvoiceListParams: V1CustomerInvoiceListParams) = apply {
            customerId = v1CustomerInvoiceListParams.customerId
            creditTypeId = v1CustomerInvoiceListParams.creditTypeId
            endingBefore = v1CustomerInvoiceListParams.endingBefore
            limit = v1CustomerInvoiceListParams.limit
            nextPage = v1CustomerInvoiceListParams.nextPage
            skipZeroQtyLineItems = v1CustomerInvoiceListParams.skipZeroQtyLineItems
            sort = v1CustomerInvoiceListParams.sort
            startingOn = v1CustomerInvoiceListParams.startingOn
            status = v1CustomerInvoiceListParams.status
            additionalHeaders = v1CustomerInvoiceListParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CustomerInvoiceListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CustomerInvoiceListParams =
            V1CustomerInvoiceListParams(
    ...
    override fun toString() =
        "V1CustomerInvoiceListParams{customerId=$customerId, creditTypeId=$creditTypeId, endingBefore=$endingBefore, limit=$limit, nextPage=$nextPage, skipZeroQtyLineItems=$skipZeroQtyLineItems, sort=$sort, startingOn=$startingOn, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
