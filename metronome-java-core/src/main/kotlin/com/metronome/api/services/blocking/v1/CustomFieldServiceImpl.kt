...
class CustomFieldServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CustomFieldService {

    private val withRawResponse: CustomFieldService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): CustomFieldService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldService = CustomFieldServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions) {
      // post /v1/customFields/deleteValues
      withRawResponse().deleteValues(params, requestOptions)
    }

    override fun listKeys(params: CustomFieldListKeysParams, requestOptions: RequestOptions): CustomFieldListKeysPage =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CustomFieldService.WithRawResponse = CustomFieldServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())

        private val addKeyHandler: Handler<Void?> = emptyHandler()

        override fun addKey(params: CustomFieldAddKeyParams, requestOptions: RequestOptions): HttpResponse {
        ...
        override fun deleteValues(params: CustomFieldDeleteValuesParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun listKeys(params: CustomFieldListKeysParams, requestOptions: RequestOptions): HttpResponseFor<CustomFieldListKeysPage> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun removeKey(params: CustomFieldRemoveKeyParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun setValues(params: CustomFieldSetValuesParams, requestOptions: RequestOptions): HttpResponse {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
