...
class ContractCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractCreateResponse: ContractCreateResponse) =
            apply {
     ...
     *   expected type.
     */
    fun validate(): ContractCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Data @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (contract.asKnown().getOrNull()?.validity() ?: 0)
        ...
        class Contract @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
            ...
            private val customerBillingProviderConfiguration: JsonField<CustomerBillingProviderConfiguration>,
            ...
            private constructor(
                ...
                @JsonProperty("usage_filter") @ExcludeMissing usageFilter: JsonField<List<UsageFilter>> = JsonMissing.of(),
                ...
                @JsonProperty("customer_billing_provider_configuration") @ExcludeMissing customerBillingProviderConfiguration: JsonField<CustomerBillingProviderConfiguration> = JsonMissing.of(),
                @JsonProperty("ending_before") @ExcludeMissing endingBefore: JsonField<OffsetDateTime> = JsonMissing.of(),
                @JsonProperty("has_more") @ExcludeMissing hasMore: JsonField<HasMore> = JsonMissing.of(),
                ...
                @JsonProperty("multiplier_override_prioritization") @ExcludeMissing multiplierOverridePrioritization: JsonField<MultiplierOverridePrioritization> = JsonMissing.of(),
                ...
                @JsonProperty("subscriptions") @ExcludeMissing subscriptions: JsonField<List<Subscription>> = JsonMissing.of(),
            ...
            /** @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value). */
            fun customerBillingProviderConfiguration(): Optional<CustomerBillingProviderConfiguration> = customerBillingProviderConfiguration.getOptional("customer_billing_provider_configuration")
             ...
             * @throws MetronomeInvalidDataException if the JSON field has an unexpected type (e.g. if the server responded with an unexpected value).
             */
            fun multiplierOverridePrioritization(): Optional<MultiplierOverridePrioritization> = multiplierOverridePrioritization.getOptional("multiplier_override_prioritization")
             ...
             *
             * Unlike [customerBillingProviderConfiguration], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("customer_billing_provider_configuration")
            @ExcludeMissing
            fun _customerBillingProviderConfiguration(): JsonField<CustomerBillingProviderConfiguration> = customerBillingProviderConfiguration
            ...
            @ExcludeMissing
            fun _hasMore(): JsonField<HasMore> = hasMore
             ...
             *
             * Unlike [multiplierOverridePrioritization], this method doesn't throw if the JSON field has an unexpected type.
             */
            @JsonProperty("multiplier_override_prioritization")
            @ExcludeMissing
            fun _multiplierOverridePrioritization(): JsonField<MultiplierOverridePrioritization> = multiplierOverridePrioritization
            ...
            class Builder internal constructor() {
                ...
                private var customerBillingProviderConfiguration: JsonField<CustomerBillingProviderConfiguration> = JsonMissing.of()
                ...
                private var multiplierOverridePrioritization: JsonField<MultiplierOverridePrioritization> = JsonMissing.of()
                 ...
                 *
                 * You should usually call [Builder.usageFilter] with a well-typed `List<UsageFilter>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun usageFilter(usageFilter: JsonField<List<UsageFilter>>) =
                    apply {
                 ...
                 * @throws IllegalStateException if the field was previously set to a non-list.
                 */
                fun addUsageFilter(usageFilter: UsageFilter) =
                    apply {
                        this.usageFilter = (this.usageFilter ?: JsonField.of(mutableListOf())).also {
                ...
                fun customerBillingProviderConfiguration(customerBillingProviderConfiguration: CustomerBillingProviderConfiguration) = customerBillingProviderConfiguration(JsonField.of(customerBillingProviderConfiguration))

                /**
                 * Sets [Builder.customerBillingProviderConfiguration] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.customerBillingProviderConfiguration] with a well-typed [CustomerBillingProviderConfiguration] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun customerBillingProviderConfiguration(customerBillingProviderConfiguration: JsonField<CustomerBillingProviderConfiguration>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.hasMore] with a well-typed [HasMore] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun hasMore(hasMore: JsonField<HasMore>) =
                    apply {
                ...
                /** Defaults to LOWEST_MULTIPLIER, which applies the greatest discount to list prices automatically. EXPLICIT prioritization requires specifying priorities for each multiplier; the one with the lowest priority value will be prioritized first. */
                fun multiplierOverridePrioritization(multiplierOverridePrioritization: MultiplierOverridePrioritization) = multiplierOverridePrioritization(JsonField.of(multiplierOverridePrioritization))

                /**
                 * Sets [Builder.multiplierOverridePrioritization] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.multiplierOverridePrioritization] with a well-typed [MultiplierOverridePrioritization] value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun multiplierOverridePrioritization(multiplierOverridePrioritization: JsonField<MultiplierOverridePrioritization>) =
                    apply {
                 ...
                 *
                 * You should usually call [Builder.subscriptions] with a well-typed `List<Subscription>` value instead. This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
            ...
            class UsageFilter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (groupKey.asKnown().isPresent) 1 else 0) + (groupValues.asKnown().getOrNull()?.size ?: 0) + (if (startingAt.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is UsageFilter && groupKey == other.groupKey && groupValues == other.groupValues && startingAt == other.startingAt && endingBefore == other.endingBefore && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "UsageFilter{groupKey=$groupKey, groupValues=$groupValues, startingAt=$startingAt, endingBefore=$endingBefore, additionalProperties=$additionalProperties}"
            }
            ...
            class CustomerBillingProviderConfiguration @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("delivery_method_configuration") @ExcludeMissing deliveryMethodConfiguration: JsonField<DeliveryMethodConfiguration> = JsonMissing.of(),
                 ...
                 * @throws MetronomeInvalidDataException if the JSON field has an unexpected type or is unexpectedly missing or null (e.g. if the server responded with an unexpected value).
                 */
                fun deliveryMethodConfiguration(): DeliveryMethodConfiguration = deliveryMethodConfiguration.getRequired("delivery_method_configuration")
                 ...
                 *
                 * Unlike [deliveryMethodConfiguration], this method doesn't throw if the JSON field has an unexpected type.
                 */
                @JsonProperty("delivery_method_configuration")
                @ExcludeMissing
                fun _deliveryMethodConfiguration(): JsonField<DeliveryMethodConfiguration> = deliveryMethodConfiguration
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(customerBillingProviderConfiguration: CustomerBillingProviderConfiguration) =
                        apply {
                            ...
                            deliveryMethodConfiguration = customerBillingProviderConfiguration.deliveryMethodConfiguration
                    ...
                    /** Configuration for the delivery method. The structure of this object is specific to the delivery method. */
                    fun deliveryMethodConfiguration(deliveryMethodConfiguration: DeliveryMethodConfiguration) = deliveryMethodConfiguration(JsonField.of(deliveryMethodConfiguration))

                    /**
                     * Sets [Builder.deliveryMethodConfiguration] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.deliveryMethodConfiguration] with a well-typed [DeliveryMethodConfiguration] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun deliveryMethodConfiguration(deliveryMethodConfiguration: JsonField<DeliveryMethodConfiguration>) =
                        apply {
                            this.deliveryMethodConfiguration = deliveryMethodConfiguration
                        }
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (id.asKnown().isPresent) 1 else 0) + (if (archivedAt.asKnown().isPresent) 1 else 0) + (billingProvider.asKnown().getOrNull()?.validity() ?: 0) + (configuration.asKnown().getOrNull()?.validity() ?: 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (deliveryMethod.asKnown().getOrNull()?.validity() ?: 0) + (deliveryMethodConfiguration.asKnown().getOrNull()?.validity() ?: 0) + (if (deliveryMethodId.asKnown().isPresent) 1 else 0)
                ...
                /** Configuration for the delivery method. The structure of this object is specific to the delivery method. */
                class DeliveryMethodConfiguration @JsonCreator private constructor(
                    @com.fasterxml.jackson.annotation.JsonValue private val additionalProperties: Map<String, JsonValue>,
                    ...
                    companion object {
                        ...
                        /** Returns a mutable builder for constructing an instance of [DeliveryMethodConfiguration]. */
                        @JvmStatic
                        fun builder() = Builder()
                    }
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(deliveryMethodConfiguration: DeliveryMethodConfiguration) =
                            apply {
                                additionalProperties = deliveryMethodConfiguration.additionalProperties.toMutableMap()
                            }
                         ...
                         * Further updates to this [Builder] will not mutate the returned instance.
                         */
                        fun build(): DeliveryMethodConfiguration = DeliveryMethodConfiguration(additionalProperties.toImmutable())
                    }
                     ...
                     *   expected type.
                     */
                    fun validate(): DeliveryMethodConfiguration =
                        apply {
                            if (validated) {
                              return@apply
                            }
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is DeliveryMethodConfiguration && additionalProperties == other.additionalProperties
                    }
                    ...
                    override fun toString() = "DeliveryMethodConfiguration{additionalProperties=$additionalProperties}"
                }
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is CustomerBillingProviderConfiguration && id == other.id && archivedAt == other.archivedAt && billingProvider == other.billingProvider && configuration == other.configuration && customerId == other.customerId && deliveryMethod == other.deliveryMethod && deliveryMethodConfiguration == other.deliveryMethodConfiguration && deliveryMethodId == other.deliveryMethodId && additionalProperties == other.additionalProperties
                }
            ...
            class HasMore @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                @JsonCreator
                private constructor(
                    @JsonProperty("commits") @ExcludeMissing commits: JsonField<Boolean> = JsonMissing.of(),
                    @JsonProperty("credits") @ExcludeMissing credits: JsonField<Boolean> = JsonMissing.of()
                ) : this(
                  commits,
                  credits,
                  mutableMapOf(),
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(hasMore: HasMore) =
                        apply {
                     ...
                     * Sets [Builder.commits] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.commits] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun commits(commits: JsonField<Boolean>) =
                        apply {
                     ...
                     * Sets [Builder.credits] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.credits] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun credits(credits: JsonField<Boolean>) =
                        apply {
                 ...
                 */
                @JvmSynthetic
                internal fun validity(): Int = (if (commits.asKnown().isPresent) 1 else 0) + (if (credits.asKnown().isPresent) 1 else 0)
                ...
                override fun equals(other: Any?): Boolean {
                  ...
                  return other is HasMore && commits == other.commits && credits == other.credits && additionalProperties == other.additionalProperties
                }
                ...
                override fun toString() = "HasMore{commits=$commits, credits=$credits, additionalProperties=$additionalProperties}"
            }

            /** Defaults to LOWEST_MULTIPLIER, which applies the greatest discount to list prices automatically. EXPLICIT prioritization requires specifying priorities for each multiplier; the one with the lowest priority value will be prioritized first. */
            class MultiplierOverridePrioritization @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                /**
                 * An enum containing [MultiplierOverridePrioritization]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [MultiplierOverridePrioritization] can contain an unknown value in a couple of cases:
                 *
                 * - It was deserialized from data that doesn't match any known member. For example, if the SDK is on
                 *   an older version than the API, then the API may respond with new members that the SDK is unaware
                 *   of.
                ...
                enum class Value {
                    LOWEST_MULTIPLIER,
                    EXPLICIT,
                    /** An enum member indicating that [MultiplierOverridePrioritization] was instantiated with an unknown value. */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        else -> throw MetronomeInvalidDataException("Unknown MultiplierOverridePrioritization: $value")
                    }
                 ...
                 *   expected type.
                 */
                fun validate(): MultiplierOverridePrioritization =
                    apply {
                        if (validated) {
                          return@apply
                        }
            ...
            class RecurringCommit @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("contract") @ExcludeMissing contract: JsonField<InnerContract> = JsonMissing.of(),
                ...
                class Builder internal constructor() {
                     ...
                     * Sets [Builder.contract] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.contract] with a well-typed [InnerContract] value instead. This method is primarily for setting the field to an undocumented or not yet
                     * supported value.
                     */
                    fun contract(contract: JsonField<InnerContract>) =
                        apply {
                            this.contract = contract
                        }
                ...
                class InnerContract @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
                    private val id: JsonField<String>,
                    private val additionalProperties: MutableMap<String, JsonValue>,
                    ...
                    companion object {
                        ...
                        /**
                         * Returns a mutable builder for constructing an instance of [InnerContract].
                         *
                         * The following fields are required:
                         *
                         * ```java
                    ...
                    class Builder internal constructor() {
                        ...
                        @JvmSynthetic
                        internal fun from(innerContract: InnerContract) =
                            apply {
                                id = innerContract.id
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is InnerContract && id == other.id && additionalProperties == other.additionalProperties
                    }
                    ...
                    override fun toString() = "InnerContract{id=$id, additionalProperties=$additionalProperties}"
                }
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data && id == other.id && contract == other.contract && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{id=$id, contract=$contract, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is ContractCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "ContractCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
