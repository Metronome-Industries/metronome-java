...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanListCustomersPageAsync && plansService == other.plansService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = PlanListCustomersPageAsync(plansService, params, response)
    }
    ...
    class AutoPager(private val firstPage: PlanListCustomersPageAsync) {
