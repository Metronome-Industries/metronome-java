...
class BillableMetricListPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<BillableMetricListPageAsync> = service.list(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billableMetricListPageAsync: BillableMetricListPageAsync) =
            apply {
        ...
        fun service(service: BillableMetricServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is BillableMetricListPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "BillableMetricListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
