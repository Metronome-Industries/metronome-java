 ...
 */
class V1CreditGrantListEntriesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): V1CreditGrantListEntriesParams = builder().build()

        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [V1CreditGrantListEntriesParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1CreditGrantListEntriesParams: V1CreditGrantListEntriesParams) = apply {
            nextPage = v1CreditGrantListEntriesParams.nextPage
            sort = v1CreditGrantListEntriesParams.sort
            body = v1CreditGrantListEntriesParams.body.toBuilder()
            additionalHeaders = v1CreditGrantListEntriesParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1CreditGrantListEntriesParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1CreditGrantListEntriesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CreditGrantListEntriesParams && nextPage == other.nextPage && sort == other.sort && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(nextPage, sort, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1CreditGrantListEntriesParams{nextPage=$nextPage, sort=$sort, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
