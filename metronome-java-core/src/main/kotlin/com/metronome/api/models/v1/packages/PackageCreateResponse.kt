...
class PackageCreateResponse @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PackageCreateResponse].
         *
    ...
    /** A builder for [PackageCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(packageCreateResponse: PackageCreateResponse) =
            apply {
                data = packageCreateResponse.data
                additionalProperties = packageCreateResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PackageCreateResponse].
         *
         ...
         */
        fun build(): PackageCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): PackageCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PackageCreateResponse && data == other.data && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PackageCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
