...
class V1ContractRetrieveRateScheduleParamsTest {
        ...
        V1ContractRetrieveRateScheduleParams.builder()
            ...
            .addSelector(
                V1ContractRetrieveRateScheduleParams.Selector.builder()
                    .billingFrequency(
                        V1ContractRetrieveRateScheduleParams.Selector.BillingFrequency.MONTHLY
                    )
                    .partialPricingGroupValues(
                        V1ContractRetrieveRateScheduleParams.Selector.PartialPricingGroupValues
                            .builder()
                    ...
                    .pricingGroupValues(
                        V1ContractRetrieveRateScheduleParams.Selector.PricingGroupValues.builder()
