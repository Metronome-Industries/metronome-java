 ...
 */
class V1ContractRetrieveParams
private constructor(
    ...
    /** A builder for [V1ContractRetrieveParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1ContractRetrieveParams: V1ContractRetrieveParams) = apply {
            body = v1ContractRetrieveParams.body.toBuilder()
            additionalHeaders = v1ContractRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1ContractRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): V1ContractRetrieveParams =
            V1ContractRetrieveParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRetrieveParams && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "V1ContractRetrieveParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
