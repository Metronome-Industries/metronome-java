 ...
 */
class ContractGetEditHistoryParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractGetEditHistoryParams: ContractGetEditHistoryParams) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContractGetEditHistoryParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ContractGetEditHistoryParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
