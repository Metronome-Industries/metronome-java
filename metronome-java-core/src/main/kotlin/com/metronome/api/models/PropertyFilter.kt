...
class PropertyFilter @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("in_values") @ExcludeMissing inValues: JsonField<List<String>> = JsonMissing.of(),
        @JsonProperty("not_in_values") @ExcludeMissing notInValues: JsonField<List<String>> = JsonMissing.of()
    ) : this(
      name,
      exists,
      inValues,
    ...
    @JsonProperty("exists")
    @ExcludeMissing
    fun _exists(): JsonField<Boolean> = exists
    ...
    @ExcludeMissing
    fun _inValues(): JsonField<List<String>> = inValues
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(propertyFilter: PropertyFilter) =
            apply {
         ...
         *
         * You should usually call [Builder.exists] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun exists(exists: JsonField<Boolean>) =
            apply {
                this.exists = exists
            }
         ...
         *
         * You should usually call [Builder.inValues] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun inValues(inValues: JsonField<List<String>>) =
            apply {
         ...
         */
        fun addInValue(inValue: String) =
            apply {
                inValues = (inValues ?: JsonField.of(mutableListOf())).also {
         ...
         *
         * You should usually call [Builder.notInValues] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun notInValues(notInValues: JsonField<List<String>>) =
            apply {
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addNotInValue(notInValue: String) =
            apply {
                notInValues = (notInValues ?: JsonField.of(mutableListOf())).also {
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = (if (name.asKnown().isPresent) 1 else 0) + (if (exists.asKnown().isPresent) 1 else 0) + (inValues.asKnown().getOrNull()?.size ?: 0) + (notInValues.asKnown().getOrNull()?.size ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PropertyFilter && name == other.name && exists == other.exists && inValues == other.inValues && notInValues == other.notInValues && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "PropertyFilter{name=$name, exists=$exists, inValues=$inValues, notInValues=$notInValues, additionalProperties=$additionalProperties}"
}
