 ...
 *
 */
class UsageListWithGroupsParams private constructor(
    ...
    /**
     * Object mapping group keys to arrays of values to filter on. Only usage matching these filter values will be returned.
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageListWithGroupsParams: UsageListWithGroupsParams) =
            apply {
         ...
         *
         * You should usually call [Builder.windowSize] with a well-typed [WindowSize] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun windowSize(windowSize: JsonField<WindowSize>) =
            apply {
                body.windowSize(windowSize)
            }

        /** If true, will return the usage for the current billing period. Will return an error if the customer is currently uncontracted or starting_on and ending_before are specified when this is true. */
        fun currentPeriod(currentPeriod: Boolean) =
            apply {
         ...
         *
         * You should usually call [Builder.currentPeriod] with a well-typed [Boolean] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun currentPeriod(currentPeriod: JsonField<Boolean>) =
            apply {
                body.currentPeriod(currentPeriod)
            }
         ...
         *
         * You should usually call [Builder.groupBy] with a well-typed [GroupBy] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        @Deprecated("deprecated")
        fun groupBy(groupBy: JsonField<GroupBy>) =
            apply {
                body.groupBy(groupBy)
            }
         ...
         *
         */
        fun groupFilters(groupFilters: GroupFilters) =
            apply {
         ...
         *
         * You should usually call [Builder.groupFilters] with a well-typed [GroupFilters] value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groupFilters(groupFilters: JsonField<GroupFilters>) =
            apply {
                body.groupFilters(groupFilters)
            }
         ...
         *
         */
        fun groupKey(groupKey: List<String>) =
            apply {
         ...
         *
         * You should usually call [Builder.groupKey] with a well-typed `List<String>` value instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun groupKey(groupKey: JsonField<List<String>>) =
            apply {
                body.groupKey(groupKey)
            }
         ...
         */
        fun addGroupKey(groupKey: String) =
            apply {
    ...
    class Body @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("window_size") @ExcludeMissing windowSize: JsonField<WindowSize> = JsonMissing.of(),
            @JsonProperty("current_period") @ExcludeMissing currentPeriod: JsonField<Boolean> = JsonMissing.of(),
            ...
            @JsonProperty("group_filters") @ExcludeMissing groupFilters: JsonField<GroupFilters> = JsonMissing.of(),
            @JsonProperty("group_key") @ExcludeMissing groupKey: JsonField<List<String>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun addGroupKey(groupKey: String) =
                apply {
                    this.groupKey = (this.groupKey ?: JsonField.of(mutableListOf())).also {
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (billableMetricId.asKnown().isPresent) 1 else 0) + (if (customerId.asKnown().isPresent) 1 else 0) + (windowSize.asKnown().getOrNull()?.validity() ?: 0) + (if (currentPeriod.asKnown().isPresent) 1 else 0) + (if (endingBefore.asKnown().isPresent) 1 else 0) + (groupBy.asKnown().getOrNull()?.validity() ?: 0) + (groupFilters.asKnown().getOrNull()?.validity() ?: 0) + (groupKey.asKnown().getOrNull()?.size ?: 0) + (if (startingOn.asKnown().isPresent) 1 else 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Body && billableMetricId == other.billableMetricId && customerId == other.customerId && windowSize == other.windowSize && currentPeriod == other.currentPeriod && endingBefore == other.endingBefore && groupBy == other.groupBy && groupFilters == other.groupFilters && groupKey == other.groupKey && startingOn == other.startingOn && additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy { Objects.hash(billableMetricId, customerId, windowSize, currentPeriod, endingBefore, groupBy, groupFilters, groupKey, startingOn, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() = "Body{billableMetricId=$billableMetricId, customerId=$customerId, windowSize=$windowSize, currentPeriod=$currentPeriod, endingBefore=$endingBefore, groupBy=$groupBy, groupFilters=$groupFilters, groupKey=$groupKey, startingOn=$startingOn, additionalProperties=$additionalProperties}"
    }
    ...
    /** Use group_key and group_filters instead. Use a single group key to group by. Compound group keys are not supported. */
    @Deprecated("deprecated")
    class GroupBy @JsonCreator(mode = JsonCreator.Mode.DISABLED) private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(groupBy: GroupBy) =
                apply {
                    key = groupBy.key
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (key.asKnown().isPresent) 1 else 0) + (values.asKnown().getOrNull()?.size ?: 0)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is GroupBy && key == other.key && values == other.values && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "GroupBy{key=$key, values=$values, additionalProperties=$additionalProperties}"
    }
     ...
     *
     */
    class GroupFilters @JsonCreator private constructor(
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(groupFilters: GroupFilters) =
                apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UsageListWithGroupsParams && limit == other.limit && nextPage == other.nextPage && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int = Objects.hash(limit, nextPage, body, additionalHeaders, additionalQueryParams)

    override fun toString() = "UsageListWithGroupsParams{limit=$limit, nextPage=$nextPage, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
