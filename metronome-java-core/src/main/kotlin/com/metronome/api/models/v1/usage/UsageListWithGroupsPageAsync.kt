...
class UsageListWithGroupsPageAsync private constructor(
    ...
    override fun nextPage(): CompletableFuture<UsageListWithGroupsPageAsync> = service.listWithGroups(nextPageParams())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageListWithGroupsPageAsync: UsageListWithGroupsPageAsync) =
            apply {
        ...
        fun service(service: UsageServiceAsync) =
            apply {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is UsageListWithGroupsPageAsync && service == other.service && streamHandlerExecutor == other.streamHandlerExecutor && params == other.params && response == other.response
    }

    override fun hashCode(): Int = Objects.hash(service, streamHandlerExecutor, params, response)

    override fun toString() = "UsageListWithGroupsPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
