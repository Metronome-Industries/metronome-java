...
class V1ContractRateCardRetrieveRateScheduleParamsTest {
        ...
        V1ContractRateCardRetrieveRateScheduleParams.builder()
            ...
            .addSelector(
                V1ContractRateCardRetrieveRateScheduleParams.Selector.builder()
                    .billingFrequency(
                        V1ContractRateCardRetrieveRateScheduleParams.Selector.BillingFrequency
                            .MONTHLY
                    )
                    ...
                    .pricingGroupValues(
                        V1ContractRateCardRetrieveRateScheduleParams.Selector.PricingGroupValues
                            .builder()
