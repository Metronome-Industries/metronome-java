...
class PricingUnitServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PricingUnitService {

    private val withRawResponse: PricingUnitService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): PricingUnitService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PricingUnitService = PricingUnitServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun list(params: PricingUnitListParams, requestOptions: RequestOptions): PricingUnitListPage =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun withOptions(modifier: Consumer<ClientOptions.Builder>): PricingUnitService.WithRawResponse = PricingUnitServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier::accept).build())
        ...
        override fun list(params: PricingUnitListParams, requestOptions: RequestOptions): HttpResponseFor<PricingUnitListPage> {
