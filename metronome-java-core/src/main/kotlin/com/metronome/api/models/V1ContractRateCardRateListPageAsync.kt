 ...
 */
class V1ContractRateCardRateListPageAsync
private constructor(
    private val ratesService: RateServiceAsync,
    private val params: V1ContractRateCardRateListParams,
    ...
    fun data(): List<V1ContractRateCardRateListResponse> = response().data()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateListPageAsync && ratesService == other.ratesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(ratesService, params, response) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardRateListPageAsync{ratesService=$ratesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): Optional<V1ContractRateCardRateListParams> {
        if (!hasNextPage()) {
    ...
    fun getNextPage(): CompletableFuture<Optional<V1ContractRateCardRateListPageAsync>> {
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1ContractRateCardRateListPageAsync(ratesService, params, response)
    }
    ...
    constructor(
        ...
        @JsonProperty("data")
        private val data: JsonField<List<V1ContractRateCardRateListResponse>> = JsonMissing.of(),
        @JsonAnySetter
        ...
        fun data(): List<V1ContractRateCardRateListResponse> = data.getNullable("data") ?: listOf()

        @JsonProperty("next_page")
        fun _nextPage(): Optional<JsonField<String>> = Optional.ofNullable(nextPage)

        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<V1ContractRateCardRateListResponse>>> =
        ...
        class Builder {
            ...
            private var data: JsonField<List<V1ContractRateCardRateListResponse>> = JsonMissing.of()
            ...
            fun data(data: List<V1ContractRateCardRateListResponse>) = data(JsonField.of(data))

            fun data(data: JsonField<List<V1ContractRateCardRateListResponse>>) = apply {
                this.data = data
            }
    ...
    class AutoPager(private val firstPage: V1ContractRateCardRateListPageAsync) {

        fun forEach(
            action: Predicate<V1ContractRateCardRateListResponse>,
            executor: Executor,
        ): CompletableFuture<Void> {
            fun CompletableFuture<Optional<V1ContractRateCardRateListPageAsync>>.forEach(
                action: (V1ContractRateCardRateListResponse) -> Boolean,
                executor: Executor,
            ): CompletableFuture<Void> =
                thenComposeAsync(
                    { page ->
        ...
        fun toList(
            executor: Executor
        ): CompletableFuture<List<V1ContractRateCardRateListResponse>> {
            val values = mutableListOf<V1ContractRateCardRateListResponse>()
