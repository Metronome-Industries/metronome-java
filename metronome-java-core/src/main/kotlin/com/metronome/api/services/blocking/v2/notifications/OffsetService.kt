...
interface OffsetService {
    ...
    interface WithRawResponse {
         ...
         * the same as [OffsetService.list].
         */
        @MustBeClosed fun list(): HttpResponseFor<OffsetListPage> = list(OffsetListParams.none())
        ...
        fun list(
            params: OffsetListParams = OffsetListParams.none()
        ): HttpResponseFor<OffsetListPage> = list(params, RequestOptions.none())
