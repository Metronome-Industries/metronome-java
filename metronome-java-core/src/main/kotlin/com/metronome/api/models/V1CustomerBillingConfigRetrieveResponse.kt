...
@NoAutoDetect
class V1CustomerBillingConfigRetrieveResponse
@JsonCreator
private constructor(
    ...
    fun validate(): V1CustomerBillingConfigRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [V1CustomerBillingConfigRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            v1CustomerBillingConfigRetrieveResponse: V1CustomerBillingConfigRetrieveResponse
        ) = apply {
            data = v1CustomerBillingConfigRetrieveResponse.data
            additionalProperties =
                v1CustomerBillingConfigRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        fun build(): V1CustomerBillingConfigRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1CustomerBillingConfigRetrieveResponse && data == other.data && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "V1CustomerBillingConfigRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
