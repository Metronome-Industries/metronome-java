 ...
 */
class V1ContractRateCardRateListPage
private constructor(
    private val ratesService: RateService,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is V1ContractRateCardRateListPage && ratesService == other.ratesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(ratesService, params, response) /* spotless:on */

    override fun toString() =
        "V1ContractRateCardRateListPage{ratesService=$ratesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<V1ContractRateCardRateListPage> {
        return getNextPageParams().map { ratesService.list(it) }
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = V1ContractRateCardRateListPage(ratesService, params, response)
    }
    ...
    class AutoPager(private val firstPage: V1ContractRateCardRateListPage) :
        Iterable<V1ContractRateCardRateListResponse> {

        override fun iterator(): Iterator<V1ContractRateCardRateListResponse> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<V1ContractRateCardRateListResponse> {
