...
class ContractServiceAsyncImpl internal constructor(
    ...
    override fun edit(params: ContractEditParams, requestOptions: RequestOptions): CompletableFuture<ContractEditResponse> =
        // post /v2/contracts/edit
        withRawResponse().edit(params, requestOptions).thenApply { it.parse() }

    override fun editCommit(params: ContractEditCommitParams, requestOptions: RequestOptions): CompletableFuture<ContractEditCommitResponse> =
        // post /v2/contracts/commits/edit
        withRawResponse().editCommit(params, requestOptions).thenApply { it.parse() }

    override fun editCredit(params: ContractEditCreditParams, requestOptions: RequestOptions): CompletableFuture<ContractEditCreditResponse> =
        // post /v2/contracts/credits/edit
        withRawResponse().editCredit(params, requestOptions).thenApply { it.parse() }

    override fun getEditHistory(params: ContractGetEditHistoryParams, requestOptions: RequestOptions): CompletableFuture<ContractGetEditHistoryResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun edit(params: ContractEditParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ContractEditResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun editCommit(params: ContractEditCommitParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ContractEditCommitResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun editCredit(params: ContractEditCreditParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ContractEditCreditResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
        ...
        override fun getEditHistory(params: ContractGetEditHistoryParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ContractGetEditHistoryResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .baseUrl(clientOptions.baseUrl())
