...
constructor(
    ...
    @JvmSynthetic
    internal fun getBody(): CreditListEntriesBody {
        return CreditListEntriesBody(
            creditTypeIds,
            customerIds,
            endingBefore,
            startingOn,
    ...
    @JsonDeserialize(builder = CreditListEntriesBody.Builder::class)
    @NoAutoDetect
    class CreditListEntriesBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CreditListEntriesBody &&
        ...
        override fun toString() =
            "CreditListEntriesBody{creditTypeIds=$creditTypeIds, customerIds=$customerIds, endingBefore=$endingBefore, startingOn=$startingOn, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(creditListEntriesBody: CreditListEntriesBody) = apply {
                this.creditTypeIds = creditListEntriesBody.creditTypeIds
                this.customerIds = creditListEntriesBody.customerIds
                this.endingBefore = creditListEntriesBody.endingBefore
                this.startingOn = creditListEntriesBody.startingOn
                additionalProperties(creditListEntriesBody.additionalProperties)
            }
            ...
            fun build(): CreditListEntriesBody =
                CreditListEntriesBody(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditListEntriesParams &&
            this.creditTypeIds == other.creditTypeIds &&
            this.customerIds == other.customerIds &&
            this.endingBefore == other.endingBefore &&
            this.startingOn == other.startingOn &&
    ...
    override fun toString() =
        "CreditListEntriesParams{creditTypeIds=$creditTypeIds, customerIds=$customerIds, endingBefore=$endingBefore, startingOn=$startingOn, nextPage=$nextPage, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(creditListEntriesParams: CreditListEntriesParams) = apply {
            this.nextPage = creditListEntriesParams.nextPage
            this.creditTypeIds(creditListEntriesParams.creditTypeIds ?: listOf())
            this.customerIds(creditListEntriesParams.customerIds ?: listOf())
            this.endingBefore = creditListEntriesParams.endingBefore
            this.startingOn = creditListEntriesParams.startingOn
            additionalQueryParams(creditListEntriesParams.additionalQueryParams)
            additionalHeaders(creditListEntriesParams.additionalHeaders)
            additionalBodyProperties(creditListEntriesParams.additionalBodyProperties)
        }
        ...
        fun build(): CreditListEntriesParams =
